...
**Status:** **full draft + tree_derived_v1 complete** — 45 units · **1213** STEPs (= 1213 verse trees)

**Related:**  
- Tree-derive track: `EXODUS_TREE_DERIVE_2026-07-24.md` · `artifacts/reprocess_exodus_from_trees.py`  
- Prior bulk map (historical): `EXODUS_BUILD_2026-07-21.md`  
...
- Bulk generator (superseded for logic grain): `artifacts/generate_exodus_units.py`
...
| 3. Logic shape | **tree_derived_v1:** one `STEP_Ex_C_V` per verse from top-split arms; law blocks keep `decision_table` | **done v1** |
| 4. he+translit+en | Structured fields (letter-map translit; en = [EN-AID]) | done |
| 5. Oral dual-track | Named; never silent-merge | done |
| 6. Mekhilta | Samples on decision_table units from `Data/mekhilta_*` | done where used |
| 7. Coverage | `tree_coverage` provisional roles; feeds per-verse STEP | done heuristic |
| 8. Confidence | hypothesis / tested — not binding law | labeled |
| 9. Not yet | Full TIR roles; human narrative gloss per arm; deep Mekhilta | open |

...
Claims come from TWO inputs, both run as a CHECKLIST: (a) the reading's
material rows, and (b) the standing canon rules that pattern-match the
span — the utterance census fires on every qualifying "and He said";
middah tagging fires on every argued inference. Day 4's blind round
proved the law: each side missed exactly one standing rule it knew.
...
twice over, blind-derived in both windows on 2026-08-21 and unified
claim-by-claim. (Day 4 rev 2 landed in canon; the workshop unit mirrors
when Brian's commit word lands it there.)

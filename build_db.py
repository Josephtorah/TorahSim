...
Builds torah_grok.sqlite: a DERIVED, REBUILDABLE index of the whole Torah —
...
logic/pre_logic_methods_2026-07-28/render_flat_ledger_morph_html.py.
"""
...
def verse_ids(book: str) -> list[tuple[str, int, int]]:
    xml = (ROOT / "Data" / f"{book}.xml").read_text(encoding="utf-8")
    out = []

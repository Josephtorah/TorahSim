...
ALLOW = {
    ...
    # the redesigned scroll page (website/scroll2/, generated by
    # tools/build_scroll2.py): one CSS class name, and transliterated
    # fragments inside triage-ledger notes whose surrounding English IS
    # the note — the same class as the generated-unit fragments above.
    # New pins land here deliberately when the generator's scope grows.
    ("index.html", "uband-head"),
    ("index.html", "ha-shamayim"),
    ("index.html", "seder-zemanim"),
    ("index.html", "va-yiqra"),
    ("index.html", "ve-harag"),
    ...
    ("front_door_mockup_v4_2026-08-23.html", "inline-flex"),
    ("front_door_mockup_v5_2026-08-25.html", "uband-head"),
    ("front_door_mockup_v5_2026-08-25.html", "inline-flex"),
}

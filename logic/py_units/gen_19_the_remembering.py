...
# ‹וַיִּזְכֹּר אֱלֹהִים אֶת־נֹחַ› (“and-He-remembered God obj-marker Noah”)
# ‹וְאֵת כָּל־הַחַיָּה וְאֶת־כָּל־הַבְּהֵמָה› (“obj-marker all the-beast
# obj-marker all the-livestock”)
# ‹אֲשֶׁר אִתּוֹ בַּתֵּבָה› (“which with-him in-ark”)
# ‹וַיַּעֲבֵר אֱלֹהִים רוּחַ› (“and-He-passed God wind/spirit”)
# ‹עַל־הָאָרֶץ וַיָּשֹׁכּוּ הַמָּיִם› (“over the-earth and-they-subsided
# the-waters”)
...
# ‹וְאֵת כָּל־הַחַיָּה וְאֶת־כָּל־הַבְּהֵמָה› (“obj-marker all the-beast
# obj-marker all the-livestock”)
# — event: remember — agent God; theme Noach, all-the-beast-and-the-
# livestock
m.event("remember", agent="elohim", themes=["noach", "kol_ha_chayah_ve_ha_behemah"])
# ‹וַיַּעֲבֵר אֱלֹהִים רוּחַ› (“and-He-passed God wind/spirit”)
# ‹עַל־הָאָרֶץ› (“over the-earth”)
# — event: pass — agent God; theme spirit-wind-over-the-earth
m.event("pass", agent="elohim", themes=["ruach_al_ha_aretz"])
# ‹וַיָּשֹׁכּוּ הַמָּיִם› (“and-they-subsided the-waters”)
# — event: subside — theme the-waters
...
# ‹וַיִּסָּכְרוּ מַעְיְנֹת תְּהוֹם› (“and-were-stopped-up fountains-of the-
# deep”)
# ‹וַאֲרֻבֹּת הַשָּׁמָיִם וַיִּכָּלֵא› (“and-windows-of the-heavens and-was-
# restrained”)
# ‹הַגֶּשֶׁם מִן־הַשָּׁמָיִם› (“the-rain from the-heavens”)
# "the fountains also of the deep and the windows of heaven were stopped,
# and the rain from heaven was restrained."
m.step("Gen.8.2")
# ‹וַיִּסָּכְרוּ מַעְיְנֹת תְּהוֹם› (“and-were-stopped-up fountains-of the-
# deep”)
# ‹וַאֲרֻבֹּת הַשָּׁמָיִם› (“and-windows-of the-heavens”)
# — event: stop-up — theme fountains-of-deep-and-windows-of-the-heavens
...
# the-heavens”)
# — event: restrain — theme the-rain
m.event("restrain", themes=["ha_geshem"])

# -------------------------- Gen.8.3 · THE_WATERS_COMMUTE_BRACKET_CLOSED ----
# ‹וַיָּשֻׁבוּ הַמַּיִם מֵעַל› (“and-they-returned the-waters from-over”)
# ‹הָאָרֶץ הָלוֹךְ וָשׁוֹב› (“the-earth going and-returning”)
# ‹וַיַּחְסְרוּ הַמַּיִם מִקְצֵה› (“and-they-diminished the-waters at-the-
# end-of”)
# ‹חֲמִשִּׁים וּמְאַת יוֹם› (“fifty and-hundred day”)
# "And the waters returned from off the earth continually; and after the end
# of a hundred and fifty days the waters decreased."
m.step("Gen.8.3")
# ‹וַיָּשֻׁבוּ הַמַּיִם מֵעַל› (“and-they-returned the-waters from-over”)
# ‹הָאָרֶץ› (“the-earth”)
# — event: return — agent the-waters
m.event("return", agent="ha_mayim")
# ‹הָלוֹךְ וָשׁוֹב … מִקְצֵה› (“going and-returning … at-the-end-of”)
# ‹חֲמִשִּׁים וּמְאַת יוֹם› (“fifty and-hundred day”)
# — fact holds: going-and-returning; from-at-the-end-of-fifty-and-hundred-
# day
m.fact("halokh_va_shov",
       "mi_qetze_chamishim_u_meat_yom")
# ‹וַיַּחְסְרוּ הַמַּיִם› (“and-they-diminished the-waters”)
# — event: diminish — theme the-waters
m.event("diminish", themes=["ha_mayim"])

# -------------------------- Gen.8.4 · THE_ARK_RESTS ------------------------
# ‹וַתָּנַח הַתֵּבָה בַּחֹדֶשׁ› (“and-it-rested the-ark in-month”)
# ‹הַשְּׁבִיעִי בְּשִׁבְעָה־עָשָׂר יוֹם› (“the-seventh in-seven teen day”)
# ‹לַחֹדֶשׁ עַל הָרֵי› (“of-month over mountain”)
# ‹אֲרָרָט› (“Ararat”)
# "And the ark rested in the seventh month, on the seventeenth day of the
# month, upon the mountains of Ararat."
m.step("Gen.8.4")
# ‹וַתָּנַח הַתֵּבָה› (“and-it-rested the-ark”)
# — event: rest — theme the-ark
m.event("rest", themes=["ha_tevah"])
# ‹בַּחֹדֶשׁ הַשְּׁבִיעִי בְּשִׁבְעָה־עָשָׂר› (“in-month the-seventh in-
# seven teen”)
# ‹יוֹם לַחֹדֶשׁ עַל› (“day of-month over”)
# ‹הָרֵי אֲרָרָט› (“mountain Ararat”)
# — fact holds: in-the-of-month-the-seventh-in-seven-teen-day; over-
# mountains-of-Ararat
m.fact("ba_chodesh_ha_shevii_be_shivah_asar_yom",
       "al_harei_ararat")

# -------------------------- Gen.8.5 · THE_TOPS_APPEAR ----------------------
# ‹וְהַמַּיִם הָיוּ הָלוֹךְ› (“and-the-waters be going”)
# ‹וְחָסוֹר עַד הַחֹדֶשׁ› (“and-diminishing until the-month”)
# ‹הָעֲשִׂירִי בָּעֲשִׂירִי בְּאֶחָד› (“the-tenth in-the-tenth in-one”)
# ‹לַחֹדֶשׁ נִרְאוּ רָאשֵׁי› (“of-month were-seen the-tops-of”)
# ‹הֶהָרִים› (“the-mountain”)
...
# seen."
m.step("Gen.8.5")
# ‹הָלוֹךְ וְחָסוֹר … נִרְאוּ› (“going and-diminishing … were-seen”)
# ‹רָאשֵׁי הֶהָרִים› (“the-tops-of the-mountain”)
# — fact holds: going-and-diminishing-until-the-of-month-the-tenth; in-the-
# tenth-in-one-were-seen-tops-of-he-mountains
m.fact("halokh_ve_chasor_ad_ha_chodesh_ha_asiri",
       "ba_asiri_be_echad_niru_rashei_he_harim")

# -------------------------- Gen.8.6 · THE_WINDOW_HE_MADE -------------------
# ‹וַיְהִי מִקֵּץ אַרְבָּעִים› (“and-be at-the-end-of forty”)
# ‹יוֹם וַיִּפְתַּח נֹחַ› (“day and-he-opened Noah”)
# ‹אֶת־חַלּוֹן הַתֵּבָה אֲשֶׁר› (“obj-marker window the-ark which”)
# ‹עָשָׂה› (“he-had-made”)
# "And it came to pass at the end of forty days, that Noah opened the window
# of the ark which he had made."
m.step("Gen.8.6")
# ‹מִקֵּץ אַרְבָּעִים יוֹם› (“at-the-end-of forty day”)
# — fact holds: from-at-the-end-of-forty-day
m.fact("mi_qetz_arbaim_yom")
# ‹וַיִּפְתַּח נֹחַ אֶת־חַלּוֹן› (“and-he-opened Noah obj-marker window”)
# ‹הַתֵּבָה אֲשֶׁר עָשָׂה› (“the-ark which he-had-made”)
# — event: open — agent Noach; theme window-the-ark
m.event("open", agent="noach", themes=["chalon_ha_tevah"])

# -------------------------- Gen.8.7 · THE_RAVEN ----------------------------
# ‹וַיְשַׁלַּח אֶת־הָעֹרֵב וַיֵּצֵא› (“and-he-sent obj-marker the-raven and-
# it-went-out”)
# ‹יָצוֹא וָשׁוֹב עַד־יְבֹשֶׁת› (“going-out and-returning until the-drying-
# of”)
# ‹הַמַּיִם מֵעַל הָאָרֶץ› (“the-waters from-over the-earth”)
# "And he sent forth a raven, and it went forth to and fro, until the waters
# were dried up from off the earth."
m.step("Gen.8.7")
# ‹וַיְשַׁלַּח אֶת־הָעֹרֵב› (“and-he-sent obj-marker the-raven”)
# — event: send — agent Noach; theme the-raven
m.event("send", agent="noach", themes=["ha_orev"])
# ‹יָצוֹא וָשׁוֹב עַד־יְבֹשֶׁת› (“going-out and-returning until the-drying-
# of”)
# ‹הַמַּיִם› (“the-waters”)
# — fact holds: going-out-and-returning-until-drying-of-the-waters
...
# ‹וַיְשַׁלַּח אֶת־הַיּוֹנָה מֵאִתּוֹ› (“and-he-sent obj-marker the-dove
# from-him”)
# — event: send — agent Noach; theme the-dove
...
# ‹וְלֹא־מָצְאָה הַיּוֹנָה מָנוֹחַ› (“and-not she-found the-dove resting-
# place”)
# ‹לְכַף־רַגְלָהּ וַתָּשָׁב אֵלָיו› (“for-the-sole-of her-foot and-return
# to-him”)
# ‹אֶל־הַתֵּבָה כִּי־מַיִם עַל־פְּנֵי› (“to the-ark that waters over face”)
# ‹כָל־הָאָרֶץ וַיִּשְׁלַח יָדוֹ› (“all the-earth and-he-sent hand-him/its”)
# ‹וַיִּקָּחֶהָ וַיָּבֵא אֹתָהּ› (“and-took-her and-brought-her-in obj-
# marker”)
# ‹אֵלָיו אֶל־הַתֵּבָה› (“to-him to the-ark”)
...
# — fact holds: not-found-the-dove-resting-place-to-sole-of-her-foot; that-
# waters-over-face-of-all-the-earth
m.fact("lo_matzah_ha_yonah_manoach_le_khaf_raglah",
       "ki_mayim_al_pnei_khol_ha_aretz")
# ‹וַתָּשָׁב אֵלָיו אֶל־הַתֵּבָה› (“and-return to-him to the-ark”)
# — event: return — agent the-dove
m.event("return", agent="ha_yonah")
# ‹וַיִּשְׁלַח יָדוֹ› (“and-he-sent hand-him/its”)
# — event: send — agent Noach; theme his-hand
m.event("send", agent="noach", themes=["yado"])
# ‹וַיִּקָּחֶהָ› (“and-took-her”)
# — event: take — agent Noach; theme the-dove
m.event("take", agent="noach", themes=["ha_yonah"])
# ‹וַיָּבֵא אֹתָהּ אֵלָיו› (“and-brought-her-in obj-marker to-him”)
# ‹אֶל־הַתֵּבָה› (“to the-ark”)
# — event: bring — agent Noach; theme the-dove
m.event("bring", agent="noach", themes=["ha_yonah"])

# -------------------------- Gen.8.10 · THE_FIRST_WAIT ----------------------
# ‹וַיָּחֶל עוֹד שִׁבְעַת› (“and-he-waited again seven”)
# ‹יָמִים אֲחֵרִים וַיֹּסֶף› (“day other and-he-again”)
# ‹שַׁלַּח אֶת־הַיּוֹנָה מִן־הַתֵּבָה› (“to-send obj-marker the-dove from
# the-ark”)
# "And he stayed yet other seven days; and again he sent forth the dove out
# of the ark."
m.step("Gen.8.10")
# ‹וַיָּחֶל עוֹד שִׁבְעַת› (“and-he-waited again seven”)
# ‹יָמִים אֲחֵרִים› (“day other”)
# — event: wait — agent Noach
m.event("wait", agent="noach")
# ‹עוֹד שִׁבְעַת יָמִים› (“again seven day”)
# ‹אֲחֵרִים› (“other”)
# — fact holds: again-seven-day-other
...
# ‹וַתָּבֹא אֵלָיו הַיּוֹנָה› (“and-come/bring to-him the-dove”)
# ‹לְעֵת עֶרֶב וְהִנֵּה› (“at-the-time-of evening and-behold”)
# ‹עֲלֵה־זַיִת טָרָף בְּפִיהָ› (“leaf olive freshly-plucked in-her-mouth”)
# ‹וַיֵּדַע נֹחַ כִּי־קַלּוּ› (“and-he-knew Noah that abated”)
# ‹הַמַּיִם מֵעַל הָאָרֶץ› (“the-waters from-over the-earth”)
...
m.step("Gen.8.11")
# ‹וַתָּבֹא אֵלָיו הַיּוֹנָה› (“and-come/bring to-him the-dove”)
# ‹לְעֵת עֶרֶב› (“at-the-time-of evening”)
# — event: come — agent the-dove; theme to-obj-marker·et-evening
m.event("come", agent="ha_yonah", themes=["le_et_erev"])
# ‹וְהִנֵּה עֲלֵה־זַיִת טָרָף› (“and-behold leaf olive freshly-plucked”)
# ‹בְּפִיהָ› (“in-her-mouth”)
# — fact holds: leaf-olive-freshly-plucked-in-her-mouth
m.fact("aleh_zayit_taraf_be_fiha")
# ‹וַיֵּדַע נֹחַ כִּי־קַלּוּ› (“and-he-knew Noah that abated”)
# ‹הַמַּיִם› (“the-waters”)
# — event: know — agent Noach; theme that-whether-they-abated-the-waters
...
# ‹וַיִּיָּחֶל עוֹד שִׁבְעַת› (“and-he-waited again seven”)
# ‹יָמִים אֲחֵרִים וַיְשַׁלַּח› (“day other and-he-sent”)
# ‹אֶת־הַיּוֹנָה וְלֹא־יָסְפָה שׁוּב־אֵלָיו› (“obj-marker the-dove and-not
# added to-return to-him”)
# ‹עוֹד› (“again”)
...
# — event: wait — agent Noach
m.event("wait", agent="noach")
# ‹וַיְשַׁלַּח אֶת־הַיּוֹנָה› (“and-he-sent obj-marker the-dove”)
# — event: send — agent Noach; theme the-dove
m.event("send", agent="noach", themes=["ha_yonah"])
...
# ‹וַיְהִי בְּאַחַת וְשֵׁשׁ־מֵאוֹת› (“and-be in-one and-six hundred”)
# ‹שָׁנָה בָּרִאשׁוֹן בְּאֶחָד› (“year in-the-first-month in-one”)
# ‹לַחֹדֶשׁ חָרְבוּ הַמַּיִם› (“of-month were-parched the-waters”)
# ‹מֵעַל הָאָרֶץ וַיָּסַר› (“from-over the-earth and-he-removed”)
# ‹נֹחַ אֶת־מִכְסֵה הַתֵּבָה› (“Noah obj-marker covering the-ark”)
# ‹וַיַּרְא וְהִנֵּה חָרְבוּ› (“and-he-saw and-behold were-parched”)
# ‹פְּנֵי הָאֲדָמָה› (“face the-ground”)
...
m.step("Gen.8.13")
# ‹בְּאַחַת וְשֵׁשׁ־מֵאוֹת שָׁנָה› (“in-one and-six hundred year”)
# ‹בָּרִאשׁוֹן בְּאֶחָד לַחֹדֶשׁ› (“in-the-first-month in-one of-month”)
# — clock anchored: t0 := year-of-601-of-month-1-day-1
m.time_anchor("shnat_601_chodesh_1_yom_1")
# ‹חָרְבוּ הַמַּיִם מֵעַל› (“were-parched the-waters from-over”)
# ‹הָאָרֶץ› (“the-earth”)
# — fact holds: were-parched-the-waters-from-over-the-earth
m.fact("charvu_ha_mayim_me_al_ha_aretz")
# ‹וַיָּסַר נֹחַ אֶת־מִכְסֵה› (“and-he-removed Noah obj-marker covering”)
# ‹הַתֵּבָה› (“the-ark”)
# — event: remove — agent Noach; theme covering-the-ark
m.event("remove", agent="noach", themes=["mikhseh_ha_tevah"])
# ‹וַיַּרְא וְהִנֵּה חָרְבוּ› (“and-he-saw and-behold were-parched”)
# ‹פְּנֵי הָאֲדָמָה› (“face the-ground”)
# — event: see — agent Noach; theme face-of-the-ground
m.event("see", agent="noach", themes=["pnei_ha_adamah"])
# ‹וְהִנֵּה חָרְבוּ פְּנֵי› (“and-behold were-parched face”)
# ‹הָאֲדָמָה› (“the-ground”)
# — fact holds: and-behold-were-parched-face-of-the-ground
...
# ‹וּבַחֹדֶשׁ הַשֵּׁנִי בְּשִׁבְעָה› (“and-in-month the-second in-seven”)
# ‹וְעֶשְׂרִים יוֹם לַחֹדֶשׁ› (“and-twenty day of-month”)
# ‹יָבְשָׁה הָאָרֶץ› (“was-dry the-earth”)
# "And in the second month, on the seven and twentieth day of the month, was
# the earth dry."
m.step("Gen.8.14")
# ‹בְּשִׁבְעָה וְעֶשְׂרִים יוֹם› (“in-seven and-twenty day”)
# ‹לַחֹדֶשׁ יָבְשָׁה הָאָרֶץ› (“of-month was-dry the-earth”)
# — fact holds: in-the-of-month-the-second-in-seven-and-twenty-day; was-dry-
# the-earth

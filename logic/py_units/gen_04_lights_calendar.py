...
# ‹וַיֹּאמֶר אֱלֹהִים יְהִי› (“and-said God let-be”)
# ‹מְאֹרֹת בִּרְקִיעַ הַשָּׁמַיִם› (“lights in-firmament-of the-heavens”)
# ‹לְהַבְדִּיל בֵּין הַיּוֹם› (“to-divide between the-day”)
# ‹וּבֵין הַלָּיְלָה וְהָיוּ› (“and-between the-night and-they-shall-be”)
# ‹לְאֹתֹת וּלְמוֹעֲדִים וּלְיָמִים› (“for-signs and-for-seasons and-for-
# days”)
# ‹וְשָׁנִים› (“and-years”)
...
m.utterance(6, "fiat")
# ‹יְהִי מְאֹרֹת› (“let-be lights”)
# — God speaks a demand — LET: exists(lights), loc=expanse-the-heavens
m.declare("Elohim", "LET",
          "exists(meorot), loc=raqia_ha_shamayim")
# ‹לְהַבְדִּיל … וְהָיוּ לְאֹתֹת› (“to-divide … and-they-shall-be for-
# signs”)
# ‹וּלְמוֹעֲדִים וּלְיָמִים וְשָׁנִים› (“and-for-seasons and-for-days and-
# years”)
# — open question logged: exists(lights), loc=expanse-the-heavens
...
# ‹וְהָיוּ לִמְאוֹרֹת בִּרְקִיעַ› (“and-they-shall-be for-lights in-
# firmament-of”)
# ‹הַשָּׁמַיִם לְהָאִיר עַל־הָאָרֶץ› (“the-heavens to-give-light upon the-
# earth”)
# ‹וַיְהִי־כֵן› (“and-there-was so”)
...
m.presupposed("aretz")
# ‹וַיְהִי־כֵן› (“and-there-was so”)
# — demand settled (popped from the queue): exists(lights), loc=expanse-the-
# heavens
m.result("exists(meorot), loc=raqia_ha_shamayim", tmark="t1")

# -------------------------- Gen.1.16 · BUILD_DIFFERENTIATE_DELTA -----------
# ‹וַיַּעַשׂ אֱלֹהִים אֶת־שְׁנֵי› (“and-made God obj-marker two-of”)
# ‹הַמְּאֹרֹת הַגְּדֹלִים אֶת־הַמָּאוֹר› (“the-lights the-great-ones obj-
# marker the-light”)
# ‹הַגָּדֹל לְמֶמְשֶׁלֶת הַיּוֹם› (“the-great for-dominion-of the-day”)
# ‹וְאֶת־הַמָּאוֹר הַקָּטֹן לְמֶמְשֶׁלֶת› (“and-obj-marker the-light the-
# small for-dominion-of”)
# ‹הַלַּיְלָה וְאֵת הַכּוֹכָבִים› (“the-night and-obj-marker the-stars”)
...
# ‹… אֶת … וְאֶת … וְאֵת› (“obj-marker … and-obj-marker … and-obj-marker”)
# — event: make — agent God; theme light-great, light-small, stars
...
# ‹לְמֶמְשֶׁלֶת הַיּוֹם … לְמֶמְשֶׁלֶת› (“for-dominion-of the-day … for-
# dominion-of”)
# ‹הַלַּיְלָה› (“the-night”)
# — role assigned: light-great -> dominion-of-day; light-small -> dominion-
# of-night
m.assign("maor_gadol", "memshelet_yom")
m.assign("maor_qaton", "memshelet_lailah")
# ‹הַמְּאֹרֹת הַגְּדֹלִים ← הַגָּדֹל› (“the-lights the-great-ones the-
# great”)
# ‹/ הַקָּטֹן› (“the-small”)
# — spec-delta — spec said from'lights (one undifferentiated plural),
# delivery says two-of the-from
...
# ‹וְאֵת הַכּוֹכָבִים› (“and-obj-marker the-stars”)
# — spec-delta — spec said no stars in the job order, delivery says and-obj-
# marker the-stars
...
# ‹לְמֶמְשֶׁלֶת› (“for-dominion-of”)
# — spec-delta — spec said jobs: divide, signs, festivals, days+years,
# shine, delivery says to-dominion-of (dominion) added
m.spec_delta("jobs: divide, signs, festivals, days+years, shine",
             "le-memshelet (dominion) added")

# -------------------------- Gen.1.17 · INSTALL_MOUNT -----------------------
# ‹וַיִּתֵּן אֹתָם אֱלֹהִים› (“and-set them God”)
# ‹בִּרְקִיעַ הַשָּׁמָיִם לְהָאִיר› (“in-firmament-of the-heavens to-give-
# light”)
# ‹עַל־הָאָרֶץ› (“upon the-earth”)
# "And God set them in the firmament of the heaven to give light upon the
# earth."
m.step("Gen.1.17")
# ‹וַיִּתֵּן אֹתָם› (“and-set them”)
# — event: place — agent God; theme them-the-lights
...
# ‹וְלִמְשֹׁל בַּיּוֹם וּבַלַּיְלָה› (“and-to-rule in-the-day and-in-the-
# night”)
# ‹וּלְהַבְדִּיל בֵּין הָאוֹר› (“and-to-divide between the-light”)
# ‹וּבֵין הַחֹשֶׁךְ וַיַּרְא› (“and-between the-darkness and-saw”)
...
m.step("Gen.1.18")
# ‹בֵּין הַיּוֹם וּבֵין› (“between the-day and-between”)
# ‹הַלָּיְלָה ← בֵּין הָאוֹר› (“the-night between the-light”)
# ‹וּבֵין הַחֹשֶׁךְ› (“and-between the-darkness”)
# — spec-delta — spec said to-divide between the-YOM u-between the-LAILAH
# (registry labels, 1:14), delivery says u-to-divide between the-OR
# u-between the-CHOSHEKH (the entities, 1:18)
...
# ‹כִּי־טוֹב› (“that good”)
# — test PASS — oracle-word good, on lights
...
m.step("Gen.1.19")
# ‹יוֹם רְבִיעִי› (“day fourth”)
# — ledger: day 4 committed

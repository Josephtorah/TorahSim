...
# ‹וַיֹּאמֶר אֱלֹהִים יִקָּווּ› (“and-said God be-gathered”)
# ‹הַמַּיִם מִתַּחַת הַשָּׁמַיִם› (“the-waters from-under the-heavens”)
# ‹אֶל־מָקוֹם אֶחָד וְתֵרָאֶה› (“to place one and-let-appear”)
# ‹הַיַּבָּשָׁה וַיְהִי־כֵן› (“the-dry-land and-there-was so”)
# "And God said: 'Let the waters under the heaven be gathered together unto
# one place, and let the dry land appear.' And it was so."
m.step("Gen.1.9")
# utterance #4 of the ten (ma'amar census)
m.utterance(4, "fiat")
# ‹יִקָּווּ הַמַּיִם› (“be-gathered the-waters”)
# — God speaks a demand — LET: gathered(waters, to=place-one)
m.declare("Elohim", "LET",
          "gathered(mayim, to=maqom-echad)")
# ‹וְתֵרָאֶה הַיַּבָּשָׁה› (“and-let-appear the-dry-land”)
# — God speaks a demand — LET?: exists(dry-land)
m.declare("Elohim", "LET?",
          "exists(yabasha)")
# reads without prior install (flag, not fix): waters, heavens
m.presupposed("mayim", "shamayim")
# ‹וַיְהִי־כֵן› (“and-there-was so”)
# — demand settled (popped from the queue): gathered(waters, to=place-one)
m.result("gathered(mayim, to=maqom-echad)", tmark="t1")
# ‹הַיַּבָּשָׁה› (“the-dry-land”)
# — demand settled (popped from the queue): exists(dry-land)
m.result("exists(yabasha)", tmark="t1")

# -------------------------- Gen.1.10 · NAME_NAME_TEST ----------------------
# ‹וַיִּקְרָא אֱלֹהִים לַיַּבָּשָׁה› (“and-called God to-the-dry-land”)
# ‹אֶרֶץ וּלְמִקְוֵה הַמַּיִם› (“Earth and-to-gathering-of the-waters”)
# ‹קָרָא יַמִּים וַיַּרְא› (“called Seas and-saw”)
# ‹אֱלֹהִים כִּי־טוֹב› (“God that good”)
# "And God called the dry land Earth, and the gathering together of the
# waters called He Seas; and God saw that it was good."
m.step("Gen.1.10")
# ‹לַיַּבָּשָׁה אֶרֶץ … קָרָא› (“to-the-dry-land Earth … called”)
# ‹יַמִּים› (“Seas”)
# — named: dry-land := Earth; miqveh-ha-mayim := Seas
...
# ‹כִּי־טוֹב› (“that good”)
# — test PASS — oracle-word good, on gathering
m.test("PASS", "tov", "gathering")

# -------------------------- Gen.1.11 · DECLARE_DELEGATED_SPEC --------------
# ‹וַיֹּאמֶר אֱלֹהִים תַּדְשֵׁא› (“and-said God let-sprout”)
# ‹הָאָרֶץ דֶּשֶׁא עֵשֶׂב› (“the-earth grass herb”)
# ‹מַזְרִיעַ זֶרַע עֵץ› (“yielding-seed seed tree”)
# ‹פְּרִי עֹשֶׂה פְּרִי› (“fruit making fruit”)
# ‹לְמִינוֹ אֲשֶׁר זַרְעוֹ־בוֹ› (“by-its-kind which its-seed in-it”)
# ‹עַל־הָאָרֶץ וַיְהִי־כֵן› (“upon the-earth and-there-was so”)
...
m.utterance(5, "fiat")
# ‹תַּדְשֵׁא הָאָרֶץ› (“let-sprout the-earth”)
# — God speaks a demand — LET: sprout(earth, vegetation)
m.declare("Elohim", "LET",
          "sprout(aretz, vegetation)")
# ‹מַזְרִיעַ זֶרַע … עֹשֶׂה› (“yielding-seed seed … making”)
# ‹פְּרִי לְמִינוֹ› (“fruit by-its-kind”)
# — standing constraint: yielding-seed(herb, seed) ∧ making(tree, fruit) ∧
# to-by-its-kind(reproduction)
m.invariant("mazria(esev, zera) ∧ oseh(etz, peri) ∧ le-mino(reproduction)")
# ‹וַיְהִי־כֵן› (“and-there-was so”)
# — demand settled (popped from the queue): sprout(earth, vegetation)
m.result("sprout(aretz, vegetation)", tmark="t2")

# -------------------------- Gen.1.12 · DELEGATED_BUILD_DELTA_TEST ----------
# ‹וַתּוֹצֵא הָאָרֶץ דֶּשֶׁא› (“and-brought-forth the-earth grass”)
# ‹עֵשֶׂב מַזְרִיעַ זֶרַע› (“herb yielding-seed seed”)
# ‹לְמִינֵהוּ וְעֵץ עֹשֶׂה־פְּרִי› (“by-its-kind and-tree making fruit”)
# ‹אֲשֶׁר זַרְעוֹ־בוֹ לְמִינֵהוּ› (“which its-seed in-it by-its-kind”)
# ‹וַיַּרְא אֱלֹהִים כִּי־טוֹב› (“and-saw God that good”)
...
m.step("Gen.1.12")
# ‹וַתּוֹצֵא הָאָרֶץ› (“and-brought-forth the-earth”)
# — event: ? — agent earth; theme grass
m.event("?", agent="aretz", themes=["deshe"])
# the world gains: grass
m.install("deshe")
# ‹עֵץ פְּרִי עֹשֶׂה› (“tree fruit making”)
# ‹פְּרִי ← וְעֵץ עֹשֶׂה־פְּרִי› (“fruit and-tree making fruit”)
# — spec-delta — spec said tree fruit making fruit, delivery says tree
# making fruit
m.spec_delta("etz peri oseh peri",
             "etz oseh peri")
# ‹עֵשֶׂב מַזְרִיעַ זֶרַע› (“herb yielding-seed seed”)
# ‹← עֵשֶׂב מַזְרִיעַ זֶרַע› (“herb yielding-seed seed”)
# ‹לְמִינֵהוּ› (“by-its-kind”)
# — spec-delta — spec said herb yielding-seed seed, delivery says herb
# yielding-seed seed to-by-its-kind
...
m.witness_state("deshe", "staged_at_soil_mouth",
                cites=["Chullin 60b:5"])
# ‹כִּי־טוֹב› (“that good”)
# — test PASS — oracle-word good, on vegetation
...
m.step("Gen.1.13")
# ‹יוֹם שְׁלִישִׁי› (“day third”)
# — ledger: day 3 committed

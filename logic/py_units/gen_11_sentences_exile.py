...
# ‹וַיֹּאמֶר יְהֹוָה אֱלֹהִים› (“and-he-said YHWH God”)
# ‹אֶל־הַנָּחָשׁ כִּי עָשִׂיתָ› (“to the-serpent because you-did”)
# ‹זֹּאת אָרוּר אַתָּה› (“this CURSED you”)
# ‹מִכָּל־הַבְּהֵמָה וּמִכֹּל חַיַּת› (“from-all the-livestock and-from-all
# beast-of”)
# ‹הַשָּׂדֶה עַל־גְּחֹנְךָ תֵלֵךְ› (“the-field upon your-belly you-shall-
# go”)
# ‹וְעָפָר תֹּאכַל כָּל־יְמֵי› (“and-dust you-shall-eat all days-of”)
# ‹חַיֶּיךָ› (“your-life”)
...
# of thy life.'"
m.step("Gen.3.14")
# ‹וַיֹּאמֶר … אֶל־הַנָּחָשׁ כִּי› (“and-he-said … to the-serpent because”)
# ‹עָשִׂיתָ זֹּאת› (“you-did this”)
# — event: sentence — agent the-LORD-God; theme serpent
...
# ‹עַל־גְּחֹנְךָ תֵלֵךְ וְעָפָר› (“upon your-belly you-shall-go and-dust”)
# ‹תֹּאכַל› (“you-shall-eat”)
# — fact holds: upon-your-belly-you-shall-go(serpent); dust-you-shall-eat-
# all-days-of-your-life(serpent)
...
# ‹וְאֵיבָה אָשִׁית בֵּינְךָ› (“and-enmity I-will-set between-you”)
# ‹וּבֵין הָאִשָּׁה וּבֵין› (“and-between the-woman and-between”)
# ‹זַרְעֲךָ וּבֵין זַרְעָהּ› (“your-seed and-between her-seed”)
# ‹הוּא יְשׁוּפְךָ רֹאשׁ› (“he strikes-you head”)
# ‹וְאַתָּה תְּשׁוּפֶנּוּ עָקֵב› (“and-you strike-him heel”)
# "'And I will put enmity between thee and the woman, and between thy seed
# and her seed; they shall bruise thy head, and thou shalt bruise their
# heel.'"
m.step("Gen.3.15")
# ‹וְאֵיבָה אָשִׁית … הוּא› (“and-enmity I-will-set … he”)
# ‹יְשׁוּפְךָ רֹאשׁ וְאַתָּה› (“strikes-you head and-you”)
# ‹תְּשׁוּפֶנּוּ עָקֵב› (“strike-him heel”)
# — pattern recorded: enmity(between-seed-the-woman, between-seed-the-
# serpent) ∧ he-shall-bruise-you-head ∧ you-shall-bruise-him-heel
...
# ‹אֶל־הָאִשָּׁה אָמַר הַרְבָּה› (“to the-woman he-said multiplying”)
# ‹אַרְבֶּה עִצְּבוֹנֵךְ וְהֵרֹנֵךְ› (“I-will-multiply your-toil and-your-
# pregnancy”)
# ‹בְּעֶצֶב תֵּלְדִי בָנִים› (“in-pain you-shall-bear sons”)
# ‹וְאֶל־אִישֵׁךְ תְּשׁוּקָתֵךְ וְהוּא› (“and-to your-man your-longing and-
# he”)
# ‹יִמְשָׁל־בָּךְ› (“shall-rule in-you”)
...
m.presupposed("ishah")
# ‹הַרְבָּה אַרְבֶּה עִצְּבוֹנֵךְ› (“multiplying I-will-multiply your-toil”)
# ‹… בְּעֶצֶב תֵּלְדִי בָנִים› (“in-pain you-shall-bear sons”)
# ‹… וְהוּא יִמְשָׁל־בָּךְ› (“and-he shall-rule in-you”)
# — fact holds: greatly-I-will-multiply-your-toil-and-your-pregnancy(woman);
# in-pain-you-shall-bear-sons(woman); to-your-husband-your-desire-and-he-
# shall-rule-in-you(woman)
...
# ‹וּלְאָדָם אָמַר כִּי־שָׁמַעְתָּ› (“and-to-Adam he-said because you-
# listened”)
# ‹לְקוֹל אִשְׁתֶּךָ וַתֹּאכַל› (“to-voice-of your-wife and-you-ate”)
# ‹מִן־הָעֵץ אֲשֶׁר צִוִּיתִיךָ› (“from the-tree which I-commanded-you”)
# ‹לֵאמֹר לֹא תֹאכַל› (“saying not you-shall-eat”)
# ‹מִמֶּנּוּ אֲרוּרָה הָאֲדָמָה› (“from-it CURSED the-ground”)
# ‹בַּעֲבוּרֶךָ בְּעִצָּבוֹן תֹּאכֲלֶנָּה› (“because-of-you in-toil you-
# shall-eat-it”)
# ‹כֹּל יְמֵי חַיֶּיךָ› (“all days-of your-life”)
...
# ‹וּלְאָדָם אָמַר כִּי־שָׁמַעְתָּ› (“and-to-Adam he-said because you-
# listened”)
# ‹לְקוֹל אִשְׁתֶּךָ … אֲשֶׁר› (“to-voice-of your-wife … which”)
# ‹צִוִּיתִיךָ לֵאמֹר לֹא› (“I-commanded-you saying not”)
# ‹תֹאכַל מִמֶּנּוּ› (“you-shall-eat from-it”)
# — event: sentence — agent the-LORD-God; theme Adam
...
# ‹בְּעִצָּבוֹן תֹּאכֲלֶנָּה כֹּל› (“in-toil you-shall-eat-it all”)
# ‹יְמֵי חַיֶּיךָ› (“days-of your-life”)
# — fact holds: in-toil-you-shall-eat-all-days-of-your-life(Adam)
...
# -------------------------- Gen.3.18 · THORN_DIET --------------------------
# ‹וְקוֹץ וְדַרְדַּר תַּצְמִיחַ› (“and-thorn and-thistle it-shall-sprout”)
# ‹לָךְ וְאָכַלְתָּ אֶת־עֵשֶׂב› (“for-you and-you-shall-eat obj-marker herb-
# of”)
# ‹הַשָּׂדֶה› (“the-field”)
...
m.step("Gen.3.18")
# ‹וְקוֹץ וְדַרְדַּר תַּצְמִיחַ› (“and-thorn and-thistle it-shall-sprout”)
# ‹… וְאָכַלְתָּ אֶת־עֵשֶׂב הַשָּׂדֶה› (“and-you-shall-eat obj-marker herb-
# of the-field”)
# — fact holds: thorn-and-thistle-tatzmiach-to-you(ground); and-you-shall-
# eat-obj-marker·et-herb-of-the-field(Adam)
m.fact("kotz_ve_dardar_tatzmiach_lakh(adamah)",
       "ve_akhalta_et_esev_ha_sadeh(adam)")

# -------------------------- Gen.3.19 · MORTALITY_BOUNDARY ------------------
# ‹בְּזֵעַת אַפֶּיךָ תֹּאכַל› (“in-sweat-of your-face you-shall-eat”)
# ‹לֶחֶם עַד שׁוּבְךָ› (“bread until your-return”)
# ‹אֶל־הָאֲדָמָה כִּי מִמֶּנָּה› (“to the-ground for from-it”)
# ‹לֻקָּחְתָּ כִּי־עָפָר אַתָּה› (“you-were-taken for dust you”)
# ‹וְאֶל־עָפָר תָּשׁוּב› (“and-to dust you-shall-return”)
# "'In the sweat of thy face shalt thou eat bread, till thou return unto the
# ground; for out of it wast thou taken; for dust thou art, and unto dust
# shalt thou return.'"
m.step("Gen.3.19")
# ‹בְּזֵעַת אַפֶּיךָ … עַד› (“in-sweat-of your-face … until”)
# ‹שׁוּבְךָ … וְאֶל־עָפָר תָּשׁוּב› (“your-return … and-to dust you-shall-
# return”)
# — fact holds: in-sweat-of-your-nostrils-you-shall-eat-bread(Adam); until-
# your-return-to-the-ground(Adam); dust-you-and-to-dust-you-shall-
# return(Adam)
m.fact("be_zeat_apekha_tokhal_lechem(adam)",
       "ad_shuvkha_el_ha_adamah(adam)",
       "afar_atah_ve_el_afar_tashuv(adam)")
# ‹עַד שׁוּבְךָ אֶל־הָאֲדָמָה› (“until your-return to the-ground”)
# ‹… כִּי־עָפָר אַתָּה וְאֶל־עָפָר› (“for dust you and-to dust”)
# ‹תָּשׁוּב› (“you-shall-return”)
# — spec-delta — spec said because in-day your-eating from-it dying you-
# shall-die (gen-08 2:17 — the armed HANDLER: dying-you-shall-die, IN THE
# DAY), delivery says until your-return to-the-ground … and-to-dust you-
...
# ‹וַיִּקְרָא הָאָדָם שֵׁם› (“and-he-called the-human name-of”)
# ‹אִשְׁתּוֹ חַוָּה כִּי› (“his-wife Chavah for”)
# ‹הִוא הָיְתָה אֵם› (“she-ktiv-hu-qere-hi was mother-of”)
# ‹כָּל־חָי› (“all living”)
...
# ‹וַיַּעַשׂ יְהוָה אֱלֹהִים› (“and-he-made YHWH God”)
# ‹לְאָדָם וּלְאִשְׁתּוֹ כָּתְנוֹת› (“for-the-human and-for-his-wife tunics-
# of”)
# ‹עוֹר וַיַּלְבִּשֵׁם› (“skin and-he-clothed-them”)
# "And the LORD God made for Adam and for his wife garments of skins, and
# clothed them."
m.step("Gen.3.21")
# ‹וַיַּעַשׂ … כָּתְנוֹת עוֹר› (“and-he-made … tunics-of skin”)
# — event: make — agent the-LORD-God; theme garments-of-skin
m.event("make", agent="YHWH_Elohim", themes=["kotnot_or"])
# ‹וַיַּלְבִּשֵׁם› (“and-he-clothed-them”)
# — event: clothe — agent the-LORD-God; theme Adam
m.event("clothe", agent="YHWH_Elohim", themes=["adam"])
# ‹כָּתְנוֹת עוֹר› (“tunics-of skin”)
# — the world gains: garments-of-skin
m.install("kotnot_or")
...
# ‹וַיֹּאמֶר יְהוָה אֱלֹהִים› (“and-he-said YHWH God”)
# ‹הֵן הָאָדָם הָיָה› (“behold the-human has-become”)
# ‹כְּאַחַד מִמֶּנּוּ לָדַעַת› (“like-one of-us to-know”)
# ‹טוֹב וָרָע וְעַתָּה› (“good and-evil and-now”)
# ‹פֶּן־יִשְׁלַח יָדוֹ וְלָקַח› (“lest he-send his-hand and-take”)
# ‹גַּם מֵעֵץ הַחַיִּים› (“also from-tree-of the-life”)
# ‹וְאָכַל וָחַי לְעֹלָם› (“and-eat and-live forever”)
# "And the LORD God said: 'Behold, the man is become as one of us, to know
# good and evil; and now, lest he put forth his hand, and take also of the
# tree of life, and eat, and live for ever.'"
m.step("Gen.3.22")
# ‹הֵן הָאָדָם הָיָה› (“behold the-human has-become”)
# ‹כְּאַחַד מִמֶּנּוּ› (“like-one of-us”)
# — event: deliberate — agent the-LORD-God; theme Adam
m.event("deliberate", agent="YHWH_Elohim", themes=["adam"])
# ‹וְעַתָּה פֶּן־יִשְׁלַח יָדוֹ› (“and-now lest he-send his-hand”)
# ‹וְלָקַח גַּם מֵעֵץ› (“and-take also from-tree-of”)
# ‹הַחַיִּים וְאָכַל וָחַי› (“the-life and-eat and-live”)
# ‹לְעֹלָם› (“forever”)
# — fact holds: like-one-from-it-to-know-good-and-evil(Adam); lest-he-send-
# his-hand-and-take-from-tree-the-life-and-living-to-forever
...
# ‹וַיְשַׁלְּחֵהוּ יְהוָה אֱלֹהִים› (“and-he-sent-him-out YHWH God”)
# ‹מִגַּן־עֵדֶן לַעֲבֹד אֶת־הָאֲדָמָה› (“from-garden-of Eden to-work obj-
# marker the-ground”)
# ‹אֲשֶׁר לֻקַּח מִשָּׁם› (“which he-was-taken from-there”)
# "Therefore the LORD God sent him forth from the garden of Eden, to till
# the ground from whence he was taken."
m.step("Gen.3.23")
# ‹וַיְשַׁלְּחֵהוּ … מִגַּן־עֵדֶן לַעֲבֹד› (“and-he-sent-him-out … from-
# garden-of Eden to-work”)
# ‹אֶת־הָאֲדָמָה אֲשֶׁר לֻקַּח› (“obj-marker the-ground which he-was-taken”)
# ‹מִשָּׁם› (“from-there”)
# — event: send-out — agent the-LORD-God; theme Adam
...
# ‹וַיְגָרֶשׁ אֶת־הָאָדָם וַיַּשְׁכֵּן› (“and-he-drove-out obj-marker the-
# human and-he-stationed”)
# ‹מִקֶּדֶם לְגַן־עֵדֶן אֶת־הַכְּרֻבִים› (“from-east-or-of-old to-garden-of
# Eden obj-marker the-cherubim”)
# ‹וְאֵת לַהַט הַחֶרֶב› (“and-obj-marker flame-of the-sword”)
# ‹הַמִּתְהַפֶּכֶת לִשְׁמֹר אֶת־דֶּרֶךְ› (“the-self-turning to-guard obj-
# marker way-of”)
# ‹עֵץ הַחַיִּים› (“tree-of the-life”)
...
# to-garden-of Eden”)
# — event: station — agent the-LORD-God; theme cherubim
m.event("station", agent="YHWH_Elohim", themes=["keruvim"])
# ‹אֶת־הַכְּרֻבִים וְאֵת לַהַט› (“obj-marker the-cherubim and-obj-marker
# flame-of”)
# ‹הַחֶרֶב הַמִּתְהַפֶּכֶת› (“the-sword the-self-turning”)
# — the world gains: cherubim, flame-of-the-sword
m.install("keruvim", "lahat_ha_cherev")
# ‹לִשְׁמֹר אֶת־דֶּרֶךְ עֵץ› (“to-guard obj-marker way-of tree-of”)
# ‹הַחַיִּים› (“the-life”)
# — role assigned: cherubim -> keeper-way-of-tree-the-life

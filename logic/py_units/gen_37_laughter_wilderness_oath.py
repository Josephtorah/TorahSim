...
# ‹וַיהוָה פָּקַד אֶת־שָׂרָה› (“and-YHWH count/visit obj-marker Sarah”)
# ‹כַּאֲשֶׁר אָמָר וַיַּעַשׂ› (“like-as/which say and-make”)
# ‹יְהוָה לְשָׂרָה כַּאֲשֶׁר› (“YHWH to-Sarah like-as/which”)
# ‹דִּבֵּר› (“speak”)
# "And the LORD remembered Sarah as He had said, and the LORD did unto Sarah
# as He had spoken."
m.step("Gen.21.1")
# ‹פָּקַד … כַּאֲשֶׁר אָמָר› (“count/visit … like-as/which say”)
# ‹… כַּאֲשֶׁר דִּבֵּר› (“like-as/which speak”)
# — fact holds: count/visit-like-which-say-and-make-like-which-speak
...
# ‹וַתַּהַר וַתֵּלֶד שָׂרָה› (“and-be-pregnant and-bear-young Sarah”)
# ‹לְאַבְרָהָם בֵּן לִזְקֻנָיו› (“to-Abraham son to-old-age-him/its”)
# ‹לַמּוֹעֵד אֲשֶׁר־דִּבֶּר אֹתוֹ› (“to-seasons which speak obj-marker-
# him/its”)
# ‹אֱלֹהִים› (“God”)
# "And Sarah conceived, and bore Abraham a son in his old age, at the set
# time of which God had spoken to him."
m.step("Gen.21.2")
# ‹וַתֵּלֶד שָׂרָה לְאַבְרָהָם› (“and-bear-young Sarah to-Abraham”)
# ‹בֵּן› (“son”)
# — the world gains: Isaac
m.install("yitzchaq")
# ‹בֵּן לִזְקֻנָיו לַמּוֹעֵד› (“son to-old-age-him/its to-seasons”)
# ‹אֲשֶׁר־דִּבֶּר› (“which speak”)
# — fact holds: son-to-me-zequnayv; to-seasons-which-speak-God
m.fact("ben_li_zequnayv",
       "la_moed_asher_diber_elohim")

# -------------------------- Gen.21.3 · THE_DECREE_EXECUTED_IN_FORMULA ------
# ‹וַיִּקְרָא אַבְרָהָם אֶת־שֶׁם־בְּנוֹ› (“and-call Abraham obj-marker name
# son-him/its”)
# ‹הַנּוֹלַד־לוֹ אֲשֶׁר־יָלְדָה־לּוֹ שָׂרָה› (“the-bear-young to-him/its
# which bear-young to-him/its Sarah”)
# ‹יִצְחָק› (“Isaac”)
...
# son-him/its”)
# ‹… יִצְחָק› (“Isaac”)
# — named: Isaac := Yitzchaq
m.name("yitzchaq", "Yitzchaq")

# -------------------------- Gen.21.4 · THE_LAWS_SECOND_CASE_EXECUTES -------
# ‹וַיָּמָל אַבְרָהָם אֶת־יִצְחָק› (“and-circumcise Abraham obj-marker
# Isaac”)
# ‹בְּנוֹ בֶּן־שְׁמֹנַת יָמִים› (“son-him/its son number day”)
# ‹כַּאֲשֶׁר צִוָּה אֹתוֹ› (“like-as/which command obj-marker-him/its”)
# ‹אֱלֹהִים› (“God”)
...
# ‹… כַּאֲשֶׁר צִוָּה אֹתוֹ› (“like-as/which command obj-marker-him/its”)
# ‹אֱלֹהִים› (“God”)
# — event: circumcise — agent Abraham; theme Isaac
m.event("circumcise", agent="avraham", themes=["yitzchaq"])
# ‹כַּאֲשֶׁר צִוָּה אֹתוֹ› (“like-as/which command obj-marker-him/its”)
# ‹אֱלֹהִים› (“God”)
# — fact holds: like-which-command-it-God
m.fact("ka_asher_tziva_oto_elohim")

# -------------------------- Gen.21.5 · THE_HUNDRED_YEAR_FRAME --------------
# ‹וְאַבְרָהָם בֶּן־מְאַת שָׁנָה› (“and-Abraham son hundred years”)
# ‹בְּהִוָּלֶד לוֹ אֵת› (“in-bear-young to-him/its obj-marker”)
# ‹יִצְחָק בְּנוֹ› (“Isaac son-him/its”)
# "And Abraham was a hundred years old, when his son Isaac was born unto
# him."
m.step("Gen.21.5")
# ‹בֶּן־מְאַת שָׁנָה› (“son hundred years”)
# — fact holds: son-hundred-year
m.fact("ben_meat_shanah")

# -------------------------- Gen.21.6 · THE_LAUGHTER_MADE_AND_CONJUGATED ----
# ‹וַתֹּאמֶר שָׂרָה צְחֹק› (“and-say Sarah laughter”)
# ‹עָשָׂה לִי אֱלֹהִים› (“make to-me/my God”)
# ‹כָּל־הַשֹּׁמֵעַ יִצְחַק־לִי› (“all the-hear laugh-outright to-me/my”)
# "And Sarah said: 'God hath made laughter for me; every one that heareth
# will laugh on account of me.'"
m.step("Gen.21.6")
# ‹צְחֹק עָשָׂה לִי› (“laughter make to-me/my”)
# ‹אֱלֹהִים כָּל־הַשֹּׁמֵעַ יִצְחַק־לִי› (“God all the-hear laugh-outright
# to-me/my”)
# — fact holds: laughter-make-to-me-God-all-the-hear-Isaac-to-me
m.fact("tzechoq_asah_li_elohim_kol_ha_shomea_yitzchaq_li")

# -------------------------- Gen.21.7 · THE_WHO_WOULD_HAVE_SAID -------------
# ‹וַתֹּאמֶר מִי מִלֵּל› (“and-say who? speak”)
# ‹לְאַבְרָהָם הֵינִיקָה בָנִים› (“to-Abraham suck son”)
# ‹שָׂרָה כִּי־יָלַדְתִּי בֵן› (“Sarah that bear-young son”)
# ‹לִזְקֻנָיו› (“to-old-age-him/its”)
...
m.step("Gen.21.7")
# ‹מִי מִלֵּל לְאַבְרָהָם› (“who? speak to-Abraham”)
# — fact holds: who?-speak-to-Abraham-heniqah-son-sarah
...
# ‹וַיִּגְדַּל הַיֶּלֶד וַיִּגָּמַל› (“and-be-large the-child and-treat-a-
# person”)
# ‹וַיַּעַשׂ אַבְרָהָם מִשְׁתֶּה› (“and-make Abraham drink”)
# ‹גָדוֹל בְּיוֹם הִגָּמֵל› (“great in-day treat-a-person”)
...
# ‹וַתֵּרֶא שָׂרָה אֶת־בֶּן־הָגָר› (“and-see Sarah obj-marker son Hagar”)
# ‹הַמִּצְרִית אֲשֶׁר־יָלְדָה לְאַבְרָהָם› (“the-Egyptian which bear-young
# to-Abraham”)
# ‹מְצַחֵק› (“laugh-outright”)
# "And Sarah saw the son of Hagar the Egyptian, whom she had borne unto
# Abraham, making sport."
m.step("Gen.21.9")
# ‹הָגָר הַמִּצְרִית› (“Hagar the-Egyptian”)
# — the world gains: Hagar
m.install("hagar")
# ‹בֶּן־הָגָר› (“son Hagar”)
# — the world gains: the-boy
m.install("ha_naar")
# ‹וַתֵּרֶא שָׂרָה … מְצַחֵק› (“and-see Sarah … laugh-outright”)
# — event: see — agent sarah; theme the-boy
...
# ‹וַתֹּאמֶר לְאַבְרָהָם גָּרֵשׁ› (“and-say to-Abraham drive-out-from-a-
# possession”)
# ‹הָאָמָה הַזֹּאת וְאֶת־בְּנָהּ› (“the-maidservant the-this and-obj-marker
# son-her/its”)
# ‹כִּי לֹא יִירַשׁ› (“that not possess/inherit”)
# ‹בֶּן־הָאָמָה הַזֹּאת עִם־בְּנִי› (“son the-maidservant the-this with son-
# me/my”)
# ‹עִם־יִצְחָק› (“with Isaac”)
...
# Isaac.'"
m.step("Gen.21.10")
# ‹גָּרֵשׁ הָאָמָה הַזֹּאת› (“drive-out-from-a-possession the-maidservant
# the-this”)
# ‹וְאֶת־בְּנָהּ› (“and-obj-marker son-her/its”)
# — sarah speaks a demand — LET: drive-out-from-a-possession(the-cubit-and-
# obj-marker-benah)
m.declare("sarah", "LET",
...
# ‹וַיֵּרַע הַדָּבָר מְאֹד› (“and-spoil the-word/thing very”)
# ‹בְּעֵינֵי אַבְרָהָם עַל› (“in-eye Abraham over”)
# ‹אוֹדֹת בְּנוֹ› (“turnings son-him/its”)
# "And the thing was very grievous in Abraham's sight on account of his
# son."
m.step("Gen.21.11")
# ‹וַיֵּרַע הַדָּבָר מְאֹד› (“and-spoil the-word/thing very”)
# ‹בְּעֵינֵי אַבְרָהָם› (“in-eye Abraham”)
# — fact holds: and-spoil-the-word/thing-very-in-eyes-of-Abraham
...
# ‹אַל־יֵרַע בְּעֵינֶיךָ עַל־הַנַּעַר› (“do-not spoil in-eye-you/your over
# the-boy”)
# ‹וְעַל־אֲמָתֶךָ כֹּל אֲשֶׁר› (“and-over maidservant-you/your all which”)
# ‹תֹּאמַר אֵלֶיךָ שָׂרָה› (“say to-you/your Sarah”)
# ‹שְׁמַע בְּקֹלָהּ כִּי› (“hear in-voice/sound-her/its that”)
# ‹בְיִצְחָק יִקָּרֵא לְךָ› (“in-Isaac call to-you/your”)
# ‹זָרַע› (“seed”)
...
m.step("Gen.21.12")
# ‹אַל־יֵרַע בְּעֵינֶיךָ› (“do-not spoil in-eye-you/your”)
# — God speaks a demand — LET-NOT: spoil(in-einekha)
m.declare("elohim", "LET-NOT",
          "yera(be_einekha)")
# ‹כֹּל אֲשֶׁר תֹּאמַר› (“all which say”)
# ‹אֵלֶיךָ שָׂרָה שְׁמַע› (“to-you/your Sarah hear”)
# ‹בְּקֹלָהּ› (“in-voice/sound-her/its”)
# — God speaks a demand — LET: hear(in-voice/sound-sarah)
m.declare("elohim", "LET",
          "shema(be_qol_sarah)")
# ‹כִּי בְיִצְחָק יִקָּרֵא› (“that in-Isaac call”)
# ‹לְךָ זָרַע› (“to-you/your seed”)
# — fact holds: that-and-Isaac-call-to-you-seed
...
# ‹וְגַם אֶת־בֶּן־הָאָמָה לְגוֹי› (“and-also obj-marker son the-maidservant
# to-nation”)
# ‹אֲשִׂימֶנּוּ כִּי זַרְעֲךָ› (“put/set-him/its that seed-you/your”)
# ‹הוּא› (“he/it”)
# "And also of the son of the bondwoman will I make a nation, because he is
# thy seed.'"
m.step("Gen.21.13")
# ‹לְגוֹי אֲשִׂימֶנּוּ כִּי› (“to-nation put/set-him/its that”)
# ‹זַרְעֲךָ הוּא› (“seed-you/your he/it”)
# — fact holds: to-nation-asimenu-that-zarakha-he/it
...
# ‹וַיִּקַּח־לֶחֶם וְחֵמַת מַיִם› (“and-take food and-skin-bottle waters”)
# ‹וַיִּתֵּן אֶל־הָגָר שָׂם› (“and-set to Hagar put/set”)
# ‹עַל־שִׁכְמָהּ וְאֶת־הַיֶּלֶד וַיְשַׁלְּחֶהָ› (“over neck-as-the-place-of-
# burden-her/its and-obj-marker the-child and-send-her/its”)
# ‹וַתֵּלֶךְ וַתֵּתַע בְּמִדְבַּר› (“and-go and-vacillate in-pasture”)
# ‹בְּאֵר שָׁבַע› (“Beer-shebah”)
...
# Beer-sheba."
m.step("Gen.21.14")
# ‹וַיַּשְׁכֵּם … וַיִּקַּח … וַיִּתֵּן› (“and-rise-early … and-take … and-
# set”)
# ‹… וַיְשַׁלְּחֶהָ› (“and-send-her/its”)
# — event: send-away — agent Abraham; theme Hagar
m.event("send_away", agent="avraham", themes=["hagar"])
# ‹וַיְשַׁלְּחֶהָ … וַתֵּתַע› (“and-send-her/its … and-vacillate”)
# — fact holds: and-rise-early-and-yeshalcheha-and-vacillate
m.fact("va_yashkem_va_yeshalcheha_va_teta")
# ‹בְּמִדְבַּר בְּאֵר שָׁבַע› (“in-pasture Beer-shebah”)
# — reads without prior install (flag, not fix): pit-seven
m.presupposed("beer_sheva")

# -------------------------- Gen.21.15 · THE_SPENT_SKIN_AND_THE_CAST_CHILD --
# ‹וַיִּכְלוּ הַמַּיִם מִן־הַחֵמֶת› (“and-be-complete the-waters from the-
# skin-bottle”)
# ‹וַתַּשְׁלֵךְ אֶת־הַיֶּלֶד תַּחַת› (“and-throw-out obj-marker the-child
# under”)
# ‹אַחַד הַשִּׂיחִם› (“one the-shoot”)
...
# ‹וַתֵּלֶךְ וַתֵּשֶׁב לָהּ› (“and-go and-dwell/sit to-her/its”)
# ‹מִנֶּגֶד הַרְחֵק כִּמְטַחֲוֵי› (“from-the-east widen like-stretch-a-bow”)
# ‹קֶשֶׁת כִּי אָמְרָה› (“bow that say”)
# ‹אַל־אֶרְאֶה בְּמוֹת הַיָּלֶד› (“do-not see in-death the-child”)
# ‹וַתֵּשֶׁב מִנֶּגֶד וַתִּשָּׂא› (“and-dwell/sit from-the-east and-
# lift/carry”)
# ‹אֶת־קֹלָהּ וַתֵּבְךְּ› (“obj-marker voice/sound-her/its and-weep”)
...
m.step("Gen.21.16")
# ‹אַל־אֶרְאֶה בְּמוֹת הַיָּלֶד› (“do-not see in-death the-child”)
# — fact holds: over-ereh-in-death-the-child
m.fact("al_ereh_be_mot_ha_yaled")
# ‹וַתִּשָּׂא אֶת־קֹלָהּ וַתֵּבְךְּ› (“and-lift/carry obj-marker
# voice/sound-her/its and-weep”)
# — event: weep — agent Hagar
m.event("weep", agent="hagar")

# -------------------------- Gen.21.17 · THE_SKY_CALL_AND_THE_HEARD_NAME ----
# ‹וַיִּשְׁמַע אֱלֹהִים אֶת־קוֹל› (“and-hear God obj-marker voice/sound”)
# ‹הַנַּעַר וַיִּקְרָא מַלְאַךְ› (“the-boy and-call messenger”)
# ‹אֱלֹהִים אֶל־הָגָר מִן־הַשָּׁמַיִם› (“God to Hagar from the-heavens”)
# ‹וַיֹּאמֶר לָהּ מַה־לָּךְ› (“and-say to-her/its what to-you/your”)
# ‹הָגָר אַל־תִּירְאִי כִּי־שָׁמַע› (“Hagar do-not fear that hear”)
# ‹אֱלֹהִים אֶל־קוֹל הַנַּעַר› (“God to voice/sound the-boy”)
# ‹בַּאֲשֶׁר הוּא־שָׁם› (“in-who he/it there”)
...
# ‹אַל־תִּירְאִי› (“do-not fear”)
# — messenger-God speaks a demand — LET-NOT: fear(Hagar)
m.declare("malakh_elohim", "LET-NOT",
          "tiri(hagar)")
# ‹כִּי־שָׁמַע אֱלֹהִים אֶל־קוֹל› (“that hear God to voice/sound”)
# ‹הַנַּעַר בַּאֲשֶׁר הוּא־שָׁם› (“the-boy in-who he/it there”)
# — fact holds: hear-God-to-voice/sound-the-boy-in-the-which-he/it-there
...
# ‹קוּמִי שְׂאִי אֶת־הַנַּעַר› (“arise lift/carry obj-marker the-boy”)
# ‹וְהַחֲזִיקִי אֶת־יָדֵךְ בּוֹ› (“and-fasten-upon obj-marker hand-you/your
# in-him/its”)
...
# ‹וְהַחֲזִיקִי אֶת־יָדֵךְ בּוֹ› (“and-fasten-upon obj-marker hand-you/your
# in-him/its”)
# — messenger-God speaks a demand — LET: arise-lift/carry-and-fasten-
# upon(obj-marker-the-boy)
m.declare("malakh_elohim", "LET",
          "qumi_sei_ve_hachaziqi(et_ha_naar)")
# ‹כִּי־לְגוֹי גָּדוֹל אֲשִׂימֶנּוּ› (“that to-nation great put/set-
# him/its”)
# — fact holds: that-to-nation-great-asimenu
...
# ‹וַתֵּרֶא בְּאֵר מָיִם› (“and-see pit waters”)
# ‹וַתֵּלֶךְ וַתְּמַלֵּא אֶת־הַחֵמֶת› (“and-go and-fill obj-marker the-skin-
# bottle”)
# ‹מַיִם וַתַּשְׁקְ אֶת־הַנָּעַר› (“waters and-give-drink obj-marker the-
# boy”)
...
# ‹וַתְּמַלֵּא אֶת־הַחֵמֶת מַיִם› (“and-fill obj-marker the-skin-bottle
# waters”)
# ‹וַתַּשְׁקְ אֶת־הַנָּעַר› (“and-give-drink obj-marker the-boy”)
# — event: water — agent Hagar
m.event("water", agent="hagar")

# -------------------------- Gen.21.20 · GOD_WITH_THE_LAD -------------------
# ‹וַיְהִי אֱלֹהִים אֶת־הַנַּעַר› (“and-be God with the-boy”)
# ‹וַיִּגְדָּל וַיֵּשֶׁב בַּמִּדְבָּר› (“and-be-large and-dwell/sit in-
# pasture”)
# ‹וַיְהִי רֹבֶה קַשָּׁת› (“and-be increase bowman”)
# "And God was with the lad, and he grew; and he dwelt in the wilderness,
# and became an archer."
m.step("Gen.21.20")
# ‹וַיְהִי אֱלֹהִים אֶת־הַנַּעַר› (“and-be God with the-boy”)
# ‹וַיִּגְדָּל› (“and-be-large”)
# — fact holds: God-obj-marker-the-boy-and-be-large
m.fact("elohim_et_ha_naar_va_yigdal")

# -------------------------- Gen.21.21 · PARAN_AND_THE_EGYPTIAN_WIFE --------
# ‹וַיֵּשֶׁב בְּמִדְבַּר פָּארָן› (“and-dwell/sit in-pasture Paran”)
...
# ‹וַתִּקַּח־לוֹ אִמּוֹ אִשָּׁה› (“and-take to-him/its mother-him/its
# woman”)
# — event: take-wife — agent Hagar
m.event("take_wife", agent="hagar")
# ‹בְּמִדְבַּר פָּארָן … מֵאֶרֶץ› (“in-pasture Paran … from-earth”)
# ‹מִצְרָיִם› (“Egypt”)
# — reads without prior install (flag, not fix): Paran, Egypt
m.presupposed("paran", "mitzrayim")

# -------------------------- Gen.21.22-24 · THE_PACT_OPENING_DEMAND_AND_COMMITMENT -
# ‹וַיְהִי בָּעֵת הַהִוא› (“and-be in-time that”)
# ‹וַיֹּאמֶר אֲבִימֶלֶךְ וּפִיכֹל› (“and-say Abimelech and-Phichol”)
# ‹שַׂר־צְבָאוֹ אֶל־אַבְרָהָם לֵאמֹר› (“officer host-him/its to Abraham to-
# say”)
# ‹אֱלֹהִים עִמְּךָ בְּכֹל› (“God with-you/your in-all”)
# ‹אֲשֶׁר־אַתָּה עֹשֶׂה … וְעַתָּה› (“which you make … and-now”)
# ‹הִשָּׁבְעָה לִּי בֵאלֹהִים› (“swear-ward to-me/my in-God”)
# ‹הֵנָּה … וַיֹּאמֶר אַבְרָהָם› (“hither … and-say Abraham”)
# ‹אָנֹכִי אִשָּׁבֵעַ› (“swear”)
...
# — the world gains: Abimelech
m.install("avimelekh")
# ‹וּפִיכֹל שַׂר־צְבָאוֹ› (“and-Phichol officer host-him/its”)
# — the world gains: Phichol
m.install("fikhol")
# ‹אֱלֹהִים עִמְּךָ בְּכֹל› (“God with-you/your in-all”)
# ‹אֲשֶׁר־אַתָּה עֹשֶׂה … כַּחֶסֶד› (“which you make … like-kindness”)
# ‹אֲשֶׁר־עָשִׂיתִי עִמְּךָ› (“which make with-you/your”)
# — fact holds: God-imkha-in-all-which-you-oseh; like-chesed-which-make-
# imkha
m.fact("elohim_imkha_be_khol_asher_atah_oseh",
       "ka_chesed_asher_asiti_imkha")
# ‹וְעַתָּה הִשָּׁבְעָה לִּי› (“and-now swear-ward to-me/my”)
# ‹בֵאלֹהִים הֵנָּה› (“in-God hither”)
# — Abimelech speaks a demand — LET: hishava(to-me-and-God)
m.declare("avimelekh", "LET",
          "hishava(li_ve_elohim)")
# ‹אָנֹכִי אִשָּׁבֵעַ› (“swear”)
# — fact holds: anokhi-swear
...
# Abimelech”)
# ‹עַל־אֹדוֹת בְּאֵר הַמַּיִם› (“over turnings pit the-waters”)
# ‹אֲשֶׁר גָּזְלוּ עַבְדֵי› (“which pluck-off servant”)
# ‹אֲבִימֶלֶךְ› (“Abimelech”)
...
# ‹וְהוֹכִחַ אַבְרָהָם אֶת־אֲבִימֶלֶךְ› (“and-be-right Abraham obj-marker
# Abimelech”)
# — event: reprove — agent Abraham; theme Abimelech
...
# ‹וַיֹּאמֶר אֲבִימֶלֶךְ לֹא› (“and-say Abimelech not”)
# ‹יָדַעְתִּי מִי עָשָׂה› (“know who? make”)
# ‹אֶת־הַדָּבָר הַזֶּה וְגַם־אַתָּה› (“obj-marker the-word/thing the-this
# and-also you”)
# ‹לֹא־הִגַּדְתָּ לִּי וְגַם› (“not tell to-me/my and-also”)
# ‹אָנֹכִי לֹא שָׁמַעְתִּי› (“not hear”)
# ‹בִּלְתִּי הַיּוֹם› (“failure-of the-day”)
# "And Abimelech said: 'I know not who hath done this thing; neither didst
# thou tell me, neither yet heard I of it, but to-day.'"
m.step("Gen.21.26")
# ‹לֹא יָדַעְתִּי … לֹא־הִגַּדְתָּ› (“not know … not tell”)
# ‹… לֹא שָׁמַעְתִּי› (“not hear”)
# — fact holds: not-know-not-tell-not-hear-failure-of-the-day
m.fact("lo_yadati_lo_higadta_lo_shamati_bilti_ha_yom")

# -------------------------- Gen.21.27 · THE_FIRST_HUMAN_HUMAN_CUT ----------
# ‹וַיִּקַּח אַבְרָהָם צֹאן› (“and-take Abraham flock”)
# ‹וּבָקָר וַיִּתֵּן לַאֲבִימֶלֶךְ› (“and-herd and-set to-Abimelech”)
...
# ‹וַיַּצֵּב אַבְרָהָם אֶת־שֶׁבַע› (“and-stand Abraham obj-marker seven”)
# ‹כִּבְשֹׂת הַצֹּאן לְבַדְּהֶן› (“ewe the-flock to-separation-them/their”)
# ‹… מָה הֵנָּה שֶׁבַע› (“what themselves seven”)
# ‹כְּבָשֹׂת … כִּי אֶת־שֶׁבַע› (“ewe … that obj-marker seven”)
# ‹כְּבָשֹׂת תִּקַּח מִיָּדִי› (“ewe take from-hand-me/my”)
# ‹בַּעֲבוּר תִּהְיֶה־לִּי לְעֵדָה› (“for-the-sake-of be to-me/my to-
# testimony”)
# ‹כִּי חָפַרְתִּי אֶת־הַבְּאֵר› (“that dig obj-marker the-pit”)
# ‹הַזֹּאת עַל־כֵּן קָרָא› (“the-this over so call”)
# ‹לַמָּקוֹם הַהוּא בְּאֵר› (“to-place that”)
# ‹שָׁבַע כִּי שָׁם› (“Beer-shebah that there”)
# ‹נִשְׁבְּעוּ שְׁנֵיהֶם› (“swear two-them/their”)
...
# ‹וַיַּצֵּב אַבְרָהָם אֶת־שֶׁבַע› (“and-stand Abraham obj-marker seven”)
# ‹כִּבְשֹׂת הַצֹּאן לְבַדְּהֶן› (“ewe the-flock to-separation-them/their”)
# — event: station — agent Abraham; theme seven-ewe
m.event("station", agent="avraham", themes=["sheva_kivsot"])
# ‹תִּקַּח מִיָּדִי בַּעֲבוּר› (“take from-hand-me/my for-the-sake-of”)
# ‹תִּהְיֶה־לִּי לְעֵדָה כִּי› (“be to-me/my to-testimony that”)
# ‹חָפַרְתִּי אֶת־הַבְּאֵר› (“dig obj-marker the-pit”)
# — fact holds: seven-khevasot-take-who?-yadi-to-edah; that-dig-obj-marker-
# the-pit
m.fact("sheva_khevasot_tiqach_mi_yadi_le_edah",
       "ki_chafarti_et_ha_beer")
# ‹כִּי שָׁם נִשְׁבְּעוּ› (“that there swear”)
# ‹שְׁנֵיהֶם› (“two-them/their”)
# — demand settled (popped from the queue): hishava(to-me-and-God)
m.result("hishava(li_ve_elohim)", tmark="t1")
# ‹עַל־כֵּן קָרָא לַמָּקוֹם› (“over so call to-place”)
# ‹הַהוּא בְּאֵר שָׁבַע› (“that Beer-shebah”)
# — pattern recorded: over-so-call-to-place-pit-Beer-shebah
...
# ‹וַיִּכְרְתוּ בְרִית בִּבְאֵר› (“and-cut covenant in”)
# ‹שָׁבַע וַיָּקָם אֲבִימֶלֶךְ› (“Beer-shebah and-arise Abimelech”)
# ‹וּפִיכֹל שַׂר־צְבָאוֹ וַיָּשֻׁבוּ› (“and-Phichol officer host-him/its
# and-return”)
# ‹אֶל־אֶרֶץ פְּלִשְׁתִּים› (“to earth Pelishtite”)
...
# ‹אֶל־אֶרֶץ פְּלִשְׁתִּים› (“to earth Pelishtite”)
# — reads without prior install (flag, not fix): earth-Pelishtite
m.presupposed("eretz_pelishtim")

# -------------------------- Gen.21.33 · THE_TAMARISK_AND_THE_EVERLASTING_NAME -
# ‹וַיִּטַּע אֶשֶׁל בִּבְאֵר› (“and-strike-in tamarisk-tree in”)
# ‹שָׁבַע וַיִּקְרָא־שָׁם בְּשֵׁם› (“Beer-shebah and-call there in-name”)
# ‹יְהוָה אֵל עוֹלָם› (“YHWH strength forever”)
# "And Abraham planted a tamarisk-tree in Beer-sheba, and called there on
# the name of the LORD, the Everlasting God."
m.step("Gen.21.33")
# ‹וַיִּטַּע אֶשֶׁל … וַיִּקְרָא־שָׁם› (“and-strike-in tamarisk-tree … and-
# call there”)
# ‹בְּשֵׁם יְהוָה› (“in-name YHWH”)
# — event: plant-and-call — agent Abraham
m.event("plant_and_call", agent="avraham")
# ‹אֵל עוֹלָם› (“strength forever”)
# — fact holds: and-call-in-name-the-LORD-to-forever
...
# ‹וַיָּגָר אַבְרָהָם בְּאֶרֶץ› (“and-turn-aside-from-the-road Abraham in-
# earth”)
# ‹פְּלִשְׁתִּים יָמִים רַבִּים› (“Pelishtite day many/great”)
# "And Abraham sojourned in the land of the Philistines many days."
m.step("Gen.21.34")
# ‹וַיָּגָר אַבְרָהָם בְּאֶרֶץ› (“and-turn-aside-from-the-road Abraham in-
# earth”)
# ‹פְּלִשְׁתִּים יָמִים רַבִּים› (“Pelishtite day many/great”)
# — fact holds: and-turn-aside-from-the-road-in-earth-Pelishtite-day-
# many/great

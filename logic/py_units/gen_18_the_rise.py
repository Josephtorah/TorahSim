...
# ‹וַיְהִי הַמַּבּוּל אַרְבָּעִים› (“and-be the-deluge forty”)
# ‹יוֹם עַל־הָאָרֶץ וַיִּרְבּוּ› (“day over the-earth and-increased”)
# ‹הַמַּיִם וַיִּשְׂאוּ אֶת־הַתֵּבָה› (“the-waters and-they-lifted obj-
# marker the-ark”)
# ‹וַתָּרָם מֵעַל הָאָרֶץ› (“and-it-rose from-over the-earth”)
...
m.step("Gen.7.17")
# ‹וַיְהִי הַמַּבּוּל אַרְבָּעִים› (“and-be the-deluge forty”)
# ‹יוֹם עַל־הָאָרֶץ› (“day over the-earth”)
# — fact holds: the-deluge-forty-day-over-the-earth
m.fact("ha_mabul_arbaim_yom_al_ha_aretz")
# ‹וַיִּרְבּוּ הַמַּיִם וַיִּשְׂאוּ› (“and-increased the-waters and-they-
# lifted”)
# ‹אֶת־הַתֵּבָה› (“obj-marker the-ark”)
# — event: lift — agent the-waters; theme the-ark
m.event("lift", agent="ha_mayim", themes=["ha_tevah"])
# ‹וַתָּרָם מֵעַל הָאָרֶץ› (“and-it-rose from-over the-earth”)
# — event: rise — theme the-ark
...
# ‹וַיִּגְבְּרוּ הַמַּיִם וַיִּרְבּוּ› (“and-prevailed the-waters and-
# increased”)
# ‹מְאֹד עַל־הָאָרֶץ וַתֵּלֶךְ› (“very over the-earth and-it-walked”)
# ‹הַתֵּבָה עַל־פְּנֵי הַמָּיִם› (“the-ark over face-of the-waters”)
# "And the waters prevailed, and increased greatly upon the earth; and the
# ark went upon the face of the waters."
m.step("Gen.7.18")
# ‹וַיִּגְבְּרוּ הַמַּיִם› (“and-prevailed the-waters”)
# — event: prevail — agent the-waters
...
# ‹וַתֵּלֶךְ הַתֵּבָה עַל־פְּנֵי› (“and-it-walked the-ark over face-of”)
# ‹הַמָּיִם› (“the-waters”)
# — event: walk — agent the-ark; theme over-face-of-the-waters
m.event("walk", agent="ha_tevah", themes=["al_pnei_ha_mayim"])

# -------------------------- Gen.7.19 · THE_MOUNTAINS_GO_UNDER --------------
# ‹וְהַמַּיִם גָּבְרוּ מְאֹד› (“and-the-waters prevailed very”)
# ‹מְאֹד עַל־הָאָרֶץ וַיְכֻסּוּ› (“very over the-earth and-were-covered”)
# ‹כָּל־הֶהָרִים הַגְּבֹהִים אֲשֶׁר־תַּחַת› (“all the-mountains the-high
# which under”)
# ‹כָּל־הַשָּׁמָיִם› (“all the-heavens”)
...
m.step("Gen.7.19")
# ‹גָּבְרוּ מְאֹד מְאֹד› (“prevailed very very”)
# ‹… כָּל־הֶהָרִים הַגְּבֹהִים אֲשֶׁר־תַּחַת› (“all the-mountains the-high
# which under”)
# ‹כָּל־הַשָּׁמָיִם› (“all the-heavens”)
# — fact holds: prevailed-very-very-over-the-earth; all-he-mountains-the-
# high-under-all-the-heavens
...
# mountains the-high”)
# — event: cover — theme all-he-mountains-the-high
...
# ‹חֲמֵשׁ עֶשְׂרֵה אַמָּה› (“five teen cubit”)
# ‹מִלְמַעְלָה גָּבְרוּ הַמָּיִם› (“upward prevailed the-waters”)
# ‹וַיְכֻסּוּ הֶהָרִים› (“and-were-covered the-mountains”)
# "Fifteen cubits upward did the waters prevail; and the mountains were
# covered."
m.step("Gen.7.20")
# ‹חֲמֵשׁ עֶשְׂרֵה אַמָּה› (“five teen cubit”)
# ‹מִלְמַעְלָה גָּבְרוּ הַמָּיִם› (“upward prevailed the-waters”)
# — fact holds: five--teen-cubit-from-upward-prevailed
m.fact("chamesh_esreh_amah_mi_lemalah_gavru")
# ‹וַיְכֻסּוּ הֶהָרִים› (“and-were-covered the-mountains”)
# — event: cover — theme mountains
m.event("cover", themes=["he_harim"])

# -------------------------- Gen.7.21 · ALL_FLESH_EXPIRES -------------------
# ‹וַיִּגְוַע כָּל־בָּשָׂר הָרֹמֵשׂ› (“and-expired all flesh the-creeping”)
# ‹עַל־הָאָרֶץ בָּעוֹף וּבַבְּהֵמָה› (“over the-earth in-flying-creature
# and-in-livestock”)
# ‹וּבַחַיָּה וּבְכָל־הַשֶּׁרֶץ הַשֹּׁרֵץ› (“and-in-beast and-in-all the-
# swarming-creature the-swarming-creature”)
# ‹עַל־הָאָרֶץ וְכֹל הָאָדָם› (“over the-earth and-all the-human”)
...
# every man;"
m.step("Gen.7.21")
# ‹וַיִּגְוַע כָּל־בָּשָׂר› (“and-expired all flesh”)
# — event: expire — theme all-flesh
m.event("expire", themes=["kol_basar"])
# ‹בָּעוֹף וּבַבְּהֵמָה וּבַחַיָּה› (“in-flying-creature and-in-livestock
# and-in-beast”)
# ‹וּבְכָל־הַשֶּׁרֶץ … וְכֹל הָאָדָם› (“and-in-all the-swarming-creature …
# and-all the-human”)
# — fact holds: in-the-flying-creature-and-and-livestock-and-and-beast-and-
# and-swarming-creature-and-all-the-human
m.fact("ba_of_u_va_behemah_u_va_chayah_u_va_sheretz_ve_khol_ha_adam")

# -------------------------- Gen.7.22 · THE_COMPOUNDED_BREATH_CRITERION -----
# ‹כֹּל אֲשֶׁר נִשְׁמַת־רוּחַ› (“all which breath-of spirit”)
# ‹חַיִּים בְּאַפָּיו מִכֹּל› (“life in-his-nostrils from-all”)
# ‹אֲשֶׁר בֶּחָרָבָה מֵתוּ› (“which on-dry-land died”)
# "all in whose nostrils was the breath of the spirit of life, whatsoever
# was in the dry land, died."
m.step("Gen.7.22")
# ‹נִשְׁמַת־רוּחַ חַיִּים בְּאַפָּיו› (“breath-of spirit life in-his-
# nostrils”)
# ‹… מִכֹּל אֲשֶׁר בֶּחָרָבָה› (“from-all which on-dry-land”)
# ‹מֵתוּ› (“died”)
# — fact holds: breath-of-spirit-wind-life-in-his-nostrils; from-all-which-
# in-dry-land-died
...
# witness-tier presupposed read: nose_predicate_laws on
# nishmat_ruach_chayim_be_apav — read, not installed
m.witness_read("nishmat_ruach_chayim_be_apav", "nose_predicate_laws",
                cites=["Sotah 45b:16", "Sotah 45b:17", "Sotah 45b:18", "Bekhorot 46b:1", "Bekhorot 46b:2", "Bekhorot 46b:3"])

# -------------------------- Gen.7.23 · THE_WIPE_EXECUTED_ONLY_NOACH_LEFT ---
# ‹וַיִּמַח אֶת־כָּל־הַיְקוּם אֲשֶׁר› (“and-He-wiped obj-marker all the-
# standing-substance which”)
# ‹עַל־פְּנֵי הָאֲדָמָה מֵאָדָם› (“over face-of the-ground from-human”)
# ‹עַד־בְּהֵמָה עַד־רֶמֶשׂ וְעַד־עוֹף› (“until livestock until creeper and-
# until flying-creature”)
# ‹הַשָּׁמַיִם וַיִּמָּחוּ מִן־הָאָרֶץ› (“the-heavens and-they-were-wiped
# from the-earth”)
# ‹וַיִשָּׁאֶר אַךְ־נֹחַ וַאֲשֶׁר› (“and-was-left only Noah and-which”)
# ‹אִתּוֹ בַּתֵּבָה› (“with-him in-ark”)
...
# substance”)
# — event: wipe — theme all-the-standing-substance
m.event("wipe", themes=["kol_ha_yequm"])
# ‹מֵאָדָם עַד־בְּהֵמָה עַד־רֶמֶשׂ› (“from-human until livestock until
# creeper”)
# ‹וְעַד־עוֹף הַשָּׁמַיִם› (“and-until flying-creature the-heavens”)
# — fact holds: from-human-until-livestock-until-creeper-and-until-flying-
# creature
m.fact("me_adam_ad_behemah_ad_remes_ve_ad_of")
# ‹וַיִּמָּחוּ מִן־הָאָרֶץ› (“and-they-were-wiped from the-earth”)
# — event: wiped — theme all-the-standing-substance
m.event("wiped", themes=["kol_ha_yequm"])
# ‹וַיִשָּׁאֶר אַךְ־נֹחַ וַאֲשֶׁר› (“and-was-left only Noah and-which”)
# ‹אִתּוֹ בַּתֵּבָה› (“with-him in-ark”)
# — event: remain — theme only-Noach-and-which-with-him
...
m.event("prevail", agent="ha_mayim")
# ‹חֲמִשִּׁים וּמְאַת יוֹם› (“fifty and-hundred day”)
# — fact holds: fifty-and-hundred-day-over-the-earth
...
if __name__ == "__main__":
    ...
    assert [(w["entity"], w["state"]) for w in m.WITNESS_READS] == [('all_mountains_quantifier', 'territorial_claim_defeated'), ('nishmat_formula', 'legal_definition_of_life'), ('rescue_override', 'bounded_by_its_own_purpose'), ('dry_land_limiter', 'fish_exempted_by_the_wording'), ('nishmat_ruach_chayim_be_apav', 'nose_predicate_laws'), ('double_wipe_verb', 'two_worlds_two_verbs'), ('from_man_to_beast_order', 'initiator_punished_first')]
    ...
    assert m.WITNESS_READS[4]["cites"] == ['Sotah 45b:16', 'Sotah 45b:17', 'Sotah 45b:18', 'Bekhorot 46b:1', 'Bekhorot 46b:2', 'Bekhorot 46b:3']
    assert all('nose_predicate_laws' not in f for f in m.WORLD["facts"])
    assert 'nishmat_ruach_chayim_be_apav' not in m.WORLD["witnessed"]
    assert m.WITNESS_READS[5]["cites"] == ['Jerusalem Talmud Sanhedrin 10:3:2']
    assert all('two_worlds_two_verbs' not in f for f in m.WORLD["facts"])
    assert 'double_wipe_verb' not in m.WORLD["witnessed"]
    assert m.WITNESS_READS[6]["cites"] == ['Mekhilta DeRabbi Yishmael, Tractate Vayehi Beshalach 2:8']

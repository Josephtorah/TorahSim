...
# ‹וַיֹּאמֶר אֱלֹהִים אֶל־יַעֲקֹב› (“and-say God to Jacob”)
# ‹קוּם עֲלֵה בֵית־אֵל› (“arise go-up Beth-el”)
# ‹וְשֶׁב־שָׁם וַעֲשֵׂה־שָׁם מִזְבֵּחַ› (“and-dwell/sit there and-make there
# altar”)
# ‹לָאֵל הַנִּרְאֶה אֵלֶיךָ› (“to-God the-see to-you/your”)
# ‹בְּבָרְחֲךָ מִפְּנֵי עֵשָׂו› (“in-bolt-you/your from-face Esau”)
# ‹אָחִיךָ› (“brother-you/your”)
...
m.step("Gen.35.1")
# ‹קוּם עֲלֵה בֵית־אֵל› (“arise go-up Beth-el”)
# — God speaks a demand — LET: arise-go-up(Jacob, from-to)
m.declare("Elohim", "LET",
          "qum_ale(yaaqov, bet_el)")
# ‹וְשֶׁב־שָׁם› (“and-dwell/sit there”)
# — God speaks a demand — LET: dwell/sit-there(Jacob, from-to)
m.declare("Elohim", "LET",
          "shev_sham(yaaqov, bet_el)")
# ‹וַעֲשֵׂה־שָׁם מִזְבֵּחַ לָאֵל› (“and-make there altar to-God”)
# — God speaks a demand — LET: make-there-altar(Jacob, to-to-the-see)
m.declare("Elohim", "LET",
...
# ‹וַיֹּאמֶר יַעֲקֹב אֶל־בֵּיתוֹ› (“and-say Jacob to house-him/its”)
# ‹וְאֶל כָּל־אֲשֶׁר עִמּוֹ› (“and-to all which with-him/its”)
# ‹הָסִרוּ אֶת־אֱלֹהֵי הַנֵּכָר› (“turn-aside obj-marker God the-foreign”)
# ‹אֲשֶׁר בְּתֹכְכֶם וְהִטַּהֲרוּ› (“which in-midst-you/your(pl) and-be-
# pure”)
# ‹וְהַחֲלִיפוּ שִׂמְלֹתֵיכֶם› (“and-slide-by dress-you/your(pl)”)
...
# ‹וְהִטַּהֲרוּ› (“and-be-pure”)
# — Jacob speaks a demand — LET: be-pure(from-Jacob)
m.declare("yaaqov", "LET",
          "hitaharu(bet_yaaqov)")
# ‹וְהַחֲלִיפוּ שִׂמְלֹתֵיכֶם› (“and-slide-by dress-you/your(pl)”)
# — Jacob speaks a demand — LET: slide-by(from-Jacob, simlotekhem)
m.declare("yaaqov", "LET",
...
# ‹וְנָקוּמָה וְנַעֲלֶה בֵּית־אֵל› (“and-arise and-go-up Beth-el”)
# ‹וְאֶעֱשֶׂה־שָּׁם מִזְבֵּחַ לָאֵל› (“and-make there altar to-God”)
# ‹הָעֹנֶה אֹתִי בְּיוֹם› (“the-eye obj-marker-me/my in-day”)
# ‹צָרָתִי וַיְהִי עִמָּדִי› (“tightness-me/my and-be along-with-me/my”)
# ‹בַּדֶּרֶךְ אֲשֶׁר הָלָכְתִּי› (“in-way/road which walk/go”)
...
m.step("Gen.35.3")
# ‹וְנָקוּמָה וְנַעֲלֶה בֵּית־אֵל› (“and-arise and-go-up Beth-el”)
# — Jacob speaks a demand — CMD-US?: arise-and-go-up(from-Jacob, from-to)
...
# ‹וַיִּתְּנוּ אֶל־יַעֲקֹב אֵת› (“and-set to Jacob obj-marker”)
# ‹כָּל־אֱלֹהֵי הַנֵּכָר אֲשֶׁר› (“all God the-foreign which”)
# ‹בְּיָדָם וְאֶת־הַנְּזָמִים אֲשֶׁר› (“in-hand-them/their and-obj-marker
# the-nose-ring which”)
# ‹בְּאָזְנֵיהֶם וַיִּטְמֹן אֹתָם› (“in-broadness.-i.e.-the-ear-them/their
# and-hide obj-marker-them/their”)
# ‹יַעֲקֹב תַּחַת הָאֵלָה› (“Jacob under the-oak”)
# ‹אֲשֶׁר עִם־שְׁכֶם› (“which with Shechem”)
...
m.step("Gen.35.4")
# ‹וַיִּתְּנוּ אֶל־יַעֲקֹב› (“and-set to Jacob”)
# — fact holds: and-set-and-hide(God-the-foreign-and-the-nose-ring, under-
# the-oak)
m.fact("va_yitnu_va_yitmon(elohe_ha_nekhar_ve_ha_nezamim, tachat_ha_ela)")

# -------------------------- Gen.35.5 · THE_UN_PURSUIT ----------------------
# ‹וַיִּסָּעוּ וַיְהִי חִתַּת› (“and-journey and-be fear”)
# ‹אֱלֹהִים עַל־הֶעָרִים אֲשֶׁר› (“God over the-city which”)
# ‹סְבִיבֹתֵיהֶם וְלֹא רָדְפוּ› (“circle-them/their and-not run-after-gone-
# by)”)
# ‹אַחֲרֵי בְּנֵי יַעֲקֹב› (“after son Jacob”)
...
m.step("Gen.35.5")
# ‹וַיִּסָּעוּ› (“and-journey”)
# — fact holds: fear-God-and-not-run-after-gone-by)(city)
m.fact("chitat_Elohim_ve_lo_radfu(he_arim)")

# -------------------------- Gen.35.6 · THE_ARRIVAL -------------------------
# ‹וַיָּבֹא יַעֲקֹב לוּזָה› (“and-come/bring Jacob Luz-ward”)
# ‹אֲשֶׁר בְּאֶרֶץ כְּנַעַן› (“which in-earth Canaan”)
# ‹הִוא בֵּית־אֵל הוּא› (“he/it Beth-el he/it”)
# ‹וְכָל־הָעָם אֲשֶׁר־עִמּוֹ› (“and-all the-people which with-him/its”)
# "[EN-AID] And Jacob came to Luz, which is in the land of Canaan — it is
# Bethel — he and all the people who were with him."
m.step("Gen.35.6")
# ‹וַיָּבֹא יַעֲקֹב לוּזָה› (“and-come/bring Jacob Luz-ward”)
# — fact holds: and-come/bring-luzah-he/it-from-to(Jacob-and-the-people)
...
# ‹וַיִּקְרָא לַמָּקוֹם אֵל› (“and-call to-place strength”)
# ‹בֵּית־אֵל כִּי שָׁם› (“Beth-el that there”)
# ‹נִגְלוּ אֵלָיו הָאֱלֹהִים› (“denude to-him/its the-God”)
# ‹בְּבָרְחוֹ מִפְּנֵי אָחִיו› (“in-bolt-him/its from-face brother-him/its”)
...
m.step("Gen.35.7")
# ‹וַיִּבֶן שָׁם מִזְבֵּחַ› (“and-build there altar”)
# — the world gains: the-place
m.install("ha_maqom")
# ‹וַיִּקְרָא לַמָּקוֹם אֵל› (“and-call to-place strength”)
# — named: the-place := to-from-to
m.name("ha_maqom", "el_bet_el")

# -------------------------- Gen.35.8 · THE_NURSE_NAMED_AT_DEATH ------------
# ‹וַתָּמָת דְּבֹרָה מֵינֶקֶת› (“and-die Deborah suck”)
# ‹רִבְקָה וַתִּקָּבֵר מִתַּחַת› (“Rebekah and-bury from-under”)
# ‹לְבֵית־אֵל תַּחַת הָאַלּוֹן› (“to Beth-el under the-oak”)
# ‹וַיִּקְרָא שְׁמוֹ אַלּוֹן› (“and-call name-him/its”)
# ‹בָּכוּת› (“Allon-bachuth”)
...
# ‹וַיִּקְרָא שְׁמוֹ אַלּוֹן› (“and-call name-him/its”)
# ‹בָּכוּת› (“Allon-bachuth”)
# — named: the-oak := oak-Allon-bachuth
...
# ‹וַיֵּרָא אֱלֹהִים אֶל־יַעֲקֹב› (“and-see God to Jacob”)
# ‹עוֹד בְּבֹאוֹ מִפַּדַּן› (“still/again in-come/bring-him/its from”)
# ‹אֲרָם וַיְבָרֶךְ אֹתוֹ› (“Padan and-bless obj-marker-him/its”)
...
# ‹וַיֹּאמֶר־לוֹ אֱלֹהִים שִׁמְךָ› (“and-say to-him/its God name-you/your”)
# ‹יַעֲקֹב לֹא־יִקָּרֵא שִׁמְךָ› (“Jacob not call name-you/your”)
# ‹עוֹד יַעֲקֹב כִּי› (“still/again Jacob very-widely-used-as-a-relati”)
# ‹אִם־יִשְׂרָאֵל יִהְיֶה שְׁמֶךָ› (“as-demonstrative Israel be name-
# you/your”)
...
# Israel."
m.step("Gen.35.10")
# ‹שִׁמְךָ יַעֲקֹב› (“name-you/your Jacob”)
# — the world gains: Jacob
m.install("yaaqov")
# ‹וַיִּקְרָא אֶת־שְׁמוֹ יִשְׂרָאֵל› (“and-call obj-marker name-him/its
# Israel”)
# — named: Jacob := Israel
...
# ‹וַיֹּאמֶר לוֹ אֱלֹהִים› (“and-say to-him/its God”)
# ‹אֲנִי אֵל שַׁדַּי› (“strength Almighty”)
# ‹פְּרֵה וּרְבֵה גּוֹי› (“be-fruitful and-multiply nation”)
# ‹וּקְהַל גּוֹיִם יִהְיֶה› (“and-assemblage nation be”)
# ‹מִמֶּךָּ וּמְלָכִים מֵחֲלָצֶיךָ› (“from-you/your and-king from-loins-
# you/your”)
# ‹יֵצֵאוּ› (“bring-forth”)
...
# out from your loins."
m.step("Gen.35.11")
# ‹פְּרֵה וּרְבֵה› (“be-fruitful and-multiply”)
# — to-Almighty speaks a demand — LET: be-fruitful-and-multiply(Israel)
...
# ‹לְאַבְרָהָם וּלְיִצְחָק לְךָ› (“to-Abraham and-to-Isaac to-you/your”)
# ‹אֶתְּנֶנָּה וּלְזַרְעֲךָ אַחֲרֶיךָ› (“set-her/its and-to-seed-you/your
# after-you/your”)
# ‹אֶתֵּן אֶת־הָאָרֶץ› (“set obj-marker the-earth”)
...
# ‹וַיַּעַל מֵעָלָיו אֱלֹהִים› (“and-go-up from-over-him/its God”)
# ‹בַּמָּקוֹם אֲשֶׁר־דִּבֶּר אִתּוֹ› (“in-place which speak with-him/its”)
# "[EN-AID] And God went up from him, in the place where He had spoken with
# him."
m.step("Gen.35.13")
# ‹וַיַּעַל מֵעָלָיו אֱלֹהִים› (“and-go-up from-over-him/its God”)
# — fact holds: and-go-up-from-alav-God(place)
m.fact("va_yaal_me_alav_Elohim(ba_maqom)")

# -------------------------- Gen.35.14 · THE_PILLAR_AND_THE_LIBATION --------
# ‹וַיַּצֵּב יַעֲקֹב מַצֵּבָה› (“and-stand Jacob pillar”)
# ‹בַּמָּקוֹם אֲשֶׁר־דִּבֶּר אִתּוֹ› (“in-place which speak with-him/its”)
# ‹מַצֶּבֶת אָבֶן וַיַּסֵּךְ› (“something-stationary stone and-pour-out”)
# ‹עָלֶיהָ נֶסֶךְ וַיִּצֹק› (“over-her/its libation and-pour-out”)
# ‹עָלֶיהָ שָׁמֶן› (“over-her/its oil”)
...
# ‹וַיַּצֵּב יַעֲקֹב מַצֵּבָה› (“and-stand Jacob pillar”)
# ‹בַּמָּקוֹם› (“in-place”)
# — fact holds: and-stand-pillar-and-pour-out-libation(Jacob, oil)
m.fact("va_yatzev_matzeva_va_yasekh_nesekh(yaaqov, shamen)")

# -------------------------- Gen.35.15 · THE_NAME_REWRITTEN -----------------
# ‹וַיִּקְרָא יַעֲקֹב אֶת־שֵׁם› (“and-call Jacob obj-marker name”)
# ‹הַמָּקוֹם אֲשֶׁר דִּבֶּר› (“the-place which speak”)
# ‹אִתּוֹ שָׁם אֱלֹהִים› (“with-him/its there God”)
# ‹בֵּית־אֵל› (“Beth-el”)
...
# ‹וַיִּקְרָא יַעֲקֹב אֶת־שֵׁם› (“and-call Jacob obj-marker name”)
# ‹הַמָּקוֹם› (“the-place”)
# — named: the-place := from-to
m.name("ha_maqom", "bet_el")

# -------------------------- Gen.35.16 · THE_HARD_BIRTH_BEGINS --------------
# ‹וַיִּסְעוּ מִבֵּית אֵל› (“and-journey from Beth-el”)
# ‹וַיְהִי־עוֹד כִּבְרַת־הָאָרֶץ לָבוֹא› (“and-be still/again length the-
# earth to-come/bring”)
# ‹אֶפְרָתָה וַתֵּלֶד רָחֵל› (“'Ephrath and-bear-young Rachel”)
# ‹וַתְּקַשׁ בְּלִדְתָּהּ› (“and-be-dense in-bear-young-her/its”)
...
m.step("Gen.35.16")
# ‹וַתְּקַשׁ בְּלִדְתָּהּ› (“and-be-dense in-bear-young-her/its”)
# — fact holds: and-be-dense-in-lidtah(Rachel, length-the-earth-'Ephrath)
m.fact("va_teqash_be_lidtah(rachel, kivrat_ha_aretz_efrata)")

# -------------------------- Gen.35.17 · THE_MIDWIFE_AND_THE_FEAR_NOT -------
# ‹וַיְהִי בְהַקְשֹׁתָהּ בְּלִדְתָּהּ› (“and-be in-be-dense-her/its in-bear-
# young-her/its”)
# ‹וַתֹּאמֶר לָהּ הַמְיַלֶּדֶת› (“and-say to-her/its the-bear-young”)
# ‹אַל־תִּירְאִי כִּי־גַם־זֶה לָךְ› (“do-not fear that also this to-
# you/your”)
# ‹בֵּן› (“son”)
...
# — the-bear-young speaks a demand — LET-NOT: fear(Rachel)
m.declare("ha_meyaledet", "LET-NOT",
          "tiri(rachel)")

# -------------------------- Gen.35.18 · THE_TWO_NAMES ----------------------
# ‹וַיְהִי בְּצֵאת נַפְשָׁהּ› (“and-be in-bring-forth living-being-her/its”)
# ‹כִּי מֵתָה וַתִּקְרָא› (“that die and-call”)
# ‹שְׁמוֹ בֶּן־אוֹנִי וְאָבִיו› (“name-him/its Ben-oni and-father-him/its”)
# ‹קָרָא־לוֹ בִנְיָמִין› (“call to-him/its Benjamin”)
...
m.install("ha_ben")
# ‹וַתִּקְרָא שְׁמוֹ בֶּן־אוֹנִי› (“and-call name-him/its Ben-oni”)
# — named: the-son := son-Ben-oni
m.name("ha_ben", "ben_oni")
# ‹וְאָבִיו קָרָא־לוֹ בִנְיָמִין› (“and-father-him/its call to-him/its
# Benjamin”)
# — named: the-son := Benjamin
...
# ‹וַתָּמָת רָחֵל וַתִּקָּבֵר› (“and-die Rachel and-bury”)
# ‹בְּדֶרֶךְ אֶפְרָתָה הִוא› (“in-way/road 'Ephrath he/it”)
# ‹בֵּית לָחֶם› (“Bethlehem”)
# "[EN-AID] And Rachel died; and she was buried on the way to Efrat — it is
# Bethlehem."
m.step("Gen.35.19")
# ‹וַתָּמָת רָחֵל› (“and-die Rachel”)
# — fact holds: and-die-and-bury(Rachel, in-way/road-'Ephrath-from-
# Bethlehem)
...
# ‹וַיַּצֵּב יַעֲקֹב מַצֵּבָה› (“and-stand Jacob pillar”)
# ‹עַל־קְבֻרָתָהּ הִוא מַצֶּבֶת› (“over sepulture-her/its he/it something-
# stationary”)
# ‹קְבֻרַת־רָחֵל עַד־הַיּוֹם› (“sepulture Rachel until the-day”)
# "[EN-AID] And Jacob set up a pillar upon her grave — it is the pillar of
# Rachel's grave to this day."
m.step("Gen.35.20")
# ‹וַיַּצֵּב יַעֲקֹב מַצֵּבָה› (“and-stand Jacob pillar”)
# — fact holds: something-stationary-sepulture-Rachel(until-the-day)
...
# ‹וַיִּסַּע יִשְׂרָאֵל וַיֵּט› (“and-journey Israel and-stretch”)
# ‹אָהֳלֹה מֵהָלְאָה לְמִגְדַּל־עֵדֶר› (“tent-him/its from-the-distance to
# Migdal-eder”)
# "[EN-AID] And Israel journeyed, and pitched his tent beyond Migdal-eder."
m.step("Gen.35.21")
# ‹וַיִּסַּע יִשְׂרָאֵל› (“and-journey Israel”)
# — fact holds: and-journey-Israel(from-distance-to-to-Migdal-eder)
m.fact("va_yisa_yisrael(me_hala_le_migdal_eder)")

# -------------------------- Gen.35.22 · REUBEN_AND_THE_COUNT ---------------
# ‹וַיְהִי בִּשְׁכֹּן יִשְׂרָאֵל› (“and-be in-reside Israel”)
# ‹בָּאָרֶץ הַהִוא וַיֵּלֶךְ› (“in-earth that and-go”)
# ‹רְאוּבֵן וַיִּשְׁכַּב אֶת־בִּלְהָה› (“Reuben and-lie-down with Bilhah”)
# ‹פִּילֶגֶשׁ אָבִיו וַיִּשְׁמַע› (“concubine father-him/its and-hear”)
# ‹יִשְׂרָאֵל וַיִּהְיוּ בְנֵי־יַעֲקֹב› (“Israel and-be son Jacob”)
# ‹שְׁנֵים עָשָׂר› (“two -teen”)
...
# concubine”)
# — fact holds: and-lie-down-Reuben-and-hear-Israel(two--teen)
...
# ‹בְּנֵי לֵאָה בְּכוֹר› (“son Leah firstborn”)
# ‹יַעֲקֹב רְאוּבֵן וְשִׁמְעוֹן› (“Jacob Reuben and-Simeon”)
# ‹וְלֵוִי וִיהוּדָה וְיִשָּׂשכָר› (“and-Levi and-Judah and-Issachar”)
# ‹וּזְבוּלֻן› (“and-Zebulun”)
# "[EN-AID] The sons of Leah: Jacob's firstborn Reuben, and Simeon and Levi
# and Judah and Issachar and Zebulun."
m.step("Gen.35.23")
# ‹בְּנֵי לֵאָה בְּכוֹר› (“son Leah firstborn”)
# — fact holds: son-Leah-shisha(Reuben-until-Zebulun)
m.fact("bene_lea_shisha(reuven_ad_zevulun)")

# -------------------------- Gen.35.24 · RACHEL_S_TWO -----------------------
# ‹בְּנֵי רָחֵל יוֹסֵף› (“son Rachel Joseph”)
# ‹וּבִנְיָמִן› (“and-Benjamin”)
...
# ‹וּבְנֵי בִלְהָה שִׁפְחַת› (“and-son Bilhah female-slave”)
# ‹רָחֵל דָּן וְנַפְתָּלִי› (“Rachel Daniel and-Naphtali”)
...
# ‹וּבְנֵי זִלְפָּה שִׁפְחַת› (“and-son Zilpah female-slave”)
# ‹לֵאָה גָּד וְאָשֵׁר› (“Leah Gad and-Asher”)
# ‹אֵלֶּה בְּנֵי יַעֲקֹב› (“these son Jacob”)
# ‹אֲשֶׁר יֻלַּד־לוֹ בְּפַדַּן› (“which bear-young to-him/its in”)
# ‹אֲרָם› (“Padan”)
# "[EN-AID] And the sons of Zilpah, Leah's maid: Gad and Asher. These are
# the sons of Jacob who were born to him in Paddan-aram."
m.step("Gen.35.26")
# ‹אֵלֶּה בְּנֵי יַעֲקֹב› (“these son Jacob”)
# ‹אֲשֶׁר יֻלַּד› (“which bear-young”)
...
# ‹וַיָּבֹא יַעֲקֹב אֶל־יִצְחָק› (“and-come/bring Jacob to Isaac”)
# ‹אָבִיו מַמְרֵא קִרְיַת› (“father-him/its Mamre”)
# ‹הָאַרְבַּע הִוא חֶבְרוֹן› (“Kirjath-Arba he/it Hebron”)
# ‹אֲשֶׁר־גָּר־שָׁם אַבְרָהָם וְיִצְחָק› (“which turn-aside-from-the-road
# there Abraham and-Isaac”)
...
# — fact holds: and-come/bring-to-Isaac(Mamre-qiryat-Kirjath-Arba-he/it-
# Hebron)
m.fact("va_yavo_el_yitzchaq(mamre_qiryat_haarba_hiv_chevron)")

# -------------------------- Gen.35.28 · ISAAC_S_DAYS -----------------------
# ‹וַיִּהְיוּ יְמֵי יִצְחָק› (“and-be day Isaac”)
# ‹מְאַת שָׁנָה וּשְׁמֹנִים› (“hundred years and-eighty”)
# ‹שָׁנָה› (“years”)
# "[EN-AID] And the days of Isaac were a hundred years and eighty years."
m.step("Gen.35.28")
# ‹וַיִּהְיוּ יְמֵי יִצְחָק› (“and-be day Isaac”)
# — fact holds: day-Isaac(hundred-and-eighty-years)
m.fact("yeme_yitzchaq(meat_u_shemonim_shana)")

# -------------------------- Gen.35.29 · THE_BROTHERS_AT_THE_GRAVE ----------
# ‹וַיִּגְוַע יִצְחָק וַיָּמָת› (“and-breathe-out Isaac and-die”)
# ‹וַיֵּאָסֶף אֶל־עַמָּיו זָקֵן› (“and-gather-for-any-purpose to people-
# him/its old”)
# ‹וּשְׂבַע יָמִים וַיִּקְבְּרוּ› (“and-satiated day and-bury”)
# ‹אֹתוֹ עֵשָׂו וְיַעֲקֹב› (“obj-marker-him/its Esau and-Jacob”)
# ‹בָּנָיו› (“son-him/its”)
...
m.step("Gen.35.29")
# ‹וַיִּגְוַע יִצְחָק וַיָּמָת› (“and-breathe-out Isaac and-die”)
# — fact holds: and-breathe-out-and-gather-for-any-purpose-and-bury(Isaac,
# Esau-and-Jacob)

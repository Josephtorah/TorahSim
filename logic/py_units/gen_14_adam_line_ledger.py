...
# ‹זה ספר תולדת› (“this book generations-of”)
# ‹אדם ביום ברא› (“Adam in-day-of creating”)
# ‹אלהים אדם בדמות› (“God Adam in-likeness-of”)
# ‹אלהים עשׂה אתו› (“God made him”)
# "This is the book of the generations of Adam. In the day that God created
# man, in the likeness of God made He him;"
m.step("Gen.5.1")
# ‹זה ספר תולדת› (“this book generations-of”)
# ‹אדם› (“Adam”)
# — section book-generations-Adam: zeh sefer toledot adam — the book header
# labels; installs nothing
m.section("sefer_toledot_adam", "zeh sefer toledot adam — the book header labels; installs nothing")
# ‹ביום ברא אלהים› (“in-day-of creating God”)
# ‹אדם בדמות אלהים› (“Adam in-likeness-of God”)
# ‹עשׂה אתו› (“made him”)
# — fact holds: in-day-of-creating-God-Adam-in-likeness-of-God-make-it
m.fact("be_yom_bero_elohim_adam_bidmut_elohim_asah_oto")
# ‹בדמות אלהים עשׂה› (“in-likeness-of God made”)
# ‹אתו› (“him”)
# — spec-delta — spec said in-our-image for-our-likeness — in-our-IMAGE
# after-our-LIKENESS (1:26, frozen day 6), delivery says in-likeness-of God
# make it — LIKENESS ONLY, the image-word dropped from the restatement (5:1)
...
# ‹זכר ונקבה בראם› (“male and-female created-them”)
# ‹ויברך אתם ויקרא› (“and-He-blessed them and-He-called”)
# ‹את־שׁמם אדם ביום› (“obj-marker their-name Adam in-day-of”)
# ‹הבראם› (“their-being-created”)
# "male and female created He them, and blessed them, and called their name
# Adam, in the day when they were created."
m.step("Gen.5.2")
# ‹זכר ונקבה בראם› (“male and-female created-them”)
# ‹ויברך אתם› (“and-He-blessed them”)
# — event: bless — agent God; theme male-and-female
m.event("bless", agent="Elohim", themes=["zakhar_u_nekevah"])
# ‹ויקרא את־שׁמם אדם› (“and-He-called obj-marker their-name Adam”)
# — named: Adam-species := Adam
m.name("adam_species", "Adam")
# ‹זכר ונקבה בראם› (“male and-female created-them”)
# — fact holds: male-and-female-when-created; in-day-of-their-being-created
...
# ‹ויחי אדם שׁלשׁים› (“and-he-lived Adam thirty”)
# ‹ומאת שׁנה ויולד› (“and-hundred year and-he-begot”)
# ‹בדמותו כצלמו ויקרא› (“in-his-likeness after-his-image and-he-called”)
# ‹את־שׁמו שׁת› (“obj-marker name-him/its Shet”)
# "And Adam lived a hundred and thirty years, and begot a son in his own
# likeness, after his image; and called his name Seth."
m.step("Gen.5.3")
# ‹ויחי אדם שׁלשׁים› (“and-he-lived Adam thirty”)
# ‹ומאת שׁנה ויולד› (“and-hundred year and-he-begot”)
# ‹בדמותו כצלמו› (“in-his-likeness after-his-image”)
# — event: beget — agent Adam; theme Shet
m.event("beget", agent="adam", themes=["shet"])
# ‹בדמותו כצלמו› (“in-his-likeness after-his-image”)
# — spec-delta — spec said in-our-image for-our-likeness — in-our-IMAGE
# after-our-LIKENESS, God to human (1:26, frozen day 6), delivery says bi-
# his-likeness like-his-image — in-his-LIKENESS after-his-IMAGE: order
# swapped, prepositions swapped, direction man-to-son (5:3)
...
# ‹ויהיו ימי־אדם אחרי› (“and-were days-of Adam after”)
# ‹הולידו את־שׁת שׁמנה› (“his-begetting obj-marker Seth eight”)
# ‹מאת שׁנה ויולד› (“hundred year and-he-begot”)
# ‹בנים ובנות› (“sons and-daughters”)
...
# ‹מאת שׁנה ויולד› (“hundred year and-he-begot”)
# ‹בנים ובנות› (“sons and-daughters”)
# — fact holds: sons-and-daughters(Adam)
m.fact("banim_u_vanot(adam)")

# -------------------------- Gen.5.5 · LEDGER_ADAM_TOTAL_DIES ---------------
# ‹ויהיו כל־ימי אדם› (“and-were all-of days-of Adam”)
# ‹אשׁר־חי תשׁע מאות› (“that lived nine hundred”)
# ‹שׁנה ושׁלשׁים שׁנה› (“year and-thirty year”)
# ‹וימת› (“and-he-died”)
...
# ‹אשׁר־חי תשׁע מאות› (“that lived nine hundred”)
# ‹שׁנה ושׁלשׁים שׁנה› (“year and-thirty year”)
# — fact holds: all-days-of-Adam-930-year
m.fact("kol_yemei_adam_930_shanah")
# ‹וימת› (“and-he-died”)
# — event: die — agent Adam
m.event("die", agent="adam")

# -------------------------- Gen.5.6 · LEDGER_SHET_BEGETS -------------------
# ‹ויחי־שׁת חמשׁ שׁנים› (“and-he-lived Seth five year”)
# ‹ומאת שׁנה ויולד› (“and-hundred year and-he-begot”)
# ‹את־אנושׁ› (“obj-marker Enos”)
# "And Seth lived a hundred and five years, and begot Enosh."
m.step("Gen.5.6")
# ‹ויחי־שׁת חמשׁ שׁנים› (“and-he-lived Seth five year”)
# ‹ומאת שׁנה ויולד› (“and-hundred year and-he-begot”)
# ‹את־אנושׁ› (“obj-marker Enos”)
# — event: beget — agent Shet; theme Enos
m.event("beget", agent="shet", themes=["enosh"])

# -------------------------- Gen.5.7 · LEDGER_SHET_AFTER --------------------
# ‹ויחי־שׁת אחרי הולידו› (“and-he-lived Seth after his-begetting”)
# ‹את־אנושׁ שׁבע שׁנים› (“obj-marker Enos seven year”)
# ‹ושׁמנה מאות שׁנה› (“and-eight hundred year”)
# ‹ויולד בנים ובנות› (“and-he-begot sons and-daughters”)
...
# ‹ושׁמנה מאות שׁנה› (“and-eight hundred year”)
# ‹ויולד בנים ובנות› (“and-he-begot sons and-daughters”)
# — fact holds: sons-and-daughters(Shet)
m.fact("banim_u_vanot(shet)")

# -------------------------- Gen.5.8 · LEDGER_SHET_TOTAL_DIES ---------------
# ‹ויהיו כל־ימי־שׁת שׁתים› (“and-were all-of days-of Seth two”)
# ‹עשׂרה שׁנה ותשׁע› (“teen year and-nine”)
# ‹מאות שׁנה וימת› (“hundred year and-he-died”)
# "And all the days of Seth were nine hundred and twelve years; and he
# died."
m.step("Gen.5.8")
# ‹ויהיו כל־ימי־שׁת שׁתים› (“and-were all-of days-of Seth two”)
# ‹עשׂרה שׁנה ותשׁע› (“teen year and-nine”)
# ‹מאות שׁנה› (“hundred year”)
# — fact holds: all-days-of-Shet-912-year
m.fact("kol_yemei_shet_912_shanah")
# ‹וימת› (“and-he-died”)
# — event: die — agent Shet
m.event("die", agent="shet")

# -------------------------- Gen.5.9 · LEDGER_ENOSH_BEGETS ------------------
# ‹ויחי אנושׁ תשׁעים› (“and-he-lived Enos ninety”)
# ‹שׁנה ויולד את־קינן› (“year and-he-begot obj-marker Cainan”)
# "And Enosh lived ninety years, and begot Kenan."
m.step("Gen.5.9")
# ‹ויחי אנושׁ תשׁעים› (“and-he-lived Enos ninety”)
# ‹שׁנה ויולד את־קינן› (“year and-he-begot obj-marker Cainan”)
# — event: beget — agent Enos; theme Cainan
m.event("beget", agent="enosh", themes=["qenan"])

# -------------------------- Gen.5.10 · LEDGER_ENOSH_AFTER ------------------
# ‹ויחי אנושׁ אחרי› (“and-he-lived Enos after”)
# ‹הולידו את־קינן חמשׁ› (“his-begetting obj-marker Cainan five”)
# ‹עשׂרה שׁנה ושׁמנה› (“teen year and-eight”)
# ‹מאות שׁנה ויולד› (“hundred year and-he-begot”)
# ‹בנים ובנות› (“sons and-daughters”)
...
# ‹מאות שׁנה ויולד› (“hundred year and-he-begot”)
# ‹בנים ובנות› (“sons and-daughters”)
# — fact holds: sons-and-daughters(Enos)
m.fact("banim_u_vanot(enosh)")

# -------------------------- Gen.5.11 · LEDGER_ENOSH_TOTAL_DIES -------------
# ‹ויהיו כל־ימי אנושׁ› (“and-were all-of days-of Enos”)
# ‹חמשׁ שׁנים ותשׁע› (“five year and-nine”)
# ‹מאות שׁנה וימת› (“hundred year and-he-died”)
...
# ‹חמשׁ שׁנים ותשׁע› (“five year and-nine”)
# ‹מאות שׁנה› (“hundred year”)
# — fact holds: all-days-of-Enos-905-year
m.fact("kol_yemei_enosh_905_shanah")
# ‹וימת› (“and-he-died”)
# — event: die — agent Enos
m.event("die", agent="enosh")

# -------------------------- Gen.5.12 · LEDGER_KENAN_BEGETS -----------------
# ‹ויחי קינן שׁבעים› (“and-he-lived Cainan seventy”)
# ‹שׁנה ויולד את־מהללאל› (“year and-he-begot obj-marker Mahalaleel”)
# "And Kenan lived seventy years, and begot Mahalalel."
m.step("Gen.5.12")
# ‹ויחי קינן שׁבעים› (“and-he-lived Cainan seventy”)
# ‹שׁנה ויולד את־מהללאל› (“year and-he-begot obj-marker Mahalaleel”)
# — event: beget — agent Cainan; theme Mahalaleel
m.event("beget", agent="qenan", themes=["mahalalel"])

# -------------------------- Gen.5.13 · LEDGER_KENAN_AFTER ------------------
# ‹ויחי קינן אחרי› (“and-he-lived Cainan after”)
# ‹הולידו את־מהללאל ארבעים› (“his-begetting obj-marker Mahalaleel forty”)
# ‹שׁנה ושׁמנה מאות› (“year and-eight hundred”)
# ‹שׁנה ויולד בנים› (“year and-he-begot sons”)
# ‹ובנות› (“and-daughters”)
...
# ‹שׁנה ויולד בנים› (“year and-he-begot sons”)
# ‹ובנות› (“and-daughters”)
# — fact holds: sons-and-daughters(Cainan)
m.fact("banim_u_vanot(qenan)")

# -------------------------- Gen.5.14 · LEDGER_KENAN_TOTAL_DIES -------------
# ‹ויהיו כל־ימי קינן› (“and-were all-of days-of Cainan”)
# ‹עשׂר שׁנים ותשׁע› (“ten year and-nine”)
# ‹מאות שׁנה וימת› (“hundred year and-he-died”)
...
# ‹עשׂר שׁנים ותשׁע› (“ten year and-nine”)
# ‹מאות שׁנה› (“hundred year”)
# — fact holds: all-days-of-Cainan-910-year
m.fact("kol_yemei_qenan_910_shanah")
# ‹וימת› (“and-he-died”)
# — event: die — agent Cainan
m.event("die", agent="qenan")

# -------------------------- Gen.5.15 · LEDGER_MAHALALEL_BEGETS -------------
# ‹ויחי מהללאל חמשׁ› (“and-he-lived Mahalaleel five”)
# ‹שׁנים ושׁשׁים שׁנה› (“year and-sixty year”)
# ‹ויולד את־ירד› (“and-he-begot obj-marker Jared”)
...
# ‹ויחי מהללאל אחרי› (“and-he-lived Mahalaleel after”)
# ‹הולידו את־ירד שׁלשׁים› (“his-begetting obj-marker Jared thirty”)
# ‹שׁנה ושׁמנה מאות› (“year and-eight hundred”)
# ‹שׁנה ויולד בנים› (“year and-he-begot sons”)
# ‹ובנות› (“and-daughters”)
...
# ‹ויהיו כל־ימי מהללאל› (“and-were all-of days-of Mahalaleel”)
# ‹חמשׁ ותשׁעים שׁנה› (“five and-ninety year”)
# ‹ושׁמנה מאות שׁנה› (“and-eight hundred year”)
# ‹וימת› (“and-he-died”)
...
# ‹חמשׁ ותשׁעים שׁנה› (“five and-ninety year”)
# ‹ושׁמנה מאות שׁנה› (“and-eight hundred year”)
# — fact holds: all-days-of-Mahalaleel-895-year
m.fact("kol_yemei_mahalalel_895_shanah")
# ‹וימת› (“and-he-died”)
# — event: die — agent Mahalaleel
m.event("die", agent="mahalalel")

# -------------------------- Gen.5.18 · LEDGER_YERED_BEGETS -----------------
# ‹ויחי־ירד שׁתים ושׁשׁים› (“and-he-lived Jared two and-sixty”)
# ‹שׁנה ומאת שׁנה› (“year and-hundred year”)
# ‹ויולד את־חנוך› (“and-he-begot obj-marker Enoch”)
...
# ‹ויחי־ירד אחרי הולידו› (“and-he-lived Jared after his-begetting”)
# ‹את־חנוך שׁמנה מאות› (“obj-marker Enoch eight hundred”)
# ‹שׁנה ויולד בנים› (“year and-he-begot sons”)
# ‹ובנות› (“and-daughters”)
...
# ‹שׁנה ויולד בנים› (“year and-he-begot sons”)
# ‹ובנות› (“and-daughters”)
# — fact holds: sons-and-daughters(Jared)
m.fact("banim_u_vanot(yered)")

# -------------------------- Gen.5.20 · LEDGER_YERED_TOTAL_DIES -------------
# ‹ויהיו כל־ימי־ירד שׁתים› (“and-were all-of days-of Jared two”)
# ‹ושׁשׁים שׁנה ותשׁע› (“and-sixty year and-nine”)
# ‹מאות שׁנה וימת› (“hundred year and-he-died”)
...
# ‹ושׁשׁים שׁנה ותשׁע› (“and-sixty year and-nine”)
# ‹מאות שׁנה› (“hundred year”)
# — fact holds: all-days-of-Jared-962-year
m.fact("kol_yemei_yered_962_shanah")
# ‹וימת› (“and-he-died”)
# — event: die — agent Jared
m.event("die", agent="yered")

# -------------------------- Gen.5.21 · LEDGER_CHANOKH_BEGETS ---------------
# ‹ויחי חנוך חמשׁ› (“and-he-lived Enoch five”)
# ‹ושׁשׁים שׁנה ויולד› (“and-sixty year and-he-begot”)
# ‹את־מתושׁלח› (“obj-marker Methuselah”)
# "And Enoch lived sixty and five years, and begot Methuselah."
m.step("Gen.5.21")
# ‹ויחי חנוך חמשׁ› (“and-he-lived Enoch five”)
# ‹ושׁשׁים שׁנה ויולד› (“and-sixty year and-he-begot”)
# ‹את־מתושׁלח› (“obj-marker Methuselah”)
# — event: beget — agent Enoch; theme Methuselah
m.event("beget", agent="chanokh", themes=["metushelach"])

# -------------------------- Gen.5.22 · WALK_REPLACES_LIVED -----------------
# ‹ויתהלך חנוך את־האלהים› (“and-he-walked Enoch with the-God”)
# ‹אחרי הולידו את־מתושׁלח› (“after his-begetting with Methuselah”)
# ‹שׁלשׁ מאות שׁנה› (“three hundred year”)
# ‹ויולד בנים ובנות› (“and-he-begot sons and-daughters”)
# "And Enoch walked with God after he begot Methuselah three hundred years,
# and begot sons and daughters."
m.step("Gen.5.22")
# ‹ויתהלך חנוך את־האלהים› (“and-he-walked Enoch with the-God”)
# — fact holds: walked-about-Enoch-obj-marker·et-the-God; sons-and-
# daughters(Enoch)
m.fact("hithalekh_chanokh_et_ha_elohim",
       "banim_u_vanot(chanokh)")

# -------------------------- Gen.5.23 · TOTAL_365_NO_REFRAIN_YET ------------
# ‹ויהי כל־ימי חנוך› (“and-was all-of days-of Enoch”)
# ‹חמשׁ ושׁשׁים שׁנה› (“five and-sixty year”)
# ‹ושׁלשׁ מאות שׁנה› (“and-three hundred year”)
# "And all the days of Enoch were three hundred sixty and five years."
m.step("Gen.5.23")
# ‹ויהי כל־ימי חנוך› (“and-was all-of days-of Enoch”)
# ‹חמשׁ ושׁשׁים שׁנה› (“five and-sixty year”)
# ‹ושׁלשׁ מאות שׁנה› (“and-three hundred year”)
# — fact holds: all-days-of-Enoch-365-year
m.fact("kol_yemei_chanokh_365_shanah")

# -------------------------- Gen.5.24 · TAKEN_NOT_DEAD ----------------------
# ‹ויתהלך חנוך את־האלהים› (“and-he-walked Enoch with the-God”)
# ‹ואיננו כי־לקח אתו› (“and-he-was-not for took him”)
# ‹אלהים› (“God”)
# "And Enoch walked with God, and he was not; for God took him."
m.step("Gen.5.24")
# ‹ויתהלך חנוך את־האלהים› (“and-he-walked Enoch with the-God”)
# ‹ואיננו› (“and-he-was-not”)
# — fact holds: walked-about-Enoch-obj-marker·et-the-God; he-is-not-for-
# take-it-God
m.fact("hithalekh_chanokh_et_ha_elohim",
       "einenu_ki_lakach_oto_elohim")
# ‹כי־לקח אתו אלהים› (“for took him God”)
# — event: take — agent God; theme Enoch
...
# ‹ויחי מתושׁלח שׁבע› (“and-he-lived Methuselah seven”)
# ‹ושׁמנים שׁנה ומאת› (“and-eighty year and-hundred”)
# ‹שׁנה ויולד את־למך› (“year and-he-begot obj-marker Lamech”)
# "And Methuselah lived a hundred eighty and seven years, and begot Lamech."
m.step("Gen.5.25")
# ‹ויחי מתושׁלח שׁבע› (“and-he-lived Methuselah seven”)
# ‹ושׁמנים שׁנה ומאת› (“and-eighty year and-hundred”)
# ‹שׁנה ויולד את־למך› (“year and-he-begot obj-marker Lamech”)
# — event: beget — agent Methuselah; theme Lamech
m.event("beget", agent="metushelach", themes=["lemekh"])

# -------------------------- Gen.5.26 · LEDGER_METUSHELACH_AFTER ------------
# ‹ויחי מתושׁלח אחרי› (“and-he-lived Methuselah after”)
# ‹הולידו את־למך שׁתים› (“his-begetting obj-marker Lamech two”)
# ‹ושׁמונים שׁנה ושׁבע› (“and-eighty year and-seven”)
# ‹מאות שׁנה ויולד› (“hundred year and-he-begot”)
# ‹בנים ובנות› (“sons and-daughters”)
...
# ‹מאות שׁנה ויולד› (“hundred year and-he-begot”)
# ‹בנים ובנות› (“sons and-daughters”)
# — fact holds: sons-and-daughters(Methuselah)
m.fact("banim_u_vanot(metushelach)")

# -------------------------- Gen.5.27 · LEDGER_METUSHELACH_TOTAL_DIES -------
# ‹ויהיו כל־ימי מתושׁלח› (“and-were all-of days-of Methuselah”)
# ‹תשׁע ושׁשׁים שׁנה› (“nine and-sixty year”)
# ‹ותשׁע מאות שׁנה› (“and-nine hundred year”)
# ‹וימת› (“and-he-died”)
...
# ‹תשׁע ושׁשׁים שׁנה› (“nine and-sixty year”)
# ‹ותשׁע מאות שׁנה› (“and-nine hundred year”)
# — fact holds: all-days-of-Methuselah-969-year
m.fact("kol_yemei_metushelach_969_shanah")
# ‹וימת› (“and-he-died”)
# — event: die — agent Methuselah
m.event("die", agent="metushelach")

# -------------------------- Gen.5.28 · SON_BORN_NAMELESS -------------------
# ‹ויחי־למך שׁתים ושׁמנים› (“and-he-lived Lamech two and-eighty”)
# ‹שׁנה ומאת שׁנה› (“year and-hundred year”)
# ‹ויולד בן› (“and-he-begot son”)
# "And Lamech lived a hundred eighty and two years, and begot a son."
m.step("Gen.5.28")
# ‹ויחי־למך שׁתים ושׁמנים› (“and-he-lived Lamech two and-eighty”)
# ‹שׁנה ומאת שׁנה› (“year and-hundred year”)
# ‹ויולד בן› (“and-he-begot son”)
# — event: beget — agent Lamech; theme son-unnamed
...
# ‹לאמר זה ינחמנו› (“saying this-one will-comfort-us”)
# ‹ממעשׂנו ומעצבון ידינו› (“from-our-work and-from-toil-of our-hands”)
# ‹מן־האדמה אשׁר אררה› (“from the-ground which He-cursed-it”)
# ‹יהוה› (“YHWH”)
...
# ‹מן־האדמה אשׁר אררה› (“from the-ground which He-cursed-it”)
# ‹יהוה› (“YHWH”)
# — fact holds: this-will-comfort-us-from-our-work-and-from-toil-of-our-
# hands; from-the-ground-that-cursed-the-LORD
...
# ‹ויחי־למך אחרי הולידו› (“and-he-lived Lamech after his-begetting”)
# ‹את־נח חמשׁ ותשׁעים› (“obj-marker Noah five and-ninety”)
# ‹שׁנה וחמשׁ מאת› (“year and-five hundred”)
# ‹שׁנה ויולד בנים› (“year and-he-begot sons”)
# ‹ובנות› (“and-daughters”)
...
# ‹שׁנה ויולד בנים› (“year and-he-begot sons”)
# ‹ובנות› (“and-daughters”)
# — fact holds: sons-and-daughters(Lamech)
m.fact("banim_u_vanot(lemekh)")

# -------------------------- Gen.5.31 · LEDGER_LEMEKH_TOTAL_777 -------------
# ‹ויהי כל־ימי־למך שׁבע› (“and-was all-of days-of Lamech seven”)
# ‹ושׁבעים שׁנה ושׁבע› (“and-seventy year and-seven”)
# ‹מאות שׁנה וימת› (“hundred year and-he-died”)
...
# ‹ושׁבעים שׁנה ושׁבע› (“and-seventy year and-seven”)
# ‹מאות שׁנה› (“hundred year”)
# — fact holds: all-days-of-Lamech-777-year
m.fact("kol_yemei_lemekh_777_shanah")
# ‹וימת› (“and-he-died”)
# — event: die — agent Lamech
m.event("die", agent="lemekh")

# -------------------------- Gen.5.32 · NOACH_500_THREE_SONS ----------------
# ‹ויהי־נח בן־חמשׁ מאות› (“and-was Noach sons five hundred”)
# ‹שׁנה ויולד נח› (“year and-he-begot Noach”)
# ‹את־שׁם את־חם ואת־יפת› (“obj-marker Shem obj-marker Cham obj-marker
# Yafet”)
...
# ‹ויולד נח את־שׁם› (“and-he-begot Noach obj-marker Shem”)
# ‹את־חם ואת־יפת› (“obj-marker Cham obj-marker Yafet”)
# — event: beget — agent Noach; theme Shem, Cham, Yafet

...
# ‹וַיִּשְׂטֹם עֵשָׂו אֶת־יַעֲקֹב› (“and-lurk-for Esau obj-marker Jacob”)
# ‹עַל־הַבְּרָכָה אֲשֶׁר בֵּרֲכוֹ› (“over the-blessing which bless-him/its”)
# ‹אָבִיו וַיֹּאמֶר עֵשָׂו› (“father-him/its and-say Esau”)
# ‹בְּלִבּוֹ יִקְרְבוּ יְמֵי› (“in-heart-him/its bring-near day”)
# ‹אֵבֶל אָבִי וְאַהַרְגָה› (“lamentation father-me/my and-smite-with-
# deadly-intent”)
# ‹אֶת־יַעֲקֹב אָחִי› (“obj-marker Jacob brother-me/my”)
...
# … and-smite-with-deadly-intent”)
# — fact holds: Esau-grudge; heart-kill-intent
m.fact("esav_grudge",
       "heart_kill_intent")
...
# ‹וַיֻּגַּד לְרִבְקָה אֶת־דִּבְרֵי› (“and-tell to-Rebekah obj-marker
# word/thing”)
# ‹עֵשָׂו בְּנָהּ הַגָּדֹל› (“Esau son-her/its the-great”)
# ‹וַתִּשְׁלַח וַתִּקְרָא לְיַעֲקֹב› (“and-send and-call to-Jacob”)
# ‹בְּנָהּ הַקָּטָן וַתֹּאמֶר› (“son-her/its the-abbreviated and-say”)
# ‹אֵלָיו הִנֵּה עֵשָׂו› (“to-him/its behold Esau”)
# ‹אָחִיךָ מִתְנַחֵם לְךָ› (“brother-you/your sigh to-you/your”)
# ‹לְהָרְגֶךָ› (“to-smite-with-deadly-intent-you/your”)
...
# deadly-intent-you/your”)
# — fact holds: leak-and-delta
...
# ‹וְעַתָּה בְנִי שְׁמַע› (“and-now son-me/my hear”)
# ‹בְּקֹלִי וְקוּם בְּרַח־לְךָ› (“in-voice/sound-me/my and-arise bolt to-
# you/your”)
# ‹אֶל־לָבָן אָחִי חָרָנָה› (“to Laban brother-me/my Haran-ward”)
# "[EN-AID] And now my son hear my voice; and arise, flee for yourself to
# Laban my brother, to Haran."
m.step("Gen.27.43")
# ‹שְׁמַע בְּקֹלִי› (“hear in-voice/sound-me/my”)
# — rivqah speaks a demand — LET: hear-in-qoli-2(Jacob)
m.declare("rivqah", "LET",
          "shema_be_qoli_2(yaaqov)")
# ‹וְקוּם בְּרַח› (“and-arise bolt”)
# — rivqah speaks a demand — LET: arise-bolt-dwell/sit(Jacob)
m.declare("rivqah", "LET",
          "qum_berach_yashavta(yaaqov)")

# -------------------------- Gen.27.44 · THE_DWELL_DUTY_AND_WRATH_RETURN_WAIT -
# ‹וְיָשַׁבְתָּ עִמּוֹ יָמִים› (“and-dwell/sit with-him/its day”)
# ‹אֲחָדִים עַד אֲשֶׁר־תָּשׁוּב› (“one until which return”)
# ‹חֲמַת אָחִיךָ› (“heat brother-you/your”)
...
# ‹עַד־שׁוּב אַף־אָחִיךָ מִמְּךָ› (“until return nose brother-you/your from-
# you/your”)
# ‹וְשָׁכַח אֵת אֲשֶׁר־עָשִׂיתָ› (“and-forget obj-marker which make”)
# ‹לּוֹ וְשָׁלַחְתִּי וּלְקַחְתִּיךָ› (“to-him/its and-send and-take-
# you/your”)
# ‹מִשָּׁם לָמָה אֶשְׁכַּל› (“from-there to-what miscarry”)
# ‹גַּם־שְׁנֵיכֶם יוֹם אֶחָד› (“also two-you/your(pl) day one”)
...
# miscarry”)
# — fact holds: Rebekah-plan-forget-send-take
...
# ‹וַתֹּאמֶר רִבְקָה אֶל־יִצְחָק› (“and-say Rebekah to Isaac”)
# ‹קַצְתִּי בְחַיַּי מִפְּנֵי› (“be-disgusted in-alive-me/my from-face”)
# ‹בְּנוֹת חֵת אִם־לֹקֵחַ› (“daughter Heth if take”)
# ‹יַעֲקֹב אִשָּׁה מִבְּנוֹת־חֵת› (“Jacob woman from-daughter Heth”)
# ‹כָּאֵלֶּה מִבְּנוֹת הָאָרֶץ› (“like-these from-daughter the-earth”)
# ‹לָמָּה לִּי חַיִּים› (“to-what to-me/my alive”)
...
m.step("Gen.27.46")
# ‹קַצְתִּי … לָמָּה לִּי› (“be-disgusted … to-what to-me/my”)
# ‹חַיִּים› (“alive”)
...
# ‹וַיִּקְרָא יִצְחָק אֶל־יַעֲקֹב› (“and-call Isaac to Jacob”)
# ‹וַיְבָרֶךְ אֹתוֹ וַיְצַוֵּהוּ› (“and-bless obj-marker-him/its and-
# command-him/its”)
# ‹וַיֹּאמֶר לוֹ לֹא־תִקַּח› (“and-say to-him/its not take”)
# ‹אִשָּׁה מִבְּנוֹת כְּנָעַן› (“woman from-daughter Canaan”)
...
m.step("Gen.28.1")
# ‹וַיְבָרֶךְ אֹתוֹ› (“and-bless obj-marker-him/its”)
# — event: ?
m.event("?")
# ‹לֹא תִקַּח› (“not take”)
# — fact holds: prohibition-not-take-kenaanit
...
# ‹קוּם לֵךְ פַּדֶּנָה› (“arise go to-Padan”)
# ‹אֲרָם בֵּיתָה בְתוּאֵל› (“Padan house-ward Bethuel”)
# ‹אֲבִי אִמֶּךָ וְקַח־לְךָ› (“father mother-you/your and-take to-you/your”)
# ‹מִשָּׁם אִשָּׁה מִבְּנוֹת› (“from-there woman from-daughter”)
# ‹לָבָן אֲחִי אִמֶּךָ› (“Laban brother mother-you/your”)
...
m.step("Gen.28.2")
# ‹קוּם לֵךְ … וְקַח› (“arise go … and-take”)
# — Isaac speaks a demand — LET: arise-go-take(Jacob)
m.declare("yitzchaq", "LET",
          "qum_lekh_qach(yaaqov)")

# -------------------------- Gen.28.3 · THE_EL_SHADDAI_JUSSIVE_PACKAGE_OPEN -
# ‹וְאֵל שַׁדַּי יְבָרֵךְ› (“and-strength Almighty bless”)
# ‹אֹתְךָ וְיַפְרְךָ וְיַרְבֶּךָ› (“obj-marker-you/your and-be-fruitful-
# you/your and-multiply-you/your”)
# ‹וְהָיִיתָ לִקְהַל עַמִּים› (“and-be to-assemblage people”)
# "[EN-AID] And may El Shaddai bless you and make you fruitful and multiply
# you, and may you become an assembly of peoples."
m.step("Gen.28.3")
# ‹וְאֵל שַׁדַּי יְבָרֵךְ› (“and-strength Almighty bless”)
# ‹… וְיַרְבֶּךָ› (“and-multiply-you/your”)
# — fact holds: to-shaddai-limbs-staged
...
# ‹וְיִתֶּן־לְךָ אֶת־בִּרְכַּת אַבְרָהָם› (“and-set to-you/your obj-marker
# blessing Abraham”)
# ‹לְךָ וּלְזַרְעֲךָ אִתָּךְ› (“to-you/your and-to-seed-you/your with-
# you/your”)
# ‹לְרִשְׁתְּךָ אֶת־אֶרֶץ מְגֻרֶיךָ› (“to-possess/inherit-you/your obj-
# marker earth sojourning-you/your”)
# ‹אֲשֶׁר־נָתַן אֱלֹהִים לְאַבְרָהָם› (“which set God to-Abraham”)
...
# Abraham."
m.step("Gen.28.4")
# ‹וְיִתֶּן … בִּרְכַּת אַבְרָהָם› (“and-set … blessing Abraham”)
# — Isaac speaks a demand — LET: to-shaddai-package(Jacob)
m.declare("yitzchaq", "LET",
          "el_shaddai_package(yaaqov)")

# -------------------------- Gen.28.5 · THE_FATHER_SEND_AND_LEKH_PARTIAL ----
# ‹וַיִּשְׁלַח יִצְחָק אֶת־יַעֲקֹב› (“and-send Isaac obj-marker Jacob”)
# ‹וַיֵּלֶךְ פַּדֶּנָה אֲרָם› (“and-go to-Padan Padan”)
# ‹אֶל־לָבָן בֶּן־בְּתוּאֵל הָאֲרַמִּי› (“to Laban son Bethuel the-Aramite”)
# ‹אֲחִי רִבְקָה אֵם› (“brother Rebekah mother”)
# ‹יַעֲקֹב וְעֵשָׂו› (“Jacob and-Esau”)
...
m.step("Gen.28.5")
# ‹וַיִּשְׁלַח … וַיֵּלֶךְ› (“and-send … and-go”)
# — fact holds: go-partial-return-no-pop
m.fact("lekh_partial_return_no_pop")

# -------------------------- Gen.28.6 · THE_ESAU_SEES_BLESS_SEND_AND_QUOTE_REPLAY -
# ‹וַיַּרְא עֵשָׂו כִּי־בֵרַךְ› (“and-see Esau that bless”)
# ‹יִצְחָק אֶת־יַעֲקֹב וְשִׁלַּח› (“Isaac obj-marker Jacob and-send”)
# ‹אֹתוֹ פַּדֶּנָה אֲרָם› (“obj-marker-him/its to-Padan Padan”)
# ‹לָקַחַת־לוֹ מִשָּׁם אִשָּׁה› (“to-take to-him/its from-there woman”)
# ‹בְּבָרֲכוֹ אֹתוֹ וַיְצַו› (“in-bless-him/its obj-marker-him/its and-
# command”)
# ‹עָלָיו לֵאמֹר לֹא־תִקַּח› (“over-him/its to-say not take”)
# ‹אִשָּׁה מִבְּנוֹת כְּנָעַן› (“woman from-daughter Canaan”)
...
m.step("Gen.28.6")
# ‹וַיַּרְא עֵשָׂו כִּי־בֵרַךְ› (“and-see Esau that bless”)
# — fact holds: Esau-sees-bless-and-send
m.fact("esav_sees_bless_and_send")

# -------------------------- Gen.28.7 · THE_VA_YISHMA_POP_AND_GO_NOT_FLEE ---
# ‹וַיִּשְׁמַע יַעֲקֹב אֶל־אָבִיו› (“and-hear Jacob to father-him/its”)
# ‹וְאֶל־אִמּוֹ וַיֵּלֶךְ פַּדֶּנָה› (“and-to mother-him/its and-go to-
# Padan”)
# ‹אֲרָם› (“Padan”)
# "[EN-AID] And Jacob heeded his father and his mother, and went to Paddan-
# aram."
m.step("Gen.28.7")
# ‹וַיִּשְׁמַע יַעֲקֹב› (“and-hear Jacob”)
# — demand settled (popped from the queue): hear-in-qoli-2(Jacob)
m.result("shema_be_qoli_2(yaaqov)", tmark="t1")
# ‹וַיֵּלֶךְ פַּדֶּנָה אֲרָם› (“and-go to-Padan Padan”)
# — fact holds: go-go-frame-not-flee-frame
...
# ‹וַיַּרְא עֵשָׂו כִּי› (“and-see Esau that”)
# ‹רָעוֹת בְּנוֹת כְּנָעַן› (“bad daughter Canaan”)
# ‹בְּעֵינֵי יִצְחָק אָבִיו› (“in-eye Isaac father-him/its”)
# "[EN-AID] And Esau saw that the daughters of Canaan were evil in the eyes
# of Isaac his father."
m.step("Gen.28.8")
# ‹רָעוֹת … בְּעֵינֵי יִצְחָק› (“bad … in-eye Isaac”)
# — fact holds: Esau-sees-canaanite-evil-in-isaacs-eyes
m.fact("esav_sees_canaanite_evil_in_isaacs_eyes")

# -------------------------- Gen.28.9 · THE_MIRROR_TAKE_MACHALAT_CODA -------
# ‹וַיֵּלֶךְ עֵשָׂו אֶל־יִשְׁמָעֵאל› (“and-go Esau to Ishmael”)
# ‹וַיִּקַּח אֶת־מָחֲלַת בַּת־יִשְׁמָעֵאל› (“and-take obj-marker Mahalath
# daughter Ishmael”)
# ‹בֶּן־אַבְרָהָם אֲחוֹת נְבָיוֹת› (“son Abraham sister Nebaioth”)
# ‹עַל־נָשָׁיו לוֹ לְאִשָּׁה› (“over woman-him/its to-him/its to-woman”)
...
# wife."
m.step("Gen.28.9")
# ‹וַיִּקַּח אֶת־מָחֲלַת› (“and-take obj-marker Mahalath”)
# — fact holds: Esau-mirror-take-Mahalath

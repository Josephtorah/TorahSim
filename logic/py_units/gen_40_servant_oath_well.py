...
# ‹וְאַבְרָהָ֣ם זָקֵ֔ן בָּ֖א› (“and-Abraham be-old come/bring”)
# ‹בַּיָּמִ֑ים וַֽיהוָ֛ה בֵּרַ֥ךְ› (“in-day and-YHWH bless”)
# ‹אֶת־אַבְרָהָ֖ם בַּכֹּֽל› (“obj-marker Abraham in-all”)
# "[EN-AID] And Abraham was old, advanced in days; and YHWH had blessed
# Abraham in all."
m.step("Gen.24.1")
# ‹אַבְרָהָם … יְהוָה› (“Abraham … YHWH”)
# — reads without prior install (flag, not fix): Abraham, the-LORD
m.presupposed("avraham", "YHWH")
# ‹זָקֵן בָּא בַּיָּמִים› (“be-old come/bring in-day”)
# ‹… בֵּרַךְ אֶת־אַבְרָהָם בַּכֹּל› (“bless obj-marker Abraham in-all”)
# — fact holds: Abraham-be-old-come/bring-come/bring-seas; the-LORD-bless-
# obj-marker-Abraham-come/bring-all
...
# ‹וַיֹּ֣אמֶר אַבְרָהָ֗ם אֶל־עַבְדּוֹ֙› (“and-say Abraham to servant-
# him/its”)
# ‹זְקַ֣ן בֵּית֔וֹ הַמֹּשֵׁ֖ל› (“old house-him/its the-rule”)
# ‹בְּכָל־אֲשֶׁר־ל֑וֹ שִֽׂים־נָ֥א יָדְךָ֖› (“in-all which to-him/its put/set
# please hand-you/your”)
# ‹תַּ֥חַת יְרֵכִֽי› (“under thigh-me/my”)
...
# all which to-him/its”)
# — the world gains: the-servant
m.install("ha_eved")
# ‹שִׂים־נָא יָדְךָ תַּחַת› (“put/set please hand-you/your under”)
# ‹יְרֵכִי› (“thigh-me/my”)
# — Abraham speaks a demand — LET: put/set(the-servant, yad-under-thigh)
...
# ‹וְאַשְׁבִּ֣יעֲךָ֔ בַּֽיהוָה֙ אֱלֹהֵ֣י› (“and-swear-you/your in-YHWH God”)
# ‹הַשָּׁמַ֔יִם וֵֽאלֹהֵ֖י הָאָ֑רֶץ› (“the-heavens and-God the-earth”)
# ‹אֲשֶׁ֨ר לֹֽא־תִקַּ֤ח אִשָּׁה֙› (“which not take woman”)
# ‹לִבְנִ֔י מִבְּנוֹת֙ הַֽכְּנַעֲנִ֔י› (“to-son-me/my from-daughter the-
# Kenaanite”)
# ‹אֲשֶׁ֥ר אָנֹכִ֖י יוֹשֵׁ֥ב› (“which dwell/sit”)
# ‹בְּקִרְבּֽוֹ› (“in-nearest-part-him/its”)
...
m.step("Gen.24.3")
# ‹וְאַשְׁבִּיעֲךָ בַּיהוָה› (“and-swear-you/your in-YHWH”)
# — fact holds: and-ashbia-you/your-come/bring-the-LORD
m.fact("ve_ashbia_kha_ba_YHWH")
# ‹לֹא־תִקַּח אִשָּׁה לִבְנִי› (“not take woman to-son-me/my”)
# ‹מִבְּנוֹת הַכְּנַעֲנִי› (“from-daughter the-Kenaanite”)
...
# witness-tier presupposed read: the_court_oaths_formula_is_abrahams_and_the
# _commission_is_the_spec_of_a_run_and_a_retelling on
# the_servant_is_the_agent_of_kiddushin_2_1 — read, not installed
m.witness_read("the_servant_is_the_agent_of_kiddushin_2_1", "the_court_oaths_formula_is_abrahams_and_the_commission_is_the_spec_of_a_run_and_a_retelling",
                cites=["Mishnah Kiddushin 2:1", "Mishnah Kiddushin 2:4", "Mishnah Kiddushin 1:7", "Mishnah Kiddushin 3:1", "Mishnah Ketubot 13:10", "Shevuot 38b:20", "Shevuot 38b:22", "Kiddushin 61b:10", "Kiddushin 61b:11", "Kiddushin 61b:12", "Yoma 28b:7", "Yoma 28b:8", "Taanit 4a:5", "Bava Batra 16b:10", "Bava Batra 141a:6", "Bava Metzia 87a:14", "Sanhedrin 107b:17", "Kiddushin 82a:10", "Shabbat 77a:6", "Chullin 95b:8", "Sanhedrin 95a:16"])

# -------------------------- Gen.24.4 · THE_GO_AND_THE_TAKE_DUTY ------------
# ‹כִּ֧י אֶל־אַרְצִ֛י וְאֶל־מוֹלַדְתִּ֖י› (“that to earth-me/my and-to
# nativity-me/my”)
# ‹תֵּלֵ֑ךְ וְלָקַחְתָּ֥ אִשָּׁ֖ה› (“go and-take woman”)
# ‹לִבְנִ֥י לְיִצְחָֽק› (“to-son-me/my to-Isaac”)
...
# me/my go”)
# — fact holds: go-to-artzi-and-to-moladti
m.fact("telekh_el_artzi_ve_el_moladti")
# ‹וְלָקַחְתָּ אִשָּׁה לִבְנִי› (“and-take woman to-son-me/my”)
# ‹לְיִצְחָק› (“to-Isaac”)
# — fact holds: take(the-servant, woman-to-me-Isaac)
m.fact("laqachta(ha_eved, isha_li_yitzchaq)")

# -------------------------- Gen.24.5 · THE_SERVANT_ASKS_THE_RETURN_CASE ----
# ‹וַיֹּ֤אמֶר אֵלָיו֙ הָעֶ֔בֶד› (“and-say to-him/its the-servant”)
# ‹אוּלַי֙ לֹא־תֹאבֶ֣ה הָֽאִשָּׁ֔ה› (“if-not not breathe-after the-woman”)
# ‹לָלֶ֥כֶת אַחֲרַ֖י אֶל־הָאָ֣רֶץ› (“to-go after-me/my to the-earth”)
# ‹הַזֹּ֑את הֶֽהָשֵׁ֤ב אָשִׁיב֙› (“the-this the-return return”)
# ‹אֶת־בִּנְךָ֔ אֶל־הָאָ֖רֶץ אֲשֶׁר־יָצָ֥אתָ› (“obj-marker son-you/your to
# the-earth which bring-forth”)
# ‹מִשָּֽׁם› (“from-there”)
...
m.step("Gen.24.5")
# ‹וַיֹּאמֶר אֵלָיו הָעֶבֶד› (“and-say to-him/its the-servant”)
# — event: say — agent the-servant
m.event("say", agent="ha_eved")
# ‹אוּלַי לֹא־תֹאבֶה … הֶהָשֵׁב› (“if-not not breathe-after … the-return”)
# ‹אָשִׁיב› (“return”)
# — fact holds: if-not-not-breathe-after-the-woman-to-go; question-he-
# hashev-return
m.fact("ulay_lo_tove_ha_isha_la_lekhet",
       "question_he_hashev_ashiv")

# -------------------------- Gen.24.6 · THE_GUARD_LEST_YOU_RETURN -----------
# ‹וַיֹּ֥אמֶר אֵלָ֖יו אַבְרָהָ֑ם› (“and-say to-him/its Abraham”)
# ‹הִשָּׁ֣מֶר לְךָ֔ פֶּן־תָּשִׁ֥יב› (“keep/guard to-you/your lest return”)
# ‹אֶת־בְּנִ֖י שָֽׁמָּה› (“obj-marker son-me/my there-ward”)
# "[EN-AID] And Abraham said to him: Guard yourself, lest you return my son
# there."
m.step("Gen.24.6")
# ‹וַיֹּאמֶר אֵלָיו אַבְרָהָם› (“and-say to-him/its Abraham”)
# — event: say — agent Abraham
m.event("say", agent="avraham")
# ‹הִשָּׁמֶר לְךָ פֶּן־תָּשִׁיב› (“keep/guard to-you/your lest return”)
# ‹אֶת־בְּנִי שָׁמָּה› (“obj-marker son-me/my there-ward”)
# — Abraham speaks a demand — LET: keep/guard(the-servant, lest-return-obj-
# marker-beni-shama)
m.declare("avraham", "LET",
          "hishamer(ha_eved, pen_tashiv_et_beni_shama)")

# -------------------------- Gen.24.7 · THE_PAST_OATH_AND_THE_ANGEL_PROMISE -
# ‹יְהוָ֣ה אֱלֹהֵ֣י הַשָּׁמַ֗יִם› (“YHWH God the-heavens”)
# ‹אֲשֶׁ֨ר לְקָחַ֜נִי מִבֵּ֣ית› (“which take-me/my from-house”)
# ‹אָבִי֮ וּמֵאֶ֣רֶץ מֽוֹלַדְתִּי֒› (“father-me/my and-from-earth nativity-
# me/my”)
# ‹וַאֲשֶׁ֨ר דִּבֶּר־לִ֜י וַאֲשֶׁ֤ר› (“and-which speak to-me/my and-which”)
# ‹נִֽשְׁבַּֽע־לִי֙ לֵאמֹ֔ר לְזַ֨רְעֲךָ֔› (“swear to-me/my to-say to-seed-
# you/your”)
# ‹אֶתֵּ֖ן אֶת־הָאָ֣רֶץ הַזֹּ֑את› (“set obj-marker the-earth the-this”)
# ‹ה֗וּא יִשְׁלַ֤ח מַלְאָכוֹ֙› (“he/it send messenger-him/its”)
# ‹לְפָנֶ֔יךָ וְלָקַחְתָּ֥ אִשָּׁ֛ה› (“to-face-you/your and-take woman”)
# ‹לִבְנִ֖י מִשָּֽׁם› (“to-son-me/my from-there”)
...
m.step("Gen.24.7")
# ‹נִשְׁבַּע־לִי … אֶתֵּן אֶת־הָאָרֶץ› (“swear to-me/my … set obj-marker
# the-earth”)
# ‹הַזֹּאת› (“the-this”)
# — fact holds: past-oath-swear-to-me; quoted-set-to-zara-you/your
m.fact("past_oath_nishba_li",
       "quoted_eten_le_zara_kha")
# ‹הוּא יִשְׁלַח מַלְאָכוֹ› (“he/it send messenger-him/its”)
# ‹לְפָנֶיךָ› (“to-face-you/your”)
# — fact holds: send-malakh-o-to-fane-you/your
m.fact("yishlach_malakh_o_le_fane_kha")
# ‹וְלָקַחְתָּ אִשָּׁה לִבְנִי› (“and-take woman to-son-me/my”)
# ‹מִשָּׁם› (“from-there”)
# — fact holds: take(the-servant, woman-to-me-veni-who?-there)
...
# ‹וְאִם־לֹ֨א תֹאבֶ֤ה הָֽאִשָּׁה֙› (“and-if not breathe-after the-woman”)
# ‹לָלֶ֣כֶת אַחֲרֶ֔יךָ וְנִקִּ֕יתָ› (“to-go after-you/your and-be-clean”)
# ‹מִשְּׁבֻעָתִ֖י זֹ֑את רַ֣ק› (“from-something-sworn-me/my this leanness”)
# ‹אֶת־בְּנִ֔י לֹ֥א תָשֵׁ֖ב› (“obj-marker son-me/my not return”)
# ‹שָֽׁמָּה› (“there-ward”)
...
m.step("Gen.24.8")
# ‹וְאִם־לֹא תֹאבֶה … וְנִקִּיתָ› (“and-if not breathe-after … and-be-
# clean”)
# ‹מִשְּׁבֻעָתִי זֹאת› (“from-something-sworn-me/my this”)
# — fact holds: release-if-not-breathe-after-then-be-clean-who?-shevuah
m.fact("release_if_lo_tove_then_niqita_mi_shevuah")
# ‹רַק אֶת־בְּנִי לֹא› (“leanness obj-marker son-me/my not”)
# ‹תָשֵׁב שָׁמָּה› (“return there-ward”)
# — fact holds: leanness-obj-marker-beni-not-return-shama
m.fact("raq_et_beni_lo_tashev_shama")

# -------------------------- Gen.24.9 · THE_THIGH_POP_AND_THE_SWEAR ---------
# ‹וַיָּ֤שֶׂם הָעֶ֨בֶד֙ אֶת־יָד֔וֹ› (“and-put/set the-servant obj-marker
# hand-him/its”)
# ‹תַּ֛חַת יֶ֥רֶךְ אַבְרָהָ֖ם› (“under thigh Abraham”)
# ‹אֲדֹנָ֑יו וַיִּשָּׁ֣בַֽע ל֔וֹ› (“lord-him/its and-swear to-him/its”)
# ‹עַל־הַדָּבָ֖ר הַזֶּֽה› (“over the-word/thing the-this”)
# "[EN-AID] And the servant placed his hand under the thigh of Abraham his
# master, and swore to him concerning this matter."
m.step("Gen.24.9")
# ‹וַיָּשֶׂם הָעֶבֶד אֶת־יָדוֹ› (“and-put/set the-servant obj-marker hand-
# him/its”)
# ‹תַּחַת יֶרֶךְ אַבְרָהָם› (“under thigh Abraham”)
# — demand settled (popped from the queue): put/set(the-servant, yad-under-
# thigh)
m.result("sim(ha_eved, yad_tachat_yerekh)", tmark="t1")
# ‹וַיִּשָּׁבַע לוֹ עַל־הַדָּבָר› (“and-swear to-him/its over the-
# word/thing”)
# ‹הַזֶּה› (“the-this”)
# — event: swear — agent the-servant; theme the-word/thing-the-this
m.event("swear", agent="ha_eved", themes=["ha_davar_ha_ze"])

# -------------------------- Gen.24.10 · THE_JOURNEY_TO_ARAM_NAHARAYIM ------
# ‹וַיִּקַּ֣ח הָ֠עֶבֶד עֲשָׂרָ֨ה› (“and-take the-servant ten”)
# ‹גְמַלִּ֜ים מִגְּמַלֵּ֤י אֲדֹנָיו֙› (“camel from-camel lord-him/its”)
# ‹וַיֵּ֔לֶךְ וְכָל־ט֥וּב אֲדֹנָ֖יו› (“and-go and-all good lord-him/its”)
# ‹בְּיָד֑וֹ וַיָּ֗קָם וַיֵּ֛לֶךְ› (“in-hand-him/its and-arise and-go”)
# ‹אֶל־אֲרַ֥ם נַֽהֲרַ֖יִם אֶל־עִ֥יר› (“to Aham-naharaim to city”)
# ‹נָחֽוֹר› (“Nahor”)
...
m.step("Gen.24.10")
# ‹וַיִּקַּח … וַיֵּלֶךְ … וַיָּקָם› (“and-take … and-go … and-arise”)
# ‹וַיֵּלֶךְ› (“and-go”)
# — event: take-go-rise-go — agent the-servant; theme camel-good
m.event("take_go_rise_go", agent="ha_eved", themes=["gemalim_tuv"])
# ‹אֲרַם נַהֲרַיִם … עִיר› (“Aham-naharaim … city”)
# ‹נָחוֹר› (“Nahor”)
# — reads without prior install (flag, not fix): aram-Aham-naharaim, city-
# Nahor
m.presupposed("aram_naharayim", "ir_nachor")

# -------------------------- Gen.24.11 · THE_CAMELS_AT_THE_WELL -------------
# ‹וַיַּבְרֵ֧ךְ הַגְּמַלִּ֛ים מִח֥וּץ› (“and-bless the-camel from-outside”)
# ‹לָעִ֖יר אֶל־בְּאֵ֣ר הַמָּ֑יִם› (“to-city to pit the-waters”)
# ‹לְעֵ֣ת עֶ֔רֶב לְעֵ֖ת› (“to-time evening to-time”)
# ‹צֵ֥את הַשֹּׁאֲבֹֽת› (“bring-forth the-bale-up-water”)
...
m.step("Gen.24.11")
# ‹וַיַּבְרֵךְ הַגְּמַלִּים … אֶל־בְּאֵר› (“and-bless the-camel … to pit”)
# ‹הַמָּיִם› (“the-waters”)
# — event: kneel-camels — agent the-servant; theme the-camel
...
# ‹וַיֹּאמַ֓ר יְהוָ֗ה אֱלֹהֵי֙› (“and-say YHWH God”)
# ‹אֲדֹנִ֣י אַבְרָהָ֔ם הַקְרֵה־נָ֥א› (“lord-me/my Abraham light-upon
# please”)
# ‹לְפָנַ֖י הַיּ֑וֹם וַעֲשֵׂה־חֶ֕סֶד› (“to-face-me/my the-day and-make
# kindness”)
# ‹עִ֖ם אֲדֹנִ֥י אַבְרָהָֽם› (“with lord-me/my Abraham”)
...
# ‹וַעֲשֵׂה־חֶסֶד עִם אֲדֹנִי› (“and-make kindness with lord-me/my”)
# ‹אַבְרָהָם› (“Abraham”)
# — the-servant speaks a demand — LET: make-kindness(the-LORD, if-adoni-
# Abraham)
m.declare("ha_eved", "LET",
          "aseh_chesed(YHWH, im_adoni_avraham)")

# -------------------------- Gen.24.13 · THE_STANDING_AT_THE_SPRING ---------
# ‹הִנֵּ֛ה אָנֹכִ֥י נִצָּ֖ב› (“behold stand”)
# ‹עַל־עֵ֣ין הַמָּ֑יִם וּבְנוֹת֙› (“over eye the-waters and-daughter”)
# ‹אַנְשֵׁ֣י הָעִ֔יר יֹצְאֹ֖ת› (“man the-city bring-forth”)
# ‹לִשְׁאֹ֥ב מָֽיִם› (“to-bale-up-water waters”)
# "[EN-AID] Behold, I am standing by the spring of water, and the daughters
# of the men of the city are coming out to draw water."
m.step("Gen.24.13")
# ‹אָנֹכִי נִצָּב … יֹצְאֹת› (“stand … bring-forth”)
# ‹לִשְׁאֹב› (“to-bale-up-water”)
# — fact holds: I-stand-over-eye-the-waters; daughters-bring-forth-to-me-
# sheov
m.fact("anokhi_nitzav_al_en_ha_mayim",
       "banot_yotzot_li_sheov")

# -------------------------- Gen.24.14 · THE_DESIGNED_SIGN ------------------
# ‹וְהָיָ֣ה הַֽנַּעֲרָ֗ אֲשֶׁ֨ר› (“and-be the-girl which”)
# ‹אֹמַ֤ר אֵלֶ֨יהָ֙ הַטִּי־נָ֤א› (“say to-her/its stretch please”)
# ‹כַדֵּךְ֙ וְאֶשְׁתֶּ֔ה וְאָמְרָ֣ה› (“pail-you/your and-drink and-say”)
# ‹שְׁתֵ֔ה וְגַם־גְּמַלֶּ֖יךָ אַשְׁקֶ֑ה› (“drink and-also camel-you/your
# give-drink”)
# ‹אֹתָ֤הּ הֹכַ֨חְתָּ֙ לְעַבְדְּךָ֣› (“obj-marker-her/its be-right to-
# servant-you/your”)
# ‹לְיִצְחָ֔ק וּבָ֣הּ אֵדַ֔ע› (“to-Isaac and-in-her/its know”)
# ‹כִּי־עָשִׂ֥יתָ חֶ֖סֶד עִם־אֲדֹנִֽי› (“that make kindness with lord-
# me/my”)
...
# ‹אֹתָהּ הֹכַחְתָּ לְעַבְדְּךָ› (“obj-marker-her/its be-right to-servant-
# you/your”)
# ‹לְיִצְחָק› (“to-Isaac”)
# — fact holds: be-right-appointment-criterion
...
# ‹וַֽיְהִי־ה֗וּא טֶרֶם֮ כִּלָּ֣ה› (“and-be he/it non-occurrence be-
# complete”)
# ‹לְדַבֵּר֒ וְהִנֵּ֧ה רִבְקָ֣ה› (“to-speak and-behold Rebekah”)
# ‹יֹצֵ֗את אֲשֶׁ֤ר יֻלְּדָה֙› (“bring-forth which bear-young”)
# ‹לִבְתוּאֵ֣ל בֶּן־מִלְכָּ֔ה אֵ֥שֶׁת› (“to-Bethuel son Milcah woman”)
# ‹נָח֖וֹר אֲחִ֣י אַבְרָהָ֑ם› (“Nahor brother Abraham”)
# ‹וְכַדָּ֖הּ עַל־שִׁכְמָֽהּ› (“and-pail-her/its over neck-as-the-place-of-
# burden-her/its”)
...
m.step("Gen.24.15")
# ‹וַיְהִי … טֶרֶם כִּלָּה› (“and-be … non-occurrence be-complete”)
# ‹לְדַבֵּר וְהִנֵּה רִבְקָה› (“to-speak and-behold Rebekah”)
# ‹יֹצֵאת› (“bring-forth”)
# — event: appear — theme rivqah
m.event("appear", themes=["rivqah"])
# ‹רִבְקָה› (“Rebekah”)
# — the world gains: rivqah
m.install("rivqah")
...
# ‹וְהַֽנַּעֲרָ֗ טֹבַ֤ת מַרְאֶה֙› (“and-the-girl good appearance”)
# ‹מְאֹ֔ד בְּתוּלָ֕ה וְאִ֖ישׁ› (“very virgin and-man”)
# ‹לֹ֣א יְדָעָ֑הּ וַתֵּ֣רֶד› (“not know-her/its and-go-down”)
# ‹הָעַ֔יְנָה וַתְּמַלֵּ֥א כַדָּ֖הּ› (“the-eye-ward and-fill pail-her/its”)
# ‹וַתָּֽעַל› (“and-go-up”)
...
# came up."
m.step("Gen.24.16")
# ‹טֹבַת מַרְאֶה› (“good appearance”)
# — fact holds: good-appearance-attribute
...
# ‹וַיָּ֥רָץ הָעֶ֖בֶד לִקְרָאתָ֑הּ› (“and-run the-servant to-encountering-
# her/its”)
# ‹וַיֹּ֕אמֶר הַגְמִיאִ֥ינִי נָ֛א› (“and-say absorb-me/my please”)
# ‹מְעַט־מַ֖יִם מִכַּדֵּֽךְ› (“little waters from-pail-her/its”)
# "[EN-AID] And the servant ran to meet her and said: Let me sip, please, a
# little water from your pitcher."
m.step("Gen.24.17")
# ‹וַיָּרָץ … וַיֹּאמֶר› (“and-run … and-say”)
# — event: run-say — agent the-servant
m.event("run_say", agent="ha_eved")
# ‹הַגְמִיאִינִי נָא› (“absorb-me/my please”)
# — the-servant speaks a demand — LET: hagmiini(rivqah, little-waters)
m.declare("ha_eved", "LET",
          "hagmiini(rivqah, meat_mayim)")

# -------------------------- Gen.24.18 · DRINK_MY_LORD_AND_THE_WATERING -----
# ‹וַתֹּ֖אמֶר שְׁתֵ֣ה אֲדֹנִ֑י› (“and-say drink lord-me/my”)
# ‹וַתְּמַהֵ֗ר וַתֹּ֧רֶד כַּדָּ֛הּ› (“and-hasten and-go-down pail-her/its”)
# ‹עַל־יָדָ֖הּ וַתַּשְׁקֵֽהוּ› (“over hand-her/its and-give-drink-him/its”)
# "[EN-AID] And she said: Drink, my lord; and she hurried and lowered her
# pitcher on her hand and gave him drink."
m.step("Gen.24.18")
# ‹שְׁתֵה אֲדֹנִי› (“drink lord-me/my”)
# — rivqah speaks a demand — LET: drink(the-servant)
...
# ‹וַתְּכַ֖ל לְהַשְׁקֹת֑וֹ וַתֹּ֗אמֶר› (“and-be-complete to-give-drink-
# him/its and-say”)
# ‹גַּ֤ם לִגְמַלֶּ֨יךָ֙ אֶשְׁאָ֔ב› (“also to-camel-you/your bale-up-water”)
# ‹עַ֥ד אִם־כִּלּ֖וּ לִשְׁתֹּֽת› (“until if be-complete to-drink”)
# "[EN-AID] And she finished giving him drink, and said: Also for your
# camels I will draw until they have finished drinking."
m.step("Gen.24.19")
# ‹וַתְּכַל לְהַשְׁקֹתוֹ› (“and-be-complete to-give-drink-him/its”)
# — event: finish-watering — agent rivqah
...
# ‹וַתְּמַהֵ֗ר וַתְּעַ֤ר כַּדָּהּ֙› (“and-hasten and-be-bare pail-her/its”)
# ‹אֶל־הַשֹּׁ֔קֶת וַתָּ֥רָץ ע֛וֹד› (“to the-trough and-run still/again”)
# ‹אֶֽל־הַבְּאֵ֖ר לִשְׁאֹ֑ב וַתִּשְׁאַ֖ב› (“to the-pit to-bale-up-water and-
# bale-up-water”)
# ‹לְכָל־גְּמַלָּֽיו› (“to-all camel-him/its”)
...
m.step("Gen.24.20")
# ‹וַתְּמַהֵר וַתְּעַר … וַתָּרָץ› (“and-hasten and-be-bare … and-run”)
# ‹… וַתִּשְׁאַב› (“and-bale-up-water”)
# — event: empty-run-draw — agent rivqah; theme all-camels
m.event("empty_run_draw", agent="rivqah", themes=["all_camels"])

# -------------------------- Gen.24.21 · THE_SILENT_GAZE --------------------
# ‹וְהָאִ֥ישׁ מִשְׁתָּאֵ֖ה לָ֑הּ› (“and-the-man stun to-her/its”)
# ‹מַחֲרִ֕ישׁ לָדַ֗עַת הַֽהִצְלִ֧יחַ› (“scratch to-know the-push-forward”)
# ‹יְהוָ֛ה דַּרְכּ֖וֹ אִם־לֹֽא› (“YHWH way/road-him/its if not”)
...
# forward”)
# — fact holds: gazing-silent-wonder
...
# ‹וַיְהִ֗י כַּאֲשֶׁ֨ר כִּלּ֤וּ› (“and-be like-as/which be-complete”)
# ‹הַגְּמַלִּים֙ לִשְׁתּ֔וֹת וַיִּקַּ֤ח› (“the-camel to-drink and-take”)
# ‹הָאִישׁ֙ נֶ֣זֶם זָהָ֔ב› (“the-man nose-ring gold”)
# ‹בֶּ֖קַע מִשְׁקָל֑וֹ וּשְׁנֵ֤י› (“section-of-ashekel weight-him/its and-
# two”)
# ‹צְמִידִים֙ עַל־יָדֶ֔יהָ עֲשָׂרָ֥ה› (“bracelet over hand-her/its ten”)
# ‹זָהָ֖ב מִשְׁקָלָֽם› (“gold weight-them/their”)
...
# ‹וַיֹּ֨אמֶר֙ בַּת־מִ֣י אַ֔תְּ› (“and-say daughter who? thou-and-thee”)
# ‹הַגִּ֥ידִי נָ֖א לִ֑י› (“tell please to-me/my”)
# ‹הֲיֵ֧שׁ בֵּית־אָבִ֛יךְ מָק֥וֹם› (“the-there-is house father-her/its
# place”)
# ‹לָ֖נוּ לָלִֽין› (“to-us/our to-stop”)
...
# — event: say — agent the-servant
m.event("say", agent="ha_eved")
# ‹הַגִּידִי נָא לִי› (“tell please to-me/my”)
# — the-servant speaks a demand — LET: tell(rivqah, daughter-who?)
m.declare("ha_eved", "LET",
          "hagidi(rivqah, bat_mi)")

# -------------------------- Gen.24.24 · THE_LINEAGE_ANSWER -----------------
# ‹וַתֹּ֣אמֶר אֵלָ֔יו בַּת־בְּתוּאֵ֖ל› (“and-say to-him/its daughter
# Bethuel”)
# ‹אָנֹ֑כִי בֶּן־מִלְכָּ֕ה אֲשֶׁ֥ר› (“son Milcah which”)
# ‹יָלְדָ֖ה לְנָחֽוֹר› (“bear-young to-Nahor”)
# "[EN-AID] And she said to him: I am the daughter of Betuel, son of Milcah,
# whom she bore to Nahor."
m.step("Gen.24.24")
# ‹וַתֹּאמֶר› (“and-say”)
# — event: say — agent rivqah
m.event("say", agent="rivqah")
# ‹בַּת־בְּתוּאֵל … לְנָחוֹר› (“daughter Bethuel … to-Nahor”)
# — fact holds: rivqah-daughter-Bethuel-line
m.fact("rivqah_bat_betuel_line")

# -------------------------- Gen.24.25 · STRAW_AND_FODDER_AND_ROOM ----------
# ‹וַתֹּ֣אמֶר אֵלָ֔יו גַּם־תֶּ֥בֶן› (“and-say to-him/its also material”)
# ‹גַּם־מִסְפּ֖וֹא רַ֣ב עִמָּ֑נוּ› (“also fodder many/great with-us/our”)
# ‹גַּם־מָק֖וֹם לָלֽוּן› (“also place to-stop”)
...
# ‹וַיִּקֹּ֣ד הָאִ֔ישׁ וַיִּשְׁתַּ֖חוּ› (“and-shrivel-up the-man and-
# afflict”)
# ‹לַֽיהוָֽה› (“to-YHWH”)
...
# YHWH”)
# — event: bow-prostrate — agent the-servant
m.event("bow_prostrate", agent="ha_eved")

# -------------------------- Gen.24.27 · BLESSED_BE_YHWH_KINDNESS_AND_TRUTH -
# ‹וַיֹּ֗אמֶר בָּר֤וּךְ יְהוָה֙› (“and-say bless YHWH”)
# ‹אֱלֹהֵי֙ אֲדֹנִ֣י אַבְרָהָ֔ם› (“God lord-me/my Abraham”)
# ‹אֲ֠שֶׁר לֹֽא־עָזַ֥ב חַסְדּ֛וֹ› (“which not loosen kindness-him/its”)
# ‹וַאֲמִתּ֖וֹ מֵעִ֣ם אֲדֹנִ֑י› (“and-stability-him/its from-with lord-
# me/my”)
# ‹אָנֹכִ֗י בַּדֶּ֨רֶךְ֙ נָחַ֣נִי› (“in-way/road guide-me/my”)
# ‹יְהוָ֔ה בֵּ֖ית אֲחֵ֥י› (“YHWH house brother”)
# ‹אֲדֹנִֽי› (“lord-me/my”)
...
# — event: say — agent the-servant
m.event("say", agent="ha_eved")
# ‹בָּרוּךְ יְהוָה … חַסְדּוֹ› (“bless YHWH … kindness-him/its”)
# ‹וַאֲמִתּוֹ› (“and-stability-him/its”)
# — fact holds: bless-the-LORD-kindness-and-emet
m.fact("barukh_YHWH_chesed_ve_emet")

# -------------------------- Gen.24.28 · SHE_RUNS_AND_TELLS -----------------
# ‹וַתָּ֨רָץ֙ הַֽנַּעֲרָ֔ וַתַּגֵּ֖ד› (“and-run the-girl and-tell”)
# ‹לְבֵ֣ית אִמָּ֑הּ כַּדְּבָרִ֖ים› (“to-house mother-her/its like-
# word/thing”)
# ‹הָאֵֽלֶּה› (“the-these”)
# "[EN-AID] And the girl ran and told her mother's household these things."
m.step("Gen.24.28")
# ‹וַתָּרָץ … וַתַּגֵּד› (“and-run … and-tell”)
# — event: run-tell — agent rivqah
m.event("run_tell", agent="rivqah")

# -------------------------- Gen.24.29 · LABAN_RUNS -------------------------
# ‹וּלְרִבְקָ֥ה אָ֖ח וּשְׁמ֣וֹ› (“and-to-Rebekah brother and-name-him/its”)
# ‹לָבָ֑ן וַיָּ֨רָץ לָבָ֧ן› (“Laban and-run Laban”)
# ‹אֶל־הָאִ֛ישׁ הַח֖וּצָה אֶל־הָעָֽיִן› (“to the-man the-outside-ward to
# the-eye”)
# "[EN-AID] And Rivqah had a brother, and his name was Laban; and Laban ran
# to the man outside, to the spring."
m.step("Gen.24.29")
# ‹וּשְׁמוֹ לָבָן› (“and-name-him/its Laban”)
# — the world gains: Laban
m.install("lavan")

# -------------------------- Gen.24.30 · HE_SEES_THE_GIFTS_AND_COMES --------
# ‹וַיְהִ֣י כִּרְאֹ֣ת אֶת־הַנֶּ֗זֶם› (“and-be like-see obj-marker the-nose-
# ring”)
# ‹וְֽאֶת־הַצְּמִדִים֮ עַל־יְדֵ֣י אֲחֹתוֹ֒› (“and-obj-marker the-bracelet
# over hand sister-him/its”)
# ‹וּכְשָׁמְע֗וֹ אֶת־דִּבְרֵ֞י רִבְקָ֤ה› (“and-like-hear-him/its obj-marker
# word/thing Rebekah”)
# ‹אֲחֹתוֹ֙ לֵאמֹ֔ר כֹּֽה־דִבֶּ֥ר› (“sister-him/its to-say like-this speak”)
# ‹אֵלַ֖י הָאִ֑ישׁ וַיָּבֹא֙› (“to-me/my the-man and-come/bring”)
# ‹אֶל־הָאִ֔ישׁ וְהִנֵּ֛ה עֹמֵ֥ד› (“to the-man and-behold stand”)
# ‹עַל־הַגְּמַלִּ֖ים עַל־הָעָֽיִן› (“over the-camel over the-eye”)
...
# and-come/bring”)
# — event: see-hear-come — agent Laban
m.event("see_hear_come", agent="lavan")

# -------------------------- Gen.24.31 · COME_IN_O_BLESSED_OF_YHWH ----------
# ‹וַיֹּ֕אמֶר בּ֖וֹא בְּר֣וּךְ› (“and-say come/bring bless”)
# ‹יְהוָ֑ה לָ֤מָּה תַעֲמֹד֙› (“YHWH to-what stand”)
# ‹בַּח֔וּץ וְאָנֹכִי֙ פִּנִּ֣יתִי› (“in-outside and-I turn”)
# ‹הַבַּ֔יִת וּמָק֖וֹם לַגְּמַלִּֽים› (“the-house and-place to-camel”)
...
m.step("Gen.24.31")
# ‹בּוֹא› (“come/bring”)
# — Laban speaks a demand — LET: come/bring(the-servant)
m.declare("lavan", "LET",
          "bo(ha_eved)")

# -------------------------- Gen.24.32 · HE_ENTERS_AND_IS_SERVED ------------
# ‹וַיָּבֹ֤א הָאִישׁ֙ הַבַּ֔יְתָה› (“and-come/bring the-man the-house-ward”)
# ‹וַיְפַתַּ֖ח הַגְּמַלִּ֑ים וַיִּתֵּ֨ן› (“and-open-wide the-camel and-set”)
# ‹תֶּ֤בֶן וּמִסְפּוֹא֙ לַגְּמַלִּ֔ים› (“material and-fodder to-camel”)
# ‹וּמַ֨יִם֙ לִרְחֹ֣ץ רַגְלָ֔יו› (“and-waters to-lave foot-him/its”)
# ‹וְרַגְלֵ֥י הָאֲנָשִׁ֖ים אֲשֶׁ֥ר› (“and-foot the-man which”)
# ‹אִתּֽוֹ› (“with-him/its”)
...
# ‹ויישם וַיּוּשַׂ֤ם לְפָנָיו֙› (“and-place and-put/set to-face-him/its”)
# ‹לֶאֱכֹ֔ל וַיֹּ֨אמֶר֙ לֹ֣א› (“to-eat and-say not”)
# ‹אֹכַ֔ל עַ֥ד אִם־דִּבַּ֖רְתִּי› (“eat until if speak”)
# ‹דְּבָרָ֑י וַיֹּ֖אמֶר דַּבֵּֽר› (“word/thing-me/my and-say speak”)
# "[EN-AID] And food was set before him to eat; and he said: I will not eat
# until I have spoken my words. And he said: Speak."
m.step("Gen.24.33")
# ‹וַיּוּשַׂם … וַיֹּאמֶר לֹא› (“and-put/set … and-say not”)
# ‹אֹכַל … וַיֹּאמֶר דַּבֵּר› (“eat … and-say speak”)
# — event: food-set
m.event("food_set")
# ‹דַּבֵּר› (“speak”)
# — house-voice speaks a demand — LET: speak(the-servant)
...
if __name__ == "__main__":
    ...
    assert m.WITNESS_READS[7]["cites"] == ['Mishnah Kiddushin 2:1', 'Mishnah Kiddushin 2:4', 'Mishnah Kiddushin 1:7', 'Mishnah Kiddushin 3:1', 'Mishnah Ketubot 13:10', 'Shevuot 38b:20', 'Shevuot 38b:22', 'Kiddushin 61b:10', 'Kiddushin 61b:11', 'Kiddushin 61b:12', 'Yoma 28b:7', 'Yoma 28b:8', 'Taanit 4a:5', 'Bava Batra 16b:10', 'Bava Batra 141a:6', 'Bava Metzia 87a:14', 'Sanhedrin 107b:17', 'Kiddushin 82a:10', 'Shabbat 77a:6', 'Chullin 95b:8', 'Sanhedrin 95a:16']
    assert all('the_court_oaths_formula_is_abrahams_and_the_commission_is_the_spec_of_a_run_and_a_retelling' not in f for f in m.WORLD["facts"])
    assert 'the_servant_is_the_agent_of_kiddushin_2_1' not in m.WORLD["witnessed"]
    assert m.WITNESS_READS[8]["cites"] == ['Bereshit Rabbah 59:10']
    assert all('registry_of_prior_events' not in f for f in m.WORLD["facts"])
    assert 'oath_preamble' not in m.WORLD["witnessed"]
    assert m.WITNESS_READS[9]["cites"] == ['Bereshit Rabbah 59:11', 'Bereshit Rabbah 60:8', 'Onkelos Genesis 24:11', 'Mishnah Demai 1:3']
    ...
    assert m.WITNESS_READS[10]["cites"] == ['Bereshit Rabbah 60:3', 'Mishnah Temurah 5:6']
    ...
    assert m.WITNESS_READS[11]["cites"] == ['Chullin 95b:7', 'Chullin 95b:8', 'Chullin 95b:9', 'Chullin 95b:13']
    assert all('divination_paradigm' not in f for f in m.WORLD["facts"])
    assert 've_haya_ha_naara' not in m.WORLD["witnessed"]
    assert m.WITNESS_READS[12]["cites"] == ['Bereshit Rabbah 60:4']
    ...
    assert m.WITNESS_READS[13]["cites"] == ['Onkelos Genesis 24:21']
    ...
    assert m.WITNESS_READS[14]["cites"] == ['Bereshit Rabbah 60:6']
    ...
    assert m.WITNESS_READS[15]["cites"] == ['Bereshit Rabbah 60:9']

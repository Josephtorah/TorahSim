...
# ‹וַיֵּ֥לֶךְ מִשָּׁ֖ם יִצְחָ֑ק› (“and-go from-there Isaac”)
# ‹וַיִּ֥חַן בְּֽנַחַל־גְּרָ֖ר וַיֵּ֥שֶׁב› (“and-encamp in-river Gerar and-
# dwell/sit”)
# ‹שָֽׁם› (“there”)
# "[EN-AID] And Isaac went from there and encamped in the wadi of Gerar, and
# dwelt there."
m.step("Gen.26.17")
# ‹וַיֵּלֶךְ מִשָּׁם יִצְחָק› (“and-go from-there Isaac”)
# — event: ?
m.event("?")
# ‹וַיִּחַן בְּנַחַל־גְּרָר וַיֵּשֶׁב› (“and-encamp in-river Gerar and-
# dwell/sit”)
# ‹שָׁם› (“there”)
# — event: ?
m.event("?")
# ‹יִצְחָק … גְּרָר› (“Isaac … Gerar”)
# — reads without prior install (flag, not fix): Isaac, Gerar
m.presupposed("yitzchaq", "gerar")

# -------------------------- Gen.26.18 · THE_REDIG_AND_THE_RESTORED_NAMES ---
# ‹וַיָּ֨שָׁב יִצְחָ֜ק וַיַּחְפֹּ֣ר› (“and-return Isaac and-dig”)
# ‹אֶת־בְּאֵרֹ֣ת הַמַּ֗יִם אֲשֶׁ֤ר› (“obj-marker pit the-waters which”)
# ‹חָֽפְרוּ֙ בִּימֵי֙ אַבְרָהָ֣ם› (“dig in-day Abraham”)
# ‹אָבִ֔יו וַיְסַתְּמ֣וּם פְּלִשְׁתִּ֔ים› (“father-him/its and-stop-up-
# them/their Pelishtite”)
# ‹אַחֲרֵ֖י מ֣וֹת אַבְרָהָ֑ם› (“after death Abraham”)
# ‹וַיִּקְרָ֤א לָהֶן֙ שֵׁמ֔וֹת› (“and-call to-them/their name”)
# ‹כַּשֵּׁמֹ֕ת אֲשֶׁר־קָרָ֥א לָהֶ֖ן› (“like-name which call to-them/their”)
# ‹אָבִֽיו› (“father-him/its”)
...
# called them."
m.step("Gen.26.18")
# ‹וַיָּשָׁב … וַיַּחְפֹּר אֶת־בְּאֵרֹת› (“and-return … and-dig obj-marker
# pit”)
# ‹הַמַּיִם› (“the-waters”)
# — event: redig-wells — agent Isaac; theme pit-Abraham
m.event("redig_wells", agent="yitzchaq", themes=["beerot_avraham"])
# ‹וַיִּקְרָא לָהֶן שֵׁמוֹת› (“and-call to-them/their name”)
# ‹כַּשֵּׁמֹת אֲשֶׁר־קָרָא לָהֶן› (“like-name which call to-them/their”)
...
# ‹וַיַּחְפְּר֥וּ עַבְדֵֽי־יִצְחָ֖ק בַּנָּ֑חַל› (“and-dig servant Isaac in-
# river”)
# ‹וַיִּ֨מְצְאוּ־שָׁ֔ם בְּאֵ֖ר מַ֥יִם› (“and-find there pit waters”)
# ‹חַיִּֽים› (“living”)
# "[EN-AID] And Isaac's servants dug in the wadi and found there a well of
# living water."
m.step("Gen.26.19")
# ‹וַיַּחְפְּרוּ … וַיִּמְצְאוּ … בְּאֵר› (“and-dig … and-find … pit”)
# ‹מַיִם חַיִּים› (“waters living”)
# — event: dig-and-find — agent servant-Isaac; theme pit-waters-living
m.event("dig_and_find", agent="avde_yitzchaq", themes=["beer_mayim_chayim"])

# -------------------------- Gen.26.20 · THE_QUARREL_AND_THE_NAME_ESEK ------
# ‹וַיָּרִ֜יבוּ רֹעֵ֣י גְרָ֗ר› (“and-toss pastoral Gerar”)
# ‹עִם־רֹעֵ֥י יִצְחָ֛ק לֵאמֹ֖ר› (“with pastoral Isaac to-say”)
# ‹לָ֣נוּ הַמָּ֑יִם וַיִּקְרָ֤א› (“to-us/our the-waters and-call”)
# ‹שֵֽׁם־הַבְּאֵר֙ עֵ֔שֶׂק כִּ֥י› (“name the-pit Esek that”)
# ‹הִֽתְעַשְּׂק֖וּ עִמּֽוֹ› (“press-upon with-him/its”)
...
m.step("Gen.26.20")
# ‹וַיָּרִיבוּ רֹעֵי גְרָר› (“and-toss pastoral Gerar”)
# ‹עִם־רֹעֵי יִצְחָק› (“with pastoral Isaac”)
# — event: quarrel — agent pastoral-Gerar
m.event("quarrel", agent="roe_gerar")
# ‹וַיִּקְרָא שֵׁם־הַבְּאֵר עֵשֶׂק› (“and-call name the-pit Esek”)
# — named: pit-Esek := Esek
m.name("beer_eseq", "eseq")

# -------------------------- Gen.26.21 · THE_SECOND_WELL_SITNAH -------------
# ‹וַֽיַּחְפְּרוּ֙ בְּאֵ֣ר אַחֶ֔רֶת› (“and-dig pit other”)
# ‹וַיָּרִ֖יבוּ גַּם־עָלֶ֑יהָ וַיִּקְרָ֥א› (“and-toss also over-her/its and-
# call”)
# ‹שְׁמָ֖הּ שִׂטְנָֽה› (“name-her/its Sitnah”)
# "[EN-AID] And they dug another well, and they quarreled over it too; and
# he called its name Sitnah."
m.step("Gen.26.21")
# ‹וַיַּחְפְּרוּ בְּאֵר אַחֶרֶת› (“and-dig pit other”)
# ‹וַיָּרִיבוּ גַּם־עָלֶיהָ› (“and-toss also over-her/its”)
# — event: dig-and-quarrel — theme pit-other
m.event("dig_and_quarrel", themes=["beer_acheret"])
# ‹וַיִּקְרָא שְׁמָהּ שִׂטְנָה› (“and-call name-her/its Sitnah”)
# — named: pit-Sitnah := Sitnah
m.name("beer_sitna", "sitna")

# -------------------------- Gen.26.22 · THE_THIRD_WELL_REHOBOTH ------------
# ‹וַיַּעְתֵּ֣ק מִשָּׁ֗ם וַיַּחְפֹּר֙› (“and-moved-on from-there and-dig”)
# ‹בְּאֵ֣ר אַחֶ֔רֶת וְלֹ֥א› (“pit other and-not”)
# ‹רָב֖וּ עָלֶ֑יהָ וַיִּקְרָ֤א› (“toss over-her/its and-call”)
# ‹שְׁמָהּ֙ רְחֹב֔וֹת וַיֹּ֗אמֶר› (“name-her/its Rehoboth and-say”)
# ‹כִּֽי־עַתָּ֞ה הִרְחִ֧יב יְהוָ֛ה› (“that now broaden YHWH”)
# ‹לָ֖נוּ וּפָרִ֥ינוּ בָאָֽרֶץ› (“to-us/our and-be-fruitful in-earth”)
...
m.step("Gen.26.22")
# ‹וַיַּעְתֵּק … וַיַּחְפֹּר … וְלֹא› (“and-moved-on … and-dig … and-not”)
# ‹רָבוּ› (“toss”)
# — event: move-dig-no-quarrel — agent Isaac
m.event("move_dig_no_quarrel", agent="yitzchaq")
# ‹וַיִּקְרָא שְׁמָהּ רְחֹבוֹת› (“and-call name-her/its Rehoboth”)
# — named: pit-Rehoboth := Rehoboth
m.name("beer_rechovot", "rechovot")
# ‹כִּי־עַתָּה הִרְחִיב יְהוָה› (“that now broaden YHWH”)
# ‹לָנוּ וּפָרִינוּ בָאָרֶץ› (“to-us/our and-be-fruitful in-earth”)
# — fact holds: broaden-the-LORD-to-us/our-and-be-fruitful
...
# ‹וַיַּ֥עַל מִשָּׁ֖ם בְּאֵ֥ר› (“and-go-up from-there”)
# ‹שָֽׁבַע› (“Beer-shebah”)
# "[EN-AID] And he went up from there to Beer-sheba."
m.step("Gen.26.23")
# ‹וַיַּעַל מִשָּׁם בְּאֵר› (“and-go-up from-there”)
# ‹שָׁבַע› (“Beer-shebah”)
# — event: go-up — agent Isaac
m.event("go_up", agent="yitzchaq")

# -------------------------- Gen.26.24 · THE_NIGHT_WORD_AND_AL_TIRA ---------
# ‹וַיֵּרָ֨א אֵלָ֤יו יְהוָה֙› (“and-see to-him/its YHWH”)
# ‹בַּלַּ֣יְלָה הַה֔וּא וַיֹּ֕אמֶר› (“in-night that and-say”)
# ‹אָנֹכִ֕י אֱלֹהֵ֖י אַבְרָהָ֣ם› (“God Abraham”)
# ‹אָבִ֑יךָ אַל־תִּירָא֙ כִּֽי־אִתְּךָ֣› (“father-you/your do-not fear that
# with-you/your”)
# ‹אָנֹ֔כִי וּבֵֽרַכְתִּ֨יךָ֙ וְהִרְבֵּיתִ֣י› (“and-bless-you/your and-
# multiply”)
# ‹אֶֽת־זַרְעֲךָ֔ בַּעֲב֖וּר אַבְרָהָ֥ם› (“obj-marker seed-you/your for-the-
# sake-of Abraham”)
# ‹עַבְדִּֽי› (“servant-me/my”)
...
# ‹בַּלַּיְלָה הַהוּא וַיֹּאמֶר› (“in-night that and-say”)
# — event: appear-night — agent the-LORD
m.event("appear_night", agent="YHWH")
# ‹אָנֹכִי אֱלֹהֵי אַבְרָהָם› (“God Abraham”)
# ‹אָבִיךָ› (“father-you/your”)
# — fact holds: anokhi-God-Abraham-avi-kha
m.fact("anokhi_elohe_avraham_avi_kha")
# ‹אַל־תִּירָא› (“do-not fear”)
# — the-LORD speaks a demand — LET-NOT: fear(Isaac)
m.declare("YHWH", "LET-NOT",
          "tira(yitzchaq)")
# ‹כִּי־אִתְּךָ אָנֹכִי וּבֵרַכְתִּיךָ› (“that with-you/your and-bless-
# you/your”)
# ‹וְהִרְבֵּיתִי אֶת־זַרְעֲךָ› (“and-multiply obj-marker seed-you/your”)
...
# ‹וַיִּ֧בֶן שָׁ֣ם מִזְבֵּ֗חַ› (“and-build there altar”)
# ‹וַיִּקְרָא֙ בְּשֵׁ֣ם יְהוָ֔ה› (“and-call in-name YHWH”)
# ‹וַיֶּט־שָׁ֖ם אָהֳל֑וֹ וַיִּכְרוּ־שָׁ֥ם› (“and-stretch there tent-him/its
# and-dig there”)
# ‹עַבְדֵי־יִצְחָ֖ק בְּאֵֽר› (“servant Isaac pit”)
...
# ‹… וַיֶּט שָׁם אָהֳלוֹ› (“and-stretch there tent-him/its”)
# — event: ?
m.event("?")
# ‹וַיִּקְרָא בְּשֵׁם יְהוָה› (“and-call in-name YHWH”)
# — event: ?
m.event("?")
# ‹וַיִּכְרוּ שָׁם עַבְדֵי› (“and-dig there servant”)
# ‹יִצְחָק בְּאֵר› (“Isaac pit”)
# — event: ?
m.event("?")
...
# ‹וַאֲבִימֶ֕לֶךְ הָלַ֥ךְ אֵלָ֖יו› (“and-Abimelech walk/go to-him/its”)
# ‹מִגְּרָ֑ר וַאֲחֻזַּת֙ מֵרֵעֵ֔הוּ› (“from-Gerar and-Ahuzzath friend-
# him/its”)
# ‹וּפִיכֹ֖ל שַׂר־צְבָאֽוֹ› (“and-Phichol officer host-him/its”)
# "[EN-AID] And Abimelech went to him from Gerar, with Achuzzath his friend
# and Phichol the commander of his army."
m.step("Gen.26.26")
# ‹וַאֲבִימֶלֶךְ הָלַךְ אֵלָיו› (“and-Abimelech walk/go to-him/its”)
# ‹מִגְּרָר› (“from-Gerar”)
# — event: visit — agent Abimelech
m.event("visit", agent="avimelekh")
# ‹אֲחֻזַּת … פִיכֹל› (“something-seized … Pikhol”)
# — reads without prior install (flag, not fix): Ahuzzath, Phichol, merea
...
# ‹וַיֹּ֤אמֶר אֲלֵהֶם֙ יִצְחָ֔ק› (“and-say to-them/their Isaac”)
# ‹מַדּ֖וּעַ בָּאתֶ֣ם אֵלָ֑י› (“what-known? come/bring to-me/my”)
# ‹וְאַתֶּם֙ שְׂנֵאתֶ֣ם אֹתִ֔י› (“and-you hate obj-marker-me/my”)
# ‹וַתְּשַׁלְּח֖וּנִי מֵאִתְּכֶֽם› (“and-send-me/my from-with-you/your(pl)”)
...
# ‹וַיֹּאמְר֗וּ רָא֣וֹ רָאִינוּ֮› (“and-say see see”)
# ‹כִּֽי־הָיָ֣ה יְהוָ֣ה עִמָּךְ֒› (“that be YHWH with-you/your”)
# ‹וַנֹּ֗אמֶר תְּהִ֨י נָ֥א› (“and-say be please”)
# ‹אָלָ֛ה בֵּינוֹתֵ֖ינוּ בֵּינֵ֣ינוּ› (“imprecation between-us/our between-
# us/our”)
# ‹וּבֵינֶ֑ךָ וְנִכְרְתָ֥ה בְרִ֖ית› (“and-between-you/your and-cut
# covenant”)
# ‹עִמָּֽךְ› (“with-you/your”)
...
# a covenant with you."
m.step("Gen.26.28")
# ‹רָאוֹ רָאִינוּ כִּי־הָיָה› (“see see that be”)
# ‹יְהוָה עִמָּךְ› (“YHWH with-you/your”)
# — fact holds: see-see-the-LORD-ima-kha
m.fact("rao_rainu_YHWH_ima_kha")
# ‹תְּהִי נָא אָלָה› (“be please imprecation”)
# ‹בֵּינוֹתֵינוּ› (“between-us/our”)
...
# ‹אִם־תַּעֲשֵׂ֨ה עִמָּ֜נוּ רָעָ֗ה› (“if make with-us/our bad”)
# ‹כַּאֲשֶׁר֙ לֹ֣א נְגַֽעֲנ֔וּךָ› (“like-as/which not touch-you/your”)
# ‹וְכַאֲשֶׁ֨ר עָשִׂ֤ינוּ עִמְּךָ֙› (“and-like-as/which make with-you/your”)
# ‹רַק־ט֔וֹב וַנְּשַׁלֵּֽחֲךָ֖ בְּשָׁל֑וֹם› (“leanness good-in-the-widest-
# sense and-send-you/your in-safe”)
# ‹אַתָּ֥ה עַתָּ֖ה בְּר֥וּךְ› (“you now bless”)
# ‹יְהוָֽה› (“YHWH”)
...
m.step("Gen.26.29")
# ‹אִם־תַּעֲשֵׂה עִמָּנוּ רָעָה› (“if make with-us/our bad”)
# ‹…› (“?”)
# — fact holds: with-make-ima-us/our-bad-oath-content
m.fact("im_taase_ima_nu_raa_oath_content")
# ‹אַתָּה עַתָּה בְּרוּךְ› (“you now bless”)
# ‹יְהוָה› (“YHWH”)
# — fact holds: now-now-bless-the-LORD
...
# -------------------------- Gen.26.30 · THE_FEAST --------------------------
# ‹וַיַּ֤עַשׂ לָהֶם֙ מִשְׁתֶּ֔ה› (“and-make to-them/their drink”)
# ‹וַיֹּאכְל֖וּ וַיִּשְׁתּֽוּ› (“and-eat and-drink”)
# "[EN-AID] And he made them a feast, and they ate and drank."
m.step("Gen.26.30")
# ‹וַיַּעַשׂ … מִשְׁתֶּה וַיֹּאכְלוּ› (“and-make … drink and-eat”)
# ‹וַיִּשְׁתּוּ› (“and-drink”)
# — event: feast-eat-drink — agent Isaac-and-guests
m.event("feast_eat_drink", agent="yitzchaq_and_guests")

# -------------------------- Gen.26.31 · THE_SWEAR_OTHER_VERB_CENTERPIECE ---
# ‹וַיַּשְׁכִּ֣ימוּ בַבֹּ֔קֶר וַיִּשָּׁבְע֖וּ› (“and-rise-early in-morning
# and-swear”)
# ‹אִ֣ישׁ לְאָחִ֑יו וַיְשַׁלְּחֵ֣ם› (“man to-brother-him/its and-send-
# them/their”)
# ‹יִצְחָ֔ק וַיֵּלְכ֥וּ מֵאִתּ֖וֹ› (“Isaac and-go from-with-him/its”)
# ‹בְּשָׁלֽוֹם› (“in-safe”)
...
m.step("Gen.26.31")
# ‹וַיַּשְׁכִּימוּ … וַיִּשָּׁבְעוּ אִישׁ› (“and-rise-early … and-swear
# man”)
# ‹לְאָחִיו› (“to-brother-him/its”)
# — event: ?
m.event("?")
# ‹וַיִּשָּׁבְעוּ ← תְּהִי / נִכְרְתָה› (“and-swear be cut”)
# — fact holds: other-verb-non-pop-be-and-nikhreta
m.fact("other_verb_non_pop_tehi_and_nikhreta")
# ‹וַיְשַׁלְּחֵם יִצְחָק וַיֵּלְכוּ› (“and-send-them/their Isaac and-go”)
# ‹… בְּשָׁלוֹם› (“in-safe”)
# — event: ?
m.event("?")

# -------------------------- Gen.26.32 · THE_WELL_FOUND_REPORT --------------
# ‹וַיְהִ֣י בַּיּ֣וֹם הַה֗וּא› (“and-be in-day that”)
# ‹וַיָּבֹ֨אוּ֙ עַבְדֵ֣י יִצְחָ֔ק› (“and-come/bring servant Isaac”)
# ‹וַיַּגִּ֣דוּ לוֹ֔ עַל־אֹד֥וֹת› (“and-tell to-him/its over turnings”)
# ‹הַבְּאֵ֖ר אֲשֶׁ֣ר חָפָ֑רוּ› (“the-pit which dig”)
# ‹וַיֹּ֥אמְרוּ ל֖וֹ מָצָ֥אנוּ› (“and-say to-him/its find”)
# ‹מָֽיִם› (“waters”)
...
# water."
m.step("Gen.26.32")
# ‹וַיַּגִּדוּ … מָצָאנוּ מָיִם› (“and-tell … find waters”)
# — event: report-well-found — agent servant-Isaac
m.event("report_well_found", agent="avde_yitzchaq")

# -------------------------- Gen.26.33 · THE_NAME_SHIBAH_AND_THE_CITY_ETIOLOGY -
# ‹וַיִּקְרָ֥א אֹתָ֖הּ שִׁבְעָ֑ה› (“and-call obj-marker-her/its Shebah”)
# ‹עַל־כֵּ֤ן שֵׁם־הָעִיר֙ בְּאֵ֣ר› (“over so name the-city”)
# ‹שֶׁ֔בַע עַ֖ד הַיּ֥וֹם› (“Beer-shebah until the-day”)
# ‹הַזֶּֽה› (“the-this”)
...
# ‹עַל־כֵּן שֵׁם הָעִיר› (“over so name the-city”)
# ‹בְּאֵר שֶׁבַע עַד› (“Beer-shebah until”)
# ‹הַיּוֹם הַזֶּה› (“the-day the-this”)
# — fact holds: over-so-name-the-city-pit-Beer-shebah
m.fact("al_ken_shem_ha_ir_beer_sheva")

# -------------------------- Gen.26.34 · ESAU_TAKES_TWO_HITTITE_WIVES -------
# ‹וַיְהִ֤י עֵשָׂו֙ בֶּן־אַרְבָּעִ֣ים› (“and-be Esau son forty”)
# ‹שָׁנָ֔ה וַיִּקַּ֤ח אִשָּׁה֙› (“years and-take woman”)
# ‹אֶת־יְהוּדִ֔ית בַּת־בְּאֵרִ֖י הַֽחִתִּ֑י› (“obj-marker Judith daughter
# Beeri the-Chittite”)
# ‹וְאֶת־בָּ֣שְׂמַ֔ת בַּת־אֵילֹ֖ן הַֽחִתִּֽי› (“and-obj-marker Bashemath
# daughter Elon the-Chittite”)
...
m.step("Gen.26.34")
# ‹עֵשָׂו בֶּן־אַרְבָּעִים שָׁנָה› (“Esau son forty years”)
# — fact holds: Esau-son-forty-years
m.fact("esav_ben_arbaim_shana")
# ‹וַיִּקַּח אִשָּׁה אֶת־יְהוּדִית› (“and-take woman obj-marker Judith”)
# ‹… וְאֶת־בָּשְׂמַת› (“and-obj-marker Bashemath”)
# — event: take-wives — agent Esau
m.event("take_wives", agent="esav")
# ‹יְהוּדִית … בָּשְׂמַת … בְּאֵרִי› (“Judith … Bashemath … Beeri”)
# ‹… אֵילֹן› (“Elon”)
# — the world gains: Judith, Bashemath, Beeri, Elon
...
# ‹וַתִּהְיֶ֖יןָ מֹ֣רַת ר֑וּחַ› (“and-be bitterness spirit”)
# ‹לְיִצְחָ֖ק וּלְרִבְקָֽה› (“to-Isaac and-to-Rebekah”)
# "[EN-AID] And they were a bitterness of spirit to Isaac and to Rivqah."
m.step("Gen.26.35")
# ‹מֹרַת רוּחַ לְיִצְחָק› (“bitterness spirit to-Isaac”)
# ‹וּלְרִבְקָה› (“and-to-Rebekah”)
# — fact holds: bitterness-spirit-wind-to-Isaac-and-to-rivqah

...
# house of David. Repo home: logic/law_era/tanakh_run/ — the pass-3
# direction's first artifact (owner question 2026-08-13: "if this were
# a simulation, what would the code look like").
#

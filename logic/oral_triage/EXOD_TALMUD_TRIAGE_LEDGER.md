# THE EXODUS TALMUD TRIAGE LEDGER — all 2,033 links-shelf rows citing Exodus
Owner's word 2026-09-03 (the audit order): "do it in that order" — the
Exodus Talmud triage was the second of the two tasks, run after the
Genesis batch stamp. Method identical to the Genesis 958-passage triage
(World/step9/TALMUD_TRIAGE_LEDGER.md): every enumerated row opened and
given a KIND verdict, one row each, APPEND-ONLY.
Enumeration: the citation-links shelf (Data/links*.csv) filtered to the
Babylonian Talmud tractates citing Exodus. 2,033 rows total: 1,913 fresh
segment-refs read in full (texts bulk-fetched from torah_grok.sqlite
export_texts); 80 exact refs credited on standing verdicts in prior
ledgers (the Genesis triage, the guardians compile ledger, the Noahide
block); 2 range-form refs (Bava Kamma 37b:11-12, Beitzah 5b:4-5) opened
from their member segments; 38 rows turned out to be SIDDUR citations
("Shabbat Siddur Sefard Linear") — the links shelf includes the prayer
book — each verdicted QUOTE as a liturgical recitation, openly not a
Talmud passage. The reading ran across two sittings around compaction
point #39 (rows 0-1059 before, 1060-1912 after), one derivation stream.

Verdict key (the Genesis triage's four kinds):
- LAW — halakhah the Talmud derives from the Exodus verse: case-row and
  compile-move candidates for the Step 5 exam.
...
TALLY: 2,033 rows — LAW 501 · CREDIT 1,109 · AGGADAH 336 · QUOTE 87

Notable finds flagged during the read (each also a verdict row above its
tractate): the vocalization-authority dispute named at Sanhedrin 4a:15
(read text vs received consonants — the tradition's own front-end
question, the one our vowel measurement answered); the three recorded
PARSE AMBIGUITIES at Yoma 52b (meshukkadim, machar, the young men's
offerings — undecided syntax in the tradition's own words); the letter
arithmetic at Sanhedrin 29a (the alef of amatayim, the ayin of ashtei
esrei); the script witness at Sanhedrin 22a (the vav-shaped hooks); the
carrying-out labor's ink at Shabbat 96b (the camp proclamation); the
grammatical-number hooks at Sanhedrin 3b:17 and Pesachim 39a:13 (M-12's
family); forewarning derived at Sanhedrin 41a:2; life-overrides-Shabbat
at Yoma 85a-b (the tunneler's own a-fortiori); and the verbal-analogy
meta-rule at Shabbat 97a:1 (no analogy without a received tradition).
...
## THE EXAM-BLOCK MAP — the 501 LAW rows clustered for Step 5
(Mapped at the triage's close, 2026-09-03, the Genesis ~12-block pattern
at Exodus scale. Counts are approximate row-shares; a row citing two
chapters may serve two blocks. Each block names its anchor sugyot.)

 1. THE LEAVEN MACHINE (~35) — search, removal, the midday deadline,
    mixtures, ownership, after-Passover. Ex 12:15-20, 13:3-7; Pesachim
    4b-49a.
 2. THE PASCHAL OFFERING (~45) — the slaughter window, for-its-own-name,
    registration and withdrawal, according-to-eating, the bone, the two
    groups, leftover-burn. Ex 12:3-11, 12:21-27, 12:43-49; Pesachim
    59a-99a, Zevachim 7b-23a.
 3. MATZA, HERBS, AND THE TELLING (~30) — the first-night obligation,
    guarded matza, the three todays, the telling's pointing, tefillin
    hide and totafot. Ex 12:8/18/20, 13:3-16; Pesachim 36a-43a, 108a-120b.
 4. EGYPT AND THE GENERATIONS (~12) — the from-it inference run, haste,
    the four-day examination, the second Passover's carve-outs. Pesachim
    95b-96b.
 5. THE DECALOGUE (~40) — image-making's scope run, the vain and false
    oath, remember-over-wine, theft-of-persons, doing-vs-causing.
    Ex 20; Rosh Hashanah 24a-b, Shevuot 20b-39a, Sanhedrin 86a.
 6. THE COURTS (~50) — compositions from the elohim verses, great
    matters, appointment, procedure (return-for-acquittal, standing
    witnesses, the distancing cluster), the king apart. Ex 18:13-26,
    22:6-8, 23:1-8; Sanhedrin 2a-36b, Shevuot 30b-31a.
 7. THE ORDINANCES' PERSONS (~45) — the slave clock's whole years, the
    child-follows-the-mother rule, parent-striker and curser, abduction,
    FOREWARNING, the assessments, transferred intent, the burglar, the
    seducer. Ex 21-22:2; Sanhedrin 41a-86a, Niddah 47b-48a.
 8. CAPITAL MODES AND IDOLATRY SERVICE (~30) — the witch, bestiality's
    passive, the blasphemy verb, sacrifice/incense/libation/bowing, the
    three bowing verses. Ex 22:17-19, 22:27, 34:14; Sanhedrin 53a-67b.
 9. SHABBAT'S MACHINERY (~45) — division of labors, carrying-out's own
    ink at the camp proclamation, labors keyed to the build, three
    meals, preparation, LIFE OVERRIDES, the laden beast, the YK overlap.
    Ex 16, 20:9-10, 31:12-17, 35:1-3, 36:6; Shabbat 69b-153b, Yoma 85a-b.
10. THE CALENDAR (~20) — Nisan for kings, only-Adar intercalated, the
    equinox rule, month mechanics, the Ninth-of-Av computation.
    Ex 12:2, 23:16, 34:21-22, 40:17; Rosh Hashanah 2a-20b, Sanhedrin
    12b-13b, Taanit 29a.
11. SANCTUARY CONSTANTS (~30) — ark, table, candelabrum derivations,
    the altar's geometry and indispensables, the red line, staves and
    breastplate prohibitions. Ex 25-27, 38; Zevachim 53a-62b, Yoma 72a-b,
    Sukkah 4b-7b.
12. VESTMENTS AND INVESTITURE (~35) — thread counts, the frontplate's
    state machine, tearing, the unvested priest's death, the seven days,
    blood collection, interposition. Ex 28-29; Yoma 5a-7b, 71b-73a,
    Zevachim 13a-19a, 88a-b, Sanhedrin 83b.
13. THE SERVICE ORDER (~30) — the morning orders, incense and lamps,
    laver mechanics, once-a-year corners, the daily lambs, the
    perpetual fire, promote-never-demote. Ex 27:20-21, 29:38-42, 30;
    Yoma 14b-15a, 32b-33b, Zevachim 11b-12a, 19b-22a, Pesachim 59a.
14. OATHS AND DEPOSITS (~15) — between-them-both, the heirs, the
    exclusions, generalization-detail-generalization — the compiled
    guardians' exam shelf. Ex 22:6-10; Shevuot 39b-47b.
15. THE INK LAYER (~15) — the vocalization-authority dispute, the three
    recorded parse ambiguities, letter arithmetic, the script witness,
    the Name-erasure list, the defective le'olam, the verbal-analogy
    and first-mention meta-rules. Sanhedrin 3b-4b, 22a, 29a, Yoma 52b,
    Shevuot 35b, Pesachim 50a, Shabbat 97a.
16. THE SINAI COVENANT (~30) — sequestering-from-Sinai, conversion's
    immersion, the mount's lapsing sanctity, the date of the giving,
    stoning-by-pushing from the boundary verse, the thirteen-attributes
    covenant and the confession formula, the oral-torah charter docket.
    Ex 19, 24, 34; Yoma 3b-4b, 36b-37a, Shabbat 86a-87b, Yevamot 46b,
    Sanhedrin 45a, Rosh Hashanah 17b, Temurah 14b.
17. FESTIVALS AND GIFTS (~25) — the food-labor license, the regalim,
    appearing with two eyes, leaven-beside-the-offering, overnight fat,
    the firstborn's passing-verb, the donkey's lamb, the delay ban, the
    sabbatical verbs. Ex 12:16, 13:12-13, 22:28-29, 23:11-19, 34:19-26.
18. CONDUCT AND LITURGY (~15) — Levites in Hebrew, the Name in the
    blessing, the Song's recitation modes, kiddush's exodus mention,
    the added soul, permission-to-rule, the giver-informs rule.
    Sotah 27b-38a, Pesachim 106a-117b, Taanit 27b, Sanhedrin 5b.

The blocks await the owner's word, per the standing rhythm (a block
opens on his order, the Noahide precedent). The compiled-function debts
(Step 5's deliverable rule) intersect blocks 7 and 14 first — the
ordinances and the guardians already hold cold functions.

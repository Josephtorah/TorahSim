...
| **C — derive units to frozen** — **▶ 2 UNITS FROZEN**: `gen_01_creation_boot` (Gen 1:1–5, 2026-07-28) + `gen_02_raqia_day` (Gen 1:6–8, 2026-07-30 — first unit derived after the interpreter; owner retained the LET? on vi-yhi mavdil; **S6 fired on real text**: commit_without_test flagged, ALL GREEN first run). Next: days 3–7; then Leviticus (casuistic payoff) | owner+agent (the long middle — this IS the project) | per unit: frozen, with scenarios ✅✅ |

...
| **C — derive units to frozen** — **▶ 3 UNITS FROZEN**: `gen_01_creation_boot` (Gen 1:1–5, 2026-07-28) + `gen_02_raqia_day` (Gen 1:6–8, 2026-07-30 — **S6 fired on real text**) + `gen_03_double_build` (Gen 1:9–13, 2026-07-30 — first DELEGATION, spec_delta flag, clean double commit; interpreter self-surfaced named_before_any_presence on miqveh-ha-mayim). Next: days 4–7; then Leviticus (casuistic payoff) | owner+agent (the long middle — this IS the project) | per unit: frozen, with scenarios ✅✅ |

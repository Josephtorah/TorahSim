...
Derived artifact only (Pre-Code): reads torah_grok.sqlite (units/steps/verses,
...
def main():
    ...
    S.append('<div class="meta">generated %s from torah_grok.sqlite (indexed from '
...
<title>Derived coverage — Torah Grok</title>
<style>

#!/usr/bin/env python3
"""
report_db_html.py — read-only HTML inspection report over torah_grok.sqlite.
...
Usage:  python3 logic/pre_logic_methods_2026-07-28/report_db_html.py
Output: logic/pre_logic_methods_2026-07-28/DB_INSPECTION_torah_grok_2026-07-28.html
"""
...
OUT = HERE / "DB_INSPECTION_torah_grok_2026-07-28.html"
...
def main():
    ...
    S.append("<h1>torah_grok.sqlite — inspection report</h1>")
...
<code>pip install datasette</code> then <code>datasette torah_grok.sqlite</code>
→ browse every table, run SQL, use FTS, all in the browser.</li>
<li><b>DB Browser for SQLite</b> (free Mac app, point-and-click): open
<code>torah_grok.sqlite</code>, Browse Data tab.</li>
<li><b>sqlite3 CLI</b> (already installed):
<code>sqlite3 torah_grok.sqlite ".tables"</code> — then paste any query shown
...
"""
    page = ("<!DOCTYPE html><html><head><meta charset='utf-8'>"
            "<title>torah_grok.sqlite inspection — 2026-07-28</title>"

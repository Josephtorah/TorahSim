...
sourced entirely from torah_grok.sqlite (no re-parse; PLAN §4 upgrade of
...
def render_verse(book, ch, v, d, frozen_rows=None):
    ...
    out.append('<div class="meta">FLAT · taamim %s · %s · %d words → %d bricks · '
               'parser status: %s · source: torah_grok.sqlite</div>'
...
<div class="meta"><b>DB-backed:</b> every row queried from <span class="tag">torah_grok.sqlite</span>

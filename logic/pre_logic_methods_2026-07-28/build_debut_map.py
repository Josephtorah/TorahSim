...
Source: torah_grok.SNAPSHOT-main-51801ca.sqlite (canonical snapshot).
Output: debut_map.SNAPSHOT-main-51801ca.sqlite at repo root
...
SRC = os.path.join(ROOT, "torah_grok.SNAPSHOT-main-51801ca.sqlite")
OUT = os.path.join(ROOT, "debut_map.SNAPSHOT-main-51801ca.sqlite")

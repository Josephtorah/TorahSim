...
| **[ORAL_COVERAGE_review_gen01-03_2026-07-30.md](ORAL_COVERAGE_review_gen01-03_2026-07-30.md)** | **Oral coverage report** (Sefaria link index): units 1–3 measured against 2,226 enumerated tier-1 sources · review findings: day-3 delta is TWO-WAY (Chullin 60a, herbs gained le-minehu — amendment recommended) · day-1 or-ha-ganuz now VERIFIED (Chagigah 12a) · day-2 enrichments optional · machine layer unchanged |

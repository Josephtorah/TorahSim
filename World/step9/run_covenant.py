#!/usr/bin/env python3
"""run_covenant.py — run round 23 (THE SINAI COVENANT) against the engine.

Loads cases_covenant.yaml, validates every input against the vocabulary
...
def main():
    spec = yaml.safe_load(open(HERE / "cases_covenant.yaml",
                               encoding="utf-8"))
    ...
    print("\nCOVENANT: %d cases, %d answered, %d matched, %d misses"

#!/usr/bin/env python3
"""run_leaven.py — run round 12 (THE LEAVEN MACHINE) against the engine.

Loads cases_leaven.yaml, validates every input against the vocabulary
...
def main():
    spec = yaml.safe_load(open(HERE / "cases_leaven.yaml",
                               encoding="utf-8"))
    ...
    print("\nLEAVEN: %d cases, %d answered, %d matched, %d misses"

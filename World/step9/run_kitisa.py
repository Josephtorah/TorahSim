#!/usr/bin/env python3
"""run_kitisa.py — run the Ki Tisa exam's case rows against the engine.

Loads cases_kitisa.yaml, validates every input against the vocabulary
...
def main():
    spec = yaml.safe_load(open(HERE / "cases_kitisa.yaml",
                               encoding="utf-8"))
    ...
    print("\nKITISA: %d cases, %d answered, %d matched, %d misses"

...
def main():
    ...
    def r6():
        ...
        assert sum(t['footers'].values()) == 9 and t['footers'].get('EMPTY') == 3, t['footers']   # THE DEUTERONOMY WALK 1b (2026-09-15): EMPTY 4 -> 3 — the footer Deut 4:45 DAEMONS by law_opening_speech (given_at Deut 1:16 inside its block); sitting 11b's note follows:   # THE NUMBERS WALK 11b (2026-09-12): EMPTY 5 -> 4 — the footer Num 36:13 DAEMONS by law_midian; typed from the gate's print

#!/usr/bin/env python3
"""run_betrothal.py — run round 32 (BETROTHAL AND THE HOUSE) against the engine.

Loads cases_betrothal.yaml, validates every input against the vocabulary
...
def main():
    spec = yaml.safe_load(open(HERE / "cases_betrothal.yaml",
                               encoding="utf-8"))
    ...
    print("\nBETROTHAL: %d cases, %d answered, %d matched, %d misses"

...
def the_exhortation(case, data):
    ...
    if ask == 'add_nothing':
        ...
        move('Sanhedrin 88b:14-89a:2; Mishnah Sanhedrin 11:3', "the addition that SPOILS — five compartments made as one (liable), a fifth beside (stands alone); the lulav by the binding, the fringes by the upper knot")
    ...
    if ask == 'add_beside':
        ink('4:2', '"you shall not add" — a fifth compartment PLACED BESIDE four made: the four stand alone (Sanhedrin 89a:2); the lulav\'s added species without binding, the fringes\' added thread without the Torah knot')
        move('Sanhedrin 88b:15-89a:2', "the elder liable only where the addition SPOILS — beside it stands alone: the Mishnah 11:3's row resolved")
        return out("an addition placed beside (Sanhedrin 89a) — the four compartments stand alone: no spoiling, exempt", ['exempt'])
...
def the_exile_case(case, data):
    ...
    if ask == 'the_case_head':
        ...
        move('Gittin 88a:15-17; Sanhedrin 38a:6; Megillah 31b:2', "'grown old' by its letters eight hundred and fifty-two — the exile hastened by two years; seven dynasties from the seven verbs; the Ninth of Av's reading")

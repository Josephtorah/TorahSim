#!/usr/bin/env python3
"""run_oaths.py — run round 15 (OATHS AND DEPOSITS) against the engine.

Loads cases_oaths.yaml, validates every input against the vocabulary
...
def main():
    spec = yaml.safe_load(open(HERE / "cases_oaths.yaml",
                               encoding="utf-8"))
    ...
    print("\nOATHS: %d cases, %d answered, %d matched, %d misses"

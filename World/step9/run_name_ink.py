#!/usr/bin/env python3
"""run_name_ink.py — run round 36 (THE NAME AND THE INK) against the engine.

Loads cases_name_ink.yaml, validates every input against the vocabulary
...
def main():
    spec = yaml.safe_load(open(HERE / "cases_name_ink.yaml",
                               encoding="utf-8"))
    ...
    print("\nNAME-INK: %d cases, %d answered, %d matched, %d misses"

...
patch('<repo-old>/World/step9/THE_LOOP.md',
      "THE SWEEP: running in the background at the close; its line is appended below when it lands.",
      "THE SWEEP: %s." % SWEEP)
patch('<repo-old>/logic/pre_logic_methods_2026-07-28/RECOVERY_new_thread_2026-09-12.md',
      "the sweep in the background at the close (its line in THE_LOOP.md's as-built and the\nstate doc when it lands)",
      "the sweep %s" % SWEEP)
p = '<repo-old>/logic/pre_logic_methods_2026-07-28/PROMPT_continue_solo_era_2026-08-06.md'

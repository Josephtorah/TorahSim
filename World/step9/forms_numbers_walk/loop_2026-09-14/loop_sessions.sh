...
b = open('<repo-old>/World/journal/data/L3_run_cold_run_sequence_seed_isaac.jsonl', encoding='utf-8').read().split('\n')
s = open('<repo-old>/World/journal/data/L3_run_cold_run_sequence_stepper.jsonl', encoding='utf-8').read().split('\n')

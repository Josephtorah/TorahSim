#!/usr/bin/env python3
# THE NUMBERS WALK 5b — THE CORPUS-WIDE DIFF: the parser 4b left (cold_run_sequence.pre_korach.py's INK block) against the parser after
# the Korach rules (the definite numeral at the head of a compound, the article on the hundreds-word, the plural unit noun, the definite
# one's accent gate), over EVERY verse of the five books — numbers AND ordinals. Every moved verse printed with both readings, to be read
...
OLD = ink('<scratch>/cold_run_sequence.pre_korach.py')

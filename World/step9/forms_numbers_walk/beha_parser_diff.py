...
#!/usr/bin/env python3
# THE NUMBERS WALK 3b — THE CORPUS-WIDE DIFF: the parser 2b left (cold_run_sequence.pre_beha.py's INK block) against the parser after
# the Beha'alotcha rules (the dual noun, the suffixed numeral, the half), over EVERY verse of the four books (and the marker verses of Deuteronomy the probes name) — numbers AND ordinals.
...
OLD = ink('<scratch>/cold_run_sequence.pre_beha.py')

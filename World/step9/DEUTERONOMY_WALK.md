# THE DEUTERONOMY WALK — the fifth book in order from 1:1 (the owner: "start with deuteronomy", 2026-09-15, after NUMBERS CLOSED)
...
## Sitting 1b — THE COMPILE OF THE OPENING SPEECH, Deuteronomy 1:1-3:29, with Numbers 27:12-23 as its callee (the design, 2026-09-15; the owner:
## "Go 1b right", then "Yes 1. Go" on the readback's first form; written after the measurements — deu_compile_recon.py, deu_runner_measure.py,
## deu_docket_scan.py, deu_compile_measure.py, deu_advance_probe.py in the scratchpad — and BEFORE any code)

THE MEASUREMENTS (what the tape and the callees say before a line is typed): EVERY ACT THE SPEECH RETELLS IS ON THE TAPE — the judges appointed
(Exodus 18:25-26 — courts_established ([1000, 100, 50, 10], 78600) and hard_cases_to_moses on Israel, the court's in_force since (1, 2, 16)); the
spies commanded, sent, instructed, gone up, returned; the report, Caleb's hushing, the evil report, the weeping, Joshua and Caleb's plea, the glory,
Moses' plea on the attributes, the pardon and the decree (sentence_pronounced on Israel at (2, 5, 9), the forty years' timer FIRED at (40, 5, 9),
Caleb's holding_owed OPEN, the ten spies put_to_death), the presumption and Hormah (presumed_to_go_up, defeated); the turn-back's debit CLOSED at
21:4; Edom's refused TWICE (20:18, 20:20-21); Sihon's refused and kings_smitten, Og's kings_smitten, the land possessed three times (21:24-25,
21:31-32, 21:35); the grant's three holding_given transfers (32:33), the sons of Machir's and Jair's land_possessed, the condition's debit OPEN on
the sons of Gad and Reuben (32:20-24), the dividers' debit OPEN (32:28-30); Moses' barred_from_the_land OPEN since (40, 1, 1) and Aaron's closed by
his death; the counter at (40, 6, 1), 318 entities, 1279 events, 157 markers, 121 closes, 14 timers pending. ONE HOLE: Numbers 27:12-23 — Moses
told to climb Abarim, the shepherd asked, Joshua commissioned by the hands — read and seated at THE TENT (NM27-08 to NM27-11) and NEVER COMPILED
(COMPILE_DEBT's 8b line; the register gate's receipt Num 27:22 declared CHAPTER with that why): Deuteronomy 3:27-28 points straight at it — this
sitting compiles the twelve verses as the callee. THE CLOCK'S COST MEASURED (deu_advance_probe.py, a scratch journal, nothing written): the running
world advanced from (40, 6, 1) to Deuteronomy 1:3's (40, 11, 1) with no line submitted FIRES 36 timers (the six purification timers of Midian's war
on the third and seventh days; the altar's thirty — the Sabbath's twenty-one, the new moon's five, the seventh month's four) and RE-ARMS 30, writes
36, closes nothing, moves no entity; eight timers pending after — the Sabbath (40, 11, 8), the month (40, 12, 1), Passover (41, 1, 15), Shavuot
(41, 3, 6), the seventh month's four in year 41. THE PARSER at the fraction: "half the hill country of Gilead" (3:12) and "the half tribe" (3:13)
read NOTHING, as do Numbers 32:33, 34:14, Joshua 22:7 and Deuteronomy 29:7; the class measured on the whole Bible — 139 tokens of "half" in 114
verses, 42 in the Torah: the parser reads the half before a MEASURE noun (the hin, the shekel — Numbers 15:9 [3, 1/2], Exodus 30:13) and "and a
half" after a numeral (Exodus 25:10 [2.5, 1.5, 1.5]) and is silent before every other noun — the tribe, the hill country, the night (Exodus 12:29),
the blood (24:6), the curtain (26:12), the altar (27:5), the flesh (Numbers 12:12), the people, the city, the kingdom. THE REGISTER GATE on 1-3:
1:1 an EMPTY footer (the block (Num 36:13, Deut 1:1] holds no law — TRUE by the ink), 1:3 / 1:19 / 1:41 NONE ("the book not read"), Deut 4:45 an
EMPTY footer declared for the same why — and the judges' charge at 1:16 falls inside (Deut 1:1, Deut 4:45]. THE GLOBAL COUNTS grepped before the
tape run: CV2, CX2, CW3, CR3 (the commanded entries on Israel: 14, the newest appoint_six_cities_of_refuge, 7 open), CT2 (the eight musaf dues from
(40, 6, 1)), CT9 / CV9 / CX9 / CY9 / CZ9 / CW9 / CR9 (entities 318, closes 121) — EVERY ONE MOVES THIS SITTING (the clock, the closes, the new
party). The checkpoint prefix CA measured FREE (CA, CC, CI, CO, CQ, CU free in the sequence file and in every probe file). THE DOCKET SIZED — 67
link rows in 26 works (Sanhedrin 8, Sotah 7, Rosh Hashanah 5, Avodah Zarah 4, Berakhot 4, Chullin 4, Taanit 4, Bava Kamma 3, Nazir 3, Shevuot 3;
the verses cited most 1:17 eight, 1:1 six, 3:25 five, 2:25 five, 2:9 five) + 797 topic rows (Sanhedrin 23a-31b WHOLE 466 — the court's own chapter,
Mishnah Sanhedrin 3's; 2a-2b 25, 32a-32b 35, 6b-7a 34, 16b-17a 40, 90b-91a 38; Rosh Hashanah 2b-3a 29; Sotah 34a-35a 48; Berakhot 30a 19; Makkot
9b-10a 43; the fifteen Mishnah Sanhedrin rows, Avot 1:1, Sheviit 9:2, Rosh Hashanah 1:1, Sotah 7:5, Berakhot 4:5-6, Makkot 2:4-8, Kelim 17:9-10,
Eruvin 4:8) = 864 rows, 250 credited: TEN verdict parts on disk. THE RECORDER AND THE STITCHER know four books (the recorder's source class
'torah3' = Genesis to Numbers; the stitcher's book order, its range regex, its section headers, THE REST's marker regex) — Deuteronomy JOINS THE
TAPE'S BOOKS this sitting (the engine's BOOK_ORDER, the register gate and the stepper already carry it).

THE NAME: cold_run_opening_speech.py — the 58th runner; law_opening_speech the 63rd daemon; the span [[Num, 27, 12, 23], [Deut, 1, 1, 46],
[Deut, 2, 1, 37], [Deut, 3, 1, 29]] — the first span in two books; the checkpoints CA1-CA9.

THE READBACK'S FIRST FORM (THE_LOOP.md's step 6 — the owner's option 1, "Yes 1. Go"; the narrative half designed here, the laws' half owed to its
own sitting when chapter 5 opens; the row in THE_LOOP.md's table gains this design's pointer):
(R1) A RETELLING IS A REFERENCE ROW, NEVER A SECOND ACT. The DATA table the_readback carries one row per retold act: the speech's verses, the
tape's kind and its first verse, the ledger entry the speech presupposes, and THE GRADE — VERBATIM (1:39 = Numbers 14:31 word for word),
TURNED (3:1-3 = 21:33-35 with the persons shifted: they → we, to Moses → to me), SHORTENED (2:27 nine tokens for 21:22's seventeen; 2:32 eight for
21:23's twenty), EXPANDED (3:14 twenty-three tokens for 32:41's eleven; 3:12-13 dividing what 32:33 gave whole; 1:9-15 the officers with the three
qualities for Jethro's four and the officers added), SUPPLIED (an act the first telling lacks — (R3)), DISAGREES (2:29 against 20:18-21; 1:37
against 20:12 — (R4)); the delta the reading measured on the tokens, RECOMPUTED by the runner from the DB (the diffs the readback's first
specimens).
(R2) THE READBACK CHECKPOINTS READ THE LEDGER AT THE SPEECH'S POSITION: every row's entry FOUND on the running world by kind and first verse (a
computed pair — rows n, found n), and the state the speech asserts read off the ledger — the oath's sentence and its timer fired, Caleb's owed
holding open, the ten spies dead, the defeat at Hormah, the turn-back closed, Edom's two refusals, Sihon's and Og's smiting, the three holdings
given, the condition open, the dividers' debit open, Moses barred, the court's founding count.
(R3) AN ACT TOLD ONLY IN THE RETELLING IS WRITTEN ONCE, AT THE TIME IT HAPPENED: a SUPPLIED row is a tape line at the speech's verse, DATED by a
RETROGRADE marker (the tape's own class since Numbers 9:1 — Pesachim 6b:7 "no earlier and later in the Torah") at the day the tape gives the act
it belongs beside; its run, where the tape already holds it, CLOSES it in the same block — THE CLOSE BY A PRIOR RUN: the debit opened by the
retold command and closed at once with the tape's earlier line as the closer (closed_by naming the run's verse), the ledger's own record that the
command came to the reader after its execution. Four such: the departure from Horeb (1:6-8 → Numbers 12:16's arrival in Paran), the turn
northward (2:2-8 → 21:10-13's march past Moab), the crossing of the Zered (2:13 → 21:12's camp), the war on Sihon (2:24-25, 2:31 → 21:24-25's
smiting).
(R4) A DISAGREEMENT IS AN OPEN ROW. 2:29 — "as the sons of Esau who dwell in Seir did for me, and the Moabites who dwell in Ar" against Numbers
20:18-21's refusal and 21:4's going round: graded DISAGREES; the chukat runner's DATA row edom_passage already holds both arms as a DISPUTE (by
CALL), no teacher joins them (the Sifrei silent — no piska on 2:29; Judges 11:17's double refusal outside the Torah): no link of our own, the row
stays open. 1:37 — "the LORD was angry with me for your sakes" at the spies' oath against 20:12's Meribah: graded DISAGREES on the ground of the
bar; the tape's one entry stands; Psalm 106:32's "for their sakes" the ink's own bridge outside the Torah, read, not run.
(R5) A RECEIPT INSIDE A RETELLING IS A RUN CITATION of the tape's act — the register gate's seat declared with that why, no ledger write pays it
(1:19 "as the LORD our God commanded us" = the departure's run at Numbers 10:12 / 12:16, read back by the row; 1:41 the receipt in the people's
mouth refused by 1:42-43 — the tape's presumed_to_go_up, read back).
(R6) THE FRAME IS THE BOOK'S ONE ACT OF ITS OWN DAY: the marker at 1:3 and the speech opened (1:1-5) — a STATUS on Israel, torah_expounded,
dated (40, 11, 1); everything after it in chapters 1-3 is read back or supplied at its own time.

THE DESIGN'S DECISIONS (the box's (a)-(l) settled on the measurements):
(a) THE ONE CLOCK. The FORWARD marker at Deuteronomy 1:3 = day_in('exodus', 40, 11, 1) by the NUMBER reader's [40, 11, 1] (the era the exodus's
by the verbal analogy "the fortieth year" / "the fortieth year" with Numbers 33:38 — Rosh Hashanah 2b:11, a TRANSFER TAUGHT, the journeys runner's
cell verbal_analogy by CALL; the ordinal reader's [40, 5] at 33:38 and the number reader's here — one clock, two readers, JO.aarons_death_retold
by CALL), placed at the tape POSITION Deut 1:1 (the stitcher's `at`, as Genesis 21:5's number sits at 21:2) so the speech line at 1:1 wears the
marker's class text_constrained; the walk from (40, 6, 1) fires the 36 timers and re-arms the 30 (measured) — the clock's cost predicted, not
suffered. THREE RETROGRADE MARKERS date the supplied acts (reading_placed — the day is the tape's own placement of the act each belongs beside, the
speech itself giving "at that time"): Deut 1:6 at the departure from Sinai M['march'] = (2, 2, 20) (Numbers 10:11's own date — the command and its
run one day); Deut 1:9 at the day of the court's founding (the courts_established entry's own day on Israel's ledger, (1, 2, 16) — read off the
ledger by the marker's code, never typed); Deut 2:2 at the departure from Mount Hor M['hor_departure'] = (40, 6, 1) (21:4's text-constrained day —
the counter's day for the whole stretch to the plains). The counter ends the sitting at (40, 11, 1); no marker after 2:2 (the plea and the charges
"at that time" — the Sifrei 26:8: after Sihon and Og — inside 2:2's stretch).
(b) THE REGISTER GATE'S FOUR SEATS PAID — each recomputed on the new tape and its declaration brought current: Deut 1:1 stays EMPTY, declared with
the why refreshed (the words' stamp; the block (Num 36:13, Deut 1:1] holds no law — by the ink and by the tape); Deut 4:45 turns DAEMONS
(law_opening_speech given_at Deut 1:16 inside (Deut 1:1, Deut 4:45]) — GREEN, its declaration DELETED (a stale declaration fails the gate); Deut
1:3 turns ACT (the speech line's write carries its source) — declared ACT with the compile's why: the receipt of the whole book's rules (the
Sifrei 2:8 — "according to all that the LORD commanded him" received as the hermeneutic rules themselves), the run of every relayed command,
closing nothing by itself, the frame the readback checkpoint reads; Deut 1:19 and 1:41 stay NONE with (R5)'s whys. Numbers 27:22 (CHAPTER, "not
compiled") turns CLOSE — the commission's debit on Moses closed by its run at 27:22-23 — GREEN, its declaration DELETED.
(c) THE OFFICERS' TABLE — DATA the_officers_table: the four grains [1000, 100, 50, 10] (the parser's [100, 50, 10] at 1:15 with the plural
"thousands" a NOUN — rule 29's other half; ES.jethro('denominations') by CALL = 4); THE COUNT with two settings: 78,600 on the round six hundred
thousand (ES.jethro('judges') by CALL — Sanhedrin 18a:3's own total; the Sifrei 14:1's "eighty thousand less a few"; the Jerusalem Talmud
Sanhedrin 10:2's arithmetic the balak runner's judges_count by CALL) and 79,064 on the census's exact 603,550 by INTEGER DIVISION at every grain
(603 + 6,035 + 12,071 + 60,355 — computed by the runner from CB.census('total') by CALL; the Sifrei 15:4's ROUNDING RULE: a thousand less one
yields one captain of a thousand — integer division is the rule's own form); THE SEVEN QUALITIES as a checklist — Jethro's four (Exodus 18:21 by
the tokens: men of valor, fearers of God, men of truth, haters of gain), 1:13's three (wise, discerning, known), 1:15's two (wise, known): seven
asked, three found (the Sifrei 15:2); the officers with the strap — the Levites (the Sifrei 15:5; 2 Chronicles 19:11 outside the Torah, DATA);
1:11's blessing Moses' own beside God's (the Sifrei 11:1; Rosh Hashanah 28b:10 — a priest may not add it: DATA). The appointment itself a
REFERENCE to judges_appointed (Exodus 18:25 — the readback row, TURNED).
(d) THE JUDGES' CHARGE IS THE LAW. law_opening_speech, given_at Deut 1:16, installed_by BOOT with the class NAMED — a law in Moses' voice with no
divine frame ("I charged your judges at that time"): the vows' class (30:2), the second pass's D2 question. THE TAPE LINE judges_charged (speech,
Deut 1:16-18, dated (1, 2, 16) by 1:9's retrograde marker) writes ONE STATUS on the court, judges_charged (a NEW effect), its value the six
clauses — hear between your brothers; judge righteously between a man and his brother and his stranger; no faces in judgment; the small as the
great; fear no man, for the judgment is God's; the hard matter to me. THE SPEC as the cell's asks, each with the exam's rows: hear (Sanhedrin
7b:14 — R. Chanina: a judge may not hear one litigant before the other comes), judge_righteously (7b:14-15 — deliberate; the rod and the strap),
no_faces (7b:18 — R. Yehuda: do not befriend; R. Elazar: do not estrange — a DISPUTE row), small_and_great (8a:2 — Reish Lakish: the peruta's case
as the hundred maneh's; 8a:4-5 the order of hearing), no_fear (7a:16 — gather not your words within you; 6b:12 Reish Lakish: refusal before
hearing, not after — the Sifrei 17:4's own line), the_judgment_is_gods (6b:3 — let the judgment pierce the mountain; the Rambam's introduction),
the_hard_matter (Exodus 18:26's hard_cases_to_moses STATUS read; the Sifrei 17:7 — Zelophehad's daughters, THE TENT: ZL.the_daughters('halt') by
CALL), the_stranger (Yevamot 47a:7 — R. Yehuda: a convert before a court), a_man_excludes_the_minor (the Sifrei 16:6), the_gentile_litigant (the
Sifrei 16:4 — R. Ishmael's two rulings against Rabban Shimon ben Gamliel: DATA), the_appointer (the Sifrei 17:1 — "you shall not respect persons"
addressed to the one who appoints judges: DATA), the_compromise (Sanhedrin 6b:1-9 — R. Eliezer son of R. Yosei HaGelili forbids the compromise
once the case is heard, R. Yehoshua ben Korcha commands it, R. Shimon ben Menasya before the verdict only: TWO VERDICT TABLES as DATA
the_compromise), the_al_tikrei (the Sifrei 13:6 — "I will appoint them your heads" read "their guilt on your heads": THE REVOCALIZATION, a move
for MOVE_CATALOG as M-29 if the catalog lacks it — checked at the records step), be_deliberate (Avot 1:1 — the Sifrei 16:1 cites the Mishnah as
the verse's reading: the exam's row), money_and_capital (Sanhedrin 4:1 — the Sifrei 18:1's ten distinctions; 32a-32b), the_court_of_three (Mishnah
Sanhedrin 1:1-3; 3:1 the litigants' choice; 23a-31b the chapter whole). THE VERDICTS on the exam's judges_case rows: accepted / exempt /
judgment_perverted (the holiness engine's effect — HO.conduct('five_effects') by CALL: the judge who perverts defiles the land, profanes the Name,
removes the Presence, fells by the sword, exiles).
(e) THE FRACTION CLASS — rule (30) THE HALF OF A NAMED WHOLE, taught to the parser: the half-word in its bare and prefixed forms — חצי ("half"),
וחצי ("and half"), לחצי ("to half"), ולחצי ("and to half"), בחצי ("in half"), מחצי ("from half"), ומחצי ("and from half"), כחצי ("as half"), כבחצי
("as in half"), החצי ("the half"), והחצי ("and the half") — and the half-part in its unsuffixed forms — מחצית ("the half-part"), ממחצית ("from the
half-part"), וממחצית ("and from the half-part") — read Fraction(1, 2), emitted with the fraction mark (%), when the token does NOT continue a
numeral or a unit noun (rule 7's "and a half" stands: Exodus 25:10 [2.5, 1.5, 1.5] unmoved) and does NOT precede a measure noun (the hin's and the
shekel's fraction stands: Numbers 15:9 [3, 1/2], Exodus 30:13 unmoved); THE SUFFIXED FORMS stay silent — חציו ("its half"), חצינו ("our half"),
חצים ("their half"), חציה ("her half"), מחציו ("from its half"), וחציו, ולחציו, והחציו, מחציתו, מחציתה, ומחציתה, ממחציתם — a pronoun's half is a
part named, not a number counted (the class NAMED, as the myriad-word at 15b). PROBES TO FAIL first (census_probes D10-D18, typed from
deu_runner_measure.out's current reads): Deut 3:12 = [1/2] (was []), Deut 3:13 = [1/2], Num 32:33 = [1/2], Num 34:13 = [9, 1/2] (was [9]), Num
34:14 = [1/2], Num 34:15 = [2, 1/2] (was [2]), Deut 29:7 = [1/2], Josh 13:7 = [9, 1/2], 1 Chr 5:18 = [1/2, 44760] (was [44760]); the regressions
R74-R80 unmoved before and after: Exod 25:10 [2.5, 1.5, 1.5], Exod 30:13 [1/2, 20, 1/2], Num 15:9 [3, 1/2], Num 28:14 [1/2, 1/3, 1/4], Exod 26:16
[10, 1.5, 1], Lev 6:13 [1/10] (the suffixed halves silent), Num 31:47 [1/50]. THE CORPUS DIFF old against new over every verse of the Tanakh READ
verse by verse — the prediction FOURTEEN Torah tokens in THIRTEEN verses move: Exodus 12:29 (half the night — the tape's own MARKER ROW, its
assert_ink [] → [1/2] retyped in the stitcher's table and the tape), 24:6 (half the blood, twice), 26:12 (half the curtain), 27:5 (half the altar),
Numbers 12:12 (half his flesh), 31:42 (the half-part of the children of Israel), 32:33, 34:13, 34:14, 34:15, Deuteronomy 3:12, 3:13, 29:7; and
some sixty outside the Torah; THE SEVEN RUNNERS whose spans hold a moved verse — exodus_story (12:29), erection (24:6), sanctuary_build (26:12,
27:5), beha (12:12), midian (31:42), gad_reuben (32:33), borders (34:13-15) — RETYPED FROM THE SWEEP'S PRINT where their ink tripwires fall (the
sweep the instrument; a runner whose tripwire does not read the verse stands as it is).
(f) THE COMMISSION — Numbers 27:12-23 compiled as the callee, F0, FOUR lines under "# ---- Num 27 ----" after the daughters' (page_order at
(40, 6, 1), the daughters' marker's bound): moses_told_to_ascend_abarim (speech, 27:12-14) → commanded on moses see_the_land_from_abarim, a DEBIT
OPEN to Deuteronomy 34:1-4 (this book's own run, its end); 27:14's "as you rebelled at Meribah" an INTERNAL pointer to 20:12's sentence, the
barred_from_the_land entry OPEN read; Deuteronomy 3:27 its retelling with Pisgah for Abarim (34:1: "Mount Nebo, the top of Pisgah" — one
mountain, three names: DATA the_commission) — READ BACK, no second write; a_shepherd_asked (speech, 27:15-17) → plea_made on moses valued "let the
LORD, the God of the spirits of all flesh, appoint a man over the congregation… that the congregation of the LORD be not as sheep without a
shepherd"; joshua_commission_commanded (speech, 27:18-21) → commanded on moses commission_joshua_before_eleazar (a DEBIT); joshua_commissioned
(act, 27:22-23) → invested_office on yehoshua valued "the hand laid, some of Moses' honor, before Eleazar the priest by the judgment of the Urim"
AND THE CLOSE of the commission debit by its run (closed_by "Num 27:22-23" — the receipt "as the LORD commanded by the hand of Moses" the spec/run
pair's form, CB8's) — the register seat Num 27:22 GREEN; the Urim's judgment final (C2.DATA['urim_judgment'] by CALL); Deuteronomy 3:28 "command
Joshua, strengthen him" the commissioning READ BACK (Kiddushin 29a:14 — "command" a galvanization, immediate and for generations).
(g) THE SUPPLIED ACTS — each ONE line at the speech's verse, dated by (a)'s retrograde markers, one write each, the close by a prior run where the
tape holds it ((R3)): horeb_departure_commanded (speech, 1:6-8, dated (2, 2, 20)) → commanded on israel journey_to_the_mountain_of_the_amorite,
CLOSED at once by the prior run Num 12:16 (paran_reached — closed_by "Num 12:16"); "go in and possess the land" a REFERENCE to land_granted (Genesis
15:18 — PR.call('land_seats') by CALL) and to the OPEN dispossess debit (33:50-56), cited, not rewritten; the seven regions (1:7) DATA (Bava Kamma
81b:6 — every tribe's portion in every kind; Shevuot 47b:6 the Euphrates called great). judges_charged (speech, 1:16-18, dated (1, 2, 16)) → (d).
turn_northward_commanded (speech, 2:2-7, dated (40, 6, 1)) → commanded on israel turn_northward CLOSED by the prior run Num 21:10-13 (the march
past Moab — closed_by "Num 21:10-13"), AND contending_barred on edom (a NEW effect, a BLOCK — "do not contend with them; not so much as a foot's
breadth: Mount Seir Esau's possession", 2:5) AND land_granted on edom valued mount_seir (the effect standing since Genesis 15:18; Kiddushin 18a:2 —
a gentile inherits by Torah law from this verse: the exam's row); "food you shall buy for money, water too" (2:6) a permission, DATA (Avodah Zarah
37b:15 the exam's row). moab_spared_commanded (speech, 2:9, dated) → contending_barred on the-moabites (the people's row, as Balak's runner wrote
it) AND land_granted on the-moabites valued ar (Bava Kamma 38a:16 — Moses' own a fortiori needed the bar; Horayot 10b:19 / Nazir 23b:11 the reward
of Lot's elder daughter's speech; Chullin 60b:13 Moab's land purified through Sihon — CK.DATA['sihon_purified'] by CALL). zered_crossing_commanded
(speech, 2:13, dated) → commanded on israel cross_the_brook_zered CLOSED by the prior run Num 21:10-13 (the Zered camp — closed_by "Num 21:12").
ammon_spared_commanded (speech, 2:17-19, dated) → contending_barred on the-sons-of-ammon (a NEW registry row — Genesis 19:38's people, Lot's
younger daughter's; the-moabites' form) AND land_granted on the-sons-of-ammon (Bava Kamma 38b:6 / Horayot 11a:1 / Nazir 23b:12 — not even harassed:
the exam's rows; 21:24's "the border of the sons of Ammon was strong" CK.DATA['ammon_border'] by CALL). sihon_war_commanded (speech, 2:24-25 with
2:31, dated) → commanded on israel begin_to_possess_sihons_land CLOSED by the prior run Num 21:24-25 (closed_by "Num 21:24-25"); 2:25's "I will
begin to put the dread of you" DATA (Avodah Zarah 25a:7-9; Taanit 20a:6-8 — the sun stood still for Moses: the exam's rows). sihons_cities_devoted
(act, 2:34-35, dated) and ogs_cities_devoted (act, 3:6-7, dated) → destroyed (the body effect the king of Arad's line wrote at 21:3) on the-amorite
TWICE, valued every city — the men, the women and the little ones; the cattle and the spoil taken: THE BAN TOLD ONLY HERE (Numbers 21:24-25 and
21:35 say smote and possessed); Genesis 15:16's amorite_not_full STATUS on the Amorite READ beside it (the fourth generation's return, OPEN on
Israel since 15:13-16 — a printed line, no verdict; Deuteronomy 20:16-17's law FORWARD). joshua_encouraged (speech, 3:21-22, dated) →
fear_not_promised on yehoshua (the HEAVEN effect the tape wrote on Moses at 21:34) valued "your eyes have seen; so shall the LORD do to all the
kingdoms; He fights for you" (Joshua 1:6 and Ai's run outside the Torah — the readback's; the Sifrei 29:8-9 the condition Joshua broke, DATA).
moses_besought (speech, 3:23-26, dated) → plea_made on moses valued the plea AND ITS ANSWER as Hobab's row carries the refusal: "let me go over
and see the good land — REFUSED: enough for you, speak no more to Me of this matter; the LORD was wroth for your sakes" — the barred_from_the_land
HEAVEN entry OPEN read, no new heaven write (Berakhot 32a:32 / Avodah Zarah 7b:18 — praise before the request, the exam's row; Sotah 13b:13 — rav
lakh measure for measure; Berakhot 30b:9 the pleading mode; the ten names of prayer the Sifrei 26:7 as DATA; the directions of prayer the Sifrei
29:5 with Mishnah Berakhot 4:5-6 / 30a as DATA). speech_opened (speech, 1:1-5, at the marker's verse, (40, 11, 1)) → torah_expounded on israel (a
NEW status effect — "Moses undertook to expound this Torah"; the eleven words of 1:1 the Sifrei's rebuke by places, Onkelos writing them into the
verse; Sotah 35b:6 the stones; the king's reading Sotah 7:8 / 41a:18; Zevachim 115b:17 R. Akiva's third teaching in the plains of Moab; the Rambam's
introduction 2:19 — DATA the_frame).
(h) THE EDGES the census will demand, answered in the yaml before the gate: exodus_story CALL (18:21-26 the judges, 16:35 the manna's forty years,
17:13 Amalek, 13:21 the pillar), shelach CALL (13-14's acts; the decree's rows — set, exceptions, count_from, deaths_ceased, turn_back, hormah,
presumption), chukat CALL (20-21's acts; edom_passage the DISPUTE row; deut3_delta; zered_date; og_lore; sihon_purified; ammon_border; the
succession), gad_reuben CALL (32's grant, condition, the offer's "until", Jair and Machir, the two and a half's count), zelophehad CALL (27:1-11's
halt — the hard matter; 27:12-23 the callee's own ink), journeys CALL (33:38's verbal analogy and the era's new year; the stations; Moses' seventh
of Adar), borders CALL (the nine and a half; the promised extents at 1:7; the relay form), second_census CALL (the rolls' exceptions; the Urim's
judgment; the age edges), balak CALL (the last camp 22:1 for 3:29; judges_count 78,600; midian_not_moab; Peor's valley), primeval CALL (Genesis
14:5 the Rephaim and the Emim; 15:16 the Amorite's iniquity; 15:18 the land), mamre CALL (Genesis 19:37-38 Moab and Ammon named), joseph CALL
(Genesis 36:8 Esau in Seir; 36:20 the Horites), ordinances CALL (23:3, 6-8 the courts' clauses; 23:31 the border), holiness CALL (19:15 no faces
and the five effects), erection CALL (33:1's departure from Horeb; the nations' seven orders; Avot 1:1's chain), bamidbar CALL (the census total;
the camp's order), beha CALL (10:11's march; the seventy; Hobab), refuge CALL (the six cities — 4:41 forward; the eastern three inside 3:12-17's
land), korach by REFERENCE (16:3's "enough for you" — the token's seat; no cell), pesach by REFERENCE (13:21's pillar at 1:33 — the exodus story's
by_day ask), and every demand the census makes past the imports read on the DB and declared (CALL / VIA / FALSE / PARAMETER / INTERNAL /
RUN_CITATION), never a blanket row; Deuteronomy 4:41-43, 20:16-17, 34:1-4, Joshua 1, 22 FORWARD or outside — no link of our own.
(i) THE DOCKET by the union rule — 864 rows in TEN parts A-J on disk (Sanhedrin 23a-31b the court's chapter WHOLE, the sizing 466 kept on file;
2a-2b, 32a-32b, 6b-7a, 16b-17a, 90b-91a; Rosh Hashanah 2b-3a; Sotah 34a-35a; Berakhot 30a; Makkot 9b-10a; the Mishnah rows; the link rows), LAW /
DERIVATION / DISPUTE / CONTEXT / OUTSIDE, the crowns expected — Sanhedrin 7b:14-8a:6 the charge read clause by clause; 6b:1-12 the compromise
and the refusal before hearing; 2a-2b the twenty-three and 16b-17a the seventy-one from Moses' seventy; 32a-32b money against capital; 23a-31b
the litigants' choice, the disqualified (the kin, the haters, the dice-players), the examination, the verdict announced, the new proof; Rosh
Hashanah 2b:9-3a:12 the date's chain (Aaron's death, Sihon, Arad, the erection — the era's new year Nisan); Sotah 34b:3-4 the spies' asking
("send for yourself" and "that they may search"); Taanit 30b:12 and Bava Batra 121b:1 the fifteenth of Av — the dying ceased, the speech
resumed (2:16-17); Bava Kamma 38a:16-38b:6 Moab and Ammon; Kiddushin 18a:2 Esau's inheritance; Chullin 60b:11-14 the verses fit to be burned
(the Avvim, Heshbon, Hermon's names); Avodah Zarah 25a:7-9 and Taanit 20a:6-8 the sun for Moses; Berakhot 32a:7 and Sanhedrin 102a:14 Di-zahab;
Berakhot 32a:32 praise before prayer; Sotah 13b:13 rav lakh; Kiddushin 29a:14 "command" galvanizes; Arakhin 32b:6, Megillah 10a:10, Shevuot 16a:14
the sixty walled cities of Argob; Sanhedrin 90b-91a the Rephaim; Makkot 9b-10a the eastern refuge cities; Kelim 17:9-10 and Eruvin 4:8 the cubit
of a man; Berakhot 4:5-6 and 30a the direction of prayer; Shevuot 47b:5 "you murmured" read as two words; Eruvin 100b:18 the generation's sons.
(j) THE DISPLAY LAYER — done at the reading (275 rows); the store's mixed families a display sitting's, filed unchanged.
(k) THE KIN PARSER READINGS FILED — the suffixed halves (Isaiah 44:16's "its half", Zechariah 14:4's, Nehemiah 4:10's) a class named, not read;
the myriad-word standing from 15b.
(l) THE TWO DISAGREEMENTS as OPEN rows ((R4)); the retellings' expansions (3:12-17's division of the east, 3:16-17's borders — the Arnon's middle,
the Jabbok, Chinnereth to the Salt Sea under Pisgah) as DATA the_easts_borders, no write (the holdings stand).

THE CELLS (eight, each returning out(verdict, effects); the INK block exec'd from the sequence file; the token probes zero-report; every seat list
and slice typed from deu_runner_measure.out): F0 the_commission (Numbers 27:12-23 — asks: the_mountain (Abarim / Nebo / Pisgah — 34:1's one
mountain; the three names' seats), the_sentence_cited (27:14's Meribah — INTERNAL to 20:12; the barred entry read), the_shepherd (27:16-17 "the God
of the spirits of all flesh" — 16:22's phrase at its second seat; "go out and come in" the leader's idiom), the_hand_laid (27:18, 23 — "a man in
whom is spirit"; one hand commanded, two laid — the Sifrei Bamidbar 141 credited at THE TENT), the_honor (27:20 "some of your honor" — Bava Batra
75a:8 the sun and the moon: DATA), the_urim (27:21 by CALL to C2's row), the_receipt (27:22-23 — the debit's close), the_debit (see_the_land OPEN to
34:1-4)); F1 the_frame (1:1-5 — asks: the_words (the eleven places as the rebuke's sins — the Sifrei 1; Onkelos's thirty-three tokens for
twenty-two; Berakhot 32a:7 / Sanhedrin 102a:14 Di-zahab), the_date (1:3 by the NUMBER reader [40, 11, 1]; the two readers; the era's new year
by CALL), the_receipt_of_the_rules (1:3 "according to all" — the Sifrei 2:8; the register seat ACT), the_eleven_days (1:2 [11] — Kadesh-barnea
from Horeb; Menachot 65a:12), after_sihon (1:4 — Rosh Hashanah 2b:13 / 3a:12 the order), began_to_expound (1:5 — Sotah 35b:6; the Rambam), the_write
(torah_expounded)); F2 the_officers_and_the_judges (1:6-18 — asks: the_horeb_command (1:6-8 — the supplied debit and its close by 12:16; ER.presence
('horev_plene') by CALL: Horeb written plene at Exodus 33:6 alone), the_regions (1:7 — the seven; the Euphrates), the_burden (1:9-12 — 11:14's
"I alone" by CALL to BH.seventy_elders), the_blessing (1:11 [1000] — Moses' own; Rosh Hashanah 28b), the_qualities (the seven), the_grains (1:15
— the four; the table), the_count (78,600 / 79,064), the_officers (the strap), the_charge (1:16-17 — (d)'s asks each), all_the_things (1:18 —
Sanhedrin 8a:6 the community warned)); F3 the_spies_read_back (1:19-46 — asks: the_asking (1:22 — the people's; Sotah 34b:3-4 against "send for
yourself"), the_twelve (1:23 [12, 1] — one per tribe by CALL), the_valley (1:24 Eshcol — the spy-verb piel against the tour-verb), good_is_the_land
(1:25 — Joshua and Caleb's, 14:7; the Sifrei 23:3), the_murmuring (1:27 — Shevuot 47b:5's two words; 1:28 the Anakim, the cities fortified to
heaven — the Sifrei 25:4's hyperbole), the_carrying (1:31 — the eagle 314:2; Exodus 19:4), the_pillar (1:33 — Exodus 13:21 by REFERENCE),
the_oath (1:34-36 — sentence_pronounced read; Caleb's holding_owed OPEN read; "he wholly followed" Joshua 14:14 outside), the_bars_ground (1:37 —
DISAGREES), joshua_shall_go_in (1:38 — "he shall cause Israel to inherit": the effect's first seat, Joshua's; the second at 3:28), the_little_ones
(1:39 VERBATIM = 14:31; "good and evil" Eden's four seats), the_turn_back (1:40 — 14:25 by CALL; the debit closed at 21:4 read), the_presumption
(1:41-44 — the receipt in the people's mouth (R5); "as bees do"; Hormah "in Seir"), the_weeping (1:45 — 14:1's wept read; "did not hear" 1:45 and
3:26 one phrase), many_days_at_kadesh (1:46 — Seder Olam 8: nineteen years, DATA), the_readback_table (the rows of 1:19-46 graded)); F4 the_bypass
(2:1-25 — asks: the_turn (2:1-3 — "many days" round Seir; "enough" plural; the supplied turn_northward and its close), esau (2:4-8 — the bar, the
grant, the purchase; Kiddushin 18a; Bava Kamma 38a), forty_years_lacking_nothing (2:7 [40] — the manna by CALL to ES.manna('forty_years')),
the_route (2:8 — Elath, Ezion-geber, the way of Moab's wilderness against 21:4's Red Sea way; Onkelos), moab (2:9 — the bar, Ar), the_emim
(2:10-12 — the Rephaim of Genesis 14:5 by CALL; the Horites of Genesis 36:20 by CALL; "as Israel did to the land of his possession" — the
dispossessions DATA), the_zered (2:13-14 — the supplied crossing; [38] against the tape's years: the spies' return marker (2, 5, 9) to the
counter's (40, 6, 1) = 38 by the era's year — computed), the_men_of_war_consumed (2:14-16 — the carcasses timer fired at (40, 5, 9) read;
deaths_ceased (40, 5, 15) by CALL to SL.DATA; Taanit 30b / Bava Batra 121b), the_speech_resumed (2:17 — "and the LORD SPOKE to me": the Bible's one
seat; Bava Batra 121b:1 — only after the last of that generation), ammon (2:17-19 — the bar, the grant; the Zamzummim; the Avvim and the Caphtorim
2:20-23 — Chullin 60b:11; Genesis 10:14 by CALL), sihon_commanded (2:24-25 — the supplied debit and its close by 21:24-25; the dread — the sun for
Moses)); F5 sihon_and_og (2:26-3:11 — asks: the_messengers (2:26-29 SHORTENED against 21:21-22 — nine tokens for seventeen: "by the road, by the
road"; Kedemoth; "words of peace" — the Sifrei 199:5 credited), the_edom_disagreement (2:29 — (R4); CK.DATA['edom_passage'] by CALL), the_hardening
(2:30 — "hardened his spirit, made his heart obstinate": Pharaoh's verbs by REFERENCE to the exodus story's hardening_seats), jahaz (2:32
SHORTENED against 21:23 — eight for twenty), the_written_and_read (2:33 — the store's twelve tokens against the DB's eleven: "his son" written,
"his sons" read; Onkelos plural), the_ban (2:34-35, 3:6-7 — the supplied acts; the cherem law FORWARD), aroer_to_gilead (2:36-37 — the border
respected; Ammon's border by CALL), og_turned (3:1-3 TURNED = 21:33-35 — the diff by the tokens; CK.well_and_kings('deut3_delta') by CALL),
the_sixty_cities (3:4-5 [60] — Argob; Arakhin 32b:6 / Megillah 10a:10 / Shevuot 16a:14 the walled cities from Joshua's days; 1 Kings 4:13;
1 Chronicles 2:23), ogs_bed (3:11 [9, 4] — "by the cubit of a man"; Kelim 17:9-10, Eruvin 4:8; the remnant of the Rephaim — Sanhedrin 90b-91a?; the
outside row 52:1), hermon (3:8-9 [2] — Sirion, Senir; Chullin 60b:14; Song 4:8)); F6 the_east_and_the_charges (3:12-22 — asks: the_division
(3:12-13 EXPANDED against 32:33 — half Gilead to Reuben and Gad, the rest and Bashan to half Manasseh: the holdings read; the fraction read [1/2],
[1/2]), jair (3:14 EXPANDED against 32:41; "to this day"), machir (3:15 = 32:40), the_borders (3:16-17 — DATA the_easts_borders), the_charge_to_the_tribes
(3:18-20 — the condition's debit OPEN read; "until the LORD gives rest" = Joshua 1:15 outside; the release 22:4; "armed" 3:18 = 32:30, 32 the three
seats), joshuas_charge (3:21-22 — the supplied fear_not_promised; "your eyes have seen"; Joshua 23:3, 10)); F7 the_plea (3:23-29 — asks: the_plea
(3:23-25 — the supplied plea_made with the refusal; the ten names; praise first), the_names (3:24 — "O LORD God" Abraham's two seats and Moses'
two; "your greatness" the Sifrei 27:4's binyan av; "your strong hand" Solomon's 1 Kings 8:42), lebanon (3:25 — the Temple at 3:25 and 1:7's Lebanon:
the Sifrei 6:2, 28:3; Gittin 56b:1; Onkelos), the_refusal (3:26 — "was wroth" three Bible seats; "enough for you" singular; Sotah 13b:13), pisgah
(3:27 — the four directions in three orders DATA; the see_the_land debit OPEN read — 27:12's, READ BACK), command_joshua (3:28 — the commission
READ BACK; Kiddushin 29a:14; "he shall cause them to inherit" the effect's second seat), beth_peor (3:29 — the last camp by CALL to BK.the_call
('last_camp'); 4:46 and 34:6 the valley's other seats — Moses' grave)).

THE DATA ROWS (twenty-four): the_readback (the table of (R1) — every retold act's row), the_officers_table (the four grains; 78,600 / 79,064 with
the rounding rule), the_seven_qualities, the_judges_charge (the six clauses with the exam's rows), the_compromise (the two verdict tables),
the_gentile_litigant (the Sifrei 16:4), the_frame (the places as the rebuke; the king's reading), the_date (the two readers; the era's chain),
the_horeb_command (the seven regions), the_spies_asked (Sotah 34b — the two tellings reconciled on the shelf), the_bars_ground (1:37 DISAGREES),
the_dispossessions (the Emim, the Horites, the Zamzummim, the Avvim by the Caphtorim), the_bypass_commands (Esau, Moab, Ammon — the three bars
with their teachers), the_thirty_eight (2:14 against the tape's years; deaths_ceased), the_edom_disagreement (2:29 — the chukat row by CALL),
the_ban (2:34, 3:6; Deuteronomy 20 FORWARD), the_sixty_cities (3:4-5), ogs_bed (the cubit of a man), the_easts_borders (3:16-17), the_armed_passage
(3:18-20; Joshua 1:15; 22:4), joshuas_charge (3:21-22, 28; 27:18-23; Joshua 1:6; Ai), the_plea (the ten names; praise before prayer; the directions
of prayer), the_four_directions (3:27, Genesis 13:14, 28:14), the_commission (27:12-23 — the mountain's three names, the Urim, the honor).

THE DAEMON law_opening_speech (given_at Deut 1:16; installed_by BOOT with the class NAMED — a law in Moses' voice with no divine frame, the
vows' class): watches speech_opened → [torah_expounded]; horeb_departure_commanded → [commanded]; judges_charged → [judges_charged];
turn_northward_commanded → [commanded, contending_barred, land_granted]; moab_spared_commanded → [contending_barred, land_granted];
zered_crossing_commanded → [commanded]; ammon_spared_commanded → [contending_barred, land_granted]; sihon_war_commanded → [commanded];
sihons_cities_devoted → [destroyed]; ogs_cities_devoted → [destroyed]; joshua_encouraged → [fear_not_promised]; moses_besought → [plea_made];
moses_told_to_ascend_abarim → [commanded]; a_shepherd_asked → [plea_made]; joshua_commission_commanded → [commanded]; joshua_commissioned →
[invested_office]; judges_case → [accepted, exempt, judgment_perverted]; speech_case → [accepted, exempt]. THE FOUR CLOSES BY A PRIOR RUN and the
commission's close by its run inside the daemon's own branches (world.close with the closer's verse — the vows' cancel-and-close form, the
recorder never records a daemon's close as a tape line); literal W dicts per kind; the two case kinds dispatching to the cells by name; NO timer;
the markers the stitcher's rows (a).

THE TYPES (add_types_deu.py): SIXTEEN tape kinds — the four of Numbers 27:12-23 (moses_told_to_ascend_abarim, a_shepherd_asked,
joshua_commission_commanded — speech; joshua_commissioned — act) and the twelve of the speech (speech_opened, horeb_departure_commanded,
...
joshua_encouraged, moses_besought — speech; sihons_cities_devoted, ogs_cities_devoted — act) with their witnesses in their verses; TWO case kinds
(judges_case, speech_case); THREE new effects — judges_charged (status on the court; the six clauses cut from 1:16-17), torah_expounded (status on
Israel; 1:5 "Moses undertook to expound this Torah"), contending_barred (block on a people; 2:5 "do not contend with them", 2:9 "do not harass
Moab nor contend with them", 2:19); the effects reused — commanded, plea_made, invested_office, fear_not_promised, destroyed, land_granted,
accepted, exempt, judgment_perverted; ONE registry row — the_sons_of_ammon (people; Genesis 19:38; Deuteronomy 2:19, 2:37; Judges 11; the
Moabites' form) — 338 → 339; the daemon block; the functions block opening_speech (the_commission … the_plea WRAPPED); the span in two books; the
edges of (h) by CALL with their link; the pointers after the gate's print; I5 62 → 63.

THE TAPE (sixteen lines): FOUR under "# ---- Num 27 ----" after the daughters' four (page_order at (40, 6, 1)): moses_told_to_ascend_abarim,
a_shepherd_asked, joshua_commission_commanded, joshua_commissioned; TWELVE under "# ---- Deut 1 / 2 / 3 ----" after the FORWARD marker at Deut 1:1
(the numbers 1:3's): speech_opened (1:1-5, text_constrained at the marker's verse); the RETROGRADE marker at 1:6 then horeb_departure_commanded
(1:6-8, dated (2, 2, 20)); the RETROGRADE marker at 1:9 then judges_charged (1:16-18, dated (1, 2, 16)); the RETROGRADE marker at 2:2 then
turn_northward_commanded (2:2-7), moab_spared_commanded (2:9), zered_crossing_commanded (2:13), ammon_spared_commanded (2:17-19), sihon_war_commanded
(2:24-25), sihons_cities_devoted (2:34-35), ogs_cities_devoted (3:6-7), joshua_encouraged (3:21-22), moses_besought (3:23-26) — every one dated
(40, 6, 1). The markers 157 → 161 (forward 126, retrograde 15 → 18, proleptic unmoved); the tape's closes 121 → 126 (the commission's by its run;
the four by a prior run).

THE CHECKPOINTS CA1-CA9 (the prefix measured free):
CA1 THE LINES — sixteen events of the sitting's kinds on the tape in the ink's order: the four of Num 27:12-23 page_order at (40, 6, 1) after the
daughters' and before Num 28; the twelve of Deuteronomy after the tape's last Numbers line; the marker at Deut 1:1 text_constrained at day
(40, 11, 1) = the counter's end; the three retrograde markers at 1:6, 1:9, 2:2 with their stated days (2, 2, 20), (1, 2, 16), (40, 6, 1); the
speech line's placement text_constrained, the eleven supplied lines' reading_placed (the stretch's class); the counter ends at (40, 11, 1).
CA2 THE ONE CLOCK — day_in(40, 11, 1) − day_in(40, 5, 1) = the six months between Aaron's death and the speech by the Calendar (computed, the
number typed from the prediction's print); the era's year at the speech's marker 40 = 33:38's year; the spies' return (2, 5, 9) to the Zered's
line (40, 6, 1) = 38 years by the era's year (2:14's [38] by the parser); the eleven days of 1:2 [11].
CA3 THE TIMERS CROSSED — TIMER-FIRE 52 → 88 (the thirty-six measured), TIMER-SET 66 → 96 (the thirty re-arms), the fires' writes thirty-six;
pending timers 8 after the marker's walk with the dues (40, 11, 8), (40, 12, 1), (41, 1, 15), (41, 3, 6), (41, 7, 1), (41, 7, 10), (41, 7, 15),
(41, 7, 22); no fire after the last Deuteronomy line (the retrograde stretches move no clock).
CA4 THE READBACK — the_readback's rows n, every row's tape entry FOUND on the running world by kind and first verse (n = n computed); the grades'
census (VERBATIM / TURNED / SHORTENED / EXPANDED / SUPPLIED / DISAGREES) typed from the runner's own print; the two DISAGREES rows open.
CA5 THE OATH READ BACK — sentence_pronounced on Israel ONE (14:26-35), the carcasses timer FIRED at (40, 5, 9) ONE fire line, Caleb's holding_owed
ONE OPEN, put_to_death on the ten spies ONE, defeated at Hormah ONE, presumed_to_go_up ONE, the turn-back's debit ONE CLOSED with the closer's note
beginning "Num 21:4", courts_established on Israel ONE valued ([1000, 100, 50, 10], 78600) at (1, 2, 16), hard_cases_to_moses ONE.
CA6 THE EAST READ BACK — holding_given on the sons of Gad, the sons of Reuben and the half tribe of Manasseh ONE each (32:33), the sons of Machir's
and Jair's land_possessed, the condition's debit on the sons of Gad and Reuben ONE OPEN, the dividers' debit ONE OPEN, Sihon's refused and
kings_smitten, Og's kings_smitten, Edom's refused TWO — and the two DISAGREES rows read as OPEN, no entry written for either.
CA7 THE JUDGES — judges_charged on the court ONE, dated (1, 2, 16) — the same day as courts_established's (read off the ledger), its source
beginning "Deut 1:16"; the court's in_force judges_appointed standing; law_opening_speech registered with given_at Deut 1:16; the register seat
Deut 4:45 DAEMONS by CALL.
CA8 THE COMMISSION AND THE PLEA — invested_office on yehoshua ONE (27:22-23) with the commission debit on Moses ONE CLOSED (closed_by beginning
"Num 27:22"); see_the_land_from_abarim on Moses ONE OPEN; plea_made on Moses TWO new (27:15-17; 3:23-26) with the refusal in the second's value;
barred_from_the_land on Moses ONE OPEN unmoved; fear_not_promised on yehoshua ONE (3:21-22); the three contending_barred (edom, the-moabites,
the-sons-of-ammon) and the three land_granted; destroyed on the-amorite TWO; the four supplied debits on Israel each CLOSED with closed_by
beginning "Num 12:16", "Num 21:10-13", "Num 21:12", "Num 21:24-25"; torah_expounded on Israel ONE dated (40, 11, 1).
CA9 THE REST — entities 318 → 319 (the sons of Ammon the one new written-on party), closes 121 → 126, the population table 148 UNMOVED (no
register), the sixteen kinds present, the other counts 15b's exactly with the sitting's lines and markers dropped (THE REST test — the marker
regex taught Deuteronomy).
CV2, CX2, CW3, CR3 RETYPED AS OF this sitting (commanded on Israel 14 → 18 — the four supplied debits, the newest begin_to_possess_sihons_land, open
7 UNMOVED — each closed by a prior run; timers set 66 → 96; closes 121 → 126); CT2 RETYPED (the pending musaf dues as of the speech's day — the eight
above); CT9, CV9, CX9, CY9, CZ9, CW9, CR9 RETYPED (entities 318 → 319, closes 121 → 126) — every retype noted AS OF this sitting.

THE PREDICTION'S ARITHMETIC: RUN = (1295, 96, 88, 0, 12, 1584, 34, 319, the four pairs, 126) — events +16 (the sixteen lines), timers set +30 (the
re-arms), fired +36 (the crossing), cancels 0, retro-writes 12 UNMOVED (a RETRO-WRITE is a past due's write, not a retrograde stretch's — measured
in the engine), writes +57 (the thirty-six fires' + Numbers 27's four + the speech's seventeen), daemons fired +1 (law_opening_speech), entities
+1 (the sons of Ammon), closes +5; PREVIOUS_RUN = 15b's RUN exactly — THE REST drops the sixteen lines by the runner's tag and the four markers by
the span (the regex taught the fifth book) and reproduces (1279, 66, 52, 0, 12, 1527, 33, 318, the four pairs, 121); NEWEST_RUNNER
'opening_speech'; PLACEMENT markers text_constrained 102 → 103, reading_placed 40 → 43; events text_constrained 106 → 107 (the speech line at the
marker's verse), page_order 1133 → 1137 (Numbers 27's four), reading_placed 40 → 51 (the eleven supplied lines) — read at the stitcher's print;
CENSUS typed from the stitcher's print (on tape 1279 → 1295, history +16, kinds 824 → 840, subjects 270 → +? — israel, moses, the court, edom,
the-moabites, the-sons-of-ammon, the-amorite, yehoshua: read from the print); the population table 148 UNMOVED; the scene's tuple PREDICTED BY
SCRIPT at the runner step (the exam's persons through judges_case and speech_case); the narrative's (16 events, 21 writes, 5 closes, the
entities — israel, moses, the-court, edom, the-moabites, the-sons-of-ammon, the-amorite, yehoshua = 8 — the written-on parties).

THE PROBES: census_probes.py D10-D18 written to FAIL on the parser 15b left (nine FAIL measured — the reads printed beside the ink's) and R74-R80
the regressions (seven PASS before and after); after rule 30, 222/222; the corpus diff old against new over every verse of the Tanakh read verse
by verse — fourteen Torah tokens in thirteen verses predicted to move, ONE a marker (Exodus 12:29 — the stitcher's row and the tape's assert_ink
retyped to [1/2]); readback_probes.py Q1-Q6 written to FAIL before the runner (Q1 the runner and its DATA table the_readback exist with the six
grades; Q2 every row's entry found on a fresh tape world; Q3 a supplied debit closed by a prior run — the closer's verse earlier on the tape than
the line's; Q4 the supplied lines dated by the retrograde stretch — event['dated'] set, the day the marker's stated; Q5 the two DISAGREES rows open,
no ledger entry for either; Q6 the register seats' classes on the new tape — 1:3 ACT, 1:19 NONE, 1:41 NONE, 4:45 DAEMONS, Num 27:22 CLOSE), 6/6
after; register_probes rerun at the gates step.

THE ORDER: the design (this section) → the probes to FAIL (D10-D18; Q1-Q6) → the state doc's checkpoint #183 → THE PARSER TAUGHT (rule 30 in the
INK block) → census_probes 222/222 → the corpus diff read → the seven runners and the Exodus 12:29 row retyped from the prints → the docket by the
union rule (ten parts, the writer with coverage computed, the cite index) → the types by script (add_types_deu.py) → the recorder and the stitcher
taught the fifth book (the source class, the book order, the range regex, the headers, SPAN_ORDER + 'opening_speech', the marker rows — Deut 1:3 F
at 1:1, the three R, Exodus 12:29's numbers; THE REST's regex) → the gates to FAIL (daemon, dependency) → the runner (deu_part1-4.py assembled by
cat; the honest-pairing guard; zero-report probes; the scene and the narrative predicted by script; CASES literal) → the recorder → the stitcher →
the literals, CA1-CA9 and the retypes (patch_seq_literals_deu.py) → the tape run (10/10 with THE REST) → the probe gates (census 222, installation
I5 63, clock, sequence, view, population, journal, cursor after the base regenerates, register_probes, readback 6/6) → the daemon and dependency
gates GREEN → the journal gate → THE REGISTER GATE --strict (Deut 4:45 and Num 27:22 deleted; 1:3 reclassed ACT; 1:1, 1:19, 1:41 refreshed) →
checkpoint_positions.py in the background (the block gained CA1-CA9) → the sweep in the background (the seven retypes inside it) → the records
(this file's AS BUILT, COMPILE_DEBT's Deuteronomy sitting-1 box PAID + the 1b box, MOVE_CATALOG (the AL TIKREI), MIDDOT's docket entries,
MISHNAH_TOPICS (Sanhedrin 1, 3, 4; Avot 1; Sheviit 9; Rosh Hashanah 1; Sotah 7; Berakhot 4; Makkot 2; Kelim 17; Eruvin 4 marked), RESEARCH_LOG,
THE_STEPS, THE_BRIEFING, THE_LOOP.md's step 6 row (the first form built), RESUME, memory, the state doc's checkpoint at the close, the recovery
file's section 32).


## Sitting 1b — AS BUILT (2026-09-15/16; the owner: "Go 1b right", "Yes 1. Go"; run in THE ORDER above, the departures from the design named)

THE ORDER HELD: the design → the probes to FAIL (census D10-D18 nine FAIL as predicted; readback Q1-Q6 0/6) → the state doc's #183 → rule (30) THE
HALF OF A NAMED WHOLE taught in the INK block (the _HALF regex beside _DUAL; verse_words' hataf-patach test under the het excluding "my arrows" at
32:23, 32:42 — the diff's find; ink_numbers' prefix reduction to the bare half-word before FRACTIONS) → census_probes 224/224 after the seven runners
were retyped from the sweep's print one tripwire at a time (midian's RATES/MARKED, gad_reuben's INTS/MARKED/RETOLD, borders' INTS/KIN, refuge's
JOSH21_LOTS — each `Fraction(1, 2)` typed, the fractions import added where missing) and R11 (Exodus 12:29) and R17 (Numbers 32:33) retyped from []
to [1/2] BY DESIGN → the corpus diff read verse by verse (deu_parser_diff.py: fifteen Torah tokens in fourteen verses moved, sixty-nine outside,
MARKED ONLY five) → THE DOCKET by the union rule: 864 rows in EIGHT parts A-H (the design said ten; the hand cut 115-row chunks — deu_docket_rows.py
the reading instrument), write_deu_docket.py the writer with the coverage computed — logic/oral_triage/deu_01_03_devarim_exam_2026-09-15.md:
LAW 83 (F2 67, F5 1, F6 2, F7 2) / DERIVATION 93 / DISPUTE 29 / CONTEXT 631 / OUTSIDE 28 (chapter 4's refuge verses at Makkot 10a:14-16 and the prayer
tractate's rows that touch nothing of 1-3), credited 250, the ten ranges read WHOLE (Sanhedrin 23a-31b 466), the twenty-nine Mishnah rows (Sotah 7:8 a
link row), sixteen crowns → THE TYPES (add_types_deu.py: 18 kinds → 1113, 3 effects → 1015, the_sons_of_ammon → 339, law_opening_speech the 63rd,
the functions block, the span in two books, 18 CALL edges + the registration, I5 63) → the recorder and the stitcher taught the fifth book (the scratch
copies: the source class, BO/RANGE/BOOK/headers, SPAN_ORDER, the four marker rows, Exodus 12:29's [1/2]; the ROOT by git rev-parse — the forms' three-dirs-up
form fits the repo's copies alone; the INK namespace must carry _ROOT) → the daemon gate FAIL (no def) and the dependency gate FAIL (18 CALL edges
with no import) → THE RUNNER cold_run_opening_speech.py (deu_part1, 2a, 2b, 3, 4 assembled by cat; 1,343 lines; the guard 97; 164 token probes; the
CASES generated as LITERALS from the cells' own asks by a script — no row mistyped; the scene 33 persons and the narrative's tuple PREDICTED by hand
before the first run and HELD: (20, 0, 8, (11, 1), 5, 0, 0, 11)) → 97/97 on the second run (the first fell on a probe token; a FAST CHECKER
(deu_fastcheck.py) then ran parts 1 and 2a in seconds without the four-minute import cycle: four probe tokens and eleven typed lists retyped from ITS
print — the spy-root 24 not 7, 14:31's thirteen tokens, Jahaz's four shared, Og's 57/55/35, the division's 37/28, Beth-peor's two seats, Micaiah's
sheep without a shepherd (1 Kings 22:17), the receipt "and Moses did as the LORD commanded him" at THREE seats (Leviticus 8:4, Numbers 17:26, 27:22),
Joshua 17:4's "before Eleazar" — the daughters' payment before the same priest) → the daemon gate demanded LITERAL submits (the scene's loop unrolled
to thirty-three lines) → GREEN → the dependency gate demanded four token edges (lev24 'under', offerings 'go up', pre_sinai 'you have dwelt', sanctions
'king' — each FALSE by sense with its why) and SEVENTEEN receipt pointers (Deut 1:11, 1:19, 1:21, 1:31, 1:44, 2:1, 2:12, 2:14, 2:16, 2:22, 2:29, 3:2,
3:6; Num 27:13, 27:14, 27:22, 27:23 — RUN_CITATION six, INTERNAL four, CALL two (chukat — the passage's DISPUTE row; Meribah's sentence), False five
(promise clauses, similes, the temporal "when")) → GREEN → the recorder (58 modules; opening_speech 16 HISTORY + 33 case) → the stitcher (markers 161:
F 126 / P 15 / R 20; PLACEMENT exactly as predicted; CENSUS (2434, 1304, 1295, 1114, 6, 10, 9, 0, 71, 161, 126, 15, 20, 840, 272)) →
patch_seq_literals_deu.py (the import, DAEMON_ORDER, RUN, PREVIOUS_RUN, NEWEST_RUNNER, PLACEMENT, VERDICTS CA, CENSUS, the two verse regexes taught
Deut, the retypes, CA1-CA9) → THE TAPE 10/10 on the FOURTH run (the three misses read, each a retype from the print — below) → the probe gates
(census 224/224, installation 6/6 with I5 63, readback 6/6, register 7/7 after R6's tallies retyped, clock, sequence 4/4, view 6/6, population 9/9,
journal 7/7, cursor 6/6) → the daemon and dependency gates GREEN → build_world ALL GREEN → the journal gate RED once, then GREEN (below) → THE REGISTER
GATE --strict GREEN (DECLARED 100, DEBT 0, FAILS 0: Num 27:22 CLOSE green and Deut 4:45 DAEMONS green — their declarations deleted; Deut 1:3 ACT declared;
Deut 1:19 and 1:41 CHAPTER declared; Deut 1:1 EMPTY refreshed) → checkpoint_positions and the sweep in the background → the records.

THE PREDICTION AND THE RUN: RUN = (1295, 96, 88, 0, 12, 1583, 34, 319, the four pairs, 126) — every count as predicted except the WRITES, recounted at
the runner step BEFORE the run: the design's arithmetic said seventeen writes for the speech's twelve lines, the daemon's watches sum to SIXTEEN
(1583, not 1584 — a counting slip in the design, caught by summing the watches, never by the run). PREVIOUS_RUN 15b's exactly; THE REST reproduces it
(the four markers dropped by the span in two books — the marker regex taught Deut). PLACEMENT markers 103 / 43, events 107 / 1137 / 51 exactly as
predicted. Entities 319; closes 126; the population 148 unmoved.

THE THREE TAPE RUNS THAT MISSED, each a retype from the print, none a retype of the design's claim about the text:
(1) CA3 compared the fires' dates through the exodus era — a pre-exodus fire has no exodus date (SystemExit): compared by DAY NUMBER (the second run).
(2) CA8 declared the register seats Deut 1:19 and 1:41 NONE; the gate's own class is CHAPTER — a receipt whose chapter holds a CLOSED entry (the Horeb
debit of 1:6-8, closed by the prior run): the receipts are run citations still (R5), the gate's word for them CHAPTER. CA8, readback Q6 and the
dispositions retyped and declared with the why. And the day-slot census: the stitcher stamped the plague line at Exodus 12:29 'night' (13 → 14) —
rule 30's fraction mark on "in the half of" (בחצי% — "at half of the night") broke the midnight phrase's second hit, leaving 'night' alone: slot_of
now strips the parser's marks before the match (the marks are the number parser's annotations, not the ink's words); restitched, 13 again (the third run).
(3) Four checkpoints the clock's walk moved, none in the design's retype list: CP6 (markers 157 → 161, F 125 → 126), CT4 and CT6 (the eight period
timers re-armed in the engine's list order — read in DUE ORDER now, where the eight stand in the ink's order again; the dues compared as sets), CX6
(the six purification timers of Numbers 31 FIRED on the walk — the third day (40, 6, 4) ×2, the seventh (40, 6, 8) ×4 — pending 0; the men of war and
the captives purified before the speech). CT2 was retyped as designed (the dues as of (40, 11, 1), in due order). CX2 needed no retype (its tuple carries
the open count alone — seven, unmoved). The fourth run 10/10.

THE JOURNAL GATE RED ONCE: the run_timers view (World/journal/run_views.sql) joined a timer's set row to every fire of the same subject and effect on
the due day — and the walk was the first stretch where two period timers of ONE effect fell on ONE day: the month's musaf and Rosh Hashanah's at
(40, 7, 1), the month's and the Sabbath's at (40, 11, 1), the speech's marker day. Timers 100 for sets 96, fired 92 for fires 88. THE FIX in the view:
the fire and cancel joins keyed on the timer's VALUE too (json '$.value', null-safe IS). Reindexed (35,091 rows, eleven segments), the gate GREEN;
cursor K5 (the views gate over the whole index) GREEN with it.

THE READBACK'S FIRST FORM, BUILT: DATA the_readback — FORTY-TWO reference rows (EXPANDED 12, SUPPLIED 11, TURNED 10, SHORTENED 6, DISAGREES 2,
VERBATIM 1), every retold act's tape kind and first verse named, every one FOUND on the running world (CA4, Q2: 42 = 42); the deltas recomputed
from the DB (1:39's shared prefix 5; 2:27 nine for seventeen, four shared; 2:32 eight for twenty, four shared; 3:1-3 fifty-seven for fifty-five,
thirty-five shared, the five pronoun shifts; 3:14 twenty-three for eleven; 3:12-13 thirty-seven for twenty-eight); the eleven SUPPLIED acts written
once at their own time by the three retrograde markers (Q4: 12 Deuteronomy lines, 11 dated, the stated days (1, 2, 16), (2, 2, 20), (40, 6, 1)); the
four supplied debits CLOSED AT ONCE BY A PRIOR RUN inside the daemon (Q3: the closer's line earlier on the tape than the opener's — Num 12:16; 21:10-13
twice (the Zered's camp inside the four camps' line, the closer's first verse a tape position); 21:24-25) — THE ENGINE WRITES A DAEMON'S EFFECTS AFTER IT
RETURNS, so the daemon writes the one-block debit itself, stamped as the engine would (the event's date, the writer), and closes it before returning:
_closed_by_prior_run, the recorder never recording a daemon's close; the two DISAGREES rows OPEN (Q5: 1:37 the bar's ground, 2:29 Edom — no ledger
entry cites either verse); the receipts run citations (1:19, 1:41 — CHAPTER at the gate); the frame the book's one act of its own day (torah_expounded
on Israel at (40, 11, 1), the marker at the tape position Deut 1:1 wearing text_constrained). The laws' half (the readback from chapter 5 on) OWED to
its own sitting — THE_LOOP.md's step 6 row says so.

THE JUDGES' CHARGE IS THE LAW: judges_charged on the court, the six clauses, dated (1, 2, 16) by the marker at 1:9 reading courts_established's own day
off Israel's ledger (the bare prediction world's fallback typed, never reached on the tape — CA7: the two days equal); law_opening_speech given_at
Deut 1:16, installed_by boot with the class NAMED (a law in Moses' voice with no divine frame — the vows' class; the second pass's D2 question), the
footer Deut 4:45 DAEMONS. THE COMMISSION as the callee: the four lines page_order at (40, 6, 1) after the daughters' statute and before Numbers 28
(CA1); see_the_land_from_abarim on Moses OPEN to Deuteronomy 34:1-4; the commission's debit CLOSED BY ITS RUN inside the daemon — the register seat
Num 27:22 CLOSE (CA8). THE ONE CLOCK: (40, 11, 1) − (40, 5, 1) = 177 days; the era's year 40 = 33:38's; the spies' return to the departure from Mount
Hor 38 years = 2:14's [38] (CA2); the walk fired thirty-six and re-armed thirty (CA3), the pending eight at their new dues.

THE OFFICERS' TABLE: the four grains [1000, 100, 50, 10]; 78,600 on the round six hundred thousand (ES.jethro by CALL — Sanhedrin 18a) and 79,064 on
the exact 603,550 by INTEGER DIVISION at every grain (CB.census by CALL — the Sifrei 15:4's rounding rule integer division's own form); seven qualities
asked, three found. THE BARS: contending_barred (a BLOCK — the third new effect) and land_granted on Edom, the Moabites and the sons of Ammon (the one
new party); the two bans on the Amorite (destroyed twice — told only in the retelling); Joshua's promise (fear_not_promised at its second party); the
plea with its refusal in the value. THE PARSER'S FINDS on the shelf: the eleven-days verse; "the LORD SPOKE to me" the Bible's one seat (2:17); "at
that time" ten seats in the span, the retelling's own dating word with no number (the retrograde markers' warrant); the contend-root's four seats (three
bars, one command to war); "and we devoted" at 2:34 and 3:6 alone; Joshua plene at 3:21 alone in the Torah; the four directions in three orders.

THE RECORDS OF THE OTHER FILES: the exam docket (864); the types in the four registries; the dispositions (dependency: the span in two books, 22 edges,
17 pointers; register: the six seats brought current; daemon: the 63rd); the engine's one fix (the slot stamp's marks) and the journal's one fix (the
timers view) — two engine-side files changed this sitting, both recorded with the gates GREEN after; COMPILE_DEBT's sitting-1 box PAID and the 1b box
opened; MOVE_CATALOG's M-16 given the al tikrei of the Sifrei 13:6 as an exemplar; MIDDOT's docket entry; MISHNAH_TOPICS' eleven tractates marked;
RESEARCH_LOG; THE_STEPS; THE_BRIEFING; THE_LOOP.md's step 6 row; RESUME; the memory; the state doc's #184; the recovery file's section 32; the forms in
World/step9/forms_deuteronomy_walk/ (the compile's scripts and prints).

⚠ THE LESSONS OF 1b: (i) a fast checker over the runner's ink and census asserts (parts exec'd without the callee imports) saves the four-minute
import cycle per typo — build it before the first run; (ii) generate the CASES literals from the cells' own asks by script, then freeze them (a
mistyped expected string grades nothing); (iii) the daemon gate reads LITERAL submits only — unroll the scene's loop; (iv) the engine writes a
daemon's effects AFTER it returns: a one-block open-and-close is the daemon's own write, stamped as the engine would; (v) sum the daemon's watches
for the writes count — the design's prose miscounted; (vi) the counter's first long walk moves every checkpoint that reads the timers' list order or
their pending state (CP6, CT2, CT4, CT6, CX6) — read pending timers in due order, and grep the checkpoints for `pend` before predicting; (vii) a
parser mark is not a word: strip the marks before any word match (the slot stamp); (viii) the register gate's CHAPTER class covers a run citation
whose chapter holds a closed entry — predict the gate's class from its code, not from the reading's sense; (ix) two period timers of one effect on
one day break a join keyed on the day alone — key on the value; (x) the scratch forms compute ROOT by git rev-parse, and the INK namespace must
carry _ROOT; (xi) a probe's expected verse form must be a tape position (the Zered's closer 21:10-13, not 21:12); (xii) compare fires by day number,
not by an era's date — the tape's early fires predate the exodus.

NEXT on the ruling: chapter 4's reading (the refuge cities of 4:41-43 the docket's OUTSIDE rows and the refuge runner's open debit; Deuteronomy 4:45
the footer of the block this daemon sits in), then its compile; the laws' readback from chapter 5 on at its own sitting.

ADDENDUM AT THE CLOSE (2026-09-16): checkpoint_positions.py measured THE FALLS — 208 checkpoints over 163 pauses (199 + the nine CA rows; the last
fall at pause 162, Deut 3:23; the table checkpoint_positions.yaml); checkpoint_probes fell 3/7 first — its "whole world" was built by run_to('Deut
1:1'), a verse BEYOND the tape when the probe was written and a position ON it now (the speech's marker), so the whole world stopped at its left edge
and CA2's marker keys were missing: the probe's verse moved past the tape's new end (Deut 4:1), CA2 reads the departure's day from Num 21:4's own key
(set long before any Deuteronomy pause) rather than the retelling's alias set at 2:2 — 7/7. The tape rerun on the final bytes: 10/10. LESSON (xiii):
a probe's "beyond the tape" verse moves when the tape grows — name it past the book's last line, or compute it from the tape. The lint baselines at
the close: MOVE_CATALOG 5 (as committed — the eleventh exemplar adds none), census_probes 1 (a docstring line of the Numbers walk, not this sitting's),
the rest at their numbers.

THE LAST TWO GATES (2026-09-16, after the addendum): the sweep run_cold_all.py — 58/58 runners green, 6,475 graded cells in all (the new runner
cold_run_opening_speech.py 97/97 in 91 s; the daemon gate and the dependency gate satisfied inside it — 435 compiled functions WRAPPED, 0 OWED,
0 NONE; 63 daemons watching 1,113 kinds; 505 edge dispositions on file); then the journal gate alone, after the sweep's process had ended — GATE
GREEN (the fold layer's twelve kinds, 9,628 rows matching the header; the state hash pinned). The prints: the scratchpad's sweep_deu.out and
journal_gate_deu3.out (copied into forms_deuteronomy_walk/). SITTING 1b CLOSED. COMMITTED b8b721d (2026-09-16, on the owner's "Commit" — 139 files, sittings 1 and 1b; NOT PUSHED, the push waits on his word).
...
ON THE TABLE — NOT A RULING (2026-09-16, relayed by the peer thread "Claude old" as the owner's word there: "Let's talk to Claude new about this. He needs to rerun it in that thread"; the owner's word in THIS thread awaited before anything is built): THE DECALOGUE AS A SCHEMA OVER THE LAW — the peer measured on the shelf that the tradition files every law under one of the ten (Rashi on Exodus 24:12 with Rabbenu Saadia; the Mekhilta's tablets chapter — five and five, paired across; Makkot 23b:18-24a:3 — R. Simlai's 613 = 365 + 248, Rav Hamnuna's 611 + 2, then David's eleven, Isaiah's six, Micah's three, Isaiah's two, Habakkuk's one: five outlines over one list), that the two copies run 620 letters / 172 words (Exodus 20:2-17) against 708 / 189 (5:6-21), that the header-to-row key is TOPICAL not lexical (every header-to-row tie a TRANSFER with a teacher, never a reference the dependency census could demand), and HOW IT WAS MISSED (the Decalogue read exam-first on 2026-09-04; the Mekhilta's tablets chapter never opened; Makkot 24a:1 and Horayot 8a:21 standing as CREDITS — a passage about the LIST ITSELF is none of the docket's classes for any cell). WHAT IT ASKS, in the walk's form (design first, probes to fail, the gates): (1) Exodus 20 read spine-by-position on the Mekhilta with Rashi 24:12 by the pointer; (2) Makkot 23b:18-24a:3+ read as STRUCTURE — a new docket class for a passage about the list itself, never a credit; (3) a registry row per commandment (the ten as headers naming the law spans and cells under each, taught_by Saadia / the Mekhilta / Makkot — a taught partition, never inferred; 613 = 365 + 248 and the five outlines as a DATA row; a `header:` field on every daemon and a gate refusing a compiled law with no header; the tablets' pairing as the join). THE SEAT IN THE WALK, if ruled: chapter 5 is the Decalogue's second copy (the laws' readback opens there) — the natural sitting; the owner decides whether it runs before or after chapter 4's compile (2b).
...
UNMOVED; PLACEMENT markers {'text_constrained': 105, 'reading_placed': 45}, events {'text_constrained': 109, 'page_order': 1138, 'reading_placed': 53}; CENSUS (2458, 1309, 1300, 1133, 6, 10, 9, 0, 71, 165, 128, 15, 22, 845, 272); CC1-CC9 all MATCH; the run
15.7s. THE DOCKET logic/oral_triage/deu_04_vaetchanan_exam_2026-09-16.md by the union rule: 327 rows (link 68 / topic 259; CONTEXT 169, DERIVATION 70,
...
THE CLAIMS (write_ch5_manifest.py → one manifest, 6 claims DV05-01..06 — 5:1-5 the covenant at Horeb, 6-11 the first words, 12-15 the
...
asserted absent; every cite checked against the ledger's CITE INDEX and every name of the index used, asserted): verify_claims 6 VERIFIED /
...
from the cwd's git after a first run with an empty ROOT found the tools at "/logic/…"; the seat once, the chain rerun past it): 13 PASS — RITUAL
...
standing 2191 + 6 = 2197, hash unmoved — the tripwire's literals set to the prediction before the bake): CORPUS TRUTH GREEN — 219 units,
1809 facts, 341 demands (191 open), hash 8b8fff1fa28953af — the prediction matched; build_world ALL GREEN; the journal gate GREEN
(12 kinds, 9660 rows); the register gate --strict GREEN (DECLARED 100, DEBT 0, FAILS 0 — the chapter's three seats
...
LAYER: 58 rows by reference and 54 by gloss (by_ref 472, by_gloss 352 after). No engine file changed at this sitting — the sweep as at
2b's close. THE LEDGER: 38 sources — Onkelos MATERIAL 31 / CONTEXT 2, the Sifrei MATERIAL 5; 78,675 bytes; gloss_lint 0 on the
first write.
...
## Sitting 3b — THE COMPILE OF CHAPTER 5, Deuteronomy 5:1-33 (the design, 2026-09-16; the owner: "go" — taken on the walk's order, the schema sitting
## still ON THE TABLE; written after the rereads (THE_STEPS' compiler block and Step 5, the debt box, the 2b design and AS BUILT, the readback's
## (R1)-(R6)) and the measurements — ch5_compile_recon.py, ch5_docket_scan.py in the scratchpad — and BEFORE any code; the compile shape with
## "Sitting 2b" as the form)

THE MEASUREMENTS (what the tape, the runners and the gates say before a line is typed): THE COUNTER stands at (40, 11, 1); the tape's LAST MARKER is
the FORWARD one at Deut 4:25 (2b's stretch ENDED — lesson 2 checked: chapter 5 opens on the counter's own day, no opening marker needed), its last
line three_cities_set_apart (4:41-43). THE TEN WORDS' CELLS BY RUNNER (the recon's regex over every runner's ink references, per def — the laws'
readback grades code against code, so every word's cell was located FIRST): the FIRST word (5:6 / Exodus 20:2) NO CELL — a declaration, not a case;
the SECOND (5:7-10 / 20:3-6) NO CELL IN ANY RUNNER (the 2b box's debt; the no-image list obey_horeb's DATA row; the images-for-study rows 2b's);
the THIRD (5:11 / 20:7) decalogue.vain_name (the asks vain_oath, false_future_oath, vain_and_false_utterance — "spoken as one utterance, like
remember and observe"); the FOURTH (5:12-15 / 20:8-11) decalogue.sabbath_clauses (remember, labor_scope, causing, laden_beast), the creation ground
pre_sinai.sabbath (delta_20_11), the sign incense_shekel.sabbath; the FIFTH (5:16 / 20:12) NO CELL AT THE DECALOGUE'S SEAT ("the parents' honor
case-law lives outside this span's answer sheets" — the runner's own note) — its kin holiness.frame (honor_defined, fear_defined, parents_order,
three_partners: Leviticus 19:3), mishpatim_3.parent_striker / parent_curser (Exodus 21:15, 21:17), sanctions.curser (Leviticus 20:9); the SIXTH
(5:17 / 20:13) mishpatim_3.killer (21:12-14) and refuge.the_murderer (Numbers 35); the SEVENTH (5:18 / 20:14) sanctions.adultery (Leviticus 20:10);
the EIGHTH (5:19 / 20:15) decalogue.theft_commandment (kidnapper, money_theft_here); the NINTH (5:20 / 20:16) NO CELL AT THE DECALOGUE'S SEAT — its
kin ordinances.courts (false_report, witness_of_violence: Exodus 23:1); Deuteronomy 19:16-21 forward; the TENTH (5:21 / 20:17) NO CELL ANYWHERE.
So TWO WORDS ARE UNCOMPILED (the second, the tenth), two compiled at their kin's seats only (the fifth, the ninth), six at the Decalogue's or the
ordinances' — THE CODE'S HOLE the laws' readback finds, as the narrative's readback found the tape's hole at 2b. THE TAPE'S SECOND HOLE: EXODUS
20:18-21 HAS NO LINE (computed: no event's source in 20:18-22; 20:18 sits in NO runner's span — the decalogue's ends at 20:17, the ordinances' begins at
20:19 — and 20:19-26 are the ordinances' law cells; the tape runs from Exod 19:20 to 24:1): the people's request for a mediator, retold at 5:23-27, is
a SUPPLIED act; THE ANSWER (5:28-31 — "they have done well … would that they had such a heart … return to your tents … you stand here with me") is
TOLD ONLY IN THE RETELLING (Exodus 20:22's answer another speech; Deuteronomy 18:16-17 cites this one forward). THE COVENANT'S LINES ON THE TAPE:
covenant_offered (Exod 19:5-6), people_answered (19:8; 24:3 "with one voice: we will do"; 24:7 "we will do and we will hear" — the erection's W7
lines), the close to_be_taken_as_a_people at 19:8, people_sanctified (19:10-15 — the timer sanctified_for_the_third_day, the separation "do not
approach a woman"), thunder_and_horn and lord_descended (19:16-20), moses_went_up thrice, covenant_blood_thrown (24:8 — the installer of thirteen
daemons, law_decalogue among them), ten_words_declared (Deut 4:10-13, dated (1, 3, 7) — 2b's supplied line) and tablets_given (4:13, dated (1, 4, 17)).
THE REGISTER GATE'S CLASS PREDICTED FROM ITS CODE (lesson viii of 1b): a receipt is CLOSE when a closed entry's closer or source contains its verse,
ACT when a ledger write's source contains it, EVENT when an event's source contains it, CHAPTER when the chapter holds a closed entry (the gate's
chapter_of on the closer or the source), else NONE — this design writes NO line whose source holds 5:12, 5:16 or 5:32 (the second copy is no line —
R1) and ONE debit closed at once whose source is Deut 5:28-31: the three seats CHAPTER, declared with the why below; Deut 4:45 DAEMONS 2 UNMOVED (the
new daemon's seat Exodus 20:3 lies outside (Deut 1:1, Deut 4:45]; chapter 5 has no footer). THE CHECKPOINT PREFIX CI measured FREE (CI, CO, CQ, CU
free; none a label elsewhere). THE GLOBAL COUNTS grepped before the tape run: CP6 (markers 165 — MOVES: 165 → 167, F 128 → 129, R 22 → 23), CA1
(the Deuteronomy retrograde list gains ((1, 3, 7), 'Deut 5:23'), the forward list a fourth (40, 11, 1) at 5:32 — RETYPED as of this sitting), CC8 /
CC9 / CA9 (closes 126 → 127 — RETYPED: the charge's debit closed inside the daemon), CC9 (markers → 167), the pending timers UNMOVED (no clock walk),
entities 319 UNMOVED (Israel and Moses the written-on parties); I5 64 → 65; every fault shown at once by checkpoint_check.py before the tape.
THE DOCKET SIZED (ch5_docket_scan.py): 43 link rows in 16 works (Bava Kamma 8, Avodah Zarah 6, Sanhedrin 4, Yevamot 4, Chullin 3, Kiddushin 3, Shabbat
3 …) + 211 topic rows (Mishnah Shevuot 3:8-9; the nine ranges whole — Shabbat 88a 9 segments, Sanhedrin 17a 22 (1 a link row), Makkot 24a 33, Berakhot
12a 28, Kiddushin 30b-31b 51, Sanhedrin 86a 20, Bava Metzia 5b 20, Yoma 4b 14, Sotah 37b 13) = 254 rows, 86 credited (the Exodus Talmud triage 36, the
opening speech's docket 22, the covenant block 16, the Decalogue's block 5 …); THE DESIGN ADDS, under the union rule, the SECOND WORD'S OWN ANSWER SHEET
— Mishnah Sanhedrin 7:6 (the idolater's acts) and Sanhedrin 60b whole (the four services) — the debt's rows, read here where the debt is paid: FOUR
parts on disk. THE CITATIONS' TWO DIVISIONS (the scan's finding): the shelf's English cites chapter 5 by TWO numberings — Sanhedrin 17a:12 cites 5:19
for "did not cease" (the export's 19 = the DB's 22) while Sotah 10b:12 cites 5:18 for the same words; Avodah Zarah 5a:8 cites 5:26 for "that it might
be good … forever" (the DB's 29) while Beitzah 5a:7 cites 5:26 for "return to your tents" (the DB's 30) — the translators' numberings differ by one
around the short words: THE ROW'S QUOTED WORDS FIX THE DB VERSE, never the cited number (each docket verdict names the DB verse by the quote; the
scan's map through sitting 3's alignment is provisional). THE CHAPTER'S OWN INK (the reading's asserts, reused in the runner): three number verses
(5:13 [6], 5:14 the ordinal [7], 5:22 [2]); 5:9's "third generation" starred, not thirty; one divine frame (5:28); one "saying" (5:5); the ten words
in the SINGULAR (6-9, 11-21; the plural at 4, 5, 22-24, 32, 33); two infinitive absolutes (keep 5:12, honor 5:16); twelve prohibitions; the two
copies diffed token by token at the reading (ch5_measure1.out section A) — the deltas this compile RECOMPUTES.

THE NAME: cold_run_covenant_at_horeb.py — the 60th runner ("the LORD our God made a covenant with us in Horeb", 5:2); law_covenant_at_horeb the 65th
daemon (given_at Exodus 20:3 — THE SECOND WORD'S FIRST GIVING, its code compiled HERE from the second copy 5:7-10 with the first, and the tenth word's
from 5:21 with 20:17: the code's hole filled from the retelling's seat, (L2) below; installed_by covenant_blood_thrown — law_decalogue's own installer,
the D2 candidate standing filed); the span [[Deut, 5, 1, 33]]; the checkpoints CI1-CI9; the unit deu_05_decalogue the frozen reading.

THE LAWS' READBACK — THE FIRST FORM'S (R1)-(R6) ON LAW (the box's (a); the readback's vocabulary gains ONE grade for the code's copy):
(L1) A WORD OF THE CODE RETOLD IS A REFERENCE ROW graded against THE RUNNER'S CELL THAT COMPILES IT — VERBATIM (the letters the same), VARIANT (a
spelling or a conjunction moved, the sense unchanged — the new grade), EXPANDED (a clause added), TURNED (a ground or a term replaced) — and every row
NAMES ITS CELL (the runner and the def, by CALL) or NO CELL; the delta recomputed from the DB (the two copies 172 tokens / 620 letters against 189 /
708). THE SIXTEEN ROWS (one per verse of the code — the ten words): 5:6 VERBATIM — NO CELL (the first word a declaration; Makkot 24a's count — heard from the Almighty's mouth); 5:7 VERBATIM — F2
the_second_word (compiled here); 5:8 VARIANT ("any form" for "and any form") — F2; 5:9 VARIANT ("fathers" plene; "and upon the third") — F2 with the
DATA row the_visiting; 5:10 VARIANT (the written "his commandments", the read "my" — the DATA note of box (d), no line) — F2; 5:11 VERBATIM —
decalogue.vain_name by CALL (Mishnah Shevuot 3:8-9 the topic rows; "vain and false in one utterance, like remember and keep" the cell's own ask);
5:12 EXPANDED (KEEP for REMEMBER; the receipt "as the LORD your God commanded you") — decalogue.sabbath_clauses('remember') by CALL, KEEP AND REMEMBER
IN ONE UTTERANCE the docket's rows (Shevuot 20b:9; Rosh Hashanah 27a:2, 27a:6; Berakhot 20b:10 — the women's kiddush; the Sifrei 233:1 the reading's
exhibit); 5:13 VERBATIM — decalogue.sabbath_clauses; 5:14 EXPANDED ("and your servant"; "your ox and your ass and all your cattle"; "that your servant
and maidservant may rest like you") — decalogue.sabbath_clauses('labor_scope', 'laden_beast') by CALL; Bava Kamma 54b:9-28 (the ox and the ass every
animal by the verbal analogy) and Yevamot 48b:5-6 (the servant's rest) the link rows; 5:15 TURNED (THE GROUND — the exodus for the creation) —
decalogue.sabbath_clauses with pre_sinai.sabbath('delta_20_11') by CALL, the fourth word's TWO GROUNDS a DATA row (box (e)); 5:16 EXPANDED (the receipt;
"and that it may go well with you") — holiness.frame('honor_defined') by CALL (Leviticus 19:3's cell; Kiddushin 30b-31b the topic range: the honor and
the fear defined, the three partners) with mishpatim_3.parent_striker / parent_curser and sanctions.curser (the sanctions' seats); THE EXPANSION'S OWN
ROW — Bava Kamma 54b-55a ("good" not said in the first tablets, which were to be broken), Kiddushin 39b-40a and Chullin 142a (the reward stated beside
the mitzva — the son on the ladder; Aher) the link rows; 5:17 VERBATIM — mishpatim_3.killer and refuge.the_murderer by CALL; 5:18 VARIANT ("and not")
— sanctions.adultery by CALL; 5:19 VARIANT — decalogue.theft_commandment('kidnapper') by CALL (Sanhedrin 86a the topic range: the theft of persons);
5:20 TURNED (a VAIN witness for a FALSE one) — ordinances.courts('false_report', 'witness_of_violence') by CALL (Exodus 23:1 the kin), the ninth word's
parameter a DATA row (box (f); Onkelos levels both to "false"); Deuteronomy 19:16-21 forward; 5:21 TURNED (the wife first; DESIRE for the second
covet; "his field") — F5 the_tenth_word (compiled here; Bava Metzia 5b the topic range).
(L2) THE CODE'S HOLE IS FILLED FROM THE RETELLING'S SEAT (R3's form on law): the two words no runner compiles — the SECOND (no other gods; no image;
no bowing, no serving; the jealous God visiting to the third and fourth generation, mercy to thousands) and the TENTH (covet; desire) — get their
CELLS here from BOTH copies' ink, and their BLOCKS are written on Israel AT THE CODE'S OWN LINE: law_covenant_at_horeb watches ten_words_declared (2b's
supplied line, dated (1, 3, 7)) and writes other_gods_barred and coveting_barred there — the giving's day, not the retelling's; the retelling's rows
stay REFERENCE rows (never a second act). THE REST TEST CARRIES ONE DECLARED DELTA for it: the daemon, installed by the covenant's blood, fires on
2b's giving line even when chapter 5's own lines are dropped.
(L3) THE RECEIPT INSIDE THE CODE (5:12, 5:16 "as the LORD your God commanded you"; 5:32 the plural "as the LORD your God commanded you") IS A RUN
CITATION of the code's first giving — the tape's ten_words_declared line (Exodus 20:8, 20:12 and 20:1-17 the first tellings); the register seats
declared CHAPTER (the gate's class from its code: no write contains the verses; the chapter holds a closed entry — the charge to teach, (L5)); no
ledger write pays a receipt (R5).
(L4) THE PARAMETERS THE COPY CHANGES ARE DATA ROWS, NO LINE MOVES: the sabbath's two grounds (the creation 20:11 / the exodus 5:15), the ninth word's
witness (false / vain), the tenth's order (the house first / the wife first) and its two verbs (covet / desire), the visiting's generations and the
thousands, the ketiv at 5:10.
(L5) THE NARRATIVE HALF ON (R3): TWO SUPPLIED LINES dated (1, 3, 7) by ONE retrograde marker at Deut 5:23 (M['request_told'] = M['giving'] — "when you
heard the voice … you came near to me" the ink's own dating; the request came on the giving's day) — THE REQUEST (5:23-27; Exodus 20:18-19 the first
telling named — the tape's second hole) writing torah_through_moses on Israel (a STATUS: "you speak to us all that the LORD our God speaks to you,
and we will hear and do" — 5:5's "I stood between the LORD and you"; Avot 1:1's vocabulary, "Moses received the Torah from Sinai"; Makkot 24a's
two words heard from the Almighty's mouth and the rest through Moses — the topic range's row), and THE ANSWER (5:28-31; told only here — 18:16-17
forward) writing TWO: THE CHARGE TO TEACH a DEBIT on Moses (commanded, valued teach_the_commandment — "stand here with me and I will speak to you all
the commandment, the statutes and the judgments which you shall teach them", 5:31; Exodus 24:12's "to teach them" by CALL to the erection's ascent
cell; 4:14's "commanded me at that time to teach you") CLOSED AT ONCE BY THE PRIOR RUN (the closer the tape's EARLIER line — speech_opened at Deut
1:1-5, "Moses undertook to expound this Torah", (40, 11, 1); 4:5's receipt the same run — the book itself is the charge's run; the opening speech's
_closed_by_prior_run form, the daemon's own write and close), and "RETURN TO YOUR TENTS" a STATUS on Israel (returned_to_tents — the separation of
Exodus 19:15 released: Beitzah 5a:7-5b:3, Shabbat 87a:4, Yevamot 62a:2, Moed Katan 7b:5, Sanhedrin 59b:3 the link rows); a FORWARD marker at Deut
5:32 (M['charge'] = M['speech']) ENDS the stretch (lesson 1) — the charge 5:32-33 at the speech's own day, NO WRITE.
(L6) THE FRAME'S SECOND SEAT AGAIN (R6): 5:1-5 the second speech's opening ("and Moses called all Israel and said: hear, O Israel … learn … keep … do";
"the LORD our God made a covenant with us in Horeb; not with our fathers … but with us, we who are all here alive this day"; "face in face the LORD
spoke with you") — NO WRITE (4:44-49's form): a REFERENCE row EXPANDED against speech_opened (Deut 1:1); 5:2-3 the covenant against the tape's
covenant_offered / people_answered / covenant_blood_thrown (the erection's blood_covenant('book_of_covenant') by CALL) — "not with our fathers" a DATA
note against 29:13-14 (the diff computed; no link of our own); 5:4 "face IN face" the Bible's one seat (the reading's crown; Onkelos "speech with
speech" — the erection's presence('speech_with_speech') by CALL, Exodus 33:11's rendering); 5:5 the mediator folded into the request's row. 5:22 THE
VOICE AND THE TABLETS: FOUND — 2b's ten_words_declared and tablets_given, no write (box (g)); the row EXPANDED against 4:13 (twenty-four tokens for
fifteen, computed); "added no more" a DATA note with Onkelos "did not cease" (Sanhedrin 17a:12 — Eldad and Medad; Sotah 10b:12 — Judah). 5:27 "WE
WILL HEAR AND DO" against 24:7's "we will do and hear" — TURNED (Shabbat 88a the topic range; exodus_story.sinai('we_will_do_seats') by CALL). 5:28
"the LORD heard the voice of your words" = 1:34's phrase (the opening speech by CALL); "they have done well" cited forward at 18:17 — a DATA note;
5:29 "who would give" (Avodah Zarah 4b:17-5a:21 — the calf and the penitents, the link rows; Job's nine seats the reading's assert); 5:31 "stand here
with me" (the Sifrei 357:40 credited — Moses prophesied standing; Megillah 21a:14 — the Megillah read sitting, the Torah standing, from this verse);
5:32-33 THE CHARGE, NO WRITE ("not turn aside right or left" — 17:11, 17:20, 28:14 forward, Joshua 1:7 outside; computed).

THE DESIGN'S DECISIONS (the box's (a)-(k) settled on the measurements):
(a) THE LAWS' READBACK — (L1): sixteen rows, each with its cell; the grades' census typed from the runner's print (VERBATIM 5, VARIANT 5,
EXPANDED 3, TURNED 3 on the code; the five narrative rows EXPANDED 2, SUPPLIED 2, TURNED 1).
(b) THE SECOND WORD COMPILED HERE — F2 the_second_word: no_other_gods (5:7 "before me" — Onkelos "except me"; Makkot 24a's first two words), no_image
(5:8 — obey_horeb's DATA row the_no_image_list by CALL; the images for study credited from 2b's docket), bow_and_serve (5:9 — Mishnah Sanhedrin 7:6:
the bower, the sacrificer, the one who says "this is my god" LIABLE, the mode STONING by the ink's own forward seat Deuteronomy 17:2-7 — "gone and
served other gods and bowed to them", a REFERENCE the ink makes, chapter 17's sitting compiling the procedure; the embracer, the kisser, the sweeper
a PROHIBITION without death — 7:6's second clause; the service in its own way — Sanhedrin 60b's four services from the Temple's by the taught verbal
analogy "sacrificing", Exodus 22:19 — a TRANSFER taught), the_visiting (5:9-10 DATA: the third and fourth generation of those who hate — when they
hold their fathers' deeds, Berakhot 7a:27 credited from the Decalogue's block; the thousands of those who love), the_ketiv (5:10 DATA), the_write
(other_gods_barred — a NEW BLOCK on Israel written at the giving's line); the verdict effects put_to_death (valued stoned, by the reference) and
exempt; THE EDGE obey_horeb → decalogue's why AMENDED ("the second word OWED" → "PAID at 3b: cold_run_covenant_at_horeb.py F2"); the 2b box's debt
PAID.
(c) THE RECEIPTS' SEATS — (L3): Deut 5:12, 5:16, 5:32 NONE → CHAPTER, declared with RUN_CITATION pointers (Exodus 20:8, 20:12, 20:1-17 through the
tape's ten_words_declared; the exhortation's 4:5 the pair).
(d) THE KETIV AT 5:10 — a DATA note the_visiting's setting: the store's seventh token the read "my"; the DB's "his"; Exodus 20:6 writes "my".
(e) THE SABBATH'S TWO GROUNDS — DATA the_sabbath_grounds (the creation 20:11 by pre_sinai.sabbath('delta_20_11'); the exodus 5:15 — 15:15, 24:18,
24:22 the phrase's other seats, computed at the reading).
(f) THE VAIN WITNESS — DATA the_ninth_word (false 20:16 / vain 5:20; Onkelos "false" at both; ordinances.courts by CALL).
(g) THE VOICE AND THE TABLETS — FOUND, no write (L6).
(h) THE REQUEST AND THE ANSWER — the two SUPPLIED lines (L5); "hear and do" TURNED; "they have done well" DATA.
(i) THE BLOCK'S EDGE — chapter 5 has no footer; the daemon's seat Exodus 20:3 lies in no Deuteronomy footer's block; 4:45 DAEMONS 2 unmoved; chapter 5
installs ONE daemon — the second and tenth words' (the code's hole), no law of its own; the charge 5:32-33 no write; the block (Deut 4:45, Deut 5:33]
closes on chapter 6's opening.
(j) THE DOCKET by the union rule — 254 rows + the second word's answer sheet (Mishnah Sanhedrin 7:6; Sanhedrin 60b) in FOUR parts A-D, LAW /
DERIVATION / DISPUTE / CONTEXT / OUTSIDE; the crowns expected — keep and remember in one utterance (Shevuot 20b; Rosh Hashanah 27a; Berakhot 20b);
the reward not written in the first tablets (Bava Kamma 55a); the ox and the ass every animal (Bava Kamma 54b); the servant's rest (Yevamot 48b); the
vain oath (Shevuot 3:8-9); the theft of persons (Sanhedrin 86a); the coveter who pays (Bava Metzia 5b); "we will do" before "we will hear" (Shabbat
88a); the first two words from the Almighty's mouth (Makkot 24a); the honor's measures (Kiddushin 30b-31b); "return to your tents" (Beitzah 5a-b;
Shabbat 87a); "did not cease" (Sanhedrin 17a); the Marah statutes (Sanhedrin 56b); the calf and the penitents (Avodah Zarah 4b-5a); the ten words
read daily and abolished (Berakhot 12a); Moses called on the seventh day (Yoma 4b); the covenants counted (Sotah 37b); the four services (Sanhedrin
60b; Mishnah Sanhedrin 7:6).
(k) THE SCHEMA SITTING stays ON THE TABLE — the keep-and-remember rows join the Sifrei 233:1's exhibit; no decision here.

THE CELLS (seven, each returning out(verdict, effects); the INK block exec'd from the sequence file; the token probes zero-report; every seat list and
slice typed from the reading's print and the recon): F1 the_assembly_called (5:1-5 — asks: hear_learn_keep_do (5:1 — the four verbs; Yevamot 109b:5 the
link row), the_covenant_at_horeb (5:2 — EXPANDED against the covenant's lines; the erection by CALL), not_with_our_fathers (5:3 — DATA; 29:13-14's
diff), face_in_face (5:4 — the one seat; Onkelos "speech with speech" by CALL), i_stood_between (5:5 — the mediator, the request's row)); F2
the_second_word (5:7-10 with Exodus 20:3-6 — (b)); F3 the_first_tablet (5:6-15 — asks: the_first_word, the_second_word_row, the_third_word,
the_fourth_word (the four rows of (L1) graded, their cells by CALL), keep_and_remember, the_ox_and_the_ass, the_servants_rest, the_two_grounds,
the_receipt_5_12); F4 the_second_tablet (5:16-21 — asks: the_fifth_word, the_sixth_word, the_seventh_word, the_eighth_word, the_ninth_word,
the_tenth_word_row (the six rows, their cells by CALL), the_reward_clause, the_receipt_5_16, the_counts (172/620 against 189/708 recomputed)); F5
the_tenth_word (5:21 with Exodus 20:17 — asks: covet_and_desire (the two verbs; Bava Metzia 5b — the coveter who pays), the_wife_first (the order
turned; his field added — DATA), the_coveter_who_pays (the exam's row), the_write (coveting_barred)); F6 the_voice_and_the_request (5:22-27 — asks:
added_no_more (5:22 — FOUND, EXPANDED; "did not cease"), the_tablets_given_to_me (5:22 — FOUND (1, 4, 17)), you_came_near (5:23 — 1:22's phrase, the
opening speech by CALL; the mob and the elders), the_request (5:24-27 — SUPPLIED; Exodus 20:18-19; 4:33's kin; 18:16 forward), hear_and_do (5:27 —
TURNED against 24:7; Shabbat 88a; the exodus story by CALL), the_write (torah_through_moses)); F7 the_answer_and_the_charge (5:28-33 — asks:
the_lord_heard (5:28 — 1:34's phrase by CALL), done_well (5:28 — 18:17 forward, DATA), who_would_give (5:29 — Avodah Zarah 4b-5a), return_to_your_tents
(5:30 — the write returned_to_tents; Beitzah 5a-b), stand_here_with_me (5:31 — SUPPLIED; the charge's debit closed by the prior run; the Sifrei
357:40; Megillah 21a), the_charge (5:32-33 — NO WRITE; the seats), the_readback_table (the rows graded), the_register_seats (5:12, 5:16, 5:32
CHAPTER by the gate's code; 4:45 DAEMONS 2)).

THE DATA ROWS (twenty): the_readback (the sixteen law rows of (L1) and the five narrative rows — 5:1-5 with 5:32-33 the frame's two ends, 5:22,
5:23-27, 5:27, 5:28-31), the_second_word
(the arms — make, bow, serve; the embracer's prohibition; the four services; the mode by the reference), the_visiting (d), the_no_image_list (by CALL),
the_tenth_word (covet / desire; the wife first; his field; the coveter who pays), the_sabbath_grounds (e), the_ninth_word (f), keep_and_remember (the
one utterance's rows; the Sifrei 233:1), the_reward_clause (Bava Kamma 55a; Kiddushin 39b), the_honor_by_call (Kiddushin 30b-31b's measures at
holiness.frame), the_receipts (5:12, 5:16, 5:32 — CHAPTER), the_two_copies (172/620, 189/708 recomputed; the ten's per-word counts), the_second_hole
(Exodus 20:18-21 — no line; 20:18 in no span), the_export_division (30 / 33; the citations' two divisions), the_mediator (5:5, 5:27, 5:31; Makkot 24a),
the_return_to_tents (the separation released), the_charge_to_teach (the debit closed by the prior run — the closer Deut 1:5), the_face_in_face (the one
seat; Onkelos), the_fathers_and_us (5:3 against 29:13-14), the_hear_and_do (5:27 against 24:7; Shabbat 88a).

THE DAEMON law_covenant_at_horeb (given_at Exodus 20:3; installed_by covenant_blood_thrown): watches ten_words_declared → [other_gods_barred,
coveting_barred]; mediator_requested → [torah_through_moses]; stand_here_commanded → [commanded, returned_to_tents] (the debit written and closed
inside the daemon by the opening speech's form, the closer "Deut 1:5"); horeb_covenant_case → [put_to_death, exempt, accepted]. No timer; literal W dicts
per kind; the case kind dispatching to the cells by name in EXPLICIT branches.

THE TYPES (add_types_ch5.py): TWO tape kinds — mediator_requested (speech, 5:23-27; the first telling Exodus 20:18-19 named in the row and its witness),
stand_here_commanded (speech, 5:28-31; told only here — 18:16-17 forward named) — with their witnesses in their verses; ONE case kind
(horeb_covenant_case); FOUR new effects — other_gods_barred (block on Israel; 5:7-9 / 20:3-5), coveting_barred (block on Israel; 5:21 / 20:17),
torah_through_moses (status on Israel; 5:27), returned_to_tents (status on Israel; 5:30); the effects reused — commanded (the debit), put_to_death,
exempt, accepted; NO registry row (Israel and Moses the written-on parties, both standing); the daemon block; the functions block covenant_at_horeb
(the seven cells WRAPPED); the span [[Deut, 5, 1, 33]]; the CALL edges by the ink — decalogue (the third, fourth and eighth words' cells; the
utterance ask), obey_horeb (the readback's first form; the no-image list; the giving and the tablets FOUND), erection (the covenant's book, the
speech-with-speech rendering, the ten words' seats, the teaching's command), exodus_story (Rabbi Yose's days; the "we will do" seats), opening_speech
(1:22, 1:34, the frame's write; the readback rows), holiness (the honor's cell), mishpatim_3 (the killer; the parents' striker and curser), sanctions
(adultery; the curser), refuge (the murderer), ordinances (the false report; the altar's seat), pre_sinai (the creation ground) — and every demand the
census makes past the imports read on the DB and declared (CALL / VIA / FALSE / PARAMETER / INTERNAL / RUN_CITATION), never a blanket row; the
pointers after the gate's print (5:12, 5:16, 5:32's receipts RUN_CITATION with (L3)'s why); I5 64 → 65.

THE TAPE (two lines, two markers): under "# ---- Deut 5 ----" after the tape's last Deuteronomy 4 line (three_cities_set_apart): the RETROGRADE marker
at Deut 5:23 (M['request_told'] = M['giving'], (1, 3, 7), placement reading_placed) then mediator_requested (5:23-27, dated) then stand_here_commanded
(5:28-31, dated); the FORWARD marker at Deut 5:32 (M['charge'] = M['speech'], (40, 11, 1)). The markers 165 → 167 (forward 128 → 129, retrograde
22 → 23, proleptic 15 unmoved); the tape's closes 126 → 127; the counter ends at (40, 11, 1) UNMOVED.

THE CHECKPOINTS CI1-CI9 (the prefix measured free):
CI1 THE LINES — two events of the sitting's kinds on the tape in the ink's order, both AFTER the tape's last Deuteronomy 4 line, both reading_placed
and dated (1, 3, 7) by the RETROGRADE marker at Deut 5:23 with its stated day; the FORWARD marker at Deut 5:32 at (40, 11, 1); the counter ends at
(40, 11, 1).
CI2 THE SECOND HOLE — no event on the tape sourced to Exodus 20:18-22 (computed 0); mediator_requested's first_telling names Exodus 20:18-19; the marker's
day = M['giving'] = the sinai_days row's seventh.
CI3 THE CODE'S HOLE FILLED — other_gods_barred and coveting_barred on israel_people ONE each (blocks), dated (1, 3, 7), source beginning "Deut 4:10" (the
giving's line); law_covenant_at_horeb registered, given_at Exod 20:3, installed_by covenant_blood_thrown; the functions block's seven cells WRAPPED.
CI4 THE LAWS' READBACK — the_readback's rows twenty-one (sixteen law rows — one per verse of the code — and five narrative rows), every row's tape
entry FOUND on the running world by kind and first verse (rows n = found n); the grades' census typed from the runner's print; the sixteen law rows
each naming a cell or NO CELL (5:6 alone); no row OPEN.
CI5 THE MEDIATOR AND THE RETURN — torah_through_moses on israel_people ONE dated (1, 3, 7), source beginning "Deut 5:23"; returned_to_tents on
israel_people ONE dated (1, 3, 7), source beginning "Deut 5:28"; people_sanctified's line ONE (Exod 19:10-11) — the separation this status releases.
CI6 THE CHARGE TO TEACH — commanded on moses valued teach_the_commandment ONE, CLOSED, closed_by beginning "Deut 1:" (the prior run), the closer's line
EARLIER on the tape than the charge's (Q3's form); closes 126 → 127.
CI7 THE REGISTER SEATS — Deut 5:12, 5:16, 5:32 CHAPTER by CALL to the gate's class_receipts (no write contains them; the chapter holds the closed
charge); Deut 4:45 DAEMONS with daemons 2 unmoved.
CI8 HOREB READ BACK AGAIN — ten_words_declared ONE and tablets_given ONE (FOUND, no second write: covenant_declared ONE, tablets_delivered ONE unmoved);
people_answered at Exod 24:7 ONE (the "do and hear" line the TURNED row reads); lord_descended at Exod 19:18 ONE.
CI9 THE REST — entities 319 UNMOVED (Israel and Moses the written-on parties), closes 127, the population table 148 UNMOVED, the two kinds present;
markers 165 → 167; the other counts 2b's exactly with the two lines, the two markers and the daemon's two block writes dropped or declared (THE REST test).
CP6 RETYPED (markers 165 → 167, F 128 → 129, R 22 → 23), CA1 RETYPED (the Deuteronomy retrograde list gains ((1, 3, 7), 'Deut 5:23'); the forward list a
fourth (40, 11, 1)), CC8 / CC9 / CA9 RETYPED (closes 126 → 127; CC9's markers → 167) AS OF this sitting; every miss shown at once by
checkpoint_check.py --all before the tape.

THE PREDICTION'S ARITHMETIC: RUN = (1302, 96, 88, 0, 12, 1593, 36, 319, the four pairs, 127) — events +2 (the two lines), timers set +0, fired +0 (no
clock walk; the retrograde marker a dated point), cancels 0, retro-writes 12 UNMOVED, writes +5 (the daemon's watches summed: the two blocks at the
giving's line, torah_through_moses at the request, commanded and returned_to_tents at the answer), daemons fired +1 (law_covenant_at_horeb), entities
+0 (Israel and Moses standing), closes +1 (the charge's debit closed inside the daemon); PREVIOUS_RUN = 2b's RUN WITH ONE DECLARED DELTA — (1300, 96,
88, 0, 12, 1590, 36, 319, the four pairs, 126): THE REST drops the two lines and the two markers by the runner's tag and the span, but the new daemon
(installed by the covenant's blood at Exod 24:8) still fires on 2b's giving line and writes the two blocks — writes +2 and daemons fired +1 on THE REST,
read at the design (6b's form: one declared cause); NEWEST_RUNNER 'covenant_at_horeb'; PLACEMENT markers text_constrained 105 → 106 (the forward
marker at 5:32), reading_placed 45 → 46 (the retrograde marker at 5:23); events text_constrained 109 UNMOVED, page_order 1138 UNMOVED, reading_placed
53 → 55 (the two supplied lines) — read at the stitcher's print; CENSUS typed from the stitcher's print (on tape 1300 → 1302, history +2, kinds 845 →
847 — the two tape kinds, subjects 272 UNMOVED, markers 165 → 167 (F 129, R 23), closes 71 unmoved; the case rows the exam's persons); the population
table 148 UNMOVED; the scene's tuple PREDICTED BY SCRIPT at the runner step (the exam's persons through horeb_covenant_case — each written once; no
timer; the persons the entities; no close); the narrative's (on its own world with the giving's line replayed: 5 writes, 1 close, the entities israel
and moses = 2, the counter's day (11, 1), 3 dated lines, no row).

THE PROBES: readback_probes.py Q10-Q12 written to FAIL before the runner exists (Q10 the runner and its the_readback table — twenty-one rows, the
sixteen law rows each naming a cell or NO CELL (5:6 alone), the grades' census VERBATIM 5 / VARIANT 5 / EXPANDED 5 / TURNED 4 / SUPPLIED 2; Q11 the two supplied lines dated (1, 3, 7) by the retrograde marker at
Deut 5:23, the request naming Exodus 20:18-19, the charge's debit CLOSED by the prior run with the closer's line earlier on the tape; Q12 the register
seats on the new tape — Deut 5:12, 5:16, 5:32 CHAPTER, 4:45 DAEMONS with daemons 2 — and the two blocks other_gods_barred and coveting_barred on Israel
dated (1, 3, 7) with source Deut 4:10); Q4 and Q7 unchanged (narrowed to their own chapters); NO parser rule this sitting (the three number verses read
right at the reading — census_probes unmoved at 224); the register gate unchanged; checkpoint_probes' verse computed (2b's form).

THE ORDER: the design (this section) → the probes to FAIL (readback Q10-Q12 0/3) → the state doc's checkpoint (the docket may cross a compaction) →
THE DOCKET by the union rule (four parts A-D, the reading instrument ch5_docket_rows.py, the writer write_ch5_docket.py with the coverage computed
and the cite index; the second word's rows added to the scan) → the types by script (add_types_ch5.py) → the recorder and the stitcher (the scratch
copies: SPAN_ORDER + 'covenant_at_horeb'; the two marker rows at Deut 5:23 and 5:32) → the gates to FAIL (daemon, dependency) → the runner
(ch5_part1-4.py assembled by cat; the fast checker over parts 1 and 2 before the first run; the honest-pairing guard; zero-report probes; the scene and
the narrative predicted by script; CASES generated from the cells' asks) → the recorder → the stitcher → the literals, CI1-CI9 and the retypes
(patch_seq_literals_ch5.py) → `checkpoint_check.py --all` (every fault in one print) → the tape run (10/10 with THE REST) → `gates_chain.sh` in the
background (one summary: the probe gates, the daemon and dependency gates, build_world, the journal gate, THE REGISTER GATE --strict with the three
seats declared, the positions table, checkpoint_probes, the sweep, the journal gate again) → the records from the sheet in one call (this file's AS
BUILT, COMPILE_DEBT's sitting-3 box PAID + the 3b box, the 2b box's second-word line PAID, MOVE_CATALOG (checked), MIDDOT's docket entries,
MISHNAH_TOPICS, RESEARCH_LOG, THE_STEPS, THE_BRIEFING, THE_LOOP.md's step 6 row (the laws' half of the readback built), RESUME, memory, the state doc's
addendum, the recovery page rewritten, the addenda's section) → the forms copied.
...
UNMOVED; PLACEMENT markers {'text_constrained': 106, 'reading_placed': 46}, events {'text_constrained': 109, 'page_order': 1138, 'reading_placed': 55} — AS PREDICTED (the answer's line inside the stretch reading_placed); CENSUS (2471, 1311, 1302, 1144, 6, 10,
9, 0, 71, 167, 129, 15, 23, 847, 272); CI1-CI9 all MATCH; the run 15.9s. THE DOCKET logic/oral_triage/deu_05_vaetchanan_exam_2026-09-16.md by the union
...
## Sitting 4b — THE COMPILE OF CHAPTER 6, Deuteronomy 6:1-25 (2026-09-17; the owner: "Go" after sitting 4's commit a7955cc): THE DESIGN — written at the
...
## THE WHOLE-ROW RULE (owner-ruled 2026-09-17: "OK, never ever cut corners with the Talmud go back and fix the ones where the shortcut was taken and write it in the rules forever") — written between 4b's RUN 2 and RUN 3
...
WHERE THE CUT WAS TAKEN (measured on the record before the fix): (1) SITTING 4b — chapter 6's docket, all 747 rows printed at 170 characters (708 rows longer than the cut; the dump 407,226 characters); (2) SITTING 4 — the Sifrei's 67 spine rows printed with the English capped at 1,500 characters and the Hebrew's opening 150 (seven rows past the cap: 31:1, 31:4, 31:6, 32:7, 32:18, 36:1, 36:2; the ledger COMMITTED at a7955cc); (3) SITTING 3b — the docket's part C (rows 140-209) printed at 650 characters on the record (fifteen rows longer), the other parts' print not on record (82 of 275 rows longer than 650; the docket COMMITTED at 7c8554e); (4) SITTINGS 2b AND 1b — the instrument existed with N a parameter and the print not on record (2b: 114 of 327 rows longer than 650; 1b's dump in the scratchpad); the link rows of 1b-3b "read whole" by their parts' own headers. Before the four-run rule (2026-09-16) — the Numbers walk's dockets — every row was read whole from the dump by the parts' own headers.

THE FIX (in this order; each chunk's corrections on disk before the next is read): (a) chapter 6's docket reread whole in chunks of forty rows on ch6_docket_rows.py with N = 100000; each part carries a WHOLE overlay {address: (verdict, note)} applied by ch6_docket_common.apply_whole (the cut's verdict stays above it; a corrected note ends "[whole: what the cut missed]"); the docket (uncommitted) deleted and rewritten with the counts in its header; (b) sitting 4's seven Sifrei rows reread past the cap and the 67 Hebrew rows whole — a correction to the committed ledger an APPENDED section; (c) 3b's rows over 650 reread whole — a correction to the committed docket an appended section, a cell typed from a cut row retyped; (d) 2b's and 1b's rows over 650 the same. Then 4b's RUN 3 as designed.

THE FIX — AS BUILT (2026-09-17, parts (a)-(c)): (a) chapter 6's docket reread whole — 70 of 747 rows corrected, 21 verdicts changed (six rows had carried another row's content; nine rules and five arms missed; the open row's principle at Sanhedrin 4b:12-14, not 4b:2); the docket rewritten with a REREAD WHOLE header, the WHOLE overlays in the parts. (b) sitting 4's Sifrei — the seven spine rows and three outside rows past the 1,500 cap reread: nothing the ledger lacks; the 67 Hebrew rows read whole against the English: the one divergence 36:10 as recorded; an appended section on the ledger. (c) 3b's 82 rows over 650 reread whole: NO verdict changed, three notes would grow; an appended section on the docket. THE MEASURE: at 170 characters one verdict in ten was wrong in substance and two in a hundred sat on the wrong row; at 650 none. (d) 2b (114 rows over 650 of 327) and 1b (215 of 864) are the next run's work; then 4b's RUN 3.

THE FIX — AS BUILT, part (d) (2026-09-17; the owner: "Go"): 2b's 114 rows over 650 (of 327) and 1b's 215 (of 864) printed whole beside their verdicts (whole_rows_d.py, seven chunks) and read. 2b: SIX rows corrected, TWO verdicts moved — Berakhot 21b:15 DISPUTE → DERIVATION (the cut had R. Yehoshua ben Levi's "awe and fear" where the row has "as if received from Horeb"); Tosefta Rosh Hashanah 2:11 CONTEXT → DISPUTE (the Talmud twin's dispute with R. Yehuda's reason) — and four notes: Sanhedrin 89a:2 the CHALLENGE typed as the resolution (R. Zeira's answer makes the fifth compartment spoil either way), Gittin 12a:11 a rejected hypothesis typed as the ruling, Gittin 88a:17 the seven counted from "seven verbs" instead of "beget" and "children" thrice, Eruvin 96a:6 R. Yosei HaGelili's baraita credited to R. Akiva; the crowns' two lines corrected by the appended section. ONE CELL RETYPED: cold_run_obey_horeb.py's add_beside from exempt to accepted (R. Zeira) with its DATA setting, its moves and its CASES literal; the runner's cases 52/52; the tape and the gates carry the flip at 4b's runs 3-4 (one ledger effect on one exam person; no line, marker, timer or entity moves). 1b: NO verdict changed; one credited note corrected (Makkot 10a:13 — the Angel of Death, not the evil inclination). Appended REREAD WHOLE sections on both committed dockets. THE MEASURE, WHOLE: at 170 characters (4b) one verdict in ten wrong in substance and one row in fifty carrying another row's content; 2b (the cut not on record) six in 114 with two verdicts and one cell; 3b's 650 none in 82; 1b one note in 215; sitting 4's 1,500 none. THE LESSON — A CUT ROW ENDS BEFORE THE ANSWER: the Gemara's challenge, its hypothesis and its first reading sit at a row's head and the resolution at its tail; three of 2b's six errors (89a:2, 12a:11, 96a:6) and the worst of chapter 6's (Temurah 3b:16 / 4a:2, Berakhot 2a:6) have that shape — the reason a row is read to its end before its verdict is typed. THE FIX'S FOUR PARTS ARE CLOSED; 4b's RUN 3 next.
...
UNMOVED; PLACEMENT markers {'text_constrained': 106, 'reading_placed': 46}, events {'text_constrained': 109, 'page_order': 1140, 'reading_placed': 55} (page_order 1138 → 1140 — AS PREDICTED); CENSUS (2487, 1313, 1304, 1158, 6, 10, 9, 0, 71, 167, 129, 15, 23,
849, 272) as the stitcher printed it (on tape 1302 → 1304, kinds 847 → 849, subjects 272 unmoved); CO1-CO9 all MATCH; the run 16.7s. THE SHEMA'S LAW IS
...
teach stands CLOSED by the prior run (6:1 a reference row — CO7). THE DOCKET logic/oral_triage/deu_06_vaetchanan_exam_2026-09-17.md by the union rule: 747 rows (link 95 / topic 652; LAW 346, DERIVATION 57, DISPUTE 83, CONTEXT 261; credited 174; 204,382 bytes), EVERY ROW READ WHOLE — 70 rows carry a "[whole: …]" note naming what the 170-character pass had missed; Berakhot 2a-16a's five verse-anchored
...
119 asserts, seven fell on the first pass, all forms and none facts, 0 on the second) and this design — CLOSED HERE, a clean compaction point (#194); RUN 2 the
...
RUN 2 — AS RUN (2026-09-18, on "go for run 2" after the compaction): the rereads (the recovery page, the map's two newest sections, the memory; then THE_STEPS' compiler block,
Step 2 and Step 5's head); the three outside rows and the twenty-six Onkelos rows read WHOLE again from the run-1 prints (ch7_sifrei_outside.txt, ch7_onkelos.txt — the
compaction had emptied them from the window; the whole-row rule); three row scripts and the ledger writer on sitting 4's forms with the spine sections dropped (chapter 4's
shape on chapter 6's form — no CREDITED spine rows, no piska loop); the ledger logic/oral_triage/deu_07_vaetchanan_ekev_2026-09-17.md — 29 sources (Onkelos 26: MATERIAL 19 / CONTEXT 7;
the outside rows 3: MATERIAL 2 / CONTEXT 1, 37:1 marked an INTERPOLATION in its own line), coverage computed (missing 0, extra 0; the spine's 0 rows on the chapter said
and why), lint 0, NO CUT MISSED on the first run (65,967 bytes); the kin's spine CREDITED BY NAME in its own section with the counts computed from those ledgers (the angel's
clauses 8 Onkelos rows, the renewed covenant 7, the dispossession 7, the erection docket's Mishnah Avodah Zarah 3:5 on 7:25; the Mekhilta rows 21) — not this ledger's sources,
not in its cite index. ⚠ LESSONS (run 2): A CHAPTER WITHOUT A SPINE HAS A LEDGER WITHOUT A SPINE SECTION — the form drops the spine's loop, the credits dict and the
divergence check whole, and the coverage line says "0 rows" with the heads computed, never a blank. THE OUTSIDE ROWS ARE THE SPINE'S WHOLE VOICE — three rows, one the
translator's own: 50:4 reads 7:1's count (each of the seven greater than all Israel) and 61:7 reads 7:26's doubled verbs as the rule of RENAMING the shrines for the worse — the
shelf's two moves on the chapter both by E10, the repetition made to teach. A SINGULAR AND A PLURAL "THAN YOU" — the ink's phrase census had the singular's three seats (4:38,
7:1, 9:1); the shelf's 50:4 puts 11:23's PLURAL beside 7:1's singular, and the plural's one seat was computed at the write (a census by spelling splits what the shelf joins by
sense — the row names the seat). THE ORDER (RUN 3, the first step): write_ch7_overrides.py — the display-layer patch (49 by gloss, 36 by reference) under the sitting's marker
"THE DEUTERONOMY WALK sitting 5 (2026-09-17, Deuteronomy 7)", the ink rerun PATCHED; then the manifest (six claims DV07-01..06, each check the block's longest store-piece
whole — 7:9's "His commandments" not a check), the seat (six WITNESS_READ operators at 7:1, 6, 9, 12, 17, 25, step E), the chain (the ritual), the fold (221 / 2209 / the hash
unmoved), build_world, the journal gate, the register gate --strict (no seat), the home-path gate → the checkpoint (#194 addendum 2, a clean point).

RUN 3 — AS RUN (2026-09-18, on "run 3 go" after run 2): the display layer patched (49 by gloss, 36 by reference; by_ref 532, by_gloss 434 — the anchors the last rows of
sitting 4's two blocks), the ink rerun PATCHED with 0 failing; the manifest's six claims with every CITE INDEX name used (29), verify_claims 6/0, the labels census GREEN
(385 claims labeled, debt 0); six WITNESS_READ seats at 7:1, 6, 9, 12, 17, 25, step E, seven anchor scenarios (the tree-derived thirty-three rewritten), verify_text GREEN
(26 steps, 7 scenarios); the ritual 13 PASS — the 221st frozen unit and its Python layer; the fold predicted and matched (221 units, standing 2209, hash 8b8fff1fa28953af; 1809 facts,
341 demands, 191 open) before and after the bake; build_world ALL GREEN; the journal gate GREEN (12 kinds, 9688 rows — 9674 + 14, the fold layer's rows for the new unit; the
tape unmoved); the register gate --strict GREEN (DECLARED 100, DEBT 0, FAILS 0 — no seat in the chapter, as designed); the home-path gate GREEN. ⚠ LESSONS (run 3):
THE FORMS HELD FIRST TIME — five scripts derived from sitting 4's by name changes alone (the patch's anchors the prior sitting's last rows; the manifest's checks cut
from the store's bytes, 7:9's placed on "the faithful" BEFORE the store's extra token so the written/read pair stays out of every check; the seat's anchors the claims'
first verses), none retyped: a reading's run 3 is a form, not a design. THE FOLD LAYER GROWS WITH A FREEZE WHILE THE TAPE STANDS — the journal's index +14 rows on the
221st unit with no line added to the tape; the gate re-pins the header to the unmoved hash. THE ORDER (RUN 4, the first step): the sheet RECORD_FORMS.md read,
write_ch7_records.py from write_ch6_records.py by sed → the records in one call (this section's AS BUILT, COMPILE_DEBT's sitting-5 box — 5b's owed list, MIDDOT
(E10 twice on the chapter: 50:4, 61:7), MISHNAH_TOPICS (the testing shelf routed — Avodah Zarah, Kiddushin 3:12, Makkot), RESEARCH_LOG (the reading's entry — the
flock's word tagged a name in the morph; the written/read pair at 7:9; the spine silent), THE_STEPS, THE_BRIEFING (the scoreboard 221 units / standing 2209 + an entry),
THE_WORLD, RESUME, the stamp row, the recovery page whole, the memory, copy_ch7_forms.py) → the lints → #194 addendum 3 (the sitting's close) → the commit
message drafted for the owner's word.
...
## Sitting 5 — CHAPTER 7 — AS BUILT (2026-09-18; the design above stands as written — the four runs ran as designed, the RUN 2 and RUN 3 paragraphs their record; every departure from the design named here)

THE RESULT: Deuteronomy 7:1-26 READ AND FROZEN as one unit — deu_07_nations_cherem, the 221st frozen unit (the portion's edge at 7:12 inside it — the chapter the unit, per the
ruling); the ledger logic/oral_triage/deu_07_vaetchanan_ekev_2026-09-17.md (29 sources: Onkelos 26 — MATERIAL 19 / CONTEXT 7; the Sifrei's spine 0 rows — SILENT on the
chapter; the outside rows 3 — MATERIAL 2 / CONTEXT 1, 37:1 an interpolation; the kin's spine credited by name in its own section; 65,967 bytes; lint 0); the
manifest deu_07_nations_cherem_claims.json (6 claims DV07-01..06, verify_claims 6/0, the labels census GREEN — 385 labeled, debt 0); six WITNESS_READ seats at 7:1, 6, 9,
12, 17, 25, step E, seven anchor scenarios; the ritual 13 PASS; the fold predicted and matched before and after the bake (221 units, standing 2209, hash
8b8fff1fa28953af; 1809 facts, 341 demands, 191 open); the display layer +36 by reference and +49 by gloss (by_ref 532, by_gloss 434 after); the stamp row
...
THE DEPARTURES FROM THE DESIGN: none in substance. THE FOUR RUNS held their edges — run 1 the rereads, the measurements, the ink (119 asserts, seven failing
...
THE GATES, COMPUTED FROM THEIR PRINTS: the ritual 13 PASS (RITUAL COMPLETE, 221 frozen units); CORPUS TRUTH GREEN twice (221 units, 1809 facts, 341
demands (191 open), hash 8b8fff1fa28953af — the tripwire's literals set to the prediction before the bake, matched); build_world ALL GREEN; the journal gate
GREEN (12 kinds, 9688 rows — 9674 at sitting 4b, +14 on the fold layer with the tape unmoved); the register gate --strict GREEN (DECLARED 100, DEBT 0,
FAILS 0 — no seat in chapter 7); the home-path gate GREEN; the labels census GREEN (385 claims labeled, debt 0); large_letter_probes 6/6; the lints at their
baselines.
...
reading's run 3 is a form, not a design. (12) THE FOLD LAYER GROWS WITH A FREEZE WHILE THE TAPE STANDS — the journal's index +14 rows on the new unit, the
...
## Sitting 5b — THE COMPILE OF CHAPTER 7, Deuteronomy 7:1-26 (2026-09-18; the owner: "Go" after sitting 5's run 4): THE DESIGN — written at the close of
...
high_places_banned PRESENT on the land; the journeys' dispossession debits FOUND on the world — commanded on israel_people valued ['destroy_their_images', 'dispossess_the_inhabitants_and_possess_the_land'], OPEN (Num 33:50-56). THE TAPE'S LINES THE CHAPTER RETELLS (every one FOUND by the recon's section 5): the ten
...
remainder enumerated (465 whole, 303 read, 162 by amud [('43a', 18), ('43b', 20), ('44a', 19), ('47a', 22), ('49a', 19), ('50a', 12), ('50b', 13), ('51a', 23), ('53a', 16)]); the dump 520 rows (link 52, topic 468, credited 65 — the whole-range scan's 89 had
...
LAW 145, DERIVATION 34, DISPUTE 110, CONTEXT 156, OUTSIDE 75 in the four parts (A 88, B 169, C 134, D 129); LAW by cell F1 64, F4 1, F5 1, F6 79; OUTSIDE 75 — a declared range's digression on another matter (1b's
form: Avodah Zarah 49, Makkot 10, Sotah 9, Chullin 4, Yevamot 3). THE DOCKET logic/oral_triage/deu_07_vaetchanan_ekev_exam_2026-09-18.md (230305 bytes; coverage computed, the cite index, lint 0) with its
...
RUN 3 — AS RUN (2026-09-18, on "keep going" after run 2's close; the compaction point #195 with its addenda 4-6): THE TYPES BY SCRIPT (add_types_ch7.py from
add_types_ch6.py): kinds 1125 -> 1129, effects 1025 -> 1029 — with ONE COLLISION the design did not see: blessing_promised was already Abram's ladder
entry (Genesis 12:2-3; 26:24) — the first run added three of four, and the chapter's conditional heaven entry is named blessings_for_hearing (the
registry decides; the daemon watch, the kind's text, the runner and the probe Q17 carry the name); daemons 66 -> 67; the span and thirteen CALL edges; I5
67. THE CALLEES' FACTS PRINTED BEFORE ANY ASSERT (ch7_callees.py — the asks' signatures: ordinances.land and erection.covenant take a string and return a
dict, journeys.the_command and the words take (case, data), shemini.classify a signs dict) and THE TAPE'S FIRST VERSES BY GREP of the runners' submits —
covenant_offered at Exod 19:5 (the design's CQ4 said 19:4; the case_source is 'Exod 19:5-6': THE CENSUS DECIDES), brought_out 12:51, healer_promised 15:26,
plague_struck 7:20, stand_here_commanded Deut 5:28. THE RUNNER cold_run_seven_nations.py in four parts (part 1 the header, the guard, the INK block
exec'd and the reading's DB asserts with the readback's deltas; part 2 the six cells, 51 asks; part 3 the callees' facts asserted from the print, the
READBACK table — twenty-one rows, six on the tape by kind and first verse, fifteen in the kin's cells by CALL with cell_found asserted at build — the four
HOLES, nineteen DATA rows (the docket's three among them: the_calfs_agency, the_bans_condition, the_pitys_row), the daemon, LINES, CLOSES, PERSONS
(fourteen), scene(), narrative(); part 4 the CASES generated from the cells' own asks): the fast checker part1 0 / part2 0 ON THE FIRST PASS (the reading's
asserts proven once hold), the DELTA assert typed from its print; ONE ASSEMBLY FAULT — the exam asks returned the WRITE effects (favor_barred …) and the
daemon's case branch maps accepted / exempt / lashes only: the seven exam asks retyped to accepted, the writes on the the_write asks alone (4b's form);
THE FIRST GRADED RUN 51/51, THE SCENE ((1,)*14, four exempt arms, one lashes, no timer, 14 entities, 0 closes) and THE NARRATIVE (7, 0, 1, (11, 1),
0, 0, 0, 0) AS PREDICTED. THE RECORDER AND THE STITCHER (seq_record_ch7.py, seq_stitch_ch7.py — 'seven_nations' appended to the order): statute 3, case
14, register-off 0 — STATUTE BY FORM held; PLACEMENT {'markers': {'text_constrained': 106, 'reading_placed': 46}, 'events': {'text_constrained': 109, 'page_order': 1143, 'reading_placed': 55}} and the CENSUS (2504, 1316, 1307, 1172, 6, 10, 9, 0, 71, 167, 129, 15, 23, 852, 272) AS PREDICTED (on tape 1307, kinds 852, markers 167). THE LITERALS
(patch_seq_literals_ch7.py — RUN (1307, 96, 88, 0, 12, 1602, 38, 319, the four pairs, 127), PREVIOUS_RUN 4b's exactly, NEWEST_RUNNER 'seven_nations',
PLACEMENT and CENSUS read, CQ1-CQ9). THE TAPE 9/10 ON ITS FIRST RUN — every CQ MATCH, THE REST reproduced 4b's tuple exactly; THE ONE MISS four older
checkpoints (CV2, CX2, CW3, CR3) holding the CURRENT COUNT of the commanded entries on israel_people — the ban's DEBIT moves 18 -> 19, the newest
devote_the_seven_nations, open 7 -> 8: RETYPED FROM THE PRINT with the 5b note (the first retype tripped on an unescaped apostrophe — escaped); THE TAPE
10/10 ON ITS SECOND RUN. checkpoint_check.py --all AFTER the tape: 244 rows, 18 misses — EXACTLY 4b's eighteen (the tape's known diverges), 0 raised.
readback_probes.py: readback_probes: 18/18. DEPARTURE FROM THE ORDER: the gates-to-FAIL step (daemon, dependency) was not run separately before the runner; the gates
run in run 4's chain. THE LESSONS: a registry name the design predicts may already exist — the types script's 'added N' count is the tripwire; a DEBIT
on Israel moves the older checkpoints' commanded-count literals (3b's closes lesson, now on the debits — a 'no retype' clause covers only what it
names); the callees' facts print settles the signatures and the first verses before an assert is typed; a probe written before the runner is retyped
once; A GUARD THAT MATCHES A STRING ANOTHER SITTING ALSO WROTE IS NO GUARD (run 2's map paragraph was skipped by one that matched sitting 5's
"RUN 2 — AS RUN (2026-09-18" — both paragraphs appended at this close; a guard names the sitting). ALSO AT THIS CLOSE: the other thread had appended a
"§8 THE OTHER THREAD" to the recovery page (over its 10 KB cap) — folded into one READ ON DEMAND line, the page under the cap again. NEXT: RUN 4 per
THE ORDER — the gates chain, the records, the forms.
...
UNMOVED; PLACEMENT markers {'text_constrained': 106, 'reading_placed': 46}, events {'text_constrained': 109, 'page_order': 1143, 'reading_placed': 55} (page_order 1140 → 1143 — AS PREDICTED); CENSUS (2504, 1316, 1307, 1172, 6, 10, 9, 0, 71, 167, 129, 15, 23,
852, 272) as the stitcher printed it (on tape 1304 → 1307, kinds 849 → 852, subjects 272 unmoved); CQ1-CQ9 all MATCH; the run 16.4s. THE DOCKET logic/oral_triage/deu_07_vaetchanan_ekev_exam_2026-09-18.md by
the union rule: 520 rows (link 52 / topic 468; LAW 145, DERIVATION 34, DISPUTE 110, CONTEXT 156, OUTSIDE 75; credited 117; 230,305 bytes), EVERY ROW READ WHOLE FROM THE START — no cut, no overlay (the parts' WHOLE dicts empty, the correction counts zero and computed); Avodah Zarah 42a-54b's six verse-anchored amudim (42a-42b, 44b-46b, 47b-48b, 49b, 51b-52b, 53b-54b — 303 rows) read whole, the
...
## THE TWO-RUN RULE (owner-ruled 2026-09-18 after 5b's commit 29c189b — "Can we combine runs? These are too short", then "Yes" to the recommendation) — SUPERSEDES THE FOUR-RUN RULE (2026-09-16; its section above stands as history)

THE MEASURE THAT MOVED IT: the four runs came in at 100-200k tokens each against a window of a million; the window that held 5b's run 4 (the chain's wait, the records, the forms), the tutorial's rewrite and the commit used 231k (the owner's /context print: 231.3k of 1m, 23%). THE RULE: a COMPILE sitting is TWO RUNS, a clean compaction point announced after each — RUN A: the rereads (the recovery page, the map's newest section, the memory index; THE_STEPS' compiler block and Step 5's head), the measurements (the recon, the docket scan), THE DESIGN in the map before any code, the probes to FAIL, then THE DOCKET by the union rule (the scan with the ranges named, every row WHOLE in parts on the whole-row instruments, the writer with coverage computed and the cite index) and the map's RUN A paragraph; RUN B: the types by script, the callees' facts printed, the recorder and the stitcher, the runner in parts (the fast checker, the CASES generated from the cells), the literals, the tape to 10/10 with THE REST, checkpoint_check.py --all after the tape, the gates chain in one summary, the records from the sheet in one call (the AS BUILT), the forms copied, the commit message — the commit on the owner's word. A READING sitting is ONE RUN (the measurements and the ink, the rows whole and the ledger, the seat, the chain and the fold, the records). THE SIZES: each run near 300k tokens, never 600k. THE TRIPWIRE: a docket past about 700 rows takes a run of its own (the docket takes the runs its whole reading needs — the whole-row rule stands untouched). The state doc's checkpoint at each run's end names the next run's first step; the recovery page's IN FLIGHT line and the memory index line at each edge as before. WHAT DOES NOT CHANGE: every shelf row whole; the design before the code; the gates in one chain; the records in one call; the compaction announced, the owner compacting. Chapter 8 runs this way: RUN A its reading as one run (the reading sitting), then the compile's RUN A and RUN B.


## Sitting 6 — CHAPTER 8, Deuteronomy 8:1-20 (2026-09-18; the owner: "Go" after 5b's commit 29c189b and THE TWO-RUN RULE): the reading and the unit — THE DESIGN, written after the measurements and the ink, before a row is typed; ONE RUN (a reading sitting under the two-run rule)
...
## Sitting 6 — CHAPTER 8 — AS BUILT (2026-09-18; the design above stands as written — the one run ran as designed; every departure from the design named here)

THE RESULT: Deuteronomy 8:1-20 READ AND FROZEN as one unit — deu_08_manna_humility, the 222nd frozen unit (no portion edge inside it — Ekev runs 7:12-11:25; the
chapter the unit, per the ruling); the ledger logic/oral_triage/deu_08_ekev_2026-09-18.md (36 sources: Onkelos 20 — MATERIAL 18 / CONTEXT 2; the Sifrei's spine
0 rows — SILENT on the chapter; the outside rows 16 — MATERIAL 12 / CONTEXT 4, five of them reread whole; the kin's spine credited by name in its own section — the
Numbers 11, 14, 20 and 21 ledgers' 6 / 2 / 13 / 6 rows and the Mekhilta's 8 over the ledgers, computed; 84,776 bytes; lint 0); the manifest deu_08_manna_humility_claims.json
(6 claims DV08-01..06, verify_claims 6/0, the labels census GREEN — 3,275 claims in 225 manifests labeled, debt 0 (Deuteronomy 52)); six WITNESS_READ seats at 8:1, 2, 7, 11, 15, 19, step E, seven anchor
scenarios; the ritual 13 PASS; the fold predicted and matched before and after the bake (222 units, standing 2215, hash 8b8fff1fa28953af; 1809 facts, 341
demands, 191 open); the display layer +20 by reference and +32 by gloss (by_ref 552, by_gloss 466 after); the stamp row delegated (FULL RULE). No engine file
...
ink (144 asserts, four failing on the first pass and 0 on the second and third), the design, the rows whole, the ledger, the display patch, the manifest, the
...
THE GATES, COMPUTED FROM THEIR PRINTS: the ritual 13 PASS (RITUAL COMPLETE, 222 frozen units); CORPUS TRUTH GREEN twice (222 units, 1809 facts, 341
demands (191 open), hash 8b8fff1fa28953af — the tripwire's literals set to the prediction before the bake, matched); build_world ALL GREEN; the journal gate
GREEN (12 kinds, 9702 rows — 9688 at sitting 5b, +14 on the fold layer with the tape unmoved); the register gate --strict GREEN (DECLARED 100, DEBT 0,
FAILS 0 — no seat in chapter 8); the home-path gate GREEN; the labels census GREEN (3,275 claims in 225 manifests labeled, debt 0 — Deuteronomy 52); large_letter_probes 6/6; the lints at their
baselines.
...
the claims' verifier and the labels census beside it. (11) THE FOLD LAYER GROWS WITH A FREEZE WHILE THE TAPE STANDS — the journal's index +14 rows on the new
unit, the header re-pinned to the unmoved hash (5's lesson held again). (12) A PRINT'S ROW IS READ BY ITS LABEL — the labels census's "num" row is the NUMBERS BOOK'S row (385 at chapters 7
and 8 alike), not the total; the forms since chapter 4 parsed it as the total and the records said "385 labeled": the head line holds the count (3,275
claims in 225 manifests; Deuteronomy 52), the form retyped here, chapter 7's record left as written with this note.
...
## Sitting 6b — THE COMPILE OF CHAPTER 8, Deuteronomy 8:1-20 (2026-09-18; the owner: "Next" after sitting 6's close): THE DESIGN — written at the close of
...
over forty years, told only here (29:4 the plural garments, Nehemiah 9:21 the only other "did not swell"); NO ROW on any ledger names a garment, clothing, a shoe or a swelling on Israel (the other garment rows on the world: 57 — the vestments', Joseph's, Aaron's). THE CHAPTER'S KIN IS IN THE CODE:
...
THE ONE DATABASE READ (run_ledger): manna_provided PRESENT (7, 0), water_from_the_rock PRESENT (14, 0), serpents_sent PRESENT (7, 7),
bread_and_water_blessed ABSENT (0, 0) — in the registry, never on the world: ordinances' entered_the_land case is Joshua's, shema_commanded (6, 0) and test_barred (6, 0) on Israel, other_gods_barred (6, 0), blessings_for_hearing
(5, 5), treasured_people (7, 7); forgetting_barred and bless_after_eating_commanded ABSENT (never written). THE TESTIMONY'S EFFECT: 4:26's line witnesses_called is watched by law_obey_horeb writing ['heaven_and_earth_witness'] (present on Israel: [(6, 0)]) — the chapter's 8:19 REUSES that effect at its second seat, no new effect (the effects 1029 → 1031). THE
...
one case kind), effects 1029 → 1031; CENSUS on tape 1307 → 1310, kinds 852 → 855; PLACEMENT events page_order 1143 → 1146 (the lines on the counter's
...
6:12's clause has a cell and no write; the block written here, its first tape write), THE TESTIMONY (8:19-20 — reused
...
the chapter's third line perishing_testified (8:19-20): the effect witnesses_called writes, REUSED — no new effect.
...
[forgetting_barred]; perishing_testified → [the reused effect]; good_land_case → [accepted, exempt, lashes]. No
...
— ONE case kind (good_land_case); the new effects — bless_after_eating_commanded (status on Israel; 8:10), forgetting_barred (block on Israel; 8:11);
the effects reused — accepted, exempt, lashes, the witnesses-line effect at 8:19; NO registry row (Israel the written-on party; the manna, the rock and the
...
CU6 THE TESTIMONY — the witnesses-line effect on israel_people +1 at source "Deut 8:19" (the reuse), the 4:26 entry UNMOVED.
...
WHOLE to ch8_rows_A-C.txt (73, 80, 114 KB) by the dump's order: A rows 0-117 (the 34 link rows; Mishnah Berakhot 6:1-7:5; Mishnah Bikkurim 1:1-1:11; Berakhot 5a;
...
verdict was typed, the parts' WHOLE dicts empty, apply_whole's counts zero (computed): A 118 rows (CONTEXT 30, DERIVATION 24, DISPUTE 7, LAW 28, OUTSIDE 29), B 142 (CONTEXT 43, DERIVATION 19, DISPUTE 15, LAW 28, OUTSIDE 37),
C 191 (CONTEXT 87, DERIVATION 39, DISPUTE 14, LAW 24, OUTSIDE 27). THE WRITER write_ch8_docket.py (write_ch7_docket.py's form: the ENUMERATED line parsed for Berakhot 35a-49b, LONG 9 ranges
asserted, MISH 24, the three Berakhot ranges inside 35a-49b asserted to sum to the read count, the verse hits asserted, THE UNCITED VERSES COMPUTED) WROTE
logic/oral_triage/deu_08_ekev_exam_2026-09-19.md (184,226 bytes — dated the day it was written, the design having expected 09-18): 451 rows (link 34, topic 417), credited 101
(link 9, topic 92); the verdicts CONTEXT 160, DERIVATION 82, DISPUTE 36, LAW 80, OUTSIDE 93 (link CONTEXT 5, DERIVATION 15, DISPUTE 3, LAW 11; topic CONTEXT 155, DERIVATION 67, DISPUTE 33, LAW 69, OUTSIDE 93); LAW by cell F3 75, F4 4 (no LAW row names F1, F2, F5 or F6 — the chapter's
law is the grace and the warning, the rest reference rows and DATA); OUTSIDE by work Berakhot 67, Yoma 8, Sotah 6, Eruvin 12; Berakhot 35a-49b whole 506, read 197, the remainder 309 enumerated by amud; the
verses cited 3 (4), 5, 7 (2), 8 (8), 9 (5), 10 (14), 11, 14 (3), 15, 16 — 10 cited by no one (1, 2, 4, 6, 12, 13, 17, 18, 19, 20); coverage computed, the cite index 451 addresses, missing 0 extra 0; lint 0 (one flag on the first write — the word for a reciter of the early teaching in one note, retyped in the SPEC and the ledger rewritten by the same writer before any record cited it).
THE CROWNS (fourteen in the finds section): the grace after meals BY TORAH LAW and its four blessings — the verse cut three ways (the baraita's 48b:5, the Tosefta 6:1's, Rabbi's 48b:6), the fourth blessing's standing disputed (49a:5); THE BLESSING BEFORE — every derivation refuted (the praises, the a fortiori, the seven species, "that He gave you", Exodus 23:25, Saul's blessing), the rule FOUNDED ON REASON and rabbinic (35a:18-19; 20b:16; 21a:2, 21a:6) — the write names the after alone; THE MEASURE OF "SATISFIED" a PARAMETER with a Torah edge (20b:14; R. Meir's olive against R. Yehuda's egg from the two verbs at 49b:9, Pesachim 49b, Yoma 79b, Mishnah 7:2; R. Tzadok; "that is hunger" 42a:2; wine satisfies but no meal is based on it); THE COMMAND'S FORM — the grace NOT AN OBLIGATION but conditional on eating (49b:4), not time-bound (20b:7), its persons (women OPEN 20b:11-14; the priests; consecrated food; the zimmun's (the invitation's) persons), the meal's end and the reciter (42a:5-7, 43a:11-12; "Rav is dead and we have not learned the laws of the grace" 43a:1); the order of blessings by the verse and RAV HAMNUNA'S TWO "LAND"S (41a:8, 41b:5), the verse's other reading — the measures (Eruvin 4a, Sukkah 5b, 41a:9-41b:3; the Rambam: a mnemonic), the seven species' after-blessing and "A LAND CONCLUDED THE MATTER" — the grace's object bread (44a:10), 8:8-10 the paradigm of every blessing (35a:15); the first fruits from the seven species (Bikkurim 1:3, 1:10; Menachot 84a-b; the seven vessels); "he afflicted you and let you hunger" — the Day's affliction hunger by the analogy with 8:3 and ITS TWO GUARDS (the public's from the public's, God's hand from God's hand — Yoma 74b:12-13), the manna's forms and tastes, the daily manna's reason ("everyone's heart to their Father in Heaven every day" 76a:2-3), the sixty cubits, MOSES' FIRST BLESSING AT THE MANNA (48b:2); the Land lacks nothing — the pepper (three seats), the stones read builders (Taanit 4a), 28:48's inversion (35b:7); the afflictions of love and the Land's price (5a:9-23); arrogance — denial (4b:11), idolatry by 7:26 (4b:10), hewn like an Asherah by 7:5 (5a:10), the eighth of an eighth (5a:16-17), "filling his stomach" (32a); "BEWARE, LEST, NOT" NOTHING BUT A PROHIBITION at three seats (Sotah 5a:3; Makkot 13b:5; Eruvin 96a:8) and the rule's limit (96a:9) — 8:11 a negative command, forgetting_barred a BLOCK; the grace in any language (Sotah 33a); the rock's verb in the blessing's grammar (38a); 12:21 a receipt seat forward (Yoma 75b:4).
WHAT THE DESIGN DID NOT PREDICT, for RUN B: (1) the grace CONDITIONAL on eating, not an obligation (Berakhot 49b:4) — a DATA row the_grace_conditional for F3; (2) the first blessing instituted AT THE MANNA before its verse (48b:2) — an install-order note for the table beside THE INSTALL HYPOTHESIS; (3) Rabbi's third division of the verse and the fourth blessing's standing disputed (48b:6, 49a:5) — the four blessings' DATA row carries three divisions; (4) "a land concluded the matter" — the grace's object BREAD by the Rabbis (44a:10) — the write's object named in F3's row; (5) the analogy's two guards — 8:3's hunger GOD'S ACT on the PUBLIC (Yoma 74b:12-13) — the readback row 8:3 TURNED's shelf reading, cited in the row; (6) 12:21 "as I have commanded you" a receipt seat for chapter 12's compile (Yoma 75b:4) — a note owed forward; (7) 28:48 "in want of all things" inverts 8:9's "lack nothing" (Berakhot 35b:7) — a note for F3 lack_nothing, chapter 28 forward; (8) the quail's written/read pair and the 248 counted from a defective spelling (Yoma 75b:6, 75b:10) — the store's letters again, notes. THE DESIGN'S ONE OPEN DECISION MEASURED ON THE SHELF: 8:4 (the garment and the foot) is cited by NO ROW — the fifth form's SUPPLIED grade stands unchallenged by the shelf, the decision the owner's. NOTHING OF THE ENGINE TOUCHED; the tree: + the exam ledger, + eighteen forms in
...
THE RUN: cold_run_good_land.py the 63rd runner — 55/55 on its FIRST graded run (six cells, 55 asks — per cell {'F1': 4, 'F2': 9, 'F3': 20, 'F4': 8, 'F5': 6, 'F6': 8}; the CASES generated from the cells'
...
-> 855 read at the stitcher's print as predicted, markers 167, closes 127, entities 319 unmoved, CU1-CU9 MATCH (16.8 s); THE FIRST RUN 9/10 — ONE OLDER
...
21/21 after. THE GATES (one chain, ALL GREEN): the daemon gate GREEN (68 daemons, 466 functions WRAPPED); the dependency gate GREEN (574 edges and 200 pointers on file — the link census reference 553 / transfer 48 / hypothesis 9 / none 164; required 265 edges and 201 pointers, live import edges 420); build_world ALL GREEN (222 units, standing 2215, hash 8b8fff1fa28953af unmoved — no freeze this run); the journal gate GREEN twice — before and after the sweep (12 kinds, 9702 rows in the index); THE REGISTER GATE --strict GREEN (DECLARED 100, DEBT 0, FAILS 0 — no seat in chapter 8: no receipt form in it, as the design measured and the runner's F1 asserts by the finder's own rule); the positions table 253 checkpoints over 169 pauses (CU1-CU9 in it; checkpoint_probes 7/7 after the rebuild); the sweep 63/63 at 6,724 graded cells; the home-path gate GREEN; the twelve probe suites — census 224/224, installation 6/6 (I5 68), readback 21/21 (Q19-Q21 the fifth form), register 7/7, clock 22/22, sequence 4/4, view 6/6, population 9/9, journal 7/7, cursor 6/6, large_letter 6/6, checkpoint 7/7. THE DOCKET (its own run, 2026-09-19): 451 rows (link 34 / topic 417; LAW 80, DERIVATION 82, DISPUTE 36, CONTEXT 160, OUTSIDE 93; credited 105; 184,226 bytes), EVERY ROW READ WHOLE FROM THE START — no cut, no overlay (the parts' WHOLE dicts empty, the correction counts zero and computed).
...
value (the fast checker's print); (10) the guard's count from the generator's print (55), never a grep; (11) the readback's rb() form extended — a
...
## Sitting 7 — CHAPTER 9, Deuteronomy 9:1-29 (2026-09-19; the owner: "Let's keep run as it is and do another section" after THE GATES CUT): the reading and the unit — THE DESIGN, written after the measurements and the ink, before a row is typed; ONE RUN (a reading sitting under THE TWO-RUN RULE)
...
## Sitting 7 — CHAPTER 9 — AS BUILT (2026-09-19; the design above stands as written — the one run ran as designed; every departure from it is named here)
...
ledger logic/oral_triage/deu_09_ekev_2026-09-19.md (36 sources — Onkelos 29: MATERIAL 28 / CONTEXT 1; the Sifrei's outside rows 7: MATERIAL 6 / CONTEXT
1; 71,446 bytes, lint 0, no cut missed), the manifest 6 claims DV09-01..06 verified 6/0 (every he_contains cut from the store's own bytes; every cite
index name used by a claim), seated as six WITNESS_READ operators at 9:1, 7, 12, 15, 22, 25 with step E; the ritual 13 PASS; verify_text GREEN (29 steps,
7 scenarios); the fold predicted and matched (units 222 → 223, standing 2215 → 2221, the hash 8b8fff1fa28953af unmoved — CORPUS TRUTH GREEN before and after
the bake: 223 units, 1809 facts, 341 demands, 191 open); build_world ALL GREEN; the journal gate GREEN (12 kinds, 9716 rows — +14 on the fold layer since
chapter 8's reading, the tape unmoved); the register gate --strict GREEN (DECLARED 100, DEBT 0, FAILS 0 — no receipt form in the chapter); large_letter_probes 6/6;
the labels census GREEN (3,281 claims in 226 manifests, Deuteronomy 58); the home-path gate GREEN; the display layer +60 by reference and +36 by gloss (612 / 502 in all).
...
THE GATES, COMPUTED FROM THEIR PRINTS: the ritual 13 PASS (RITUAL COMPLETE, 223 frozen units); CORPUS TRUTH GREEN twice (223 units, 1809 facts, 341 demands, 191 open;
the hash unmoved); build_world ALL GREEN; the journal gate GREEN (12 kinds, 9716 rows, +14); the register gate --strict GREEN (DECLARED 100, DEBT 0, FAILS 0);
verify_claims 6 verified / 0 failed; the labels census GREEN (3,281 claims in 226 manifests); large_letter_probes 6/6; the home-path gate GREEN; the ink 164 asserts — 18 failing on the first
...
COMMITTED 2f4ec5b (2026-09-20, on the owner's "Commit" — not pushed; a985fbc the last push): the cache, 7b, 8, 8b and this sitting in one message. NEXT on his word: the push; 9b.


## Sitting 9b — THE COMPILE OF CHAPTER 11, Deuteronomy 11:1-32 (2026-09-20; the owner: "9b go" after sitting 9's commit 2f4ec5b): THE DESIGN — written at the close of RUN A of two under THE TWO-RUN RULE (the rereads: THE_STEPS' compiler block and Step 5's head, the sitting-9 AS BUILT, the 8b
...
deu_11_ekev_reeh_exam_2026-09-20.md — 1048 rows (link 74 in 20 works, topic 974: the eight Mishnah rows; Berakhot 13a-16a 191; Menachot 34a-37b 98; Kiddushin 29a-30b 75; Kiddushin 36b-37a 24; Kiddushin 40b-40b 14; Taanit 2a-3a 44; Taanit 7a-10a 118; Berakhot 33a-33a 37; Rosh Hashanah 16a-17b 67; Gittin 8a-8a 11; Pesachim 8b-8b 17; Sotah 32a-37b 188; Ketubot 110b-111a 52; Sanhedrin 90b-90b 21; Sukkah 52a-52a 13;
Tosefta Sotah 8 and Tosefta Sheviit 4 whole; Tosefta Sotah 8:6 listed twice in the dump — the link row and the chapter's listing — taken once, 1 dropped, computed);
the verdicts LAW 258, DERIVATION 150, DISPUTE 113, CONTEXT 423, OUTSIDE 104 (the link rows LAW 37, DERIVATION 17, DISPUTE 5, CONTEXT 14, OUTSIDE 1; the topic rows LAW 221, DERIVATION 133, DISPUTE 108, CONTEXT 409, OUTSIDE 103); LAW by cell, this docket's own notes {'F2': 8, 'F3': 35, 'F4': 8, 'F5': 11}; credited 622 — 571 CARRIED WITH THEIR
...
beginning "CREDITED (<ledger>; carried) —") and 51 whose ledger's form carried no verdict (the Exodus and Genesis triages' CREDIT rows, the topic dockets' lists,
the gen_ tables) READ WHOLE HERE; 477 ROWS READ WHOLE IN THIS RUN in ten chunk files (ch11_docket_uncred.py — 27,000 bytes each, the row printed entire);
coverage computed (missing 0, extra 0); lint 0 after one gloss on a carried word; the verses no row cites [1, 2, 3, 4, 5, 7, 8, 9, 22, 23, 24, 25, 26, 27, 28, 32]. THE CROWNS (the file's finds section): THE YOKE
...
many); (9) THE EXAM'S PERSONS nineteen, one exempt (the pilgrim with no land — Pesachim 8b:9); (10) THE POINTER at 11:25 DEMANDED by the census (the design's
...
the counter's day, the two parameters and the one-database scans typed); ch11_part2.py (six cells, 59 asks — F1 9, F2 7, F3 18, F4 7, F5 13, F6 5);
...
ch11_fastcheck.py (0 fails after the scan narrowed); ch11_cases_gen.py (59 cases — two slips at the import: the cascade cell's found-test, the DATA count);
ch11_assemble.py --guard 59; cold_run_blessing_and_curse.py 59/59; seq_record_ch11.py with the cache OFF (3039 records; blessing_and_curse statute 2, case 19);
seq_stitch_ch11.py (no marker; PLACEMENT {'markers': {'text_constrained': 108, 'reading_placed': 49}, 'events': {'text_constrained': 110, 'page_order': 1151, 'reading_placed': 58}}; CENSUS (2520, 1319, 1319, 1185, 6, 10, 9, 0, 71, 172, 131, 15, 26, 864, 272)); patch_seq_literals_ch11.py (the import line, DAEMON_ORDER, RUN, PREVIOUS_RUN, NEWEST_RUNNER,
PLACEMENT and CENSUS read, DC1-DC9, the VERDICTS, DB7 retyped); the tape 10/10 (17.7 s); checkpoint_check.py --all (280 rows, 18 miss — the eighteen known,
0 raised); Q30 retyped once from the print; THE GATES CHAIN TWICE — the first pass stopped at the probes step (readback 29/30: Q30's retype had put its comment INSIDE the return's tuple, the second element swallowed, the probe's unpack a TypeError; ink_cache 7/8: C2 fell on the runner's two RAW scan names alone, the database's state at the harvest — before the tape sealed the sitting's own five entries — against the full load's after it; the raw names dropped from the module, the derived own-excluded lists kept, equal on both loads) and at the dependency gate by THREE demands (the token census matched 'Pharaoh KING of Egypt' at 11:3 to the sanctions span's Molech — a homograph filed FALSE, 5b's lesson a second time; the sequential run's registration edge sequence -> blessing_and_curse filed with link none, 8b's form; the AS_WHEN pointer at Deut 11:25 'as He spoke to you' dispositioned RUN_CITATION of Exodus 23:27 by two teachers — the design's prediction, the census's demand); the dependency gate rerun alone GREEN, the runner rerun 59/59 with the cache off, then the second pass whole from the tape GREEN to the register gate (readback 30/30, ink_cache 8/8, the dependency gate satisfied) and KILLED at the positions table by the session's memory watchdog (eight workers each the whole tape — 7b's kill, not the machine's own gate); THE POSITIONS TABLE THEN BY FOUR WORKERS with the step's own command (checkpoint_positions.py --jobs 4, its print in the chain's folder), and the third pass from the checkpoint probe ALL GREEN: the probe suites (readback 30/30, census 224/224, installation
6/6 with I5 71, large_letter 6/6, checkpoint 7/7, ink_cache 8/8), the daemon gate (71
daemons, 484 functions), the dependency gate (626 edges, 204 pointers; the link census reference 599 / transfer 48 / hypothesis
9 / none 174), build_world, the journal gate (12 kinds, 9744 rows), THE REGISTER GATE --strict (DECLARED 100, DEBT 0,
FAILS 0 — no seat in chapter 11), the positions table (280 checkpoints), the sweep 65/65 at 6886 graded cells, the home-path gate.
THE LESSONS (thirteen): (1) THE DOCKET'S NEW FORM — a credited row is CARRIED with its ledger's own verdict line, parsed from the ledger's form by script; a form
...
its fourth compile sitting with the docket clause: RUN A, the docket, RUN B — three clean points, the owner compacting once; (13) A GUARD NEVER TYPES WHAT IT
GUARDS AGAINST — the design writer's copy named the machine username as its own assert's literal and the home-path gate refused the commit (bb62e90 after the
retype to a regex without the name). NEXT on the owner's word: CHAPTER 12's
...
computed — the English's 12:32 the DB's 13:1; no portion edge inside it): the ledger logic/oral_triage/deu_12_reeh_2026-09-20.md (197 sources — Onkelos 31: MATERIAL
30 / CONTEXT 1; THE SIFREI'S SPINE piskaot 59-81 159 rows: MATERIAL 102 / CONTEXT 57, 4 of them read before and REREAD WHOLE (the prior reads found in the earlier
ledgers by computation — 61:7 at chapter 7, 80:4-5 at chapter 11, 75:2 at two Genesis sittings); the outside rows 7: MATERIAL 6 / CONTEXT 1, 1 reread (2:2 from
sitting 1); 149,777 bytes, lint 0, no cut missed), the manifest 6 claims DV12-01..06 verified 6/0 (every he_contains cut from the store's own bytes; every cite index
...
outside rows with the claims whose verses they cite), seated as six WITNESS_READ operators at 12:1, 5, 13, 15, 20, 29 with step E; the ritual 13 PASS; verify_text
GREEN (31 steps, 7 scenarios); the fold predicted and matched (units 225 → 226, standing 2233 → 2239, the hash 8b8fff1fa28953af unmoved — CORPUS TRUTH GREEN before
and after the bake: 226 units, 1809 facts, 341 demands, 191 open); build_world ALL GREEN; the journal gate GREEN (12 kinds, 9758 rows — +14 on the fold layer since
chapter 11's reading, the tape unmoved since 9b); the register gate --strict GREEN (DECLARED 100, DEBT 0, FAILS 0 — the header at 12:1 the declared EMPTY seat; 12:21's
"as I have commanded you" listed nowhere: the receipt without the Name, the finder's fourth seat); large_letter_probes 6/6; the labels census GREEN (3,299 claims in 229 manifests,
Deuteronomy 76); the home-path gate GREEN; the display layer +124 by reference and +69 by gloss (983 / 673 in all).
...
the ledger's rows — E1 at 63:2, 68:4, 68:5, 70:5, 76:7, 78:4, 81:6; E10 at 67:4, 68:6; I1 at 71:6, 72:9, 72:10, 72:11, 73:1, 74:1, 76:2, 76:5, 76:7, 76:8, 76:9, 145:3, 286:16; I2 at 62:4, 63:9, 64:2, 69:1, 71:6, 138:1; I12 at 59:5; I13 at 62:2, 62:3, 70:4. THE GATES CHAIN RAN ONCE, ALL GREEN ON ITS FIRST PASS (19:19:18 to 19:26:57 — 7 min 39 s: the seat, verify_text, the ritual, the fold, build_world, the journal gate, the register gate --strict, large_letter, the home gate; no demand, no retype; the summary read once) — launched in one background command behind the manifest, verify_claims (6 verified / 0 failed) and the labels census (GATE PASSED, debt 0 — no label refused: every middah string ends in its parenthesis, chapter 10's lesson 7 kept, asserted by the manifest writer before a byte was written).

THE GATES, COMPUTED FROM THEIR PRINTS: the ritual 13 PASS (RITUAL COMPLETE, 226 frozen units); CORPUS TRUTH GREEN twice (226 units, 1809 facts, 341 demands, 191 open;
the hash unmoved); build_world ALL GREEN; the journal gate GREEN (12 kinds, 9758 rows, +14); the register gate --strict GREEN (DECLARED 100, DEBT 0, FAILS 0);
verify_claims 6 verified / 0 failed; the labels census GREEN (3,299 claims in 229 manifests); large_letter_probes 6/6; the home-path gate GREEN; the ink 121 asserts — 5 failing on the
first typed pass, 0 on the second and third (the third after the display patch).
...
name to the ch11 → ch12 replace; a placeholder guards it. (13) EVERY STEP TIMED — the machine's share of the sitting 11 min 49 s of 115 min 30 s wall time from
2026-09-20 17:34:53 to the records; the rest the reading, the typing and one compaction: the reading is the sitting, the machine its instrument.
...
| step | began | ran | the gap before it (reading, typing, the owner's compaction) |
|---|---|---|---|
| rereads (the page, the map, the memory, THE_STEPS, sitting 9) | 17:36:08 | 75 s | 1 min 15 s |
| dump0 (the measurements' first pass) | 17:38:34 | 12 s | 1 min 11 s |
| measure1 (the second measurement pass) | 17:50:32 | 18 s | 11 min 46 s |
| ink (the first typed pass, assert_driver) | 18:13:40 | 18 s | 22 min 50 s |
| ink (the second pass) | 18:14:47 | 18 s | 0 min 49 s |
| design (the map's section) | 18:17:27 | 0 s | 2 min 22 s |
| ledger (the rows and the writer) | 18:33:47 | 19 s (rc 1) | 16 min 20 s |
| ledger (the second run) | 18:34:58 | 18 s | 0 min 52 s |
| rereads (the tail: the page, the map's Sitting 10, the memory) | 19:06:03 | 32 s | 30 min 47 s |
| patch (the display layer, ch12_patch_overrides.py) | 19:10:28 | 18 s | 3 min 53 s |
| ink (the third pass, PATCHED) | 19:10:46 | 19 s | 0 min 0 s |
| manifest (write_ch12_manifest.py — six claims) | 19:19:17 | 0 s | 8 min 12 s |
| verify_claims (the six claims) | 19:19:17 | 0 s | 0 min 0 s |
| labels census --strict | 19:19:17 | 0 s | 0 min 0 s |
| gates chain (ch12_gates.sh: the seat, verify_text, the ritual, the fold, build_world, the journal gate, the register gate --strict, large_letter, the home gate) | 19:19:17 | 460 s | 0 min 0 s |
| records --check (write_ch12_records.py) | 19:29:18 | 0 s (rc 1) | 2 min 21 s |
| records --check (second run) | 19:29:34 | 0 s (rc 1) | 0 min 16 s |
| records --check (third run, the page trimmed) | 19:30:21 | 2 s | 0 min 47 s |

The chain's inner steps (ch12_gates_SUMMARY.txt): chain 54 s; fold 89 s; build_world 61 s; journal_gate 250 s; register_gate 2 s; large_letter 1 s; home_gate 2 s; the chain 7 min 39 s in all. The machine's share 11 min 49 s; the sitting 115 min 30 s from 2026-09-20 17:34:53
...
computed — the English's 12:32 the DB's 13:1; no portion edge inside it): the ledger logic/oral_triage/deu_13_reeh_2026-09-21.md (122 sources — Onkelos 19: MATERIAL
19 / CONTEXT 0; THE SIFREI'S SPINE piskaot 82-96 97 rows: MATERIAL 59 / CONTEXT 38, 2 of them read before and REREAD WHOLE (the prior reads found in the earlier
ledgers by computation — 82:5 at sitting 1, 83:4 at a Genesis sitting); the outside rows 6: MATERIAL 6 / CONTEXT 0, none read before; 100,667 bytes, lint 0, no cut
missed — the ledger written clean on its first run), the manifest 6 claims DV13-01..06 verified 6/0 (every he_contains cut from the store's own bytes; every cite index name
...
six outside rows with the claims whose verses they cite), seated as six WITNESS_READ operators at 13:1, 2, 7, 13, 17, 19 with step E; the ritual 13 PASS; verify_text
GREEN (19 steps, 7 scenarios); the fold predicted and matched (units 226 → 227, standing 2239 → 2245, the hash 8b8fff1fa28953af unmoved — CORPUS TRUTH GREEN before
and after the bake: 227 units, 1809 facts, 341 demands, 191 open); build_world ALL GREEN; the journal gate GREEN (12 kinds, 9772 rows — +14 on the fold layer since
10b's chain, the tape unmoved since 10b); the register gate --strict GREEN (DECLARED 100, DEBT 0, FAILS 0 — no receipt, no header, no footer in chapter 13; 13:18's
"as He swore to your fathers" the oath's AS_WHEN form, a run citation for 11b's census); large_letter_probes 6/6; the labels census GREEN (3,305 claims in 230 manifests, Deuteronomy 82);
the home-path gate GREEN; the display layer +139 by reference and +34 by gloss (1122 / 707 in all).
...
THE DISPLAY PATCH held first time (twelve asserted substitutions on the chapter-12 form; the anchors sitting 10's last rows found by walking, never typed; override rows written: by_ref 139 by_gloss 34 | by_ref total 1122 | by_gloss total 707).
THE MIDDAH CODES held — every code checked in MIDDOT.md before it was typed, none relabeled: the census from the ledger's rows — E30 at 93:2; I1 at 86:3; I2 at 86:6, 90:2, 93:6, 117:3, 149:1, 190:7. THE GATES CHAIN RAN ONCE, ALL GREEN ON ITS FIRST PASS (11:49:38 to 11:57:33 — 7 min 55 s: the seat, verify_text, the ritual, the fold, build_world, the journal gate, the register gate --strict, large_letter, the home gate; no demand, no retype; the summary read once) — launched in the background after the manifest (every cite index name used), verify_claims (6 verified / 0 failed) and the labels census (GATE PASSED, debt 0 — no label refused: every middah string ends in its parenthesis, asserted by the manifest writer before a byte was written) had run in the foreground and their prints were read.

THE GATES, COMPUTED FROM THEIR PRINTS: the ritual 13 PASS (RITUAL COMPLETE, 227 frozen units); CORPUS TRUTH GREEN twice (227 units, 1809 facts, 341 demands, 191 open;
the hash unmoved); build_world ALL GREEN; the journal gate GREEN (12 kinds, 9772 rows, +14); the register gate --strict GREEN (DECLARED 100, DEBT 0, FAILS 0);
verify_claims 6 verified / 0 failed; the labels census GREEN (3,305 claims in 230 manifests); large_letter_probes 6/6; the home-path gate GREEN; the ink 103 asserts — 0 failing on
...
the shelf quotes the read form (94:2); the Prophets write the feminine, the Torah never. (13) EVERY STEP TIMED — the machine's share of the sitting 9 min 57 s of
84 min 2 s wall time from 10:36:30 to the records; the rest the reading, the typing and one compaction: the reading is the sitting, the machine its instrument.
...
| step | began | ran | the gap before it (reading, typing, the owner's compaction) |
|---|---|---|---|
| 11 dump0 (the measurements' first pass) | 10:36:30 | 12 s | 0 min 0 s |
| 11 the spine split by piska | 10:38:02 | 0 s | 1 min 20 s |
| 11 measure1 (the second measurement pass) | 10:46:09 | 19 s | 8 min 7 s |
| 11 ink (the first typed pass, assert_driver) | 11:06:09 | 0 s | 19 min 41 s |
| 11 ink (the first typed pass, rerun from the repo root) | 11:08:06 | 18 s | 1 min 57 s |
| 11 ink (the second pass, the English's slips added) | 11:25:34 | 17 s | 17 min 10 s |
| 11 design (the map's section) | 11:25:51 | 1 s | 0 min 0 s |
| 11 ledger (the rows and the writer) | 11:25:52 | 17 s | 0 min 0 s |
| 11 ledger lint | 11:27:18 | 0 s | 1 min 9 s |
| 11 the clean compaction point | 11:27:18 | 0 s | 0 min 0 s |
| 11 the display patch (the overrides written) | 11:38:07 | 18 s | 10 min 49 s |
| 11 ink (the third pass, PATCHED) | 11:38:25 | 18 s | 0 min 0 s |
| 11 manifest (six claims, every cite index name used) | 11:48:49 | 0 s | 10 min 6 s |
| 11 verify_claims | 11:48:49 | 0 s | 0 min 0 s |
| 11 labels census | 11:48:49 | 0 s | 0 min 0 s |
| 11 the gates chain (seat, verify_text, ritual, fold, build_world, journal, register --strict, large_letter, home) | 11:49:38 | 475 s | 0 min 49 s |
| 11 records (--check, nothing written) | 12:00:30 | 2 s | 2 min 57 s |

The chain's inner steps (ch13_gates_SUMMARY.txt): chain 54 s; fold 89 s; build_world 60 s; journal_gate 267 s; register_gate 2 s; large_letter 1 s; home_gate 2 s; the chain 7 min 55 s in all. The machine's share 9 min 57 s; the sitting 84 min 2 s from 10:36:30

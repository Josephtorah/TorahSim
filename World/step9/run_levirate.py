#!/usr/bin/env python3
"""run_levirate.py — run round 33 (LEVIRATE, SEED, AND UNIONS) against the engine.

Loads cases_levirate.yaml, validates every input against the vocabulary
...
def main():
    spec = yaml.safe_load(open(HERE / "cases_levirate.yaml",
                               encoding="utf-8"))
    ...
    print("\nLEVIRATE: %d cases, %d answered, %d matched, %d misses"

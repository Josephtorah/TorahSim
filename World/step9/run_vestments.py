#!/usr/bin/env python3
"""run_vestments.py — run round 27 (VESTMENTS AND INVESTITURE) against the engine.

Loads cases_vestments.yaml, validates every input against the vocabulary
...
def main():
    spec = yaml.safe_load(open(HERE / "cases_vestments.yaml",
                               encoding="utf-8"))
    ...
    print("\nVESTMENTS: %d cases, %d answered, %d matched, %d misses"

# THE FRONTIER LEDGER — verses the law engine is owed by underived books
# (Set up 2026-08-31 on the owner's word. Append rows as rules meet roots
# outside the compiled corpus; flip rows to PAID as the compile pass
# reaches them. This is also the prioritization map for pass 1.)

## THE INTAKE RULE (standing, proven by the pilot)
A case row qualifies for the Step 9 exam ONLY if a derived unit already
anchors it — we never go TO the Mishnah; it reaches us through wires the
reading soldered. Rules may still rest on roots in underived books: those
are recorded here as anchor_pending in the engine's provenance, never
chased, never pretended.

## OWED

| verse | quote | owed by | why | recorded at |
|---|---|---|---|---|
| Leviticus 18:5 | "and live by them" | life_override (doubt cases — the rockslide) | the sugya auditions every proposed derivation of the Shabbat override and refutes all FOR DOUBT except Shmuel's from this verse | Yoma 85b:6, read 2026-08-31 |
| Exodus 31:16 | "the children of Israel shall keep Shabbat, to observe Shabbat" | life_override (certain-danger leg) | R. Shimon ben Menasya: desecrate one Shabbat so he will observe many — stands for certain danger, refuted for doubt | Yoma 85b:3, read 2026-08-31 |

#!/usr/bin/env python3
"""run_capital.py — run round 25 (CAPITAL MODES AND IDOLATRY SERVICE) against the engine.

Loads cases_capital.yaml, validates every input against the vocabulary
...
def main():
    spec = yaml.safe_load(open(HERE / "cases_capital.yaml",
                               encoding="utf-8"))
    ...
    print("\nCAPITAL: %d cases, %d answered, %d matched, %d misses"

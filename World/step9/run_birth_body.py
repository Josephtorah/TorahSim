#!/usr/bin/env python3
"""run_birth_body.py — run round 39 (BIRTH AND THE BODY) against the engine.

Loads cases_birth_body.yaml, validates every input against the vocabulary
...
def main():
    spec = yaml.safe_load(open(HERE / "cases_birth_body.yaml",
                               encoding="utf-8"))
    ...
    print("\nBIRTH-BODY: %d cases, %d answered, %d matched, %d misses"

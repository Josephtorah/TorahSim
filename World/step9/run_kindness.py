#!/usr/bin/env python3
"""run_kindness.py — run round 41 (KINDNESS, MOURNING, AND CHARITY — the Genesis finale) against the engine.

Loads cases_kindness.yaml, validates every input against the vocabulary
...
def main():
    spec = yaml.safe_load(open(HERE / "cases_kindness.yaml",
                               encoding="utf-8"))
    ...
    print("\nKINDNESS: %d cases, %d answered, %d matched, %d misses"

#!/usr/bin/env python3
"""run_emor.py — run round 45 (THE EMOR EXAM — bare Mishnah rows, Lev 21-24) against the engine.

Loads cases_emor.yaml, validates every input against the vocabulary
...
def main():
    spec = yaml.safe_load(open(HERE / "cases_emor.yaml",
                               encoding="utf-8"))
    ...
    print("\nEMOR: %d cases, %d answered, %d matched, %d misses"

#!/usr/bin/env python3
"""run_persons.py — run round 14 (THE ORDINANCES PERSONS) against the engine.

Loads cases_persons.yaml, validates every input against the vocabulary
...
agreement. Same discipline as run_tzav.py."""
import sys
...
def main():
    spec = yaml.safe_load(open(HERE / "cases_persons.yaml",
                               encoding="utf-8"))
    ...
    print("\nPERSONS: %d cases, %d answered, %d matched, %d misses"

#!/usr/bin/env python3
"""run_tzav.py — run the Vayikra exam's case rows against the engine.

Loads cases_tzav.yaml, validates every input against the vocabulary
...
agreement. Same discipline as run_vayikra.py."""
import sys
...
def main():
    spec = yaml.safe_load(open(HERE / "cases_tzav.yaml",
                               encoding="utf-8"))
    ...
    print("\nTZAV: %d cases, %d answered, %d matched, %d misses"

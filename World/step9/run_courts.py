#!/usr/bin/env python3
"""run_courts.py — run round 13 (THE COURTS) against the engine.

Loads cases_courts.yaml, validates every input against the vocabulary
...
def main():
    spec = yaml.safe_load(open(HERE / "cases_courts.yaml",
                               encoding="utf-8"))
    ...
    print("\nCOURTS: %d cases, %d answered, %d matched, %d misses"

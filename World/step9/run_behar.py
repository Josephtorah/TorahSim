#!/usr/bin/env python3
"""run_behar.py — run round 46 (THE BEHAR-BECHUKOTAI EXAM — bare Mishnah rows, Lev 25-27) against the engine.

Loads cases_behar.yaml, validates every input against the vocabulary
...
def main():
    spec = yaml.safe_load(open(HERE / "cases_behar.yaml",
                               encoding="utf-8"))
    ...
    print("\nBEHAR-BECHUKOTAI: %d cases, %d answered, %d matched, %d misses"

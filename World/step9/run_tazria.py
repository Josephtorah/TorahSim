#!/usr/bin/env python3
"""run_tazria.py — run round 43 (THE TAZRIA-METZORA EXAM — bare Mishnah rows, Lev 12-15) against the engine.

Loads cases_tazria.yaml, validates every input against the vocabulary
...
def main():
    spec = yaml.safe_load(open(HERE / "cases_tazria.yaml",
                               encoding="utf-8"))
    ...
    print("\nTAZRIA-METZORA: %d cases, %d answered, %d matched, %d misses"

#!/usr/bin/env python3
"""run_pesach.py — run round 16 (THE PASCHAL OFFERING) against the engine.

Loads cases_pesach.yaml, validates every input against the vocabulary
...
def main():
    spec = yaml.safe_load(open(HERE / "cases_pesach.yaml",
                               encoding="utf-8"))
    ...
    print("\nPESACH: %d cases, %d answered, %d matched, %d misses"

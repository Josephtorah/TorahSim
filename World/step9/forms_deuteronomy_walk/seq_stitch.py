...
_ROOT = _sp.check_output(['git', 'rev-parse', '--show-toplevel'], text=True).strip()   # a scratch script (THE DEUTERONOMY WALK 1b, 2026-09-15): the repo root from git, never typed — the forms' three-dirs-up form fits the repo's own copies alone

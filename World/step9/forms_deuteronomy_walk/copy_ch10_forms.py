#!/usr/bin/env python3
# THE DEUTERONOMY WALK sitting 8 — CHAPTER 10's READING (2026-09-19/20): the sitting's scripts and prints copied from the scratchpad into
...
PY = ['derive_ch10_dump0.py', 'ch10_dump0.py', 'derive_ch10_measure1.py', 'ch10_measure1_sections.py', 'ch10_measure1.py', 'ch10_ink_head.py', 'ch10_ink_body.py', 'derive_ch10_ink.py', 'ch10_ink.py', 'ch10_ink_diag.py', 'patch_ink_ch10.py', 'assert_driver.py',
      'ch10_rows_onkelos_a.py', 'ch10_rows_onkelos_b.py', 'ch10_rows_outside.py', 'write_ch10_ledger.py', 'ch10_patch_overrides.py', 'write_ch10_manifest.py', 'seat_ch10.py', 'write_ch10_design.py', 'write_ch10_records.py', 'copy_ch10_forms.py']
OUT = ['ch10_dump0.out', 'ch10_measure1.out', 'ch10_onkelos.txt', 'ch10_sifrei_outside.txt', 'ch10_store_glosses.txt', 'ch10_ink_run1.out', 'ch10_ink_run2.out', 'ch10_ink_run3.out', 'ch10_manifest.out',
       'ch10_chain.log', 'ch10_ritual_deu_10_second_tablets.out', 'ch10_vt_deu_10_second_tablets.out', 'ch10_vc.out', 'ch10_labels.out', 'ch10_fold.out', 'ch10_fold_check1.out', 'ch10_bake.out', 'ch10_build.out', 'ch10_journal.out', 'ch10_register.out', 'ch10_large_letter.out', 'ch10_home.out', 'ch10_truth.out', 'ch10_gates_SUMMARY.txt', 'ch10_gates.log', 'ch10_records_check.out', 'ch10_records_write.out', 'ch10_chain.sh', 'ch10_fold.sh', 'ch10_gates.sh']

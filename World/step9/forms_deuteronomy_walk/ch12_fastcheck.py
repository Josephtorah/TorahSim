...
# every assert reported with its tuple (ch11_fastcheck.py's form, extended to the table's part). RUN FROM THE REPO ROOT.
import os, sys, re, subprocess, traceback, ast
ROOT = _ROOT
SP = os.path.dirname(os.path.abspath(__file__))
sys.path.insert(0, ROOT + '/World/step9')
p1 = open(SP + '/ch12_part1.py', encoding='utf-8').read()
...
ns = {'__file__': SP + '/ch12_part1.py', '__name__': 'fastcheck'}

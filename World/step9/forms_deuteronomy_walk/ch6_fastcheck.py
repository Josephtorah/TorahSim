...
# every assert reported with its tuple (deu_fastcheck.py's form)
import os, sys, re, subprocess, traceback, ast
ROOT = _ROOT
SP = os.path.dirname(os.path.abspath(__file__))
sys.path.insert(0, ROOT + '/World/step9')
p1 = open(SP + '/ch6_part1.py', encoding='utf-8').read()
...
ns = {'__file__': SP + '/ch6_part1.py', '__name__': 'fastcheck'}
...
p2 = open(SP + '/ch6_part2.py', encoding='utf-8').read()

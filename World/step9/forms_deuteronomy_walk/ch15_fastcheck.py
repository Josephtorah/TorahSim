...
# every assert reported with its tuple (ch14_fastcheck.py's form). RUN FROM THE REPO ROOT.
...
ns = {'__file__': SP + '/ch15_part1.py', '__name__': 'fastcheck'}

...
_ROOT = _os.path.normpath(_os.path.join(_os.path.dirname(_os.path.abspath(__file__)), '..', '..', '..'))   # THE PORTABLE REPO (2026-09-15): the repo root from this file's own place   # THE DEUTERONOMY WALK 14b (2026-09-23): a scratch script — the repo root from git, run from the repo root (the forms copy computes it from its own place)
#!/usr/bin/env python3
...
# THE DEUTERONOMY WALK 14b (2026-09-23; DEUTERONOMY_WALK.md "Sitting 14b" THE LEAN DESIGN): NO MARKER — chapter 16's FIVE lines (passover_at_the_place_declared 16:1-8,

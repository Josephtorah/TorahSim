#!/usr/bin/env python3
"""run_mishpatim.py — run the Mishpatim exam's case rows against the engine.

Loads cases_mishpatim.yaml, validates every input against the vocabulary
...
def main():
    spec = yaml.safe_load(open(HERE / "cases_mishpatim.yaml",
                               encoding="utf-8"))
    ...
    print("\nMISHPATIM: %d cases, %d answered, %d matched, %d misses"

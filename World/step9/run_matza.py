#!/usr/bin/env python3
"""run_matza.py — run round 18 (MATZA, HERBS, AND THE TELLING) against the engine.

Loads cases_matza.yaml, validates every input against the vocabulary
...
def main():
    spec = yaml.safe_load(open(HERE / "cases_matza.yaml",
                               encoding="utf-8"))
    ...
    print("\nMATZA: %d cases, %d answered, %d matched, %d misses"

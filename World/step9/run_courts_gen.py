#!/usr/bin/env python3
"""run_courts_gen.py — run round 35 (THE COURTS GENESIS LAYER) against the engine.

Loads cases_courts_gen.yaml, validates every input against the vocabulary
...
def main():
    spec = yaml.safe_load(open(HERE / "cases_courts_gen.yaml",
                               encoding="utf-8"))
    ...
    print("\nCOURTS-GEN: %d cases, %d answered, %d matched, %d misses"

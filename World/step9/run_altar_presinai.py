#!/usr/bin/env python3
"""run_altar_presinai.py — run round 38 (THE ALTAR BEFORE SINAI) against the engine.

Loads cases_altar_presinai.yaml, validates every input against the vocabulary
...
def main():
    spec = yaml.safe_load(open(HERE / "cases_altar_presinai.yaml",
                               encoding="utf-8"))
    ...
    print("\nALTAR-PRESINAI: %d cases, %d answered, %d matched, %d misses"

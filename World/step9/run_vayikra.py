#!/usr/bin/env python3
"""run_vayikra.py — run the Vayikra exam's case rows against the engine.

Loads cases_vayikra.yaml, validates every input against the vocabulary
...
def main():
    spec = yaml.safe_load(open(HERE / "cases_vayikra.yaml",
                               encoding="utf-8"))
    ...
    print("\nVAYIKRA: %d cases, %d answered, %d matched, %d misses"

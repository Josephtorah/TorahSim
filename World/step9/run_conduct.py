#!/usr/bin/env python3
"""run_conduct.py — run round 21 (CONDUCT AND LITURGY) against the engine.

Loads cases_conduct.yaml, validates every input against the vocabulary
...
def main():
    spec = yaml.safe_load(open(HERE / "cases_conduct.yaml",
                               encoding="utf-8"))
    ...
    print("\nCONDUCT: %d cases, %d answered, %d matched, %d misses"

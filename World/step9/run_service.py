#!/usr/bin/env python3
"""run_service.py — run round 28 (THE SERVICE ORDER) against the engine.

Loads cases_service.yaml, validates every input against the vocabulary
...
def main():
    spec = yaml.safe_load(open(HERE / "cases_service.yaml",
                               encoding="utf-8"))
    ...
    print("\nSERVICE: %d cases, %d answered, %d matched, %d misses"

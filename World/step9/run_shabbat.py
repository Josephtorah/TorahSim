#!/usr/bin/env python3
"""run_shabbat.py — run round 17 (SHABBAT'S MACHINERY) against the engine.

Loads cases_shabbat.yaml, validates every input against the vocabulary
...
def main():
    spec = yaml.safe_load(open(HERE / "cases_shabbat.yaml",
                               encoding="utf-8"))
    ...
    print("\nSHABBAT: %d cases, %d answered, %d matched, %d misses"

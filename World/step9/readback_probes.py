...
def q17():
    ...
    return got == (1, 1, 1, False, 172, 1, 1, 1, 1, 1, 2, 1, 'Deut 7:1', 'Deut 7:25'), 'got (nations_devoted, hearing_blessed, abomination_barred, a chapter-7 marker, markers, the ban\'s debit, covenant_barred, favor_barred, intermarriage_barred, blessing_promised, pity_barred, house_abomination_barred, their sources) = %s' % (got,)
def q18():
    import yaml as _y
    isr = W.entities.get('israel_people')
    def L(eff): return [e for e in isr.ledger if e['effect'] == eff] if isr else []

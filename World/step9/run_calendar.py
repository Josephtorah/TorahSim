#!/usr/bin/env python3
"""run_calendar.py — run round 22 (THE CALENDAR) against the engine.

Loads cases_calendar.yaml, validates every input against the vocabulary
...
def main():
    spec = yaml.safe_load(open(HERE / "cases_calendar.yaml",
                               encoding="utf-8"))
    ...
    print("\nCALENDAR: %d cases, %d answered, %d matched, %d misses"

#!/usr/bin/env python3
"""run_sanctuary.py — run round 26 (SANCTUARY CONSTANTS) against the engine.

Loads cases_sanctuary.yaml, validates every input against the vocabulary
...
def main():
    spec = yaml.safe_load(open(HERE / "cases_sanctuary.yaml",
                               encoding="utf-8"))
    ...
    print("\nSANCTUARY: %d cases, %d answered, %d matched, %d misses"

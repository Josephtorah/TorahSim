#!/usr/bin/env python3
"""run_circumcision.py — run round 31 (THE CIRCUMCISION MACHINE) against the engine.

Loads cases_circumcision.yaml, validates every input against the vocabulary
...
def main():
    spec = yaml.safe_load(open(HERE / "cases_circumcision.yaml",
                               encoding="utf-8"))
    ...
    print("\nCIRCUMCISION: %d cases, %d answered, %d matched, %d misses"

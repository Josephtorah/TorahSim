#!/usr/bin/env python3
"""run_ink.py — run round 20 (THE INK LAYER) against the engine.

Loads cases_ink.yaml, validates every input against the vocabulary
...
def main():
    spec = yaml.safe_load(open(HERE / "cases_ink.yaml",
                               encoding="utf-8"))
    ...
    print("\nINK: %d cases, %d answered, %d matched, %d misses"

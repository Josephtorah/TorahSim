#!/usr/bin/env python3
"""run_conduct_gen.py — run round 40 (THE CONDUCT TORAH) against the engine.

Loads cases_conduct_gen.yaml, validates every input against the vocabulary
...
def main():
    spec = yaml.safe_load(open(HERE / "cases_conduct_gen.yaml",
                               encoding="utf-8"))
    ...
    print("\nCONDUCT-GEN: %d cases, %d answered, %d matched, %d misses"

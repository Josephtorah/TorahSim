#!/usr/bin/env python3
"""run_decalogue.py — run round 29 (THE DECALOGUE, the finale) against the engine.

Loads cases_decalogue.yaml, validates every input against the vocabulary
...
def main():
    spec = yaml.safe_load(open(HERE / "cases_decalogue.yaml",
                               encoding="utf-8"))
    ...
    print("\nDECALOGUE: %d cases, %d answered, %d matched, %d misses"

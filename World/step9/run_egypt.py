#!/usr/bin/env python3
"""run_egypt.py — run round 19 (EGYPT AND THE GENERATIONS) against the engine.

Loads cases_egypt.yaml, validates every input against the vocabulary
...
agreement. Same discipline as run_matza.py."""
import sys
...
def main():
    spec = yaml.safe_load(open(HERE / "cases_egypt.yaml",
                               encoding="utf-8"))
    ...
    print("\nEGYPT: %d cases, %d answered, %d matched, %d misses"

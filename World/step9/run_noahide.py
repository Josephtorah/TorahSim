#!/usr/bin/env python3
"""run_noahide.py — run the Noahide block's case rows against the engine.

Loads cases_noahide.yaml, validates every input against the vocabulary
...
def main():
    spec = yaml.safe_load(open(HERE / "cases_noahide.yaml",
                               encoding="utf-8"))
    ...
    print("\nNOAHIDE: %d cases, %d answered, %d matched, %d misses"

#!/usr/bin/env python3
"""run_vayakhel_pekudei.py — run the Vayakhel-Pekudei exam's case rows against the engine.

Loads cases_vayakhel_pekudei.yaml, validates every input against the vocabulary
...
agreement. Same discipline as run_kitisa.py."""
import sys
...
def main():
    spec = yaml.safe_load(open(HERE / "cases_vayakhel_pekudei.yaml",
                               encoding="utf-8"))
    ...
    print("\nVAYAKHEL-PEKUDEI: %d cases, %d answered, %d matched, %d misses"

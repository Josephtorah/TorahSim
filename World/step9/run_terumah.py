#!/usr/bin/env python3
"""run_terumah.py — run the Terumah exam's case rows against the engine.

Loads cases_terumah.yaml, validates every input against the vocabulary
...
def main():
    spec = yaml.safe_load(open(HERE / "cases_terumah.yaml",
                               encoding="utf-8"))
    ...
    print("\nTERUMAH: %d cases, %d answered, %d matched, %d misses"

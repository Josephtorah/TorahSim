#!/usr/bin/env python3
"""run_table_knife.py — run round 37 (THE TABLE AND THE KNIFE) against the engine.

Loads cases_table_knife.yaml, validates every input against the vocabulary
...
def main():
    spec = yaml.safe_load(open(HERE / "cases_table_knife.yaml",
                               encoding="utf-8"))
    ...
    print("\nTABLE-KNIFE: %d cases, %d answered, %d matched, %d misses"

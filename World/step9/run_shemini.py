#!/usr/bin/env python3
"""run_shemini.py — run round 42 (THE SHEMINI EXAM — bare Mishnah rows, Lev 9-11) against the engine.

Loads cases_shemini.yaml, validates every input against the vocabulary
...
def main():
    spec = yaml.safe_load(open(HERE / "cases_shemini.yaml",
                               encoding="utf-8"))
    ...
    print("\nSHEMINI: %d cases, %d answered, %d matched, %d misses"

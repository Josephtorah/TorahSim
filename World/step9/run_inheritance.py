#!/usr/bin/env python3
"""run_inheritance.py — run round 34 (INHERITANCE, DEEDS, AND SURETY) against the engine.

Loads cases_inheritance.yaml, validates every input against the vocabulary
...
def main():
    spec = yaml.safe_load(open(HERE / "cases_inheritance.yaml",
                               encoding="utf-8"))
    ...
    print("\nINHERITANCE: %d cases, %d answered, %d matched, %d misses"

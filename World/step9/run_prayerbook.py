#!/usr/bin/env python3
"""run_prayerbook.py — run round 30 (THE PRAYER BOOK OF THE PATRIARCHS) against the engine.

Loads cases_prayerbook.yaml, validates every input against the vocabulary
...
def main():
    spec = yaml.safe_load(open(HERE / "cases_prayerbook.yaml",
                               encoding="utf-8"))
    ...
    print("\nPRAYERBOOK: %d cases, %d answered, %d matched, %d misses"

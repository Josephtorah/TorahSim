#!/usr/bin/env python3
"""run_festivals.py — run round 24 (FESTIVALS AND GIFTS) against the engine.

Loads cases_festivals.yaml, validates every input against the vocabulary
...
def main():
    spec = yaml.safe_load(open(HERE / "cases_festivals.yaml",
                               encoding="utf-8"))
    ...
    print("\nFESTIVALS: %d cases, %d answered, %d matched, %d misses"
